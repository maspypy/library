...
data:
  ...
  bundledCode: "#line 1 \"test/atcoder/abc276_h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc276/tasks/abc276_Ex\"\
    ...
    \n  }\r\n};\n#line 1 \"linalg/solve_linear_F2.hpp\"\n// bitset \u3067\u9AD8\u901F\
    ...
    \ d, e);\n    --a, --c;\n    dat.eb(a, b, c, d, e);\n  }\n\n  auto idx = [&](int\
    \ i, int j) -> int { return (N + 1) * i + j; };\n\n  // 4 \u3064\u7D44 -> 2 \u306E\
    \u500B\u6570\u306E\u5076\u5947\n  vc<T> eqs;\n  for (auto&& [a, b, c, d, e]: dat)\
    \ {\n    if (e == 0) continue;\n    int x0 = idx(a, c);\n    int x1 = idx(a, d);\n\
    \    int x2 = idx(b, c);\n    int x3 = idx(b, d);\n    eqs.eb(x0, x1, x2, x3,\
    \ (e == 1 ? 0 : 1));\n  }\n  vc<int> X;\n  for (auto&& [a, b, c, d, e]: eqs) X.eb(a),\
    \ X.eb(b), X.eb(c), X.eb(d);\n  UNIQUE(X);\n  for (auto&& [a, b, c, d, e]: eqs)\
    \ {\n    a = LB(X, a);\n    b = LB(X, b);\n    c = LB(X, c);\n    d = LB(X, d);\n\
    \  }\n\n  vv(bool, mat, len(eqs), len(X));\n  vc<bool> y(len(eqs));\n  FOR(i,\
    \ len(eqs)) {\n    auto [a, b, c, d, e] = eqs[i];\n    mat[i][a] = 1;\n    mat[i][b]\
    \ = 1;\n    mat[i][c] = 1;\n    mat[i][d] = 1;\n    y[i] = e;\n  }\n\n  vv(int,\
    \ ANS2, N, N);\n\n  if (len(eqs)) {\n    auto sol = solve_linear_F2<8000>(len(eqs),\
    ...
    \ N + 1) { FOR(x, N) ANS1[x + 1][y] += ANS1[x][y]; }\n  ANS1.resize(N);\n  FOR(i,\
    \ N) ANS1[i].resize(N);\n  FOR(i, N) FOR(j, N) { ANS1[i][j] = (ANS1[i][j] == 0\
    \ ? 0 : 1); }\n\n  // 0 \u306E\u6761\u4EF6\u3092\u30C1\u30A7\u30C3\u30AF\u3059\
    ...
    \ solve();\n\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc276/tasks/abc276_Ex\"\n\
    #include \"my_template.hpp\"\n#include \"other/io.hpp\"\n#include \"mod/modint.hpp\"\
    \n#include \"ds/cumsum2d.hpp\"\n#include \"linalg/solve_linear_F2.hpp\"\n\nvoid\
    \ solve() {\n  LL(N, Q);\n  using T = tuple<int, int, int, int, int>;\n  vc<T>\
    \ dat;\n  FOR(Q) {\n    LL(a, b, c, d, e);\n    --a, --c;\n    dat.eb(a, b, c,\
    \ d, e);\n  }\n\n  auto idx = [&](int i, int j) -> int { return (N + 1) * i +\
    \ j; };\n\n  // 4 \u3064\u7D44 -> 2 \u306E\u500B\u6570\u306E\u5076\u5947\n  vc<T>\
    \ eqs;\n  for (auto&& [a, b, c, d, e]: dat) {\n    if (e == 0) continue;\n   \
    \ int x0 = idx(a, c);\n    int x1 = idx(a, d);\n    int x2 = idx(b, c);\n    int\
  ...
  verifiedWith: []
documentation_of: test/atcoder/abc276_h.test.cpp
layout: document
redirect_from:
- /verify/test/atcoder/abc276_h.test.cpp
- /verify/test/atcoder/abc276_h.test.cpp.html
