...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc180e.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc180/tasks/abc180_e\"\
    ...
    \ -1;\n    }();\n    C.eb(frm);\n    t ^= 1 << to;\n  }\n  reverse(all(C));\n\
    \  return {res, C};\n}\n#line 6 \"test/5_atcoder/abc180e.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N);\n  using T = tuple<int, int, int>;\n  VEC(T, dat, N);\n  Graph<int,\
    \ 1> G(N);\n  FOR(i, N) FOR(j, N) {\n    if (i == j) continue;\n    auto [a, b,\
    \ c] = dat[i];\n    auto [p, q, r] = dat[j];\n    G.add(i, j, abs(p - a) + abs(q\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc180e.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc180e.test.cpp
- /verify/test/5_atcoder/abc180e.test.cpp.html
