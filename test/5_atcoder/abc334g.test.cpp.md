...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc334g.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc334/tasks/abc334_g\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc334g.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \    int k = binary_search(\n        [&](int k) -> bool {\n          int c = ch[r][k];\n\
    \          return LID[c] <= LID[v];\n        },\n        0, n);\n    return ch[r][k];\n\
    \  }\n};\n#line 7 \"test/5_atcoder/abc334g.test.cpp\"\n\nusing mint = modint998;\n\
    \nvoid solve() {\n  LL(H, W);\n  VEC(string, S, H);\n  vv(int, IDX, H, W, -1);\n\
    \  int p = 0;\n  FOR(x, H) FOR(y, W) {\n    if (S[x][y] == '#') { IDX[x][y] =\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc334g.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc334g.test.cpp
- /verify/test/5_atcoder/abc334g.test.cpp.html
