...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/agc013e.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/agc013/tasks/agc013_e\"\
    ...
    \  }\n}\n#line 8 \"test/5_atcoder/agc013e.test.cpp\"\n\nusing mint = modint107;\n\
    \nvoid solve() {\n  LL(N, M);\n  using poly = vc<mint>;\n  poly f = {0, 1, 1};\n\
    \  poly Q = {1, -4, 2, -1};\n  int now = 0;\n  FOR(M) {\n    INT(x);\n    f =\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/agc013e.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/agc013e.test.cpp
- /verify/test/5_atcoder/agc013e.test.cpp.html
