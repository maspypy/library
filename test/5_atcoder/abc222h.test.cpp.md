...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc222h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc222/tasks/abc222_h\"\
    ...
    \n}\r\n#line 6 \"test/5_atcoder/abc222h.test.cpp\"\n\nusing mint = modint998;\n\
    using poly = vc<mint>;\nvoid solve() {\n  LL(N);\n  poly f = {1, 3, 1};\n  f.resize(N);\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc222h.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc222h.test.cpp
- /verify/test/5_atcoder/abc222h.test.cpp.html
