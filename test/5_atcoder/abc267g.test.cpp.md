...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc267g.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc267/tasks/abc267_g\"\
    ...
    \n\r\n  reverse(all(f));\r\n  mint ia = a.inverse();\r\n  mint pow = 1;\r\n  FOR(i,\
    \ n) f[i] *= pow, pow *= ia;\r\n  return f;\r\n}\r\n#line 8 \"test/5_atcoder/abc267g.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc267g.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc267g.test.cpp
- /verify/test/5_atcoder/abc267g.test.cpp.html
