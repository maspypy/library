...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc256ex.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc256/tasks/abc256_Ex\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc256ex.test.cpp\"\n\n#line 2 \"ds/fastset.hpp\"\
    \n\r\n// 64-ary tree\r\n// space: (N/63) * u64\r\nstruct FastSet {\r\n  static\
    \ constexpr u32 B = 64;\r\n  int n, log;\r\n  vvc<u64> seg;\r\n\r\n  FastSet()\
    ...
    \ x;\r\n    return a * E(size);\r\n  }\r\n};\r\n#line 8 \"test/5_atcoder/abc256ex.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc256ex.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc256ex.test.cpp
- /verify/test/5_atcoder/abc256ex.test.cpp.html
