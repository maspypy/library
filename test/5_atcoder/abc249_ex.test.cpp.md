...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc249_ex.test.cpp\"\n#define PROBLEM \"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc249_ex.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ a[i][i];\n      a[i][i] *= c;\n      b[i] *= c;\n    }\n    FOR(j, i + 1, n)\
    \ {\n      b[j] -= b[i] * a[j][i];\n      a[j][i] = T(0);\n    }\n  }\n  return\
    \ b;\n}\n#line 8 \"test/5_atcoder/abc249_ex.test.cpp\"\n\nusing mint = modint998;\n\
    \nvoid solve() {\n  LL(N);\n  VEC(ll, A, N);\n  for (auto&& x: A) --x;\n  vi CNT(N);\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc249_ex.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc249_ex.test.cpp
- /verify/test/5_atcoder/abc249_ex.test.cpp.html
