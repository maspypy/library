...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc270_f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc270/tasks/abc270_f\"\
    ...
    \ in_mst, MST, ANS};\r\n}\n#line 6 \"test/5_atcoder/abc270_f.test.cpp\"\n\nvoid\
    \ solve() {\n  LL(N, M);\n  VEC(ll, X, N);\n  VEC(ll, Y, N);\n  using T = tuple<int,\
...
layout: document
redirect_from:
- /verify/test/5_atcoder/abc270_f.test.cpp
- /verify/test/5_atcoder/abc270_f.test.cpp.html
