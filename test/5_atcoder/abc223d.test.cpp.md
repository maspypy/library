...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc223d.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc223/tasks/abc223_d\"\
    ...
    \    }\n  }\n  return (len(V) < N ? vc<int>{} : V);\n}\n#line 5 \"test/5_atcoder/abc223d.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M);\n  Graph<int, 1> G(N);\n  G.read_graph(M);\n \
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc223d.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc223d.test.cpp
- /verify/test/5_atcoder/abc223d.test.cpp.html
