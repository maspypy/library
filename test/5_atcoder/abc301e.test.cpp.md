...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc301e.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc301/tasks/abc301_e\"\
    ...
    \ ny, dist[x][y] + 1);\n    }\n  }\n  return dist;\n}\n#line 5 \"test/5_atcoder/abc301e.test.cpp\"\
    \n\nvoid solve() {\n  LL(H, W, T);\n  VEC(string, A, H);\n\n  vc<pi> pos;\n  FOR(x,\
    \ H) FOR(y, W) if (A[x][y] == 'S') pos.eb(x, y);\n  FOR(x, H) FOR(y, W) if (A[x][y]\
    ...
    \ {\n        ll t = s | 1 << b;\n        if (s == t) continue;\n        chmin(dp[t][b],\
    \ dp[s][a] + dist[a][b]);\n      }\n    }\n  }\n\n  if (dist[0][N - 1] > T) return\
    \ print(-1);\n\n  ll ANS = 0;\n  FOR(s, 1 << N) {\n    if (dp[s][N - 1] > T) continue;\n\
    \    ll n = popcnt(s) - 2;\n    chmax(ANS, n);\n  }\n  print(ANS);\n}\n\nsigned\
    \ main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc301/tasks/abc301_e\"\n#include\
...
layout: document
redirect_from:
- /verify/test/5_atcoder/abc301e.test.cpp
- /verify/test/5_atcoder/abc301e.test.cpp.html
