...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc318/tasks/abc318_Ex
    links:
    - https://atcoder.jp/contests/abc318/tasks/abc318_Ex
  bundledCode: "#line 1 \"test/5_atcoder/abc318h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc318/tasks/abc318_Ex\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc318h.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ : fps_exp_dense<mint>(f));\r\n}\r\n#line 7 \"test/5_atcoder/abc318h.test.cpp\"\
    \n\nusing mint = modint998;\n\nvoid solve() {\n  LL(N);\n  mint ALL = fact<mint>(N)\
    \ * fact<mint>(N);\n  vc<mint> f(N + 1);\n  FOR(n, 1, N + 1) { f[n] = inv<mint>(n)\
    \ * inv<mint>(n); }\n  f = fps_exp(f);\n  mint A = f[N] * fact<mint>(N) * fact<mint>(N);\n\
    \  mint ANS = ALL - A - A + fact<mint>(N);\n  print(ANS);\n}\n\nsigned main()\
    \ {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc318/tasks/abc318_Ex\"\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc318h.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc318h.test.cpp
- /verify/test/5_atcoder/abc318h.test.cpp.html
