...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc288ex.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc288/tasks/abc288_Ex\"\
    ...
    \  return res;\n}\n#line 7 \"test/5_atcoder/abc288ex.test.cpp\"\n\nusing mint\
    \ = modint998;\nusing poly = vc<mint>;\n\nvoid solve() {\n  LL(N, M, X);\n  ++M;\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc288ex.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc288ex.test.cpp
- /verify/test/5_atcoder/abc288ex.test.cpp.html
