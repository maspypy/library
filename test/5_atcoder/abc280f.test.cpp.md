...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc280f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc280/tasks/abc280_f\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 5 \"test/5_atcoder/abc280f.test.cpp\"\
    ...
    \ = true;\r\n};\r\n#line 8 \"test/5_atcoder/abc280f.test.cpp\"\n\nvoid solve()\
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc280/tasks/abc280_f\"\n\n\
    ...
    \n#include \"alg/monoid/add.hpp\"\n\nvoid solve() {\n  LL(N, M, Q);\n  Potentialized_UnionFind<Monoid_Add<ll>>\
    \ uf(N);\n  vi neg(N);\n\n  FOR(M) {\n    LL(a, b, c);\n    --a, --b;\n    auto\
    \ [ra, xa] = uf[a];\n    auto [rb, xb] = uf[b];\n    if (ra != rb) {\n      uf.merge(a,\
    \ b, c);\n      continue;\n    }\n    if (xa + c == xb) continue;\n    neg[a]\
    \ = 1;\n  }\n  FOR(v, N) if (neg[v]) {\n    auto [r, x] = uf[v];\n    neg[r] =\
