...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc324g.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc324/tasks/abc324_g\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc324g.test.cpp\"\n\n#line 1 \"ds/bit_vector.hpp\"\
    \nstruct Bit_Vector {\n  int n;\n  bool prepared = 0;\n  vc<pair<u64, u32>> dat;\n\
    ...
    \ + mid[d] - r0;\r\n      if (l0 < r0) L = l0, R = r0;\r\n      if (l0 == r0)\
    \ L = l1, R = r1;\r\n      seg[d].multiply(L, t);\r\n    }\r\n  }\r\n  void add(int\
    \ i, T t) { multiply(i, t); }\r\n};\r\n#line 6 \"test/5_atcoder/abc324g.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc324g.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc324g.test.cpp
- /verify/test/5_atcoder/abc324g.test.cpp.html
