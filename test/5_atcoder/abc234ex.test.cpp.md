...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc234ex.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc234/tasks/abc234_Ex\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc234ex.test.cpp\"\n\n#line 1 \"ds/kdtree/kdtree.hpp\"\
    ...
    \    }\n  }\n};\n#line 6 \"test/5_atcoder/abc234ex.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N, K);\n  vc<int> X(N), Y(N);\n  FOR(i, N) {\n    INT(a, b);\n    X[i]\
    \ = a, Y[i] = b;\n  }\n  KDTree<int> KDT(X, Y);\n\n  int x_min = MIN(X);\n  int\
    \ x_max = MAX(X);\n  int y_min = MIN(Y);\n  int y_max = MAX(Y);\n\n  vc<pair<int,\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc234ex.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc234ex.test.cpp
- /verify/test/5_atcoder/abc234ex.test.cpp.html
