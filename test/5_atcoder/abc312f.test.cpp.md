...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc312f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc312/tasks/abc312_f\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc312f.test.cpp\"\n\n#line 2 \"ds/removable_queue.hpp\"\
    ...
    \ x) { qr.remove(x), sr -= x; }\n};\n#line 6 \"test/5_atcoder/abc312f.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M);\n  vi A, B, C;\n  ll ANS = 0;\n  FOR(N) {\n  \
    \  LL(t, x);\n    if (t == 0) C.eb(x);\n    if (t == 1) B.eb(x);\n    if (t ==\
    \ 2) A.eb(x);\n  }\n  sort(all(A));\n  reverse(all(A));\n  sort(all(B));\n  reverse(all(B));\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc312f.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc312f.test.cpp
- /verify/test/5_atcoder/abc312f.test.cpp.html
