...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc245g.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc245/tasks/abc245_g\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc245g.test.cpp\"\n\n#line 2 \"graph/base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T cost;\n  int id;\n\
    ...
    \ = true;\n};\n#line 7 \"test/5_atcoder/abc245g.test.cpp\"\n\nvoid solve() {\n\
    \  LL(N, M, K, L);\n  VEC(ll, A, N);\n  for (auto&& a: A) --a;\n  VEC(ll, B, L);\n\
    \  for (auto&& b: B) --b;\n\n  Graph<int, 0> G(N);\n  G.read_graph(M, 1);\n\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc245g.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc245g.test.cpp
- /verify/test/5_atcoder/abc245g.test.cpp.html
