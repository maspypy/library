...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc245g2.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc245/tasks/abc245_g\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc245g2.test.cpp\"\n\n#line 2 \"graph/base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T cost;\n  int id;\n\
    ...
    \ }\n  }\n  return dist;\n}\n#line 6 \"test/5_atcoder/abc245g2.test.cpp\"\n\n\
    void solve() {\n  LL(N, M, K, L);\n  VEC(ll, A, N);\n  for (auto&& a: A) --a;\n\
    \  VEC(ll, B, L);\n  for (auto&& b: B) --b;\n\n  Graph<int, 1> G(N + K);\n  FOR(M)\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc245g2.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc245g2.test.cpp
- /verify/test/5_atcoder/abc245g2.test.cpp.html
