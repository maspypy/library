...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/arc123d.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/arc123/tasks/arc123_d\"\
    ...
    \ }\r\n    sort(all(left));\r\n    sort(all(right));\r\n    print(\"min_f\", min_f,\
    \ \"left\", left, \"right\", right);\r\n  }\r\n#endif\r\n};\n#line 5 \"test/5_atcoder/arc123d.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  VEC(ll, A, N);\n  Slope_Trick_0 X;\n  FOR(i, N)\
  ...
  requiredBy: []
  timestamp: '2024-11-03 22:39:21+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/5_atcoder/arc123d.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/arc123d.test.cpp
- /verify/test/5_atcoder/arc123d.test.cpp.html
