...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/agc023f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/agc023/tasks/agc023_f\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/agc023f.test.cpp\"\n\n#line 2 \"graph/tree.hpp\"\
    ...
    \ = [&](Data x, Data y) -> bool { return x.x0 * y.x1 > x.x1 * y.x0; };\n  auto\
    \ [ord, x]\n      = optimal_product_on_tree<decltype(tree), Mono, true>(tree,\
    \ A, comp);\n  print(x.ans);\n}\n\nsigned main() {\n  solve();\n  return 0;\n\
    }\n"
...
layout: document
redirect_from:
- /verify/test/5_atcoder/agc023f.test.cpp
- /verify/test/5_atcoder/agc023f.test.cpp.html
