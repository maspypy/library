...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/arc133f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/arc133/tasks/arc133_f\"\
    ...
    \  return composition_f_a_plus_bx(f, c, d);\n}\n#line 7 \"test/5_atcoder/arc133f.test.cpp\"\
    \n\nusing mint = modint998;\n\nvoid solve() {\n  LL(N, K);\n  vc<mint> f(N + 1);\n\
    \  FOR(i, N + 1) {\n    U32(x);\n    f[i] = x;\n  }\n\n  f = composition_f_a_plus_bx_div_c_plus_dx<mint,\
    \ true>(f, 1, -1, 1, 1);\n  FOR(i, N + 1) f[i] *= mint(N - i - i).pow(K);\n  f\
    \ = composition_f_a_plus_bx_div_c_plus_dx<mint, true>(f, 0, 1, 2, -1);\n  f =\
    \ composition_f_a_plus_bx<mint>(f, 1, -1);\n  mint sm = SUM<mint>(f);\n  mint\
    \ cf = mint(1) / sm;\n  for (auto&& x: f) x *= cf;\n  print(f);\n}\n\nsigned main()\
    \ {\n  solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/arc133/tasks/arc133_f\"\n\n\
    ...
    void solve() {\n  LL(N, K);\n  vc<mint> f(N + 1);\n  FOR(i, N + 1) {\n    U32(x);\n\
    \    f[i] = x;\n  }\n\n  f = composition_f_a_plus_bx_div_c_plus_dx<mint, true>(f,\
    \ 1, -1, 1, 1);\n  FOR(i, N + 1) f[i] *= mint(N - i - i).pow(K);\n  f = composition_f_a_plus_bx_div_c_plus_dx<mint,\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/arc133f.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/arc133f.test.cpp
- /verify/test/5_atcoder/arc133f.test.cpp.html
