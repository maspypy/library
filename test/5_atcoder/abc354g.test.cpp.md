...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc354g.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc354/tasks/abc354_g\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc354g.test.cpp\"\n\n#line 2 \"string/zalgorithm.hpp\"\
    ...
    \  }\n  ans = SUM<WT>(wt) - ans;\n  return {ans, antichain};\n}\n#line 7 \"test/5_atcoder/abc354g.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  VEC(string, S, N);\n  VEC(ll, A, N);\n  {\n  \
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc354g.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc354g.test.cpp
- /verify/test/5_atcoder/abc354g.test.cpp.html
