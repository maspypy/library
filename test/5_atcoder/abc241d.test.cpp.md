...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc241d.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc241/tasks/abc241_d\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/5_atcoder/abc241d.test.cpp\"\n\n#line 1 \"ds/my_multiset.hpp\"\
    ...
    \ My_Multiset {\n  struct Mono {\n    using value_type = pair<ll, i128>; // cnt,\
    \ sum\n    using X = value_type;\n    static X op(X x, X y) { return {x.fi + y.fi,\
    \ x.se + y.se}; }\n    static constexpr X unit() { return {0, 0}; }\n    static\
    \ constexpr bool commute = 1;\n  };\n  Dynamic_SegTree_Sparse<Mono, false, NODES>\
...
layout: document
redirect_from:
- /verify/test/5_atcoder/abc241d.test.cpp
- /verify/test/5_atcoder/abc241d.test.cpp.html
