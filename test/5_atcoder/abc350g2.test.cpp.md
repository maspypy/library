...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc350g2.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc350/tasks/abc350_g\"\
    ...
    #line 5 \"test/5_atcoder/abc350g2.test.cpp\"\n\nusing BS = My_Bitset;\n\nvoid\
    \ solve() {\n  LL(N, Q);\n  vc<BS> bs(N);\n  vc<set<int>> nbd(N);\n  int t = 100;\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc350g2.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc350g2.test.cpp
- /verify/test/5_atcoder/abc350g2.test.cpp.html
