...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc339f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc339/tasks/abc339_f\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc339f.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ = b;\r\n  }\r\n};\n#line 8 \"test/5_atcoder/abc339f.test.cpp\"\n\nusing B =\
    \ BigInteger;\n\nvoid solve() {\n  LL(N);\n  vc<B> A(N);\n  FOR(i, N) {\n    STR(S);\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc339f.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc339f.test.cpp
- /verify/test/5_atcoder/abc339f.test.cpp.html
