...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc139f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc139/tasks/abc139_f\"\
    ...
    \ yes(!t); }\r\n#line 6 \"test/5_atcoder/abc139f.test.cpp\"\n\n#line 2 \"geo/base.hpp\"\
    \ntemplate <typename T>\nstruct Point {\n  T x, y;\n\n  Point() : x(0), y(0) {}\n\
    ...
    \ }\n  return {ANS, ids};\n}\n#line 8 \"test/5_atcoder/abc139f.test.cpp\"\n\n\
    using P = Point<ll>;\n\nvoid solve() {\n  LL(N);\n  VEC(P, point, N);\n  auto\
    \ [val, I] = max_norm_sum<ll, ll>(point);\n  ll x = 0, y = 0;\n  for (auto&& i:\
    \ I) x += point[i].x, y += point[i].y;\n  assert(val == x * x + y * y);\n  double\
    \ ANS = sqrtl(val);\n  print(ANS);\n}\n\nsigned main() {\n  solve();\n  return\
    \ 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc139f.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc139f.test.cpp
- /verify/test/5_atcoder/abc139f.test.cpp.html
