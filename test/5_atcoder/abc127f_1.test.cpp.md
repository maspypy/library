...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc127f_1.test.cpp\"\n#define PROBLEM \"\
    ...
    #line 6 \"test/5_atcoder/abc127f_1.test.cpp\"\n\nvoid solve() {\n  LL(Q);\n  vi\
    \ A, B, query;\n  FOR(Q) {\n    LL(t);\n    if (t == 1) {\n      LL(a, b);\n \
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc127f_1.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc127f_1.test.cpp
- /verify/test/5_atcoder/abc127f_1.test.cpp.html
