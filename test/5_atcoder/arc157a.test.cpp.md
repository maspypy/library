...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/arc157a.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/arc157/tasks/arc157_a\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/arc157a.test.cpp\"\n\n#line 2 \"ds/unionfind/unionfind.hpp\"\
    ...
    \u3042\u308B\u6210\u5206\u3092\u6570\u3048\u308B\r\n    int nc = 0;\r\n    for\
    \ (int v = 0; v < N; ++v) {\r\n      if (uf[v] == v && cnt_edge[v] >= 1) ++nc;\r\
    \n    }\r\n    return nc <= 1;\r\n  }\r\n}\n#line 6 \"test/5_atcoder/arc157a.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, A, B, C, D);\n  Graph<int, 1> G(2);\n  FOR(A) G.add(0,\
    \ 0);\n  FOR(B) G.add(0, 1);\n  FOR(C) G.add(1, 0);\n  FOR(D) G.add(1, 1);\n \
...
layout: document
redirect_from:
- /verify/test/5_atcoder/arc157a.test.cpp
- /verify/test/5_atcoder/arc157a.test.cpp.html
