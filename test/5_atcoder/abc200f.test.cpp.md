...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc200f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc200/tasks/abc200_f\"\
    ...
    \ >= 0);\n    X res = Monoid::unit();\n    while (exp) {\n      if (exp & 1) res\
    \ = Monoid::op(res, x);\n      x = Monoid::op(x, x);\n      exp >>= 1;\n    }\n\
    \    return res;\n  }\n}\n#line 7 \"test/5_atcoder/abc200f.test.cpp\"\n\nusing\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc200f.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc200f.test.cpp
- /verify/test/5_atcoder/abc200f.test.cpp.html
