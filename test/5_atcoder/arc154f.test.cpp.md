...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/arc154f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/arc154/tasks/arc154_f\"\
    ...
    \ \u6B21\u591A\u9805\u5F0F\u306E\u9577\u3055 2^k \u304C\u4E0E\u3048\u3089\u308C\
    \u308B\u306E\u3067 2^k+1 \u306B\u3059\u308B\ntemplate <typename mint, bool transposed\
    ...
    \ B.eb(mint(k));\n  return sum_of_exp_bx(N, A, B);\n}\n#line 8 \"test/5_atcoder/arc154f.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/arc154f.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/arc154f.test.cpp
- /verify/test/5_atcoder/arc154f.test.cpp.html
