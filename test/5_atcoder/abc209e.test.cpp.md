...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc209e.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc209/tasks/abc209_e\"\
    ...
    \ == 0) que.eb(e.to);\n      }\n    }\n  }\n};\n#line 7 \"test/5_atcoder/abc209e.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  VEC(string, dat, N);\n  vc<string> states;\n \
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc209e.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc209e.test.cpp
- /verify/test/5_atcoder/abc209e.test.cpp.html
