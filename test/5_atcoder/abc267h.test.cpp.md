...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc267h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc267/tasks/abc267_Ex\"\
    ...
    \ <typename mint, typename INT>\nvc<mint> product_of_one_minus_xn(vc<INT> A, int\
    \ LIM) {\n  vc<int> CNT(LIM + 1);\n  for (auto&& x: A) {\n    if (x <= LIM) CNT[x]++;\n\
    ...
    \n}\n#line 7 \"test/5_atcoder/abc267h.test.cpp\"\n\nusing mint = modint998;\n\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc267h.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc267h.test.cpp
- /verify/test/5_atcoder/abc267h.test.cpp.html
