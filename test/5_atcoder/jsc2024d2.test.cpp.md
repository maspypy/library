...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/jsc2024d2.test.cpp\"\n#define PROBLEM \"\
    https://atcoder.jp/contests/jsc2024-final/tasks/jsc2024_final_d\"\n#line 1 \"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/jsc2024d2.test.cpp\"\n\n#line 2 \"ds/segtree/segtree_beats.hpp\"\
    ...
    \   return {e.x, e.y};\n  }\n  pair<T1, T2> prod_all() {\n    auto e = seg.prod_all();\n\
    \    return {e.x, e.y};\n  }\n  void apply(int l, int r, T1 a, T2 b) { seg.apply(l,\
    \ r, {a, b}); }\n};\n#line 6 \"test/5_atcoder/jsc2024d2.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N);\n  VEC(int, A, N);\n  vc<int> X = A;\n  UNIQUE(X);\n  vc<int> rk(N);\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/jsc2024d2.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/jsc2024d2.test.cpp
- /verify/test/5_atcoder/jsc2024d2.test.cpp.html
