...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc306h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc306/tasks/abc306_ex\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/5_atcoder/abc306h.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ LIM>(RA);\n}\n#line 8 \"test/5_atcoder/abc306h.test.cpp\"\n\nusing mint = modint998;\n\
    void solve() {\n  LL(N, M);\n  vc<int> nbd(N);\n  FOR(M) {\n    INT(a, b);\n \
    \   --a, --b;\n    nbd[a] |= 1 << b;\n    nbd[b] |= 1 << a;\n  }\n\n  vc<mint>\
    \ F(1 << N);\n  FOR(s, 1 << N) {\n    int comp = 0;\n    int yet = s;\n    while\
    \ (yet) {\n      int root = lowbit(yet);\n      yet ^= 1 << root;\n      ++comp;\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc306h.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc306h.test.cpp
- /verify/test/5_atcoder/abc306h.test.cpp.html
