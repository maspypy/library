...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc272_h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc272/tasks/abc272_Ex\"\
    ...
    \n\r\n  reverse(all(f));\r\n  mint ia = a.inverse();\r\n  mint pow = 1;\r\n  FOR(i,\
    \ n) f[i] *= pow, pow *= ia;\r\n  return f;\r\n}\r\n#line 8 \"test/5_atcoder/abc272_h.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc272_h.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc272_h.test.cpp
- /verify/test/5_atcoder/abc272_h.test.cpp.html
