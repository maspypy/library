...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/arc105.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/arc105/tasks/arc105_f\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 5 \"test/5_atcoder/arc105.test.cpp\"\
    ...
    \    copy(all(a), s.begin() + (1 << i));\n  }\n  return s;\n}\n#line 10 \"test/5_atcoder/arc105.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/arc105.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/arc105.test.cpp
- /verify/test/5_atcoder/arc105.test.cpp.html
