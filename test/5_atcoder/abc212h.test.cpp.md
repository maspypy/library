...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc212h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc212/tasks/abc212_h\"\
    ...
    \ log) FOR(s, 1 << log) {\r\n    int t = s ^ (1 << n);\r\n    if (s < t) tie(A[s],\
    \ A[t]) = mp(A[s] + A[t], A[s] - A[t]);\r\n  }\r\n}\n#line 6 \"test/5_atcoder/abc212h.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc212h.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc212h.test.cpp
- /verify/test/5_atcoder/abc212h.test.cpp.html
