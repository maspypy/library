...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc253h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc253/tasks/abc253_Ex\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/5_atcoder/abc253h.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ 9 \"test/5_atcoder/abc253h.test.cpp\"\n\nconst int LIM = 14;\nusing mint = modint998;\n\
    \nvoid solve() {\n  LL(N, M);\n\n  vv(int, mat, N, N);\n  FOR(M) {\n    INT(a,\
    \ b);\n    --a, --b;\n    mat[a][b]++, mat[b][a]++;\n  }\n\n  // count tree\n\
    \  vc<mint> dp(1 << N);\n  dp[0] = 0;\n  FOR(i, N) {\n    vc<mint> a = {dp.begin(),\
    \ dp.begin() + (1 << i)};\n    FOR(s, 1 << i) {\n      int k = 0;\n      FOR(j,\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc253h.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc253h.test.cpp
- /verify/test/5_atcoder/abc253h.test.cpp.html
