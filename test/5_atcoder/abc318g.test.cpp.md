...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc318g.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc318/tasks/abc318_g\"\
    ...
    \          if (lim == 0) break;\n        }\n      }\n    }\n    return res;\n\
    \  }\n};\n#line 5 \"test/5_atcoder/abc318g.test.cpp\"\n\nvoid solve() {\n  LL(N,\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc318g.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc318g.test.cpp
- /verify/test/5_atcoder/abc318g.test.cpp.html
