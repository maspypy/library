...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc224h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc224/tasks/abc224_h\"\
    ...
    \    return {-val, P};\n  }\n};\n#line 6 \"test/5_atcoder/abc224h.test.cpp\"\n\
    \nvoid solve() {\n  LL(N, M);\n  VEC(ll, A, N);\n  VEC(ll, B, M);\n  VV(ll, C,\
...
layout: document
redirect_from:
- /verify/test/5_atcoder/abc224h.test.cpp
- /verify/test/5_atcoder/abc224h.test.cpp.html
