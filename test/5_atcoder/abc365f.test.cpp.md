...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc365f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc365/tasks/abc365_f\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc365f.test.cpp\"\n\n#line 2 \"ds/segtree/segtree.hpp\"\
    ...
    \ ^ xor_val)]); }\n      l /= 2, r /= 2, xor_val /= 2;\n    }\n    return x;\n\
    \  }\n};\n#line 1 \"alg/monoid/add_chmin_chmax_with_cost.hpp\"\n\ntemplate <typename\
    ...
    \ = 0;\n};\n#line 7 \"test/5_atcoder/abc365f.test.cpp\"\n\nvoid solve() {\n  LL(N);\n\
    \  vi L(N), R(N);\n  FOR(i, N) read(L[i], R[i]);\n  using Mono = Monoid_Add_Chmin_Chmax_With_Cost<ll>;\n\
    \  using F = Mono::F;\n  SegTree<Mono> seg(N, [&](int i) -> F { return F(0, 0,\
    \ 0, L[i], R[i]); });\n  LL(Q);\n  FOR(Q) {\n    LL(x1, y1, x2, y2);\n    --x1,\
    \ --x2;\n    if (x1 > x2) swap(x1, x2), swap(y1, y2);\n    F f = seg.prod(x1,\
    \ x2);\n    auto [a, b, c] = f.eval_cost(y1);\n    ll ANS = b + c;\n    y1 = y1\
    \ + a + b - c;\n    ANS += abs(y1 - y2);\n    ANS += abs(x1 - x2);\n    print(ANS);\n\
    \  }\n}\n\nsigned main() { solve(); }\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc365/tasks/abc365_f\"\n#include\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc365f.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc365f.test.cpp
- /verify/test/5_atcoder/abc365f.test.cpp.html
