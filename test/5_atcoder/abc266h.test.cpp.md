...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc266h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc266/tasks/abc266_Ex\"\
    ...
    \ commute = true;\r\n};\r\n#line 6 \"test/5_atcoder/abc266h.test.cpp\"\n\nusing\
    \ Mono = Monoid_Max<ll>;\n\nvoid solve() {\n  LL(N);\n  using T = tuple<ll, ll,\
    \ ll, ll>;\n\n  VEC(T, dat, N);\n  dat.eb(0, 0, 0, 0);\n  ++N;\n\n  sort(all(dat),\
    \ [&](auto& a, auto& b) -> bool {\n    auto [at, ax, ay, aa] = a;\n    auto [bt,\
...
layout: document
redirect_from:
- /verify/test/5_atcoder/abc266h.test.cpp
- /verify/test/5_atcoder/abc266h.test.cpp.html
