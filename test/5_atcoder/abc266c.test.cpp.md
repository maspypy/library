...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc266c.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc266/tasks/abc266_c\"\
    ...
    \u5916\uFF1A-1\n  int side(Point<T> p) {\n    int a = LOWER.side(p);\n    int\
    \ b = UPPER.side(-p);\n    if (a == 0 || b == 0) return 0;\n    return min(a,\
    \ b);\n  }\n};\n#line 5 \"test/5_atcoder/abc266c.test.cpp\"\n\nvoid solve() {\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc266c.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc266c.test.cpp
- /verify/test/5_atcoder/abc266c.test.cpp.html
