...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc285h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc285/tasks/abc285_Ex\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/5_atcoder/abc285h.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \  f = convolution(f, g);\n  f.resize(n);\n  reverse(all(f));\n  FOR(i, n) f[i]\
    \ *= fact_inv<mint>(i);\n  return f;\n}\n#line 9 \"test/5_atcoder/abc285h.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc285h.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc285h.test.cpp
- /verify/test/5_atcoder/abc285h.test.cpp.html
