...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc279b.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc279/tasks/abc279_b\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/5_atcoder/abc279b.test.cpp\"\n\n#line 1 \"string/zalgorithm.hpp\"\
    ...
    \ >= n) return true;\n  }\n  return false;\n}\n#line 7 \"test/5_atcoder/abc279b.test.cpp\"\
    \n\nvoid solve() {\n  STR(S, T);\n  Yes(is_substring(T, S));\n}\n\nsigned main()\
    \ {\n  solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc279/tasks/abc279_b\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc279b.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc279b.test.cpp
- /verify/test/5_atcoder/abc279b.test.cpp.html
