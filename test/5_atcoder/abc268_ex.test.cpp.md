...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc268_ex.test.cpp\"\n#define PROBLEM \"\
    ...
    \ c;\r\n    fill(all(c.ch), -1);\r\n    fill(all(c.nxt), -1);\r\n    c.parent\
    \ = -1;\r\n    c.suffix_link = -1;\r\n    nodes.eb(c);\r\n    return n_node++;\r\
    \n  }\r\n};\r\n#line 5 \"test/5_atcoder/abc268_ex.test.cpp\"\n\nvoid solve() {\n\
    \  STR(S);\n  LL(N);\n  Trie<26> X;\n  FOR(N) {\n    STR(T);\n    X.add(T, 'a');\n\
...
layout: document
redirect_from:
- /verify/test/5_atcoder/abc268_ex.test.cpp
- /verify/test/5_atcoder/abc268_ex.test.cpp.html
