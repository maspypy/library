...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc259g.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc259/tasks/abc259_g\"\
    ...
    \    }\n  }\n};\n#line 5 \"test/5_atcoder/abc259g.test.cpp\"\n\nvoid solve() {\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc259g.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc259g.test.cpp
- /verify/test/5_atcoder/abc259g.test.cpp.html
