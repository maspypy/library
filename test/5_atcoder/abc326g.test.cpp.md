...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc326g.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc326/tasks/abc326_g\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc326g.test.cpp\"\n\n#line 1 \"flow/maxflow.hpp\"\
    ...
    \          if (lim == 0) break;\n        }\n      }\n    }\n    return res;\n\
    \  }\n};\n#line 6 \"test/5_atcoder/abc326g.test.cpp\"\n\nvoid solve() {\n  LL(N,\
    \ M);\n  VEC(ll, C, N);\n  VEC(ll, A, M);\n\n  int s = 0;\n  int t = 1;\n  auto\
    \ idx = [&](int i, int j) -> int {\n    if (j == 0) return s;\n    if (j == 5)\
    \ return t;\n    return 2 + 4 * i + (j - 1);\n  };\n  auto idx_a = [&](int i)\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc326g.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc326g.test.cpp
- /verify/test/5_atcoder/abc326g.test.cpp.html
