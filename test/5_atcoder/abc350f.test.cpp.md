...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc350f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc350/tasks/abc350_f\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/5_atcoder/abc350f.test.cpp\"\n\n#line 2 \"ds/splaytree/splaytree.hpp\"\
    ...
    \nusing SplayTreeNodes::SplayTree_Basic;\n#line 8 \"test/5_atcoder/abc350f.test.cpp\"\
    \n\nvoid solve() {\n  STR(S);\n  ll N = len(S);\n  SplayTree_Basic<char> ST(1\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc350f.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc350f.test.cpp
- /verify/test/5_atcoder/abc350f.test.cpp.html
