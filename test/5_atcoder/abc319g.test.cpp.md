...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc319g.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc319/tasks/abc319_g\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc319g.test.cpp\"\n\n#line 2 \"graph/base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T cost;\n  int id;\n\
    ...
    #line 7 \"test/5_atcoder/abc319g.test.cpp\"\nusing mint = modint998;\n\nvoid solve()\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc319g.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc319g.test.cpp
- /verify/test/5_atcoder/abc319g.test.cpp.html
