...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc220g.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc220/tasks/abc220_g\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/5_atcoder/abc220g.test.cpp\"\n\n#line 2 \"geo/base.hpp\"\
    \ntemplate <typename T>\nstruct Point {\n  T x, y;\n\n  Point() : x(0), y(0) {}\n\
    ...
    \ = true;\n};\n#line 10 \"test/5_atcoder/abc220g.test.cpp\"\n\nusing P = Point<ll>;\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc220g.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc220g.test.cpp
- /verify/test/5_atcoder/abc220g.test.cpp.html
