...
data:
  ...
  bundledCode: "#line 1 \"test/5_atcoder/abc127f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc127/tasks/abc127_f\"\
    ...
    \ }\r\n    sort(all(left));\r\n    sort(all(right));\r\n    print(\"min_f\", min_f,\
    \ \"left\", left, \"right\", right);\r\n  }\r\n#endif\r\n};\n#line 5 \"test/5_atcoder/abc127f.test.cpp\"\
    \n\nvoid solve() {\n  LL(Q);\n  Slope_Trick_0 f;\n  FOR(Q) {\n    LL(t);\n   \
    \ if (t == 1) {\n      LL(a, b);\n      f.add_const(b);\n      f.add_abs(a);\n\
  ...
  verifiedWith: []
documentation_of: test/5_atcoder/abc127f.test.cpp
layout: document
redirect_from:
- /verify/test/5_atcoder/abc127f.test.cpp
- /verify/test/5_atcoder/abc127f.test.cpp.html
