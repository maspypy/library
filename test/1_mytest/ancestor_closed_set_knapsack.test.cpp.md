...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/ancestor_closed_set_knapsack.test.cpp\"\n\
    ...
    \ typename VAL>\nvc<VAL> ancestor_closed_set_knapsack(TREE& tree, vc<int> weight,\
    \ vc<VAL> val,\n                                     int LIM) {\n  using V = vc<VAL>;\n\
    ...
    \    return Y;\n  };\n\n  V X(LIM + 1, -infty<VAL>);\n  X[0] = 0;\n  V ANS = dfs(dfs,\
    \ 0, X);\n  for (auto& x : ANS)\n    if (x < 0) x = -infty<VAL>;\n  return ANS;\n\
    }\n#line 7 \"test/1_mytest/ancestor_closed_set_knapsack.test.cpp\"\n\nvoid test(int\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include \"\
    ...
    \    vc<int> weight, val;\n    FOR(N) {\n      weight.eb(RNG(1, 10));\n      val.eb(RNG(1,\
    \ 10));\n    }\n    int LIM = RNG(1, 100);\n    auto ANS = ancestor_closed_set_knapsack(tree,\
    \ weight, val, LIM);\n    vc<int> god(LIM + 1, -infty<int>);\n    FOR(s, 1 <<\
    \ N) {\n      bool ok = 1;\n      FOR(v, 1, N) {\n        if (has_kth_bit(s, v)\
    \ && !has_kth_bit(s, tree.parent[v])) ok = 0;\n      }\n      if (!ok) continue;\n\
    \      int a = 0, b = 0;\n      FOR(v, N) if (s >> v & 1) a += weight[v], b +=\
