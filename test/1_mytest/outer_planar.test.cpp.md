...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/outer_planar.test.cpp\"\n#define PROBLEM \"\
    ...
    \ others.end()), ...);\n}\n#endif\n#line 4 \"test/1_mytest/outer_planar.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/1_mytest/outer_planar.test.cpp
- /verify/test/1_mytest/outer_planar.test.cpp.html
