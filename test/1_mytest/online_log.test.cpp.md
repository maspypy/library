...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/online_log.test.cpp\"\n#define PROBLEM \"\
    ...
    \ * f_i, f[i - 1]);\n  }\n};\n#line 7 \"test/1_mytest/online_log.test.cpp\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/online_log.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/online_log.test.cpp
- /verify/test/1_mytest/online_log.test.cpp.html
