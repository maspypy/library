...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/online_inv.test.cpp\"\n#define PROBLEM \"\
    ...
    \    return X.query(i, g_i, f_i);\n  }\n};\n#line 7 \"test/1_mytest/online_inv.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/online_inv.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/online_inv.test.cpp
- /verify/test/1_mytest/online_inv.test.cpp.html
