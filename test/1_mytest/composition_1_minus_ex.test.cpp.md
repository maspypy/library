...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/composition_1_minus_ex.test.cpp\"\n#define\
    ...
    \ others.begin(), others.end()), ...);\n}\n#endif\n#line 3 \"test/1_mytest/composition_1_minus_ex.test.cpp\"\
    \n\n#line 2 \"random/base.hpp\"\n\nu64 RNG_64() {\n  static u64 x_ = u64(chrono::duration_cast<chrono::nanoseconds>(chrono::high_resolution_clock::now().time_since_epoch()).count())\
    \ * 10150724397891781847ULL;\n  x_ ^= x_ << 7;\n  return x_ ^= x_ >> 9;\n}\n\n\
    u64 RNG(u64 lim) { return RNG_64() % lim; }\n\nll RNG(ll l, ll r) { return l +\
    \ RNG_64() % (r - l); }\n#line 1 \"poly/composition_f_1_minus_ex.hpp\"\n\n#line\
    \ 2 \"poly/poly_taylor_shift.hpp\"\n\r\n#line 2 \"nt/primetable.hpp\"\n\ntemplate\
...
layout: document
redirect_from:
- /verify/test/1_mytest/composition_1_minus_ex.test.cpp
- /verify/test/1_mytest/composition_1_minus_ex.test.cpp.html
