...
void test() {
  ...
  assert(min_cost_matching_on_line(A, B) == 6302172);
  A = {1234567891, 1}, B = {1, 99999999999};
  assert(min_cost_matching_on_line(A, B) == 1234567890);
}
