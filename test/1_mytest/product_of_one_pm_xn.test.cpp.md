...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/product_of_one_pm_xn.test.cpp\"\n#define PROBLEM\
    ...
    \n}\n#line 7 \"test/1_mytest/product_of_one_pm_xn.test.cpp\"\n\nusing mint = modint998;\n\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/product_of_one_pm_xn.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/product_of_one_pm_xn.test.cpp
- /verify/test/1_mytest/product_of_one_pm_xn.test.cpp.html
