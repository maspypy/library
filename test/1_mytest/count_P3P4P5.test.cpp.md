...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/count_P3P4P5.test.cpp\"\n#define PROBLEM \"\
    ...
    \ : (1ULL << n) - 1; }\n#line 4 \"test/1_mytest/count_P3P4P5.test.cpp\"\n\n#line\
    ...
    \      P5[v] += P4[e.to];\n    }\n    P5[v] -= C4[v] * 2;\n    P5[v] -= C3[v]\
    \ * 2 * (deg[v] - 3);\n    P5[v] -= P3[v] * (deg[v] - 1);\n  }\n  return {P3,\
    \ P4, P5};\n}\n#line 7 \"test/1_mytest/count_P3P4P5.test.cpp\"\n\nvoid test()\
    \ {\n  FOR(N, 20) {\n    FOR(50) {\n      Graph<int, 0> G(N);\n      for (auto&\
    ...
    \        A[a] += adj[a][b] * adj[b][c];\n      }\n      FOR(a, N) FOR(b, N) FOR(c,\
    \ N) FOR(d, N) {\n        int s = (1 << a) | (1 << b) | (1 << c) | (1 << d);\n\
    \        if (popcnt(s) != 4) continue;\n        B[a] += adj[a][b] * adj[b][c]\
    \ * adj[c][d];\n      }\n      FOR(a, N) FOR(b, N) FOR(c, N) FOR(d, N) FOR(e,\
