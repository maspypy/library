...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/count_labeled_tournament.test.cpp\"\n#define\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 5 \"test/1_mytest/count_labeled_tournament.test.cpp\"\
    ...
    #line 8 \"test/1_mytest/count_labeled_tournament.test.cpp\"\n\nusing mint = modint998;\n\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/count_labeled_tournament.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/count_labeled_tournament.test.cpp
- /verify/test/1_mytest/count_labeled_tournament.test.cpp.html
