...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/chirp_z.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \n\r\n  reverse(all(f));\r\n  mint ia = a.inverse();\r\n  mint pow = 1;\r\n  FOR(i,\
    \ n) f[i] *= pow, pow *= ia;\r\n  return f;\r\n}\r\n#line 6 \"test/1_mytest/chirp_z.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/chirp_z.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/chirp_z.test.cpp
- /verify/test/1_mytest/chirp_z.test.cpp.html
