...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/pascal.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \  f = convolution(f, g);\n  f.resize(n);\n  reverse(all(f));\n  FOR(i, n) f[i]\
    \ *= fact_inv<mint>(i);\n  return f;\n}\n#line 7 \"test/1_mytest/pascal.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/pascal.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/pascal.test.cpp
- /verify/test/1_mytest/pascal.test.cpp.html
