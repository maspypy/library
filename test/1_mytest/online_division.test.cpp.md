...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/online_division.test.cpp\"\n#define PROBLEM\
    ...
    \ - 1], g[i]));\n    return F[i];\n  }\n};\n#line 7 \"test/1_mytest/online_division.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/online_division.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/online_division.test.cpp
- /verify/test/1_mytest/online_division.test.cpp.html
