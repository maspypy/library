...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/primesum_mod4.test.cpp\"\n#define PROBLEM\
    ...
    \ calc_sum() {\n    A.calc([](ll x) -> T {\n      ll n = (x + 1) / 2;\n      return\
    \ T(n) * T(n);\n    });\n    B.calc([](ll x) -> T {\n      ll n = (x + 1) / 2;\n\
    \      return (n % 2 == 0 ? T(-n) : T(n));\n    });\n  }\n};\n#line 5 \"test/1_mytest/primesum_mod4.test.cpp\"\
    \n\nvoid test_count() {\n  ll LIM = 10000;\n  vc<int> A1(LIM), A3(LIM);\n  for\
    \ (auto&& p : prime_table(LIM))\n    if (p % 4 == 1) {\n      A1[p]++;\n    }\n\
    \  for (auto&& p : prime_table(LIM))\n    if (p % 4 == 3) {\n      A3[p]++;\n\
    \    }\n  A1 = cumsum<int>(A1, 0);\n  A3 = cumsum<int>(A3, 0);\n\n  FOR(N, LIM)\
    \ {\n    Prime_Sum_Mod_4<int> X(N);\n    X.calc_count();\n    FOR(K, 1, N + 10)\
    \ { assert(X[N / K] == mp(A1[N / K], A3[N / K])); }\n  }\n}\n\nvoid test_sum()\
    \ {\n  ll LIM = 10000;\n  vc<int> A1(LIM), A3(LIM);\n  for (auto&& p : prime_table(LIM))\n\
    \    if (p % 4 == 1) {\n      A1[p] += p;\n    }\n  for (auto&& p : prime_table(LIM))\n\
    \    if (p % 4 == 3) {\n      A3[p] += p;\n    }\n  A1 = cumsum<int>(A1, 0);\n\
    \  A3 = cumsum<int>(A3, 0);\n\n  FOR(N, LIM) {\n    Prime_Sum_Mod_4<int> X(N);\n\
    \    X.calc_sum();\n    FOR(K, 1, N + 10) { assert(X[N / K] == mp(A1[N / K], A3[N\
    \ / K])); }\n  }\n}\n\nvoid solve() {\n  int a, b;\n  cin >> a >> b;\n  cout <<\
    \ a + b << \"\\n\";\n}\n\nsigned main() {\n  test_count();\n  test_sum();\n  solve();\n\
    \n  return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n#include \"my_template.hpp\"\
    \n#include \"other/io.hpp\"\n#include \"nt/prime_sum_mod4.hpp\"\n\nvoid test_count()\
    \ {\n  ll LIM = 10000;\n  vc<int> A1(LIM), A3(LIM);\n  for (auto&& p : prime_table(LIM))\n\
    \    if (p % 4 == 1) {\n      A1[p]++;\n    }\n  for (auto&& p : prime_table(LIM))\n\
    \    if (p % 4 == 3) {\n      A3[p]++;\n    }\n  A1 = cumsum<int>(A1, 0);\n  A3\
    \ = cumsum<int>(A3, 0);\n\n  FOR(N, LIM) {\n    Prime_Sum_Mod_4<int> X(N);\n \
