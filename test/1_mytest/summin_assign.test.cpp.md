...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/summin_assign.test.cpp\"\n#define PROBLEM\
    ...
    \  }\n};\n#line 6 \"test/1_mytest/summin_assign.test.cpp\"\n\nvoid test() {\n\
    \  int N = RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] = RNG(1, 100);\n  using\
    \ AM = ActedMonoid_SumMin_Assign<ll, -1>;\n  using Mono = typename AM::Monoid_X;\n\
...
layout: document
redirect_from:
- /verify/test/1_mytest/summin_assign.test.cpp
- /verify/test/1_mytest/summin_assign.test.cpp.html
