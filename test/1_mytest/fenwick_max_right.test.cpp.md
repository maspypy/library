...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/fenwick_max_right.test.cpp\"\n#define PROBLEM\
    ...
    \ others.end()), ...);\n}\n#endif\n#line 4 \"test/1_mytest/fenwick_max_right.test.cpp\"\
    ...
    \ RNG_64() % (r - l); }\n#line 7 \"test/1_mytest/fenwick_max_right.test.cpp\"\n\
    \nvoid test(int N) {\n  FenwickTree<Monoid_Add<int>> bit(N);\n\n  FOR(1 << 15)\
    \ {\n    bit.set(RNG(0, N), RNG(0, 10));\n    ll s = RNG(0, N + 1);\n    ll sm\
    \ = bit.sum(s, N);\n    ll K = RNG(0, 2 * sm + 1);\n    {\n      ll god = bit.max_right([&](ll\
    \ x) -> bool { return x <= K; }, s);\n      ll ans = binary_search([&](ll r) ->\
    \ bool { return bit.prod(s, r) <= K; },\n                             s, N + 1);\n\
    \      assert(god == ans);\n    }\n  }\n\n  FOR(1 << 15) {\n    bit.set(RNG(0,\
    \ N), RNG(0, 10));\n    ll s = RNG(0, N + 1);\n    ll sm = bit.sum(s, N);\n  \
    \  ll K = s + RNG(0, 2 * sm + 1);\n    {\n      ll god = bit.max_right_with_index(\n\
    \          [&](ll i, ll x) -> bool { return i + x <= K; }, s);\n      ll ans =\
    \ binary_search(\n          [&](ll r) -> bool { return r + bit.prod(s, r) <= K;\
    \ }, s, N + 1);\n      assert(god == ans);\n    }\n  }\n}\n\nvoid solve() {\n\
    \  int a, b;\n  cin >> a >> b;\n  cout << a + b << \"\\n\";\n}\n\nsigned main()\
    \ {\n  FOR(N, 1, 100) test(N);\n  solve();\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include \"\
    ...
    \ ans = binary_search([&](ll r) -> bool { return bit.prod(s, r) <= K; },\n   \
    \                          s, N + 1);\n      assert(god == ans);\n    }\n  }\n\
    \n  FOR(1 << 15) {\n    bit.set(RNG(0, N), RNG(0, 10));\n    ll s = RNG(0, N +\
    \ 1);\n    ll sm = bit.sum(s, N);\n    ll K = s + RNG(0, 2 * sm + 1);\n    {\n\
    \      ll god = bit.max_right_with_index(\n          [&](ll i, ll x) -> bool {\
    \ return i + x <= K; }, s);\n      ll ans = binary_search(\n          [&](ll r)\
    \ -> bool { return r + bit.prod(s, r) <= K; }, s, N + 1);\n      assert(god ==\
    \ ans);\n    }\n  }\n}\n\nvoid solve() {\n  int a, b;\n  cin >> a >> b;\n  cout\
    \ << a + b << \"\\n\";\n}\n\nsigned main() {\n  FOR(N, 1, 100) test(N);\n  solve();\n\
    }\n"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2026-04-13 22:24:35+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/1_mytest/fenwick_max_right.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/fenwick_max_right.test.cpp
- /verify/test/1_mytest/fenwick_max_right.test.cpp.html
