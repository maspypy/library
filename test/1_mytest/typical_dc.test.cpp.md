...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/typical_dc.test.cpp\"\n#define PROBLEM \"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/1_mytest/typical_dc.test.cpp\"\
    \n\n#line 2 \"random/base.hpp\"\n\nu64 RNG_64() {\n  static u64 x_ = u64(chrono::duration_cast<chrono::nanoseconds>(chrono::high_resolution_clock::now().time_since_epoch()).count())\
    \ * 10150724397891781847ULL;\n  x_ ^= x_ << 7;\n  return x_ ^= x_ >> 9;\n}\n\n\
    u64 RNG(u64 lim) { return RNG_64() % lim; }\n\nll RNG(ll l, ll r) { return l +\
    \ RNG_64() % (r - l); }\n#line 6 \"test/1_mytest/typical_dc.test.cpp\"\n\n#line\
    ...
    \ dfs(dfs, rch[k], g2);\n      };\n      dfs(dfs, root, f);\n    }\n    return\
    \ ANS;\n  }\n};\n#line 9 \"test/1_mytest/typical_dc.test.cpp\"\n\nusing mint =\
    \ modint998;\nusing poly = vc<mint>;\n\npoly gen(int d) {\n  poly f(d + 1);\n\
    ...
    \ i + 1, N) F = convolution(F, B[j]);\n        prod[i] = F;\n      }\n      Typical_Divide_Conquer<mint>\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/typical_dc.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/typical_dc.test.cpp
- /verify/test/1_mytest/typical_dc.test.cpp.html
