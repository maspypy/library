...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/composition_ex_minus_1.test.cpp\"\n#define\
...
layout: document
redirect_from:
- /verify/test/1_mytest/composition_ex_minus_1.test.cpp
- /verify/test/1_mytest/composition_ex_minus_1.test.cpp.html
