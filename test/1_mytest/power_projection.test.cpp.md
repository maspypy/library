...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/power_projection.test.cpp\"\n#define PROBLEM\
    ...
    \ b) {\n  while (b != 0) {\n    i128 c = a % b;\n    a = b, b = c;\n  }\n  return\
    \ abs(a);\n}\n#endif\n#line 3 \"test/1_mytest/power_projection.test.cpp\"\n\n\
    ...
    \ K) : fps_pow_1_dense(f, K));\n}\n#line 8 \"test/1_mytest/power_projection.test.cpp\"\
    \n\nusing mint = modint998;\n\nvoid test() {\n  FOR(100) {\n    FOR(N, 10) FOR(K,\
    \ 10) {\n      vc<mint> f(K + 1);\n      vc<mint> wt(K + 1);\n      FOR(k, K +\
    \ 1) f[k] = RNG(0, 5), wt[k] = RNG(0, 5);\n      vc<mint> A(N + 1);\n      FOR(n,\
    \ N + 1) {\n        vc<mint> h = fps_pow<mint>(f, n);\n        FOR(i, K + 1) A[n]\
    \ += wt[i] * h[i];\n      }\n      vc<mint> B = power_projection<mint>(wt, f,\
    \ N);\n      assert(A == B);\n    }\n  }\n}\n\nvoid solve() {\n  int a, b;\n \
    \ cin >> a >> b;\n  cout << a + b << \"\\n\";\n}\n\nsigned main() {\n  test();\n\
    \  solve();\n}\n"
  ...
  verifiedWith: []
documentation_of: test/1_mytest/power_projection.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/power_projection.test.cpp
- /verify/test/1_mytest/power_projection.test.cpp.html
