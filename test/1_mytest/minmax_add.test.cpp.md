...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/minmax_add.test.cpp\"\n#define PROBLEM \"\
    ...
    \ {\r\n  using P = pair<X, X>;\r\n  using value_type = P;\r\n  static constexpr\
    \ P op(const P x, const P y) noexcept {\r\n    return {min(x.fi, y.fi), max(x.se,\
    \ y.se)};\r\n  }\r\n  static constexpr P from_element(const X x) { return {x,\
    ...
    \ 6 \"test/1_mytest/minmax_add.test.cpp\"\n\nvoid test() {\n  int N = RNG(1, 100);\n\
...
layout: document
redirect_from:
- /verify/test/1_mytest/minmax_add.test.cpp
- /verify/test/1_mytest/minmax_add.test.cpp.html
