...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/count_labeled_strong.test.cpp\"\n#define PROBLEM\
    ...
    \ yes(!t); }\r\n#line 5 \"test/1_mytest/count_labeled_strong.test.cpp\"\n\n#line\
    ...
    \  FOR(i, N + 1) F[i] = -F[i] * fact<mint>(i);\n  return F;\n}\n#line 8 \"test/1_mytest/count_labeled_strong.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/count_labeled_strong.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/count_labeled_strong.test.cpp
- /verify/test/1_mytest/count_labeled_strong.test.cpp.html
