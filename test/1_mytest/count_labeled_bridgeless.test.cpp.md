...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/count_labeled_bridgeless.test.cpp\"\n#define\
    ...
    \  while (b != 0) {\n    i128 c = a % b;\n    a = b, b = c;\n  }\n  return abs(a);\n\
    }\n#endif\n#line 3 \"test/1_mytest/count_labeled_bridgeless.test.cpp\"\n\n#line\
    \ 1 \"graph/count/count_labeled_undirected.hpp\"\n// https://oeis.org/A006125\n\
    ...
    \n  // [x^N]B(x) \u304C\u51FA\u305F\n  ANS *= inv<mint>(N);\n  ANS *= fact<mint>(N);\n\
    \  return ANS;\n}\n#line 5 \"test/1_mytest/count_labeled_bridgeless.test.cpp\"\
