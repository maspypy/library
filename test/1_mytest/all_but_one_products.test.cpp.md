...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/all_but_one_products.test.cpp\"\n#define PROBLEM\
...
layout: document
redirect_from:
- /verify/test/1_mytest/all_but_one_products.test.cpp
- /verify/test/1_mytest/all_but_one_products.test.cpp.html
