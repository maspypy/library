...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/convex_polygon_side.test.cpp\"\n#define PROBLEM\
...
layout: document
redirect_from:
- /verify/test/1_mytest/convex_polygon_side.test.cpp
- /verify/test/1_mytest/convex_polygon_side.test.cpp.html
