...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/graph_count.test.cpp\"\n#define PROBLEM \"\
    ...
    \  while (b != 0) {\n    i128 c = a % b;\n    a = b, b = c;\n  }\n  return abs(a);\n\
    }\n#endif\n#line 3 \"test/1_mytest/graph_count.test.cpp\"\n\n#line 1 \"poly/fps_log.hpp\"\
    ...
    }\n#line 2 \"graph/count/count_labeled_unicyclic.hpp\"\n\n// https://oeis.org/A057500\n\
    ...
    \nusing modint107 = modint<1000000007>;\nusing modint998 = modint<998244353>;\n\
    #line 8 \"test/1_mytest/graph_count.test.cpp\"\n\nusing mint = modint998;\n\n\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/graph_count.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/graph_count.test.cpp
- /verify/test/1_mytest/graph_count.test.cpp.html
