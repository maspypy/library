...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/dynamic_lazy_segtree_persistent.test.cpp\"\
    ...
    \n  struct Node {\n    Node *l, *r;\n    X x;\n    A lazy;\n  };\n\n  const int\
    \ NODES;\n  const ll L0, R0;\n  Node *pool;\n  int pid;\n  using np = Node *;\n\
    \n  Dynamic_Lazy_SegTree(\n      int NODES, ll L0, ll R0, F default_prod = [](ll\
    \ l, ll r) -> X { return MX::unit(); })\n      : default_prod(default_prod), NODES(NODES),\
    \ L0(L0), R0(R0), pid(0) {\n    pool = new Node[NODES];\n  }\n  ~Dynamic_Lazy_SegTree()\
    ...
    \ = typename AM::X;\n\n  FOR(100) {\n    int N = RNG(1, 1000);\n\n    vvc<int>\
    \ AA;\n    AA.eb(vc<int>(N, 10));\n    Dynamic_Lazy_SegTree<AM, true> X(30000,\
    \ 0, N, [](ll l, ll r) -> P { return {10 * (r - l), 10}; });\n    using np = typename\
    \ decltype(X)::np;\n\n    int Q = RNG(1, 1000);\n    vc<np> roots;\n    roots.eb(X.new_node(0,\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n#include \"my_template.hpp\"\
    ...
    \ X(30000, 0, N, [](ll l, ll r) -> P { return {10 * (r - l), 10}; });\n    using\
