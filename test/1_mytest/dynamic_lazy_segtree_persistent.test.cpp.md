...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/dynamic_lazy_segtree_persistent.test.cpp\"\
    ...
    \ Node {\n    Node *l, *r;\n    X x;\n    A lazy;\n  };\n\n  Node_Pool<Node> pool;\n\
    \  const ll L0, R0;\n  using np = Node *;\n\n  Dynamic_Lazy_SegTree(\n      ll\
    \ L0, ll R0, F default_prod = [](ll, ll) -> X { return MX::id(); })\n      : default_prod(default_prod),\
    ...
    \ X x = MX::id();\n    prod_rec(root, L0, R0, l, r, x, MA::id());\n    return\
    ...
    \ && L0 <= R && R <= R0 && check(MX::id()));\n    X x = MX::id();\n    return\
    \ min_left_rec(root, check, L0, R0, R, x);\n  }\n\n  // f(idx, val)\n  template\
    \ <typename F>\n  void enumerate(np root, F f) {\n    auto dfs = [&](auto &dfs,\
    \ np c, ll l, ll r, A a) -> void {\n      if (!c) return;\n      if (r - l ==\
    \ 1) {\n        f(l, AM::act(c->x, a, 1));\n        return;\n      }\n      ll\
    \ m = (l + r) / 2;\n      a = MA::op(c->lazy, a);\n      dfs(dfs, c->l, l, m,\
    \ a);\n      dfs(dfs, c->r, m, r, a);\n    };\n    dfs(dfs, root, L0, R0, MA::id());\n\
    \  }\n\n  void reset() { pool.reset(); }\n\n  // root[l:r) \u3092 apply(other[l:r),a)\
    \ \u3067\u4E0A\u66F8\u304D\u3057\u305F\u3082\u306E\u3092\u8FD4\u3059\n  np copy_interval(np\
    \ root, np other, ll l, ll r, A a) {\n    if (root == other) return root;\n  \
    ...
    \ = typename AM::X;\n\n  FOR(100) {\n    int N = RNG(1, 1000);\n\n    vvc<int>\
    \ AA;\n    AA.eb(vc<int>(N, 10));\n    Dynamic_Lazy_SegTree<AM, true> X(\n   \
...
layout: document
redirect_from:
- /verify/test/1_mytest/dynamic_lazy_segtree_persistent.test.cpp
- /verify/test/1_mytest/dynamic_lazy_segtree_persistent.test.cpp.html
