...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/max_of_linear_segments.test.cpp\"\n#define\
    ...
    \ a, int b, int mod) {\n  a = (a == 0 ? 0 : mod - a);\n  b = mod - 1 - b;\n  return\
    \ min_of_linear_segments(a, b, mod);\n}\n#line 5 \"test/1_mytest/max_of_linear_segments.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/max_of_linear_segments.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/max_of_linear_segments.test.cpp
- /verify/test/1_mytest/max_of_linear_segments.test.cpp.html
