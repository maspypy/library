...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/multinomial.test.cpp\"\n#define PROBLEM \"\
    ...
    \ others.begin(), others.end()), ...);\n}\n#endif\n#line 3 \"test/1_mytest/multinomial.test.cpp\"\
    ...
    #line 5 \"test/1_mytest/multinomial.test.cpp\"\nusing mint = modint998;\n\nvoid\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/multinomial.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/multinomial.test.cpp
- /verify/test/1_mytest/multinomial.test.cpp.html
