...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/cf940f.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \ 0, r = 0;\r\n    for (auto&& qid : I) {\r\n      auto [nt, nl, nr] = query[qid];\r\
    \n      while (l > nl) ADD_L(--l);\r\n      while (r < nr) ADD_R(r++);\r\n   \
    \   while (l < nl) RM_L(l++);\r\n      while (r > nr) RM_R(--r);\r\n      while\
    \ (t < nt) ADD_CHANGE(t++, l, r);\r\n      while (t > nt) RM_CHANGE(--t, l, r);\r\
    ...
    \   while (CNT_2[mex]) ++mex;\n    ANS[q] = mex;\n  };\n\n  mo.calc(ADD, ADD,\
    \ RM, RM, ADD_CHANGE, RM_CHANGE, CALC);\n  return ANS;\n}\n\nvoid test_CF940F()\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n#include \"my_template.hpp\"\
    ...
    \ b] = change[t];\n    if (l <= i && i < r) {\n      ADD_ELEM(a, -1), ADD_ELEM(b,\
    \ 1);\n    }\n    A[i] = b;\n  };\n  auto RM_CHANGE = [&](int t, int l, int r)\
    \ -> void {\n    auto [i, a, b] = change[t];\n    if (l <= i && i < r) {\n   \
    \   ADD_ELEM(b, -1), ADD_ELEM(a, +1);\n    }\n    A[i] = a;\n  };\n  auto CALC\
    \ = [&](int q) -> void {\n    int mex = 0;\n    while (CNT_2[mex]) ++mex;\n  \
