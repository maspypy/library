...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/maxidx_add.test.cpp\"\n#define PROBLEM \"\
    ...
    \ {\r\n  using Monoid_X = Monoid_MaxIdx<E, tie_is_left>;\r\n  using Monoid_A =\
    ...
    \ 6 \"test/1_mytest/maxidx_add.test.cpp\"\n\nvoid test() {\n  int N = RNG(1, 100);\n\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/maxidx_add.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/maxidx_add.test.cpp
- /verify/test/1_mytest/maxidx_add.test.cpp.html
