...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/count_labeled_biconnected.test.cpp\"\n#define\
    ...
    \ others.begin(), others.end()), ...);\n}\n#endif\n#line 4 \"test/1_mytest/count_labeled_biconnected.test.cpp\"\
    ...
    \ g); }\r\n  return composition_0_garner(f, g);\r\n}\r\n#line 6 \"graph/count/count_labeled_biconnected.hpp\"\
    ...
    \ G[i] * E[N - 2 - i];\n\n  ANS *= inv<mint>(N - 1);\n  ANS *= inv<mint>(N);\n\
    \  ANS *= fact<mint>(N);\n  return ANS;\n}\n#line 7 \"test/1_mytest/count_labeled_biconnected.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2025-07-26 09:01:06+09:00'
