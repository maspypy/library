...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/count_labeled_dag.test.cpp\"\n#define PROBLEM\
    ...
    \  while (b != 0) {\n    i128 c = a % b;\n    a = b, b = c;\n  }\n  return abs(a);\n\
    }\n#endif\n#line 4 \"test/1_mytest/count_labeled_dag.test.cpp\"\n\n#line 1 \"\
    ...
    \ fps_inv_dense<mint>(f));\n}\n#line 2 \"graph/count/count_labeled_dag.hpp\"\n\
    \n// https://oeis.org/A003024\ntemplate <typename mint>\nvc<mint> count_labeled_dag(int\
    \ N) {\n  vc<mint> F(N + 1, 1);\n  mint pow = 1;\n  FOR(n, 1, N + 1) F[n] = F[n\
    \ - 1] * pow, pow *= inv<mint>(2);\n  FOR(i, N + 1) F[i] *= fact_inv<mint>(i);\n\
    \  FOR(i, N + 1) if (i % 2 == 1) F[i] = -F[i];\n\n  F = fps_inv(F);\n  FOR(i,\
    \ N + 1) F[i] *= fact<mint>(i);\n  mint c = 1;\n  pow = 1;\n  FOR(i, N + 1) F[i]\
    \ *= c, c *= pow, pow += pow;\n  return F;\n}\n#line 7 \"test/1_mytest/count_labeled_dag.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/count_labeled_dag.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/count_labeled_dag.test.cpp
- /verify/test/1_mytest/count_labeled_dag.test.cpp.html
