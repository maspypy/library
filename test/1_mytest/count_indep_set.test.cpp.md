...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/count_indep_set.test.cpp\"\n#define PROBLEM\
    ...
    \ << N) - 1);\n  res.resize(N + 1);\n  return res;\n}\n#line 6 \"test/1_mytest/count_indep_set.test.cpp\"\
    \n\nvoid test() {\n  FOR(100) {\n    FOR(n, 10) {\n      Graph<int, 0> G(n);\n\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/count_indep_set.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/count_indep_set.test.cpp
- /verify/test/1_mytest/count_indep_set.test.cpp.html
