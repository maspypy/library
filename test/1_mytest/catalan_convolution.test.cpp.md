...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/catalan_convolution.test.cpp\"\n#define PROBLEM\
    ...
    \  while (b != 0) {\n    i128 c = a % b;\n    a = b, b = c;\n  }\n  return abs(a);\n\
    }\n#endif\n#line 3 \"test/1_mytest/catalan_convolution.test.cpp\"\n\n#line 1 \"\
    ...
    \ 0 ? mint(1) : mint(0));\n  return mint(pow) * inv<mint>(n + n + pow) * C<mint>(n\
...
layout: document
redirect_from:
- /verify/test/1_mytest/catalan_convolution.test.cpp
- /verify/test/1_mytest/catalan_convolution.test.cpp.html
