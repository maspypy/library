...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/online_exp.test.cpp\"\n#define PROBLEM \"\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/online_exp.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/online_exp.test.cpp
- /verify/test/1_mytest/online_exp.test.cpp.html
