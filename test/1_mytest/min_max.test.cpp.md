...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/min_max.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \  }\n};\n#line 6 \"test/1_mytest/min_max.test.cpp\"\n\nvoid test() {\n  int N\
    \ = RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] = RNG(1, 100);\n  using AM\
    \ = ActedMonoid_Min_Max<int>;\n  Lazy_SegTree<AM> seg(A);\n  int Q = RNG(1, 100);\n\
    \  FOR(Q) {\n    ll t = RNG(0, 2);\n    ll L = RNG(0, N);\n    ll R = RNG(0, N);\n\
    \    if (L > R) swap(L, R);\n    ++R;\n    if (t == 1) {\n      ll x = RNG(1,\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/min_max.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/min_max.test.cpp
- /verify/test/1_mytest/min_max.test.cpp.html
