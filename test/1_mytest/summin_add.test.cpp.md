...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/summin_add.test.cpp\"\n#define PROBLEM \"\
    ...
    \ X op(X x, X y) { return {x.fi + y.fi, min(x.se, y.se)}; }\r\n  static X from_element(E\
    ...
    \ * k + 1, laz[k]);\n    laz[k] = MA::unit();\n  }\n};\n#line 6 \"test/1_mytest/summin_add.test.cpp\"\
    \n\nvoid test() {\n  int N = RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] =\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/summin_add.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/summin_add.test.cpp
- /verify/test/1_mytest/summin_add.test.cpp.html
