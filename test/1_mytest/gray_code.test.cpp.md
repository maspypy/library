...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/gray_code.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \n#line 4 \"test/1_mytest/gray_code.test.cpp\"\n\nvoid test() {\n  FOR(LOG, 10)\
...
layout: document
redirect_from:
- /verify/test/1_mytest/gray_code.test.cpp
- /verify/test/1_mytest/gray_code.test.cpp.html
