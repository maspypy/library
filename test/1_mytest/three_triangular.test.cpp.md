...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/three_triangular.test.cpp\"\n#define PROBLEM\
    ...
    \ others.begin(), others.end()), ...);\n}\n#endif\n#line 3 \"test/1_mytest/three_triangular.test.cpp\"\
    ...
    \ * N + 3);\n  a = (a + 1) / 2;\n  b = (b + 1) / 2;\n  c = (c + 1) / 2;\n  return\
    \ {a, b, c};\n}\n#line 6 \"test/1_mytest/three_triangular.test.cpp\"\n\nvoid test()\
  ...
  verifiedWith: []
documentation_of: test/1_mytest/three_triangular.test.cpp
layout: document
redirect_from:
- /verify/test/1_mytest/three_triangular.test.cpp
- /verify/test/1_mytest/three_triangular.test.cpp.html
