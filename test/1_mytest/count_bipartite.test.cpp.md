...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/count_bipartite.test.cpp\"\n#define PROBLEM\
    ...
    \ others.end()), ...);\n}\n#endif\n#line 3 \"test/1_mytest/count_bipartite.test.cpp\"\
    ...
    \  FOR(i, N + 1) F[i] *= fact<mint>(i);\n  return F;\n}\n#line 6 \"test/1_mytest/count_bipartite.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/1_mytest/count_bipartite.test.cpp
- /verify/test/1_mytest/count_bipartite.test.cpp.html
