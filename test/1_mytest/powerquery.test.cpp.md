...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/powerquery.test.cpp\"\n#define PROBLEM \"\
...
layout: document
redirect_from:
- /verify/test/1_mytest/powerquery.test.cpp
- /verify/test/1_mytest/powerquery.test.cpp.html
