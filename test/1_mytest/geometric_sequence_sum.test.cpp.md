...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/geometric_sequence_sum.test.cpp\"\n#define\
    ...
    \  while (b != 0) {\n    i128 c = a % b;\n    a = b, b = c;\n  }\n  return abs(a);\n\
    }\n#endif\n#line 3 \"test/1_mytest/geometric_sequence_sum.test.cpp\"\n\n#line\
    \ 1 \"mod/dynamic_modint.hpp\"\n\n#line 1 \"other/bit.hpp\"\n\nint popcnt(int\
...
layout: document
redirect_from:
- /verify/test/1_mytest/geometric_sequence_sum.test.cpp
- /verify/test/1_mytest/geometric_sequence_sum.test.cpp.html
