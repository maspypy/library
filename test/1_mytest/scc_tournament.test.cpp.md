...
data:
  ...
  bundledCode: "#line 1 \"test/1_mytest/scc_tournament.test.cpp\"\n#define PROBLEM\
    ...
    \ b) {\n  while (b != 0) {\n    i128 c = a % b;\n    a = b, b = c;\n  }\n  return\
    \ abs(a);\n}\n#endif\n#line 3 \"test/1_mytest/scc_tournament.test.cpp\"\n\n#line\
    ...
    \ DAG;\n}\n#line 1 \"graph/scc_tournament_by_indegrees.hpp\"\npair<int, vc<int>>\
  ...
  - graph/scc_tournament_by_indegrees.hpp
  - random/base.hpp
