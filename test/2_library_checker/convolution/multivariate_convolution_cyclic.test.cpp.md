...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/convolution/multivariate_convolution_cyclic.test.cpp\"\
    ...
    \ 3 \"poly/multivar_convolution_cyclic.hpp\"\n\n/*\nexample : ns = (2, 3)\n[a0,\
    \ a1, a2, a3, a4, a5] = [a(0,0), a(1,0), a(0,1), a(1,1), a(0,2), a(1,2)]\n[b0,\
    \ b1, b2, b3, b4, b5] = [b(0,0), b(1,0), b(0,1), b(1,1), b(0,2), b(1,2)]\n*/\n\
    template <typename mint>\nvc<mint> multivar_convolution_cyclic(vc<int> ns, vc<mint>\
