...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/convolution/subset_convolution.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/convolution/subset_convolution.test.cpp\"\
    ...
    \  f[d] = x;\r\n    }\r\n  }\r\n  return ranked_mobius<T, LIM>(RA);\r\n}\r\n#line\
    \ 7 \"test/2_library_checker/convolution/subset_convolution.test.cpp\"\n\r\nusing\
    \ mint = modint998;\r\n\r\nvoid solve() {\r\n  LL(N);\r\n  VEC(mint, A, 1 << N);\r\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/convolution/subset_convolution.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/convolution/subset_convolution.test.cpp
- /verify/test/2_library_checker/convolution/subset_convolution.test.cpp.html
