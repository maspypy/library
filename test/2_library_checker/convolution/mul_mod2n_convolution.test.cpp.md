...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/convolution/mul_mod2n_convolution.test.cpp\"\
    ...
    \ mint>\r\nvc<mint> multiplicative_convolution_mod_2n(vc<mint>& A, vc<mint>& B){\r\
    \n  int N = 0;\r\n  while((1<<N) < len(A)) ++N;\r\n  assert((1<<N) == len(A) &&\
    \ (1<<N) == len(B));\r\n  \r\n  int mask = (1 << N) - 1;\r\n\r\n  vc<vc<vc<mint>>>\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/convolution/mul_mod2n_convolution.test.cpp
- /verify/test/2_library_checker/convolution/mul_mod2n_convolution.test.cpp.html
