...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/convolution/subset_convolution_multivar.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/convolution/subset_convolution_multivar.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/subset_convolution\"\r\n\
    ...
    \n\r\nvoid solve() {\r\n  LL(N);\r\n  VEC(mint, A, 1 << N);\r\n  VEC(mint, B,\
    \ 1 << N);\r\n  vc<int> ns(N, 2);\r\n  auto C = multivar_convolution(ns, A, B);\r\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/convolution/subset_convolution_multivar.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/convolution/subset_convolution_multivar.test.cpp
- /verify/test/2_library_checker/convolution/subset_convolution_multivar.test.cpp.html
