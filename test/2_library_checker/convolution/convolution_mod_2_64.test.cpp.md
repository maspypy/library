...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/convolution/convolution_mod_2_64.test.cpp\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/2_library_checker/convolution/convolution_mod_2_64.test.cpp\"\
    ...
    \ a3[i].val, a4[i].val);\r\n  return c;\r\n}\r\n#line 6 \"test/2_library_checker/convolution/convolution_mod_2_64.test.cpp\"\
    \n\r\nvoid solve() {\r\n  LL(N, M);\r\n  VEC(u64, A, N);\r\n  VEC(u64, B, M);\r\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/convolution/convolution_mod_2_64.test.cpp
- /verify/test/2_library_checker/convolution/convolution_mod_2_64.test.cpp.html
