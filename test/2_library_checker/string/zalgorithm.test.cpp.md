...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/string/zalgorithm.test.cpp\"\n#define\
    ...
    \ && s[k] == s[i + k]) k++;\n    if (j + z[j] < i + z[i]) j = i;\n  }\n  z[0]\
    \ = n;\n  return z;\n}\n#line 6 \"test/2_library_checker/string/zalgorithm.test.cpp\"\
    \n\r\nvoid solve() {\r\n  STR(S);\r\n  auto Z = zalgorithm(S);\r\n  print(Z);\r\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/string/zalgorithm.test.cpp
- /verify/test/2_library_checker/string/zalgorithm.test.cpp.html
