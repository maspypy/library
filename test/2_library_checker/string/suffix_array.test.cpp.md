...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/string/suffix_array.test.cpp\"\n\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 4 \"test/2_library_checker/string/suffix_array.test.cpp\"\
    ...
    \    }\n    LCP.resize(n - 1);\n  }\n};\n#line 6 \"test/2_library_checker/string/suffix_array.test.cpp\"\
    \n\r\nvoid solve() {\r\n  STR(S);\r\n  Suffix_Array sa(S);\r\n  print(sa.SA);\r\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/string/suffix_array.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/string/suffix_array.test.cpp
- /verify/test/2_library_checker/string/suffix_array.test.cpp.html
