...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/string/online_z.test.cpp\"\n#define\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/string/online_z.test.cpp\"\n\n\
    ...
    \ i) { return (Z[i] == -1 ? len(S) - i : Z[i]); }\n};\n#line 6 \"test/2_library_checker/string/online_z.test.cpp\"\
