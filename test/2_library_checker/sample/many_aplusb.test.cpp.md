...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/sample/many_aplusb.test.cpp\"\n#define\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/2_library_checker/sample/many_aplusb.test.cpp\"\
    \n\r\nvoid solve() {\r\n  LL(T);\r\n  FOR(T) {\r\n    LL(a, b);\r\n    print(a\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/sample/many_aplusb.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/sample/many_aplusb.test.cpp
- /verify/test/2_library_checker/sample/many_aplusb.test.cpp.html
