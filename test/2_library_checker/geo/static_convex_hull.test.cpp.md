...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/geo/static_convex_hull.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/geo/static_convex_hull.test.cpp\"\
    ...
    \ == XY[P.back()]) P.pop_back();\n  return P;\n}\n#line 7 \"test/2_library_checker/geo/static_convex_hull.test.cpp\"\
    \n\nusing P = Point<ll>;\nvoid solve() {\n  LL(N);\n  VEC(P, point, N);\n  vc<int>\
  ...
  requiredBy: []
  timestamp: '2024-08-14 04:18:24+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/2_library_checker/geo/static_convex_hull.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/geo/static_convex_hull.test.cpp
- /verify/test/2_library_checker/geo/static_convex_hull.test.cpp.html
