...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/linear_algebra/matrix_det.test.cpp\"\
    ...
    #line 6 \"test/2_library_checker/linear_algebra/matrix_det.test.cpp\"\n\r\nusing\
    \ mint = modint998;\r\nvoid solve() {\r\n  LL(N);\r\n  VV(mint, A, N, N);\r\n\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/linear_algebra/matrix_det.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/linear_algebra/matrix_det.test.cpp
- /verify/test/2_library_checker/linear_algebra/matrix_det.test.cpp.html
