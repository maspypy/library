...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/other/twosat.test.cpp\"\n#define\
    ...
    \  return {true, values};\r\n  }\r\n};\n#line 5 \"test/2_library_checker/other/twosat.test.cpp\"\
    \n\r\nvoid solve() {\r\n  STR(p, cnf);\r\n  LL(N, M);\r\n  TwoSat ts(N);\r\n \
    \ FOR(i, M) {\r\n    LL(a, b, c);\r\n    a = (a > 0 ? a - 1 : a);\r\n    b = (b\
    \ > 0 ? b - 1 : b);\r\n    ts.add(a, b);\r\n  }\r\n  auto [ok, A] = ts.calc();\r\
    \n  if (ok) {\r\n    print(\"s SATISFIABLE\");\r\n    vc<int> ANS(N);\r\n    FOR(i,\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/other/twosat.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/other/twosat.test.cpp
- /verify/test/2_library_checker/other/twosat.test.cpp.html
