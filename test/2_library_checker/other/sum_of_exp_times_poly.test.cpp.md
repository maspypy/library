...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/other/sum_of_exp_times_poly.test.cpp\"\
    \n#define PROBLEM \\\r\n  \"https://judge.yosupo.jp/problem/sum_of_exponential_times_polynomial\"\
    ...
    \ {\n      ll i = pp;\n      while (i <= N) {\n        f[i] *= xp;\n        i\
    \ += pp;\n      }\n      pp *= p;\n    }\n  }\n  return f;\n}\n#line 7 \"test/2_library_checker/other/sum_of_exp_times_poly.test.cpp\"\
    \n\r\nusing mint = modint998;\r\nvoid solve() {\r\n  mint r;\r\n  read(r);\r\n\
    \  LL(d, n);\r\n  int L = d + 5;\r\n  vc<mint> a = power_table_2<mint>(d, L -\
    \ 1);\r\n  mint p = 1;\r\n  FOR(i, L) {\r\n    a[i] *= p;\r\n    p *= r;\r\n \
...
layout: document
redirect_from:
- /verify/test/2_library_checker/other/sum_of_exp_times_poly.test.cpp
- /verify/test/2_library_checker/other/sum_of_exp_times_poly.test.cpp.html
