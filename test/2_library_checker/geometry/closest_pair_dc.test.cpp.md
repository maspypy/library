...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/geometry/closest_pair_dc.test.cpp\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 4 \"test/2_library_checker/geometry/closest_pair_dc.test.cpp\"\
    \n\n#line 2 \"geo/base.hpp\"\ntemplate <typename T>\nstruct Point {\n  T x, y;\n\
    ...
    \ == 0 || dy * dy > best) break;\n        upd(idx, j);\n      }\n      near.eb(idx);\n\
    \    }\n    return I;\n  };\n  dfs(dfs, 0, N);\n  return best_pair;\n}\n#line\
    \ 6 \"test/2_library_checker/geometry/closest_pair_dc.test.cpp\"\n\nusing P =\
    \ Point<ll>;\n\nvoid solve() {\n  LL(N);\n  VEC(P, point, N);\n  auto [i, j] =\
    \ closest_pair_dc(point);\n  print(i, j);\n}\n\nsigned main() {\n  INT(T);\n \
    \ FOR(T) solve();\n  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/geometry/closest_pair_dc.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/geometry/closest_pair_dc.test.cpp
- /verify/test/2_library_checker/geometry/closest_pair_dc.test.cpp.html
