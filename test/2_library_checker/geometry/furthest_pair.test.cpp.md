...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/geometry/furthest_pair.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/2_library_checker/geometry/furthest_pair.test.cpp\"\
    \n\n#line 2 \"geo/base.hpp\"\ntemplate <typename T>\nstruct Point {\n  T x, y;\n\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/geometry/furthest_pair.test.cpp
- /verify/test/2_library_checker/geometry/furthest_pair.test.cpp.html
