...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/geometry/sort_points_by_argument.test.cpp\"\
    ...
    \ 5 \"test/2_library_checker/geometry/sort_points_by_argument.test.cpp\"\n\r\n\
    void solve() {\r\n  LL(N);\r\n  vc<Point<ll>> P(N);\r\n  FOR(i, N) read(P[i].x),\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/geometry/sort_points_by_argument.test.cpp
- /verify/test/2_library_checker/geometry/sort_points_by_argument.test.cpp.html
