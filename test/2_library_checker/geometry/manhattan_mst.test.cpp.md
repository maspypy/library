...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/geometry/manhattan_mst.test.cpp\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 4 \"test/2_library_checker/geometry/manhattan_mst.test.cpp\"\
    ...
    }\n#line 6 \"test/2_library_checker/geometry/manhattan_mst.test.cpp\"\n\nvoid\
    \ solve() {\n  LL(N);\n  using P = pair<int, int>;\n  VEC(P, XY, N);\n  auto G\
    \ = manhattan_mst<int>(XY);\n  ll ANS = 0;\n  for (auto&& e: G.edges) { ANS +=\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/geometry/manhattan_mst.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/geometry/manhattan_mst.test.cpp
- /verify/test/2_library_checker/geometry/manhattan_mst.test.cpp.html
