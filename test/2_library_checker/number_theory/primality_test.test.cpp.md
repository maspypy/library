...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/number_theory/primality_test.test.cpp\"\
    ...
    \n  }\r\n  return true;\r\n}\n#line 5 \"test/2_library_checker/number_theory/primality_test.test.cpp\"\
    \n\nvoid solve() {\n  LL(p);\n  Yes(primetest(p));\n}\n\nsigned main() {\n  INT(T);\n\
    \  FOR(T) solve();\n  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/number_theory/primality_test.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/number_theory/primality_test.test.cpp
- /verify/test/2_library_checker/number_theory/primality_test.test.cpp.html
