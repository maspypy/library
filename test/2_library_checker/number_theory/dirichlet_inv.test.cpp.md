...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/number_theory/dirichlet_inv.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/dirichlet_inverse_and_prefix_sums\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 5 \"test/2_library_checker/number_theory/dirichlet_inv.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/number_theory/dirichlet_inv.test.cpp
- /verify/test/2_library_checker/number_theory/dirichlet_inv.test.cpp.html
