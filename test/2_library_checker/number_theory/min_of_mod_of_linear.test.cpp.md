...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/number_theory/min_of_mod_of_linear.test.cpp\"\
    ...
    \ break;\n  }\n  int y = (ll(a) * x + b) % mod;\n  return {L + x, y};\n}\n#line\
    \ 6 \"test/2_library_checker/number_theory/min_of_mod_of_linear.test.cpp\"\n\n\
    void solve() {\n  LL(n, m, a, b);\n  auto [x, fx] = min_of_linear(0, n, a, b,\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/number_theory/min_of_mod_of_linear.test.cpp
- /verify/test/2_library_checker/number_theory/min_of_mod_of_linear.test.cpp.html
