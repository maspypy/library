...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/number_theory/tetration.test.cpp\"\
    ...
    \ v, mod_chain[i]);\r\n  return v % mod;\r\n}\r\n#line 5 \"test/2_library_checker/number_theory/tetration.test.cpp\"\
    \n\r\nvoid solve() {\r\n  LL(a, b, m);\r\n  if (a == 0) {\r\n    ll ANS = (b %\
    \ 2 == 0 ? 1 : 0);\r\n    return print(ANS % m);\r\n  }\r\n  chmin(b, 64);\r\n\
    \  vi v(b, a);\r\n  print(tetration(v, m));\r\n}\r\n\r\nsigned main() {\r\n  LL(T);\r\
    \n  FOR(T) solve();\r\n\r\n  return 0;\r\n}\r\n"
...
layout: document
redirect_from:
- /verify/test/2_library_checker/number_theory/tetration.test.cpp
- /verify/test/2_library_checker/number_theory/tetration.test.cpp.html
