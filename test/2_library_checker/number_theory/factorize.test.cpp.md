...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/number_theory/factorize.test.cpp\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/2_library_checker/number_theory/factorize.test.cpp\"\
    ...
    \ n, vc<int>& lpf) {\n  vc<pair<ll, int>> res;\n  while (n > 1) {\n    int p =\
    \ lpf[n];\n    int e = 0;\n    while (n % p == 0) {\n      n /= p;\n      ++e;\n\
    \    }\n    res.eb(p, e);\n  }\n  return res;\n}\n#line 6 \"test/2_library_checker/number_theory/factorize.test.cpp\"\
    \n\nvoid solve() {\n  LL(x);\n  auto pf = factor(x);\n  vi ANS;\n  for (auto&&\
