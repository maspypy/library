...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/data_structure/line_add_get_min_lichao_2.test.cpp\"\
    ...
    \ f((COMPRESS ? X[min<int>(x, n - 1)] : min<int>(x + lo, hi - 1)));\n  }\n};\n\
