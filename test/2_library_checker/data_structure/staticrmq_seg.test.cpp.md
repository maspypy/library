...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/data_structure/staticrmq_seg.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/staticrmq\"\r\n#include\
    ...
    \ using Mono = Monoid_Min<int>;\r\n  SegTree<Mono> seg(N, [&](int i) -> int {\r\
    \n    INT(x);\r\n    return x;\r\n  });\r\n  FOR(Q) {\r\n    LL(L, R);\r\n   \
    \ print(seg.prod(L, R));\r\n  }\r\n}\r\n\r\nsigned main() {\r\n  solve();\r\n\r\
    \n  return 0;\r\n}\r\n"
  dependsOn:
...
layout: document
redirect_from:
- /verify/test/2_library_checker/data_structure/staticrmq_seg.test.cpp
- /verify/test/2_library_checker/data_structure/staticrmq_seg.test.cpp.html
