...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/data_structure/deque_operate_all_compsite.test.cpp\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/2_library_checker/data_structure/deque_operate_all_compsite.test.cpp\"\
    ...
    \ push_back(X[i]);\n    assert(sz == len(X));\n  }\n};\n#line 8 \"test/2_library_checker/data_structure/deque_operate_all_compsite.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/data_structure/deque_operate_all_compsite.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/data_structure/deque_operate_all_compsite.test.cpp
- /verify/test/2_library_checker/data_structure/deque_operate_all_compsite.test.cpp.html
