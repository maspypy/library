...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/data_structure/sort_segtree_1.test.cpp\"\
    ...
    \ rev;\n\n  Sortable_SegTree(int NODES, int KEY_MAX, vector<int> key, vector<X>\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/data_structure/sort_segtree_1.test.cpp
- /verify/test/2_library_checker/data_structure/sort_segtree_1.test.cpp.html
