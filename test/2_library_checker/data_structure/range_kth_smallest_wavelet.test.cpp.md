...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/data_structure/range_kth_smallest_wavelet.test.cpp\"\
    ...
    \ + mid[d] - r0;\r\n      if (l0 < r0) L = l0, R = r0;\r\n      if (l0 == r0)\
    \ L = l1, R = r1;\r\n      seg[d].multiply(L, t);\r\n    }\r\n  }\r\n};\r\n#line\
    \ 5 \"test/2_library_checker/data_structure/range_kth_smallest_wavelet.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/data_structure/range_kth_smallest_wavelet.test.cpp
- /verify/test/2_library_checker/data_structure/range_kth_smallest_wavelet.test.cpp.html
