...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/data_structure/static_range_mode_query.test.cpp\"\
    ...
    \      MP[x] = ans = kind++;\n    }\n    return ans;\n  }\n};\n#line 8 \"test/2_library_checker/data_structure/static_range_mode_query.test.cpp\"\
    \n\nvoid solve() {\n  INT(N, Q);\n  VEC(int, A, N);\n  vc<int> key = A;\n  UNIQUE(key);\n\
