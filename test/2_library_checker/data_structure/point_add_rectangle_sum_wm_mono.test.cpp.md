...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/data_structure/point_add_rectangle_sum_wm_mono.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/2_library_checker/data_structure/point_add_rectangle_sum_wm_mono.test.cpp\"\
    ...
    \ ^ xor_val)]); }\n      l /= 2, r /= 2, xor_val /= 2;\n    }\n    return x;\n\
    \  }\n};\n#line 9 \"test/2_library_checker/data_structure/point_add_rectangle_sum_wm_mono.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, Q);\n  vc<u32> X(N), Y(N);\n  vc<u64> W(N);\n  FOR(i,\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/data_structure/point_add_rectangle_sum_wm_mono.test.cpp
- /verify/test/2_library_checker/data_structure/point_add_rectangle_sum_wm_mono.test.cpp.html
