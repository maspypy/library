...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/data_structure/predecessor_problem_5.test.cpp\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 5 \"test/2_library_checker/data_structure/predecessor_problem_5.test.cpp\"\
    ...
    \ 7 \"test/2_library_checker/data_structure/predecessor_problem_5.test.cpp\"\n\
    ...
    \ (t == 3) {\n      int ans = bit.max_right([&](int x) -> bool { return x <= 0;\
    \ }, k);\n      if (ans == N) ans = -1;\n      print(ans);\n    }\n    if (t ==\
    \ 4) {\n      int ans = bit.min_left([&](int x) -> bool { return x <= 0; }, k\
    \ + 1) - 1;\n      print(ans);\n    }\n  }\n}\n\nsigned main() {\n  int T = 1;\n\
    \  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
...
layout: document
redirect_from:
- /verify/test/2_library_checker/data_structure/predecessor_problem_5.test.cpp
- /verify/test/2_library_checker/data_structure/predecessor_problem_5.test.cpp.html
