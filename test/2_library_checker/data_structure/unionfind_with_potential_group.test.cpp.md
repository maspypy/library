...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/data_structure/unionfind_with_potential_group.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/data_structure/unionfind_with_potential_group.test.cpp\"\
    ...
    \ [is_same, path] = uf.get_path(v, u);\n      bool valid = (!is_same) || (path\
  ...
  requiredBy: []
  timestamp: '2024-09-10 11:56:01+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/2_library_checker/data_structure/unionfind_with_potential_group.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/data_structure/unionfind_with_potential_group.test.cpp
- /verify/test/2_library_checker/data_structure/unionfind_with_potential_group.test.cpp.html
