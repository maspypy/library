...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/data_structure/rectangle_sum_wm.test.cpp\"\
    ...
    #line 7 \"test/2_library_checker/data_structure/rectangle_sum_wm.test.cpp\"\n\n\
    void solve() {\n  LL(N, Q);\n  vc<u32> X(N), Y(N), W(N);\n  FOR(i, N) read(X[i],\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/data_structure/rectangle_sum_wm.test.cpp
- /verify/test/2_library_checker/data_structure/rectangle_sum_wm.test.cpp.html
