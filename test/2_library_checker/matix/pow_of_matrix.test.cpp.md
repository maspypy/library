...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/matix/pow_of_matrix.test.cpp\"\n\
    ...
    \ yes(!t); }\r\n#line 5 \"test/2_library_checker/matix/pow_of_matrix.test.cpp\"\
    ...
    #line 8 \"test/2_library_checker/matix/pow_of_matrix.test.cpp\"\n\nusing mint\
    \ = modint998;\n\nvoid solve() {\n  INT(N);\n  U64(K);\n  VV(mint, A, N, N);\n\
    \  A = matrix_pow(A, K);\n  FOR(i, N) print(A[i]);\n}\n\nsigned main() {\n  solve();\n\
    \  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/matix/pow_of_matrix.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/matix/pow_of_matrix.test.cpp
- /verify/test/2_library_checker/matix/pow_of_matrix.test.cpp.html
