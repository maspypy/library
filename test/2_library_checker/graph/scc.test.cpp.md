...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/graph/scc.test.cpp\"\n#define PROBLEM\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/graph/scc.test.cpp\"\n\n#line\
    \ 2 \"graph/base.hpp\"\n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n\
    ...
    \ DAG;\n}\n#line 7 \"test/2_library_checker/graph/scc.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N, M);\n  Graph<int, 1> G(N);\n  G.read_graph(M, 0, 0);\n\n  auto [C,\
    \ comp] = strongly_connected_component(G);\n  vc<vc<int>> ANS(C);\n  FOR(v, N)\
    \ ANS[comp[v]].eb(v);\n  print(len(ANS));\n  for (auto&& C: ANS) print(len(C),\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/graph/scc.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/graph/scc.test.cpp
- /verify/test/2_library_checker/graph/scc.test.cpp.html
