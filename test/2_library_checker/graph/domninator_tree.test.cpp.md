...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/graph/domninator_tree.test.cpp\"\n\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/2_library_checker/graph/domninator_tree.test.cpp\"\
    ...
    \  }\n  return idom;\n}\n#line 6 \"test/2_library_checker/graph/domninator_tree.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M, root);\n  Graph<int, 1> G(N);\n  G.read_graph(M,\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/graph/domninator_tree.test.cpp
- /verify/test/2_library_checker/graph/domninator_tree.test.cpp.html
