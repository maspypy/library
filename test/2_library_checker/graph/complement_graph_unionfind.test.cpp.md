...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/graph/complement_graph_unionfind.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/connected_components_of_complement_graph\"\
    ...
    \ solve() {\n  LL(N, M);\n  Graph<int, 0> G(N);\n  G.read_graph(M, 0, 0);\n  auto\
    \ uf = complement_graph_unionfind(G);\n\n  vvc<int> vs(N);\n  FOR(v, N) { vs[uf[v]].eb(v);\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/graph/complement_graph_unionfind.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/graph/complement_graph_unionfind.test.cpp
- /verify/test/2_library_checker/graph/complement_graph_unionfind.test.cpp.html
