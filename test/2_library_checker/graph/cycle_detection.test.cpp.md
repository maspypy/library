...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/graph/cycle_detection.test.cpp\"\n\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/2_library_checker/graph/cycle_detection.test.cpp\"\
    ...
    \n    int y = e.frm + e.to - x;\r\n    if (y == a) break;\r\n    vs.eb(y);\r\n\
    \    es.eb(par[y]);\r\n  }\r\n  return {vs, es};\r\n}\r\n#line 7 \"test/2_library_checker/graph/cycle_detection.test.cpp\"\
    \n\r\nvoid solve() {\r\n  LL(N, M);\r\n  Graph<int, 1> G(N);\r\n  G.read_graph(M,\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/graph/cycle_detection.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/graph/cycle_detection.test.cpp
- /verify/test/2_library_checker/graph/cycle_detection.test.cpp.html
