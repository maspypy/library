...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/graph/shortest_path.test.cpp\"\n\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 5 \"test/2_library_checker/graph/shortest_path.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/graph/shortest_path.test.cpp
- /verify/test/2_library_checker/graph/shortest_path.test.cpp.html
