...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/graph/incremental_scc.test.cpp\"\n\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/2_library_checker/graph/incremental_scc.test.cpp\"\
    ...
    \    return true;\n  }\n\n  vc<int> get_all() {\n    vc<int> A(n);\n    FOR(i,\
    \ n) A[i] = (*this)[i];\n    return A;\n  }\n};\n#line 8 \"test/2_library_checker/graph/incremental_scc.test.cpp\"\
