...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/graph/maximum_independent_set2.test.cpp\"\
    ...
    \  }\n  assert(0);\n  return {};\n}\n#line 5 \"test/2_library_checker/graph/maximum_independent_set2.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M);\n  Graph<int, 0> G(N);\n  G.read_graph(M, 0, 0);\n\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/graph/maximum_independent_set2.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/graph/maximum_independent_set2.test.cpp
- /verify/test/2_library_checker/graph/maximum_independent_set2.test.cpp.html
