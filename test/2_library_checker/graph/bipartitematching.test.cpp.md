...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/graph/bipartitematching.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/graph/bipartitematching.test.cpp
- /verify/test/2_library_checker/graph/bipartitematching.test.cpp.html
