...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/polynomial/sqrt_of_fps_sparse.test.cpp\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 4 \"test/2_library_checker/polynomial/sqrt_of_fps_sparse.test.cpp\"\
    ...
    \ + i] * c;\r\n  g = fps_sqrt(g);\r\n  FOR(i, len(g)) g[i] *= x;\r\n  g.resize(n);\r\
    \n  FOR_R(i, n) {\r\n    if (i >= d / 2)\r\n      g[i] = g[i - d / 2];\r\n   \
    \ else\r\n      g[i] = 0;\r\n  }\r\n  return g;\r\n}\r\n#line 6 \"test/2_library_checker/polynomial/sqrt_of_fps_sparse.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/polynomial/sqrt_of_fps_sparse.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/polynomial/sqrt_of_fps_sparse.test.cpp
- /verify/test/2_library_checker/polynomial/sqrt_of_fps_sparse.test.cpp.html
