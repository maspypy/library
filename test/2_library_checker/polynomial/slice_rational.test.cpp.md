...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/polynomial/slice_rational.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/consecutive_terms_of_linear_recurrent_sequence\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 5 \"test/2_library_checker/polynomial/slice_rational.test.cpp\"\
    ...
    \n\ntemplate <typename mint>\nvc<mint> slice_rational_fps_ntt(vector<mint> P,\
    \ vector<mint> Q, ll L, ll R) {\n  while (len(Q) && Q.back() == mint(0)) POP(Q);\n\
    \  assert(Q[0] == mint(1));\n  if (len(Q) == 1) {\n    vc<mint> ANS(R - L);\n\
    ...
    \  }\n}\n#line 7 \"test/2_library_checker/polynomial/slice_rational.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/polynomial/slice_rational.test.cpp
- /verify/test/2_library_checker/polynomial/slice_rational.test.cpp.html
