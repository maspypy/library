...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/polynomial/log_of_fps.test.cpp\"\n\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 4 \"test/2_library_checker/polynomial/log_of_fps.test.cpp\"\
    ...
    }\n#line 7 \"test/2_library_checker/polynomial/log_of_fps.test.cpp\"\n\r\nusing\
    \ mint = modint998;\r\n\r\nvoid solve() {\r\n  LL(N);\r\n  VEC(mint, f, N);\r\n\
    \  auto ANS = fps_log(f);\r\n  print(ANS);\r\n}\r\n\r\nsigned main() {\r\n  solve();\r\
    \n\r\n  return 0;\r\n}\r\n"
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/polynomial/log_of_fps.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/polynomial/log_of_fps.test.cpp
- /verify/test/2_library_checker/polynomial/log_of_fps.test.cpp.html
