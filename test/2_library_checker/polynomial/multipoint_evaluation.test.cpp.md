...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/polynomial/multipoint_evaluation.test.cpp\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 4 \"test/2_library_checker/polynomial/multipoint_evaluation.test.cpp\"\
    ...
    \n\r\n  reverse(all(f));\r\n  mint ia = a.inverse();\r\n  mint pow = 1;\r\n  FOR(i,\
    \ n) f[i] *= pow, pow *= ia;\r\n  return f;\r\n}\r\n#line 6 \"test/2_library_checker/polynomial/multipoint_evaluation.test.cpp\"\
    \n\r\n#line 8 \"test/2_library_checker/polynomial/multipoint_evaluation.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/polynomial/multipoint_evaluation.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/polynomial/multipoint_evaluation.test.cpp
- /verify/test/2_library_checker/polynomial/multipoint_evaluation.test.cpp.html
