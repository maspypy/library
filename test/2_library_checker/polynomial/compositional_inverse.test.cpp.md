...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/polynomial/compositional_inverse.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/compositional_inverse_of_formal_power_series\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 5 \"test/2_library_checker/polynomial/compositional_inverse.test.cpp\"\
    ...
    \    G1 = {G1.begin() + n, G1.end()};\n    G1 = fps_div(G1, G2);\n    FOR(i, n)\
    \ G[n + i] -= G1[i];\n  }\n  G.resize(N);\n  return G;\n}\n#line 8 \"test/2_library_checker/polynomial/compositional_inverse.test.cpp\"\
