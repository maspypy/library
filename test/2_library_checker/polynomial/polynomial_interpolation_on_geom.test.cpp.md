...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/polynomial/polynomial_interpolation_on_geom.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/polynomial_interpolation_on_geometric_sequence\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 5 \"test/2_library_checker/polynomial/polynomial_interpolation_on_geom.test.cpp\"\
    ...
    \n\r\n  reverse(all(f));\r\n  mint ia = a.inverse();\r\n  mint pow = 1;\r\n  FOR(i,\
    \ n) f[i] *= pow, pow *= ia;\r\n  return f;\r\n}\r\n#line 7 \"test/2_library_checker/polynomial/polynomial_interpolation_on_geom.test.cpp\"\
    \n\n#line 9 \"test/2_library_checker/polynomial/polynomial_interpolation_on_geom.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/polynomial/polynomial_interpolation_on_geom.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/polynomial/polynomial_interpolation_on_geom.test.cpp
- /verify/test/2_library_checker/polynomial/polynomial_interpolation_on_geom.test.cpp.html
