...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/polynomial/multipoint_evaluation_on_geom_2.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/multipoint_evaluation_on_geometric_sequence\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/2_library_checker/polynomial/multipoint_evaluation_on_geom_2.test.cpp\"\
    ...
    \n\r\n  reverse(all(f));\r\n  mint ia = a.inverse();\r\n  mint pow = 1;\r\n  FOR(i,\
    \ n) f[i] *= pow, pow *= ia;\r\n  return f;\r\n}\r\n#line 8 \"test/2_library_checker/polynomial/multipoint_evaluation_on_geom_2.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/polynomial/multipoint_evaluation_on_geom_2.test.cpp
- /verify/test/2_library_checker/polynomial/multipoint_evaluation_on_geom_2.test.cpp.html
