...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/bigint/multiplication_of_bigintegers.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/bigint/multiplication_of_bigintegers.test.cpp\"\
    ...
    }\n#endif\n#line 6 \"test/2_library_checker/bigint/multiplication_of_bigintegers.test.cpp\"\
    \n\nusing B = BigInteger;\n\nvoid solve() {\n  B a, b;\n  read(a, b);\n  print(a\
    \ * b);\n}\n\nsigned main() {\n  INT(T);\n  FOR(T) solve();\n\n  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/bigint/multiplication_of_bigintegers.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/bigint/multiplication_of_bigintegers.test.cpp
- /verify/test/2_library_checker/bigint/multiplication_of_bigintegers.test.cpp.html
