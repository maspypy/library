...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/datastructure/rectangle_sum_bit2d.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/2_library_checker/datastructure/rectangle_sum_bit2d.test.cpp\"\
    ...
    \ R = prev(R); }\r\n    return pos;\r\n  }\r\n};\r\n#line 7 \"test/2_library_checker/datastructure/rectangle_sum_bit2d.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, Q);\n  vi X(N), Y(N), W(N);\n  FOR(i, N) {\n    LL(x,\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/datastructure/rectangle_sum_bit2d.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/datastructure/rectangle_sum_bit2d.test.cpp
- /verify/test/2_library_checker/datastructure/rectangle_sum_bit2d.test.cpp.html
