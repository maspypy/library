...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/datastructure/vertex_add_subtree_sum_monoid.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/datastructure/vertex_add_subtree_sum_monoid.test.cpp\"\
    ...
    \ X(0); }\r\n  static constexpr bool commute = true;\r\n};\r\n#line 7 \"test/2_library_checker/datastructure/vertex_add_subtree_sum_monoid.test.cpp\"\
    \n\r\nvoid solve() {\r\n  LL(N, Q);\r\n  VEC(ll, A, N);\r\n  Graph<int, 1> G(N);\r\
    \n  FOR3(v, 1, N) {\r\n    LL(p);\r\n    G.add(p, v);\r\n  }\r\n  G.build();\r\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/datastructure/vertex_add_subtree_sum_monoid.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/datastructure/vertex_add_subtree_sum_monoid.test.cpp
- /verify/test/2_library_checker/datastructure/vertex_add_subtree_sum_monoid.test.cpp.html
