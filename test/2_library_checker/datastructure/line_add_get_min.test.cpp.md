...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/datastructure/line_add_get_min.test.cpp\"\
    ...
    \ }\r\n};\r\n#line 5 \"test/2_library_checker/datastructure/line_add_get_min.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, Q);\n  CHT_min<ll> cht_min;\n  CHT_max<ll> cht_max;\n\
    \  FOR(N) {\n    LL(a, b);\n    cht_min.add(a, b);\n    cht_max.add(-a, -b);\n\
    \  }\n  FOR(Q) {\n    LL(t);\n    if (t == 0) {\n      LL(a, b);\n      cht_min.add(a,\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/datastructure/line_add_get_min.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/datastructure/line_add_get_min.test.cpp
- /verify/test/2_library_checker/datastructure/line_add_get_min.test.cpp.html
