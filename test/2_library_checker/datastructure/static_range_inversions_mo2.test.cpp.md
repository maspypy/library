...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/datastructure/static_range_inversions_mo2.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/datastructure/static_range_inversions_mo2.test.cpp\"\
    ...
    \        query(qid);\n        rollback();\n        l = LMAX;\n      }\n    }\n\
    \  }\n};\n#line 7 \"test/2_library_checker/datastructure/static_range_inversions_mo2.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, Q);\n  VEC(ll, A, N);\n  vi key = A;\n  UNIQUE(key);\n\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/datastructure/static_range_inversions_mo2.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/datastructure/static_range_inversions_mo2.test.cpp
- /verify/test/2_library_checker/datastructure/static_range_inversions_mo2.test.cpp.html
