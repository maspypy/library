...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/datastructure/set_xor_min.test.cpp\"\
    ...
    \ dat.eb(key[i], val[i]);\r\n    }\r\n    build(2 * len(dat));\r\n    for (auto&\
    \ [a, b]: dat) (*this)[a] = b;\r\n  }\r\n};\n#line 6 \"test/2_library_checker/datastructure/set_xor_min.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/datastructure/set_xor_min.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/datastructure/set_xor_min.test.cpp
- /verify/test/2_library_checker/datastructure/set_xor_min.test.cpp.html
