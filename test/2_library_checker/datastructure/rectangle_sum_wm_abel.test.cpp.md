...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/datastructure/rectangle_sum_wm_abel.test.cpp\"\
    ...
    #line 8 \"test/2_library_checker/datastructure/rectangle_sum_wm_abel.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, Q);\n  vc<u32> X(N), Y(N), W(N);\n  FOR(i, N) read(X[i],\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/datastructure/rectangle_sum_wm_abel.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/datastructure/rectangle_sum_wm_abel.test.cpp
- /verify/test/2_library_checker/datastructure/rectangle_sum_wm_abel.test.cpp.html
