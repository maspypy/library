...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/datastructure/rect_add_pt_get.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/2_library_checker/datastructure/rect_add_pt_get.test.cpp\"\
    ...
    \      LL(a, b, c, d, x);\n      QUERY.eb(a, b, c, d, x);\n    }\n    if (t ==\
    \ 1) {\n      LL(x, y);\n      X.eb(x), Y.eb(y);\n      QUERY.eb(x, y, -1, -1,\
    \ -1);\n    }\n  }\n\n  Dual_FenwickTree_2D<Monoid_Add<ll>, int, false> bit(X,\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/datastructure/rect_add_pt_get.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/datastructure/rect_add_pt_get.test.cpp
- /verify/test/2_library_checker/datastructure/rect_add_pt_get.test.cpp.html
