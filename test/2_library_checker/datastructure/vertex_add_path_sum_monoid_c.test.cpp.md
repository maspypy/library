...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/datastructure/vertex_add_path_sum_monoid_c.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/datastructure/vertex_add_path_sum_monoid_c.test.cpp\"\
    ...
    \ X(0); }\r\n  static constexpr bool commute = true;\r\n};\r\n#line 7 \"test/2_library_checker/datastructure/vertex_add_path_sum_monoid_c.test.cpp\"\
    \n\r\nvoid solve() {\r\n  LL(N, Q);\r\n  VEC(ll, A, N);\r\n  Graph G(N);\r\n \
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/datastructure/vertex_add_path_sum_monoid_c.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/datastructure/vertex_add_path_sum_monoid_c.test.cpp
- /verify/test/2_library_checker/datastructure/vertex_add_path_sum_monoid_c.test.cpp.html
