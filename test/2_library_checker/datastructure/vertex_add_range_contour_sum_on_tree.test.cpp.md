...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/datastructure/vertex_add_range_contour_sum_on_tree.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/vertex_add_range_contour_sum_on_tree\"\
    ...
    \ yes(!t); }\r\n#line 6 \"test/2_library_checker/datastructure/vertex_add_range_contour_sum_on_tree.test.cpp\"\
    ...
    \ v) {\n    vc<int> res;\n    FOR(k, info_indptr[v], info_indptr[v + 1]) {\n \
    \     int idx = info_idx[k];\n      int p = comp[idx];\n      res.eb(comp_range[p]\
    \ + dep[idx]);\n    }\n    return res;\n  }\n};\n#line 9 \"test/2_library_checker/datastructure/vertex_add_range_contour_sum_on_tree.test.cpp\"\
    \n\n#line 11 \"test/2_library_checker/datastructure/vertex_add_range_contour_sum_on_tree.test.cpp\"\
    \n\nvoid solve() {\n  INT(N, Q);\n  VEC(ll, A, N);\n  Graph<int, 0> G(N);\n  G.read_tree(0,\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/datastructure/vertex_add_range_contour_sum_on_tree.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/datastructure/vertex_add_range_contour_sum_on_tree.test.cpp
- /verify/test/2_library_checker/datastructure/vertex_add_range_contour_sum_on_tree.test.cpp.html
