...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/datastructure/vertex_add_path_sum_abelgroup.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/datastructure/vertex_add_path_sum_abelgroup.test.cpp\"\
    ...
    \ l + 1), bit_subtree.prod(r, N));\r\n  }\r\n};\r\n#line 7 \"test/2_library_checker/datastructure/vertex_add_path_sum_abelgroup.test.cpp\"\
    \n\r\nvoid solve() {\r\n  LL(N, Q);\r\n  VEC(ll, A, N);\r\n  Graph G(N);\r\n \
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/datastructure/vertex_add_path_sum_abelgroup.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/datastructure/vertex_add_path_sum_abelgroup.test.cpp
- /verify/test/2_library_checker/datastructure/vertex_add_path_sum_abelgroup.test.cpp.html
