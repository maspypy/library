...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/datastructure/static_range_mode_query.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/2_library_checker/datastructure/static_range_mode_query.test.cpp\"\
    ...
    \ query(u64 x) { return MP.get(x, -1); }\n};\n#line 8 \"test/2_library_checker/datastructure/static_range_mode_query.test.cpp\"\
    \n\nvoid solve() {\n  INT(N, Q);\n  VEC(int, A, N);\n  vc<int> key = A;\n  UNIQUE(key);\n\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/datastructure/static_range_mode_query.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/datastructure/static_range_mode_query.test.cpp
- /verify/test/2_library_checker/datastructure/static_range_mode_query.test.cpp.html
