...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/datastructure/rectangle_sum_cf2d.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/2_library_checker/datastructure/rectangle_sum_cf2d.test.cpp\"\
    ...
    \ {\n      T cf = T(1);\n      FOR(a, 1, A) cf *= T(a);\n      FOR(b, 1, B) cf\
    \ *= T(b);\n      for (auto&& x: res) x /= cf;\n    }\n    return res;\n  }\n\
    };\n#line 8 \"test/2_library_checker/datastructure/rectangle_sum_cf2d.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/datastructure/rectangle_sum_cf2d.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/datastructure/rectangle_sum_cf2d.test.cpp
- /verify/test/2_library_checker/datastructure/rectangle_sum_cf2d.test.cpp.html
