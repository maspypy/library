...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/set_power_series/sps_exp.test.cpp\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/2_library_checker/set_power_series/sps_exp.test.cpp\"\
    ...
    \ dp.begin() + (1 << i));\n  }\n  return dp;\n}\n#line 7 \"test/2_library_checker/set_power_series/sps_exp.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/set_power_series/sps_exp.test.cpp
- /verify/test/2_library_checker/set_power_series/sps_exp.test.cpp.html
