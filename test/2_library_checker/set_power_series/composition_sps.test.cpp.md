...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/set_power_series/composition_sps.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/polynomial_composite_set_power_series\"\
    ...
    \ LIM>(g, s);\n}\n#line 8 \"test/2_library_checker/set_power_series/composition_sps.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/set_power_series/composition_sps.test.cpp
- /verify/test/2_library_checker/set_power_series/composition_sps.test.cpp.html
