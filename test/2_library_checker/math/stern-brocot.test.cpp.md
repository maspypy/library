...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/math/stern-brocot.test.cpp\"\n#define\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/math/stern-brocot.test.cpp\"\n\
    ...
    \    string res;\n    char c = 'L';\n    for (auto&& x: p) {\n      c = 'L' +\
    \ 'R' - c;\n      if (x == 0) continue;\n      res += c;\n      res += \" \" +\
    \ std::to_string(x);\n    }\n    return res;\n  }\n};\n#line 6 \"test/2_library_checker/math/stern-brocot.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/math/stern-brocot.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/math/stern-brocot.test.cpp
- /verify/test/2_library_checker/math/stern-brocot.test.cpp.html
