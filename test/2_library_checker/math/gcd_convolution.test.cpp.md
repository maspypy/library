...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/math/gcd_convolution.test.cpp\"\n\
    ...
    \ == len(B));\n  multiplier_zeta(A);\n  multiplier_zeta(B);\n  FOR(i, len(A))\
    \ A[i] *= B[i];\n  multiplier_mobius(A);\n  return A;\n}\n#line 6 \"test/2_library_checker/math/gcd_convolution.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/math/gcd_convolution.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/math/gcd_convolution.test.cpp
- /verify/test/2_library_checker/math/gcd_convolution.test.cpp.html
