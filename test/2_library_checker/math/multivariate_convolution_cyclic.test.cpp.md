...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/math/multivariate_convolution_cyclic.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/multivariate_convolution_cyclic\"\
    ...
    #line 7 \"test/2_library_checker/math/multivariate_convolution_cyclic.test.cpp\"\
    \n\nusing mint = dmint;\n\nvoid solve() {\n  INT(p, K);\n  mint::set_mod(p);\n\
    \  VEC(int, ns, K);\n  int N = 1;\n  for (auto&& n: ns) N *= n;\n  VEC(mint, f,\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/math/multivariate_convolution_cyclic.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/math/multivariate_convolution_cyclic.test.cpp
- /verify/test/2_library_checker/math/multivariate_convolution_cyclic.test.cpp.html
