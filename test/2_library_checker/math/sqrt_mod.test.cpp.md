...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/math/sqrt_mod.test.cpp\"\n#define\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/math/sqrt_mod.test.cpp\"\n\r\n\
    ...
    \ f1, 2 * f0 * f1);\r\n    f0 %= p, f1 %= p;\r\n    k >>= 1;\r\n  }\r\n  return\
    \ g0;\r\n}\r\n#line 6 \"test/2_library_checker/math/sqrt_mod.test.cpp\"\n\r\n\
    void solve() {\r\n  INT(y, p);\r\n  print(mod_sqrt(y, p));\r\n}\r\n\r\nsigned\
    \ main() {\r\n  INT(T);\r\n  FOR(T) solve();\r\n  return 0;\r\n}\n"
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/math/sqrt_mod.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/math/sqrt_mod.test.cpp
- /verify/test/2_library_checker/math/sqrt_mod.test.cpp.html
