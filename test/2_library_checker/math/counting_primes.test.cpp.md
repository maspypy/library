...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/math/counting_primes.test.cpp\"\n\
    ...
    \  void calc_sum() {\r\n    calc([](ll x) -> T {\r\n      ll a = x, b = x + 1;\r\
    \n      if (!(x & 1)) a /= 2;\r\n      if (x & 1) b /= 2;\r\n      return T(a)\
    \ * T(b);\r\n    });\r\n  }\r\n};\n#line 5 \"test/2_library_checker/math/counting_primes.test.cpp\"\
    \n\r\nvoid solve() {\r\n  LL(N);\r\n  PrimeSum<ll> X(N);\r\n  X.calc_count();\r\
    \n  print(X[N]);\r\n}\r\n\r\nsigned main() {\r\n  solve();\r\n\r\n  return 0;\r\
    \n}\r\n"
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/math/counting_primes.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/math/counting_primes.test.cpp
- /verify/test/2_library_checker/math/counting_primes.test.cpp.html
