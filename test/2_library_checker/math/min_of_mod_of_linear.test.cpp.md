...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/math/min_of_mod_of_linear.test.cpp\"\
    ...
    \ break;\n  }\n  int y = (ll(a) * x + b) % mod;\n  return {L + x, y};\n}\n#line\
    \ 6 \"test/2_library_checker/math/min_of_mod_of_linear.test.cpp\"\n\nvoid solve()\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/math/min_of_mod_of_linear.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/math/min_of_mod_of_linear.test.cpp
- /verify/test/2_library_checker/math/min_of_mod_of_linear.test.cpp.html
