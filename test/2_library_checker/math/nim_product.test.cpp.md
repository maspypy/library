...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/math/nim_product.test.cpp\"\n#define\
    ...
    \ >> (8 * b)) & 255]];\r\n  }\r\n  return v;\r\n}\n#line 5 \"test/2_library_checker/math/nim_product.test.cpp\"\
    \n\r\nvoid solve() {\r\n  u64 a, b;\r\n  read(a, b);\r\n  print(nim_product(a,\
    \ b));\r\n}\r\n\r\nsigned main() {\r\n  LL(T);\r\n  FOR(T) solve();\r\n\r\n  return\
    \ 0;\r\n}\r\n"
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/math/nim_product.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/math/nim_product.test.cpp
- /verify/test/2_library_checker/math/nim_product.test.cpp.html
