...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/tree/lca.test.cpp\"\n#define PROBLEM\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 4 \"test/2_library_checker/tree/lca.test.cpp\"\
    ...
    \ check(V[c]); }, a, b, 0);\r\n      return V[c];\r\n    }\r\n    return u;\r\n\
    \  }\r\n};\r\n#line 6 \"test/2_library_checker/tree/lca.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N, Q);\n  Graph<int, 0> G(N);\n  FOR3(v, 1, N) {\n    LL(p);\n    G.add(p,\
    \ v);\n  }\n  G.build();\n  Tree tree(G);\n\n  FOR(_, Q) {\n    LL(a, b);\n  \
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/tree/lca.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/tree/lca.test.cpp
- /verify/test/2_library_checker/tree/lca.test.cpp.html
