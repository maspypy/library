...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/tree/vertex_add_path_sum_monoid_c.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/tree/vertex_add_path_sum_monoid_c.test.cpp\"\
    ...
    \ X(0); }\r\n  static constexpr bool commute = true;\r\n};\r\n#line 7 \"test/2_library_checker/tree/vertex_add_path_sum_monoid_c.test.cpp\"\
    \n\r\nvoid solve() {\r\n  LL(N, Q);\r\n  VEC(ll, A, N);\r\n  Graph G(N);\r\n \
    \ G.read_tree(0, 0);\r\n\r\n  Tree tree(G);\r\n  const bool is_edge = false;\r\
    \n  using Mono = Monoid_Add<ll>;\r\n  Tree_Monoid<decltype(tree), Mono, is_edge>\
    \ TM(tree, A);\r\n\r\n  FOR(_, Q) {\r\n    LL(t);\r\n    if (t == 0) {\r\n   \
    \   LL(v, x);\r\n      A[v] += x;\r\n      TM.set(v, A[v]);\r\n    } else {\r\n\
