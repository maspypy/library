...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/tree/vertex_add_path_sum_abelgroup.test.cpp\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 4 \"test/2_library_checker/tree/vertex_add_path_sum_abelgroup.test.cpp\"\
    ...
    graph/ds/tree_abeliangroup.hpp\"\n\r\ntemplate <typename TREE, typename AbelianGroup,\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/tree/vertex_add_path_sum_abelgroup.test.cpp
- /verify/test/2_library_checker/tree/vertex_add_path_sum_abelgroup.test.cpp.html
