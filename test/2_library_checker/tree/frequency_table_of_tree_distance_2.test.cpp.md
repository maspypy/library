...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/tree/frequency_table_of_tree_distance_2.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/frequency_table_of_tree_distance\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 6 \"test/2_library_checker/tree/frequency_table_of_tree_distance_2.test.cpp\"\
    ...
    }\r\n#line 9 \"test/2_library_checker/tree/frequency_table_of_tree_distance_2.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  Graph<int> G(N);\n  G.read_tree(0, 0);\n  vi ANS(N);\n\
