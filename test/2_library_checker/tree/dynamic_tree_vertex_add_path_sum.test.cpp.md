...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/tree/dynamic_tree_vertex_add_path_sum.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/dynamic_tree_vertex_add_path_sum\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 5 \"test/2_library_checker/tree/dynamic_tree_vertex_add_path_sum.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/tree/dynamic_tree_vertex_add_path_sum.test.cpp
- /verify/test/2_library_checker/tree/dynamic_tree_vertex_add_path_sum.test.cpp.html
