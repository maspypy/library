...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/tree/dynamic_tree_subtree_add_subtree_sum.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/dynamic_tree_subtree_add_subtree_sum\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 5 \"test/2_library_checker/tree/dynamic_tree_subtree_add_subtree_sum.test.cpp\"\
    ...
    \ 0;\n    if (n->p->l == n) return 1;\n    if (n->p->r == n) return -1;\n    return\
    \ 0;\n  }\n};\n#line 7 \"test/2_library_checker/tree/dynamic_tree_subtree_add_subtree_sum.test.cpp\"\
    \n\n/*\nsm \u306F lazy \u53CD\u6620\u6E08\n\u305F\u3060\u3057 light edge \u304B\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/tree/dynamic_tree_subtree_add_subtree_sum.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/tree/dynamic_tree_subtree_add_subtree_sum.test.cpp
- /verify/test/2_library_checker/tree/dynamic_tree_subtree_add_subtree_sum.test.cpp.html
