...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/tree/vertex_add_range_contour_sum_on_tree.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/vertex_add_range_contour_sum_on_tree\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 6 \"test/2_library_checker/tree/vertex_add_range_contour_sum_on_tree.test.cpp\"\
    ...
    \ }\n  }\n  if (c > 0) {\n    for (int a = par[c]; a != -1; a = par[a]) { color[a]\
    \ = nc, V.eb(a); }\n    ++nc;\n  }\n  FOR(i, N) {\n    if (i != c && color[i]\
    \ == 0) color[i] = color[par[i]], V.eb(i);\n  }\n  vc<int> indptr(nc + 1);\n \
    ...
    \ 9 \"test/2_library_checker/tree/vertex_add_range_contour_sum_on_tree.test.cpp\"\
    \n\n#line 11 \"test/2_library_checker/tree/vertex_add_range_contour_sum_on_tree.test.cpp\"\
    \n\nvoid solve() {\n  INT(N, Q);\n  VEC(ll, A, N);\n  Graph<int, 0> G(N);\n  G.read_tree(0,\
