...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/tree/lca_directed.test.cpp\"\n#define\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/2_library_checker/tree/lca_directed.test.cpp\"\
    ...
    \ }, a, b, 0);\r\n      return V[c];\r\n    }\r\n    return u;\r\n  }\r\n};\r\n\
    #line 6 \"test/2_library_checker/tree/lca_directed.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N, Q);\n  Graph<int, 1> G(N);\n  FOR3(v, 1, N) {\n    LL(p);\n    G.add(p,\
    \ v);\n  }\n  G.build();\n  Tree tree(G);\n\n  FOR(_, Q) {\n    LL(a, b);\n  \
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/tree/lca_directed.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/tree/lca_directed.test.cpp
- /verify/test/2_library_checker/tree/lca_directed.test.cpp.html
