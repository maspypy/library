...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/tree/cartesian_tree.test.cpp\"\n\
...
layout: document
redirect_from:
- /verify/test/2_library_checker/tree/cartesian_tree.test.cpp
- /verify/test/2_library_checker/tree/cartesian_tree.test.cpp.html
