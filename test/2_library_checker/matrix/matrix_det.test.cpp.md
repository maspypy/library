...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/matrix/matrix_det.test.cpp\"\n#define\
    ...
    #line 6 \"test/2_library_checker/matrix/matrix_det.test.cpp\"\n\r\nusing mint\
    \ = modint998;\r\nvoid solve() {\r\n  LL(N);\r\n  VV(mint, A, N, N);\r\n  print(det(A));\r\
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/matrix/matrix_det.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/matrix/matrix_det.test.cpp
- /verify/test/2_library_checker/matrix/matrix_det.test.cpp.html
