...
data:
  ...
  bundledCode: "#line 1 \"test/2_library_checker/matrix/matrix_product_mod2.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/2_library_checker/matrix/matrix_product_mod2.test.cpp\"\
    ...
    \ string x;\n      FOR(i, 8) x += '0' + (s >> i & 1);\n      TO_STR[s] = x;\n\
    \    }\n  }\n};\nstring My_Bitset::TO_STR[256];\n#line 6 \"test/2_library_checker/matrix/matrix_product_mod2.test.cpp\"\
    \n\nusing BS = My_Bitset;\n\nvoid solve() {\n  INT(N, M, K);\n\n  vc<BS> A(N,\
    \ BS(M));\n  vc<BS> B(M, BS(K));\n  vc<BS> C(N, BS(K));\n\n  FOR(i, N) {\n   \
    \ FOR(j, M) {\n      CHAR(ch);\n      A[i][j] = ch - '0';\n    }\n  }\n  FOR(j,\
    \ M) {\n    FOR(k, K) {\n      CHAR(ch);\n      B[j][k] = ch - '0';\n    }\n \
  ...
  verifiedWith: []
documentation_of: test/2_library_checker/matrix/matrix_product_mod2.test.cpp
layout: document
redirect_from:
- /verify/test/2_library_checker/matrix/matrix_product_mod2.test.cpp
- /verify/test/2_library_checker/matrix/matrix_product_mod2.test.cpp.html
