...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2573.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/2573.test.cpp\"\n\n#line 1 \"flow/hungarian.hpp\"\
    ...
    \  for (auto&& i: match) --i;\n  if (!MINIMIZE) res = -res;\n  return {res, match,\
    \ X, Y};\n}\n#line 6 \"test/yukicoder/2573.test.cpp\"\n\nvoid solve() {\n  LL(H,\
    \ W);\n  vv(ll, mat, W, W);\n  FOR(i, W) {\n    LL(x, y);\n    --x, --y;\n   \
    ...
    \ main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2573\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2573.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2573.test.cpp
- /verify/test/yukicoder/2573.test.cpp.html
