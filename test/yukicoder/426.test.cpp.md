...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/426.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/426\"\
    ...
    \ <class T, is_modint_t<T>* = nullptr>\r\nvc<vc<T>> mat_mul(const vc<vc<T>>& A,\
    \ const vc<vc<T>>& B) {\r\n  // mod \u3092\u3068\u308B\u56DE\u6570\u3092\u6E1B\
    ...
    \n  return C;\r\n}\r\n#line 7 \"test/yukicoder/426.test.cpp\"\nusing mint = modint107;\n\
    \nusing mat = vc<vc<mint>>;\n\nstruct Mono {\n  using value_type = tuple<mat,\
    \ mat, mat>;\n  using X = value_type;\n  static X op(X x, X y) {\n    auto& [A,\
    \ B, C] = x;\n    auto& [D, E, F] = y;\n    auto P = mat_mul(D, A);\n    auto\
    \ Q = mat_mul(mat_mul(C, E), A);\n    FOR(i, 2) FOR(j, 3) Q[i][j] += B[i][j];\n\
    \    auto R = mat_mul(C, F);\n    return {P, Q, R};\n  }\n  static X unit() {\n\
    \    mat P(3), Q(2), R(2);\n    P[0] = {1, 0, 0};\n    P[1] = {0, 1, 0};\n   \
    \ P[2] = {0, 0, 1};\n    Q[0] = {0, 0, 0};\n    Q[1] = {0, 0, 0};\n    R[0] =\
    \ {1, 0};\n    R[1] = {0, 1};\n    return {P, Q, R};\n  }\n  static constexpr\
