...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/2181
    links:
    - https://yukicoder.me/problems/no/2181
  bundledCode: "#line 1 \"test/yukicoder/2181.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2181\"\
    ...
    \ pf[s].se)) x *= p;\r\n      x = x % fd_pp;\r\n      ANS += x * crt_coef[s];\r\
    \n    }\r\n    return ANS % mod;\r\n  }\r\n};\r\n#line 5 \"test/yukicoder/2181.test.cpp\"\
    \n\nvoid solve() {\n  LL(L, R, mod);\n  Binomial X(mod);\n  ll ANS = 0;\n  FOR(n,\
    \ L, R + 1) ANS += X.C(n + n, n) - 2;\n  ANS %= mod;\n  if (ANS < 0) ANS += mod;\n\
    \  print(ANS);\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n\
    \  return 0;\n}\n"
  ...
  requiredBy: []
  timestamp: '2023-02-12 02:06:08+09:00'
