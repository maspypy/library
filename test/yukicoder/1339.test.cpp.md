...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1339.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1339\"\
    ...
    \  ll k = discrete_log_group<Monoid_Mul<amint>>(amint(10), amint(1), H, 1, N +\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1339\"\n#include \"my_template.hpp\"\
    ...
    \ == 0) N /= 2;\n  while (N % 5 == 0) N /= 5;\n  amint::set_mod(N);\n  auto H\
    \ = [&](amint x) -> ll { return x.val; };\n  ll k = discrete_log_group<Monoid_Mul<amint>>(amint(10),\
    \ amint(1), H, 1, N + 10);\n  print(k);\n}\n\nsigned main() {\n  cin.tie(nullptr);\n\
    \  ios::sync_with_stdio(false);\n  cout << fixed << setprecision(15);\n\n  LL(T);\n\
    \  FOR(T) solve();\n\n  return 0;\n}\n"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2022-11-28 22:32:51+09:00'
