...
data:
  ...
  bundledCode: "#line 1 \"my_template.hpp\"\n#pragma GCC optimize(\"Ofast\")\n#pragma\
    ...
    \ { yes(!t); }\r\n#line 3 \"test/yukicoder/1769.test.cpp\"\n\n#line 2 \"graph/base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T cost;\n  int id;\n\
    ...
    \n};\r\n#line 8 \"test/yukicoder/1769.test.cpp\"\n\nvoid solve() {\n  LL(N);\n\
  ...
  code: "#include \"my_template.hpp\"\n#include \"other/io.hpp\"\n\n#include \"graph/base.hpp\"\
    ...
    \n  FOR(root, N) {\n    auto [conv, G] = CD.get_subgraph(root);\n    const int\
    \ N = G.N;\n    // lca \u304C 0 \u3067\u3042\u308B\u3088\u3046\u306A path \u306B\
    \u3064\u3044\u3066\u89E3\u304F\n    vc<int> A(N);\n    FOR(v, N) {\n      for\
    \ (auto&& e: G[v]) A[e.to] = A[v] ^ e.cost;\n    }\n    TREE<decltype(G)> tree(G,\
    \ 0, false);\n\n    // \u6839\u4EE5\u5916\u306E\u70B9\u306B\u5BFE\u3057\u3066\u3001\
    dep=1 \u306E LA\n    vc<int> par_1(N, -1);\n    FOR(v, 1, N) {\n      int p =\
    \ tree.parent[v];\n      par_1[v] = (p == 0 ? v : par_1[p]);\n    }\n\n    //\
    \ \u8272 -> \u9802\u70B9\u96C6\u5408\n    MP.reset();\n    FOR(v, 1, N) if (A[v]\
    \ != A[0]) MP[A[v]].eb(v);\n\n    // \u6839\u306E\u6B21\u306E\u70B9 -> \u9802\u70B9\
    \u306E\u500B\u6570\n    vc<int> CNT(N);\n    FOR(v, N) if (par_1[v] == v) CNT[v]\
    \ = tree.subtree_size(v);\n\n    for (auto&& [key, V]: MP.items()) {\n      //\
    \ \u6839\u306B\u5230\u9054\u3067\u304D\u306A\u3044\u70B9\u306F V \u304B\u3089\u9664\
    \u304F\n      vc<int> W;\n      for (auto&& x: V) {\n        if (len(W) && tree.in_subtree(x,\
    \ W.back())) { continue; }\n        W.eb(x);\n      }\n      V = W;\n      //\
    \ \u5230\u9054\u53EF\u80FD\u306A\u70B9\u306E\u500B\u6570\u3092\u66F4\u65B0\n \
    \     ll s = N;\n      for (auto&& v: V) {\n        int x = tree.subtree_size(v);\n\
    \        CNT[par_1[v]] -= x;\n        s -= x;\n      }\n      // \u5404 v \u304B\
    \u3089\u306E\u7B54\u3092\u8A08\u7B97\n      for (auto&& v: V) { ANS[conv[v]] +=\
    \ s - CNT[par_1[v]]; }\n      for (auto&& v: V) {\n        int x = tree.subtree_size(v);\n\
    \        CNT[par_1[v]] += x;\n      }\n    }\n    // \u6839\u304B\u3089\u9032\u3080\
    \u5834\u5408\n    vc<int> OK(N);\n    OK[0] = 1;\n    FOR(v, N) {\n      if (!OK[v])\
    \ continue;\n      for (auto&& e: G[v]) {\n        if (A[e.to] == A[0]) continue;\n\
  ...
  requiredBy: []
  timestamp: '2022-10-26 11:18:18+09:00'
