...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2525.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/2525.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ fastio::rd(s);\n  x = BigInteger(s);\n}\n#endif\n#line 6 \"test/yukicoder/2525.test.cpp\"\
    \n\nvoid solve() {\n  BigInteger A, B;\n  read(A, B);\n  bool ok = A.divmod(2).se\
    \ == B.divmod(2).se;\n  print(ok ? \"Possible\" : \"Impossible\");\n}\n\nsigned\
    \ main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2525\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2525.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2525.test.cpp
- /verify/test/yukicoder/2525.test.cpp.html
