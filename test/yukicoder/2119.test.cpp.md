...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2119.test.cpp\"\n// competitive-verifier:\
    ...
    */\ntemplate <typename T>\npair<vc<T>, vvc<pair<int, int>>> coprime_factorization(vc<T>\
    ...
    \ }\n  return ret;\n}\n#line 6 \"test/yukicoder/2119.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N, M);\n  vc<int> vals, mods;\n  FOR(M) {\n    LL(b, c);\n    c %= b;\n\
    \    if (c < 0) c += b;\n    mods.eb(b);\n    vals.eb(c);\n  }\n  auto ng = [&]()\
    ...
    \n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2119\n\n\
