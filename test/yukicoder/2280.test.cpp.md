...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2280.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2280\"\
    ...
    \ < R \u306E\u3046\u3061\u3067\u3001(ax+b mod) in [lo, hi) \u3068\u306A\u308B\u3082\
    \u306E\u306E\u500B\u6570\nll range_freq_of_linear(ll L, ll R, ll a, ll b, ll mod,\
    \ ll lo, ll hi) {\n  if (lo >= hi) return 0;\n  assert(0 <= lo && lo < hi && hi\
    \ <= mod);\n\n  i128 x1 = floor_sum_of_linear(L, R, a, b - lo, mod);\n  i128 x2\
    \ = floor_sum_of_linear(L, R, a, b - hi, mod);\n  return x1 - x2;\n}\n#line 5\
    \ \"test/yukicoder/2280.test.cpp\"\n\nvoid solve() {\n  LL(M, A, B, K);\n  ll\
    \ NA = M / A;\n  ll ANS = 0;\n\n  ll xAA = 0, xAB = 0, xBA = 0;\n  if (K == A)\
    \ { xAA = range_freq_of_linear(1, NA, A, 0, B, 1, B - A); }\n\n  auto f = [&](ll\
    \ A, ll B) -> ll {\n    if (K > A || K > B) return 0;\n    // A \u306E\u500D\u6570\
    \ -> B \u306E\u500D\u6570\n    ll res = 0;\n    ll ub = floor(M - K, A);\n   \
