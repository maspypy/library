...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1441_rbst.test.cpp\"\n#define PROBLEM \"\
    ...
    #line 6 \"test/yukicoder/1441_rbst.test.cpp\"\n\nvoid solve() {\n  LL(N, Q);\n\
    \  VEC(ll, A, N);\n  SplayTree_Monoid<Group_Add<ll>> ST;\n  auto root = ST.new_node(A);\n\
    \  FOR(Q) {\n    LL(t, l, r);\n    --l;\n    if (t == 1) {\n      auto nr = ST.split(root,\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1441\"\n#include \"my_template.hpp\"\
    ...
    \ \"alg/group_add.hpp\"\n\nvoid solve() {\n  LL(N, Q);\n  VEC(ll, A, N);\n  SplayTree_Monoid<Group_Add<ll>>\
    \ ST;\n  auto root = ST.new_node(A);\n  FOR(Q) {\n    LL(t, l, r);\n    --l;\n\
    \    if (t == 1) {\n      auto nr = ST.split(root, r);\n      auto nm = ST.split(root,\
    \ l);\n      nm = ST.new_node(nm->prod);\n      ST.merge(root, nm);\n      ST.merge(root,\
  ...
  requiredBy: []
  timestamp: '2022-05-19 13:44:35+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/yukicoder/1441_rbst.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1441_rbst.test.cpp
- /verify/test/yukicoder/1441_rbst.test.cpp.html
