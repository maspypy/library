...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1201.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1201\"\
    ...
    \    tie(a, mod) = mp(mod, a);\n  }\n  return res;\n}\n#line 5 \"test/yukicoder/1201.test.cpp\"\
    \n\nconst int mod = 1'000'000'007;\n\nvoid solve() {\n  LL(N, M);\n  VEC(ll, A,\
    \ N);\n  VEC(ll, B, M);\n\n  i128 ANS = 0;\n  for (auto&& a: A) {\n    for (auto&&\
    \ b: B) {\n      // FOR(k, 1, b + 1) ANS += mint(floor(a * k, b));\n      i128\
    \ x = floor_sum_of_linear(1, b + 1, a, 0, b);\n      ANS += x;\n    }\n  }\n \
    \ ANS += ANS;\n  ANS %= mod;\n  print(ANS);\n}\n\nsigned main() {\n  cout << fixed\
    \ << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return\
    \ 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1201\"\n#include \"my_template.hpp\"\
    ...
    \  VEC(ll, B, M);\n\n  i128 ANS = 0;\n  for (auto&& a: A) {\n    for (auto&& b:\
    \ B) {\n      // FOR(k, 1, b + 1) ANS += mint(floor(a * k, b));\n      i128 x\
    \ = floor_sum_of_linear(1, b + 1, a, 0, b);\n      ANS += x;\n    }\n  }\n  ANS\
    \ += ANS;\n  ANS %= mod;\n  print(ANS);\n}\n\nsigned main() {\n  cout << fixed\
    \ << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return\
    \ 0;\n}\n"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2022-09-20 05:00:21+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/yukicoder/1201.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1201.test.cpp
- /verify/test/yukicoder/1201.test.cpp.html
