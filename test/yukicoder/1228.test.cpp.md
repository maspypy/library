...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/1228
    links:
    - https://yukicoder.me/problems/no/1228
  bundledCode: "#line 1 \"test/yukicoder/1228.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1228\"\
    ...
    \n};\r\n#line 5 \"test/yukicoder/1228.test.cpp\"\n\nvoid solve() {\n  LL(X, K);\n\
    \  if (X == 0) ++K;\n  if (K == 0) {\n    Yes();\n    print(1);\n    print(1 ^\
    \ X);\n    return;\n  }\n  ll n = topbit(K);\n  if (K != 1 << n) return No();\n\
    ...
    \ LL(T);\n  FOR(T) solve();\n\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1228\"\n#include \"my_template.hpp\"\
  ...
  requiredBy: []
  timestamp: '2022-09-28 21:25:20+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/yukicoder/1228.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1228.test.cpp
- /verify/test/yukicoder/1228.test.cpp.html
