...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/187_crt.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/187\"\
    ...
    \ (auto&& [p, e]: pf) { x = x * mod_pow(p, e, mod) % mod; }\n  return x;\n}\n\
    ...
    \ mods, int new_mod = -1, bool coprime = true) {\n  int n = len(vals);\n  if (!coprime)\
    ...
    \  FOR(i, n) {\n    ret += prod * cfs[i];\n    prod *= mods[i];\n    if (new_mod\
    \ != -1) {\n      ret %= new_mod;\n      prod %= new_mod;\n    }\n  }\n  return\
    \ ret;\n}\n#line 6 \"test/yukicoder/187_crt.test.cpp\"\n\nvoid solve() {\n  LL(N);\n\
    \  vc<int> vals, mods;\n  FOR(i, N) {\n    LL(a, b);\n    vals.eb(a);\n    mods.eb(b);\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/187_crt.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/187_crt.test.cpp
- /verify/test/yukicoder/187_crt.test.cpp.html
