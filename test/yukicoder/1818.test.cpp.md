...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1818.test.cpp\"\n// competitive-verifier:\
    ...
    }\n#line 5 \"test/yukicoder/1818.test.cpp\"\n\nvoid solve() {\n  LL(N, M);\n \
    \ VEC(ll, A, N);\n  VEC(ll, B, M);\n  string S, T;\n  FOR(i, N) {\n    FOR(A[i])\
    \ S += 'a';\n    S += 'b';\n  }\n  FOR(i, M) {\n    FOR(B[i]) T += 'a';\n    T\
    \ += 'b';\n  }\n\n  print(edit_distance(S, T));\n}\n\nsigned main() {\n  cout\
    \ << fixed << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\
    \n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1818\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1818.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1818.test.cpp
- /verify/test/yukicoder/1818.test.cpp.html
