...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/529_two_edge.test.cpp\"\n#define PROBLEM\
    ...
    \n      sz[v] += sz[e.to];\r\n      if (chmax(hld_sz, sz[e.to]) && l < i) { swap(csr[l],\
    \ csr[i]); }\r\n    }\r\n  }\r\n\r\n  void dfs_hld(int v, int &times) {\r\n  \
    \  LID[v] = times++;\r\n    RID[v] += LID[v];\r\n    V[LID[v]] = v;\r\n    bool\
    \ heavy = true;\r\n    for (auto &&e: G[v]) {\r\n      if (!in_tree[e.id] || depth[e.to]\
    ...
    \ <= LID[a] && LID[a] < RID[b]; }\r\n\r\n  int jump(int a, int b, int k = 1) {\r\
    \n    if (k == 1) {\r\n      if (a == b) return -1;\r\n      return (in_subtree(b,\
...
layout: document
redirect_from:
- /verify/test/yukicoder/529_two_edge.test.cpp
- /verify/test/yukicoder/529_two_edge.test.cpp.html
