...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1526.test.cpp\"\n// competitive-verifier:\
    ...
    \ r, {x, -infty<T>}); }\n};\n#line 5 \"test/yukicoder/1526.test.cpp\"\n\nvoid\
    \ solve() {\n  LL(N);\n  VEC(ll, A, N);\n  for (auto&& x: A) --x;\n\n  // dp[L]\
    ...
    \  FOR(T) solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1526\n\
