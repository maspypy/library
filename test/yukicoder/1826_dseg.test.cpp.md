...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1826_dseg.test.cpp\"\n#define PROBLEM \"\
    ...
    \n  static constexpr bool commute = true;\r\n};\r\n#line 6 \"test/yukicoder/1826_dseg.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  vi X, Y, V;\n  FOR(N) {\n    LL(t, x, v);\n  \
  ...
  requiredBy: []
  timestamp: '2022-06-18 03:58:08+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/yukicoder/1826_dseg.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1826_dseg.test.cpp
- /verify/test/yukicoder/1826_dseg.test.cpp.html
