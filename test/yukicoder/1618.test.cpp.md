...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1618.test.cpp\"\n// competitive-verifier:\
    ...
    \ b);\r\n  return convolution_garner(a, b);\r\n}\r\n#line 5 \"test/yukicoder/1618.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  VEC(ll, A, N);\n  VEC(ll, B, N);\n  A.insert(A.begin(),\
    \ 0);\n  B.insert(B.begin(), 0);\n  vc<ll> f(N + 1);\n  iota(all(f), 0);\n  A\
    \ = convolution(A, f);\n  B = convolution(B, f);\n  FOR(i, len(A)) A[i] += B[i];\n\
    \  A.erase(A.begin());\n  print(A);\n}\n\nsigned main() {\n  cin.tie(nullptr);\n\
    ...
    \  // LL(T);\n  FOR(_, T) solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1618\n\
