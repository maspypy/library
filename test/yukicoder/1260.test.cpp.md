...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1260.test.cpp\"\n// competitive-verifier:\
    ...
    using modint998 = modint<998244353>;\n#line 7 \"test/yukicoder/1260.test.cpp\"\
    ...
    \ << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return\
    \ 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1260\n\
    #include \"my_template.hpp\"\n#include \"other/io.hpp\"\n#include \"nt/integer_kth_root.hpp\"\
    \n#include \"enumerate/floor_range.hpp\"\n#include \"mod/modint.hpp\"\n\nusing\
    \ mint = modint107;\n\nvoid solve() {\n  LL(N);\n  mint ANS = 0;\n  ll LIM = integer_kth_root(2,\
    \ N) + 1;\n  {\n    auto f = [&](ll i) -> ll {\n      ll res = 0;\n      ll n\
    \ = N;\n      while (n) {\n        res += n % i;\n        n /= i;\n      }\n \
    \     return res;\n    };\n    FOR(i, 2, LIM) {\n      if (i <= N) ANS += mint(f(i));\n\
