...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1867.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1867\"\
    ...
    \ i, int j) -> int { return dp[i] + inv[i][j]; };\n    Monge_LiChao_Tree<int,\
    \ false, decltype(f)> LCT(N + 1, f);\n    FOR(i, N + 1) {\n      chmax(newdp[i],\
    \ LCT.query(i).fi);\n      LCT.add_line(i);\n    }\n    swap(dp, newdp);\n   \
  ...
  - my_template.hpp
  - other/io.hpp
  - convex/monge_lichao_tree.hpp
  isVerificationFile: true
  path: test/yukicoder/1867.test.cpp
  requiredBy: []
  timestamp: '2023-11-02 19:21:51+09:00'
