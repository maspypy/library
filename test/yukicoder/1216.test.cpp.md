...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1216.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1216\"\
    ...
    \ a);\n      return (i == a ? u : tree.V[i - 1]);\n    }\n    return v;\n  }\n\
    };\n#line 6 \"test/yukicoder/1216.test.cpp\"\n// #include \"graph/treemonoid.hpp\"\
    ...
    \ dat[LID + R]);\r\n      R = prev(R);\r\n    }\r\n    return pos;\r\n  }\r\n\
    };\r\n#line 8 \"test/yukicoder/1216.test.cpp\"\n\nvoid solve() {\n  LL(N, Q);\n\
    \  Graph<ll, 0> G(N);\n  G.read_tree(1);\n  TREE<decltype(G)> tree(G);\n  vi dat(N\
    \ - 1);\n  FOR(i, N - 1) dat[i] = G.edges[i].cost;\n  // TreeMonoid<decltype(tree),\
    \ Group_Add<ll>, 1> TM(tree, dat);\n  StaticTreeMonoid<decltype(tree), Group_Add<ll>,\
    \ 1> TM(tree, dat);\n\n  auto& dist = tree.depth_weighted;\n  /*\n  \u30FB\u9802\
    \u70B9 v \u306B\u3001\u6839\u306B\u7740\u304F\u306E\u304C\u6642\u523B t \u3067\
    \u3042\u308B\u3088\u3046\u306A\u3082\u306E\u3092\u8FFD\u52A0\n  \u30FB\uFF08\u6D88\
    \u3059\uFF09\u306F\u3058\u3081\u3066\u6D88\u3048\u3066\u5230\u9054\u3059\u308B\
    \u306E\u304C w \u3067\u3042\u308B\u3068\u304D\u3001w \u306B -1 \u500B\u8FFD\u52A0\
  ...
  requiredBy: []
  timestamp: '2022-11-15 17:11:50+09:00'
