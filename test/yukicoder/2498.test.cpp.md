...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2498.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/2498.test.cpp\"\n\n#line 2 \"ds/segtree/dual_segtree.hpp\"\
    ...
    \ bool commute = 0;\n};\n#line 8 \"test/yukicoder/2498.test.cpp\"\n\nusing mint\
    \ = modint998;\n\nvoid solve() {\n  LL(N, Q);\n  VEC(u32, A, N);\n  using Mono\
    ...
    \ print(ANS);\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n\
    \  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2498\n\
    #include \"my_template.hpp\"\n#include \"other/io.hpp\"\n\n#include \"ds/segtree/dual_segtree.hpp\"\
    \n#include \"mod/modint.hpp\"\n#include \"alg/monoid/bitwise_function.hpp\"\n\n\
    using mint = modint998;\n\nvoid solve() {\n  LL(N, Q);\n  VEC(u32, A, N);\n  using\
    \ Mono = Bitwise_Function<u32>;\n  Dual_SegTree<Mono> seg(N);\n  FOR(Q) {\n  \
    \  STR(S);\n    INT(L, R, x);\n    --L;\n    if (S == \"o\") { seg.apply(L, R,\
    \ Mono::func_or(x)); }\n    if (S == \"x\") { seg.apply(L, R, Mono::func_xor(x));\
    \ }\n  }\n\n  auto F = seg.get_all();\n\n  // \u5404\u9805\u306E popcnt \u3054\
    \u3068\u306E\u6570\u3048\n  const int K = 30;\n  array<mint, K + 1> DP{};\n  DP[0]\
    \ = 1;\n\n  FOR(i, N) {\n    auto [F0, F1] = F[i];\n    // [0, A[i]]\n    struct\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2498.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2498.test.cpp
- /verify/test/yukicoder/2498.test.cpp.html
