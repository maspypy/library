...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/579.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/579.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    }\r\n#line 8 \"test/yukicoder/579.test.cpp\"\n\nusing mint = modint107;\n\nvoid\
    ...
    \ LL(T);\n  FOR(T) solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/579\n#include\
    \ \"my_template.hpp\"\n#include \"other/io.hpp\"\n\n#include \"mod/modint.hpp\"\
    \n#include \"other/connected_dp.hpp\"\n#include \"seq/interpolate_linear_rec.hpp\"\
    \n\nusing mint = modint107;\n\nvoid solve() {\n  LL(N);\n  auto [states, edges]\
    \ = connected_dp_squares::polygon_dp_graph(3);\n  const int S = len(states);\n\
    \  int E = len(edges);\n  vc<int> count_line(E);\n  FOR(e, E) {\n    auto& now\
    \ = states[edges[e].fi];\n    auto& nxt = states[edges[e].se];\n    int n = 0;\n\
