...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2005.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2005\"\
    ...
    \ X(1); }\r\n  static constexpr bool commute = true;\r\n};\r\n#line 1 \"seq/eulerian_number.hpp\"\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2005\"\n#include \"my_template.hpp\"\
    ...
    \ mint = modint998;\n\nvoid solve() {\n  ll LIM = 5000;\n  LL(N, M);\n  vvc<mint>\
    \ A = eulerian_number_2d<mint>(LIM, LIM);\n\n  // M - LIM, ... \u306E\u7A4D\u3092\
    \u3068\u308A\u305F\u3044\n  DisjointSparse<Group_Mul<mint>> seg(N + LIM + LIM\
    \ + 100,\n                                      [&](int i) { return mint(M - LIM\
    \ + i); });\n\n  auto prod = [&](ll l, ll r) -> mint {\n    l -= (M - LIM);\n\
    \    r -= (M - LIM);\n    return seg.prod(l, r);\n  };\n\n  vc<mint> dp(LIM +\
    \ 1);\n  FOR(k, 1, LIM + 1) {\n    mint& ANS = dp[k];\n    ll n = min(k, M);\n\
    \    FOR(i, n + 1) {\n      // N + k + M - i C N + k\n      ANS += prod(M - i\
