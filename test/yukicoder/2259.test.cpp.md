...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2259.test.cpp\"\n// competitive-verifier:\
    ...
    \ break;\n  }\n  int y = (ll(a) * x + b) % mod;\n  return {L + x, y};\n}\n#line\
    \ 6 \"test/yukicoder/2259.test.cpp\"\n\nvoid solve() {\n  LL(L, R, C);\n  auto\
    \ [x, fx] = min_of_linear(L, R + 1, -C, 0, 1000);\n  print(fx);\n}\n\nsigned main()\
    \ {\n  solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2259\n\
    #include \"my_template.hpp\"\n#include \"other/io.hpp\"\n\n#include \"mod/min_of_linear.hpp\"\
    \n\nvoid solve() {\n  LL(L, R, C);\n  auto [x, fx] = min_of_linear(L, R + 1, -C,\
    \ 0, 1000);\n  print(fx);\n}\n\nsigned main() {\n  solve();\n  return 0;\n}"
  dependsOn:
  - my_template.hpp
  - other/io.hpp
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2259.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2259.test.cpp
- /verify/test/yukicoder/2259.test.cpp.html
