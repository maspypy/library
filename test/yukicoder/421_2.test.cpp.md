...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/421_2.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/421_2.test.cpp\"\n\n#line 2 \"ds/my_bitset.hpp\"\
    ...
    #line 7 \"test/yukicoder/421_2.test.cpp\"\n\nusing BS = bitset<1250>;\n\nvoid\
    \ solve() {\n  INT(H, W);\n  VEC(string, G, H);\n\n  vv(int, IDX, H, W);\n  int\
    \ a = 0, b = 0;\n  FOR(x, H) FOR(y, W) {\n    if ((x + y) % 2 == 0) IDX[x][y]\
    ...
    \ += 10 * m;\n  ANS += x + y - 2 * m;\n  print(ANS);\n}\n\nsigned main() {\n \
    \ solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/421\n#include\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/421_2.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/421_2.test.cpp
- /verify/test/yukicoder/421_2.test.cpp.html
