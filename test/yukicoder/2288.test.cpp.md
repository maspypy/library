...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2288.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 5 \"test/yukicoder/2288.test.cpp\"\n\n#line 1 \"graph/stable_matching.hpp\"\
    ...
    \ int>> match;\n    FOR(v1, N1) {\n      int v2 = match_1[v1];\n      if (v2 !=\
    \ -1) match.eb(v1, v2);\n    }\n    return match;\n  }\n};\n#line 7 \"test/yukicoder/2288.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, X, Y);\n  N += 2;\n  vc<pi> col1(N, {-1, -1});\n \
    \ vc<pi> col2(N, {-1, -1});\n  vvc<int> P, Q;\n  FOR(i, X) {\n    INT(n);\n  \
    ...
    \ - 1);\n  }\n  print(ANS);\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n\
    \  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2288\n\n\
