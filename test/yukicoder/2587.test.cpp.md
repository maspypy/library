...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2587.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/2587.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    #line 7 \"test/yukicoder/2587.test.cpp\"\n\n#line 2 \"poly/poly_taylor_shift.hpp\"\
    ...
    \ {g, f};\n}\n#line 11 \"test/yukicoder/2587.test.cpp\"\n\nusing mint = modint998;\n\
    using poly = vc<mint>;\n\nvoid solve() {\n  LL(N, M, S, T);\n  --S, --T;\n  Graph<int,\
  ...
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2587\n\
    ...
    \n\nusing mint = modint998;\nusing poly = vc<mint>;\n\nvoid solve() {\n  LL(N,\
    \ M, S, T);\n  --S, --T;\n  Graph<int, 0> G(N);\n  G.read_tree();\n\n  auto [g,\
    \ f] = tree_walk_generating_function<true, mint>(\n      G, S, T, [&](int i, int\
    \ j) -> mint { return 1; });\n\n  mint ANS = coef_of_rational_fps<mint>(g, f,\
    \ M);\n  print(ANS);\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n  FOR(T)\
    \ solve();\n  return 0;\n}\n"
  dependsOn:
  - my_template.hpp
