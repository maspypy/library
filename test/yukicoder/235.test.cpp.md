...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/235.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/235\"\
    ...
    \ <typename TREE, typename Lazy, bool edge = false>\r\nstruct LazyTreeMonoid {\r\
    ...
    \ = Lazy_CntSum_Add<mint>;\n\nvoid solve() {\n  LL(N);\n  VEC(ll, S, N);\n  VEC(ll,\
    \ C, N);\n  Graph G(N);\n  G.read_tree();\n  TREE tree(G);\n  vc<pair<mint, mint>>\
    \ dat;\n  FOR(i, N) dat.eb(C[i], S[i]);\n  LazyTreeMonoid<decltype(tree), Lazy,\
    \ false> TM(tree, dat);\n  LL(Q);\n  FOR(Q) {\n    LL(t);\n    if (t == 0) {\n\
    \      LL(a, b, c);\n      --a, --b;\n      TM.apply_path(a, b, c);\n    } else\
  ...
  requiredBy: []
  timestamp: '2022-08-31 01:05:28+09:00'
