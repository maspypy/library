...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2574.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/2574.test.cpp\"\n\n#line 1 \"seq/cartesian_tree.hpp\"\
    \n/*\r\n\u8F9E\u66F8\u9806\u3067\u9AD8\u3055\u3092 unique \u3057\u3066\u3001\u6728\
    \u306B\u3057\u3066\u3044\u308B\u3002\r\n\u6975\u5927\u9577\u65B9\u5F62\u30A2\u30EB\
    \u30B4\u30EA\u30BA\u30E0\u3067\u7DDA\u5F62\u6642\u9593\u69CB\u7BC9\u3002\r\n*/\r\
    ...
    \n      res += x * (i - l + 1) * (r - i);\r\n    }\r\n    return res;\r\n  }\r\
    \n};\r\n#line 6 \"test/yukicoder/2574.test.cpp\"\n\nvoid solve() {\n  LL(H, W,\
    \ N);\n  vv(int, A, H, W, 1);\n  FOR(N) {\n    INT(x, y);\n    A[--x][--y] = 0;\n\
    \  }\n  ll ANS = 0;\n  vc<int> Y(W);\n  FOR(i, H) {\n    FOR(j, W) Y[j] = (A[i][j]\
    ...
    \    }\n  }\n  print(ANS);\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n\
    \  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2574\n\
