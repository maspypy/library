...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/1274
    links:
    - https://yukicoder.me/problems/no/1274
  bundledCode: "#line 1 \"test/yukicoder/1274_gaussian.test.cpp\"\n#define PROBLEM\
    ...
    \ { yes(!t); }\r\n#line 4 \"test/yukicoder/1274_gaussian.test.cpp\"\n\n#line 2\
    \ \"nt/primetest.hpp\"\nstruct m64 {\r\n  using i64 = int64_t;\r\n  using u64\
    ...
    #line 6 \"test/yukicoder/1274_gaussian.test.cpp\"\n\nvoid solve() {\n  using G\
    \ = Gaussian_Integer<i128>;\n  LL(a, b);\n  if (a == 0 && b == 0) return print(0.25);\n\
    ...
    \ << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return\
    \ 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1274\"\n#include \"my_template.hpp\"\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1274_gaussian.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1274_gaussian.test.cpp
- /verify/test/yukicoder/1274_gaussian.test.cpp.html
