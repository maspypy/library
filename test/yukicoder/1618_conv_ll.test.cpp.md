...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1618_conv_ll.test.cpp\"\n#define PROBLEM\
    ...
    \ b);\r\n}\r\n#line 5 \"test/yukicoder/1618_conv_ll.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N);\n  VEC(ll, A, N);\n  VEC(ll, B, N);\n  A.insert(A.begin(), 0);\n\
    \  B.insert(B.begin(), 0);\n  vc<ll> f(N + 1);\n  iota(all(f), 0);\n  A = convolution(A,\
    \ f);\n  B = convolution(B, f);\n  FOR(i, len(A)) A[i] += B[i];\n  A.erase(A.begin());\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1618_conv_ll.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1618_conv_ll.test.cpp
- /verify/test/yukicoder/1618_conv_ll.test.cpp.html
