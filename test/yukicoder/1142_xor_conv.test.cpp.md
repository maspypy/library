...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1142_xor_conv.test.cpp\"\n#define PROBLEM\
    ...
    \n  }\r\n  return A;\r\n}\r\n#line 5 \"test/yukicoder/1142_xor_conv.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M, K);\n  ll a = 0;\n  ll LIM = 1024;\n  vc<i128>\
    \ f(LIM), g(LIM);\n  f[0] = g[0] = 1;\n  FOR(i, N) {\n    LL(x);\n    a ^= x;\n\
    \    f[a]++;\n  }\n  a = 0;\n  FOR(i, M) {\n    LL(x);\n    a ^= x;\n    g[a]++;\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1142_xor_conv.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1142_xor_conv.test.cpp
- /verify/test/yukicoder/1142_xor_conv.test.cpp.html
