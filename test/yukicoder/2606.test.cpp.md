...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2606.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/2606.test.cpp\"\n\n#line 1 \"string/palindromic_tree.hpp\"\
    ...
    \ link = nodes[k].link;\n      res[link] += res[k];\n    }\n    return res;\n\
    \  }\n};\n#line 6 \"test/yukicoder/2606.test.cpp\"\n\nvoid solve() {\n  STR(S);\n\
    \  Palindromic_Tree<26> X(S, 'a');\n\n  auto CNT = X.count();\n  ll n = len(X.nodes);\n\
    \  vi dp(n);\n  FOR(i, 2, n) {\n    int p = X.nodes[i].link;\n    ll cnt = CNT[i];\n\
    \    ll L = X.nodes[i].length;\n    chmax(dp[i], dp[p] + cnt * L);\n  }\n  print(MAX(dp));\n\
    }\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return\
    \ 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2606\n\
