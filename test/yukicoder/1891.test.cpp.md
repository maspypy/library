...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1891.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1891\"\
    ...
    \ yes(!t); }\n#line 1 \"ds/disjointsparse/xor_disjointsparse.hpp\"\ntemplate <typename\
    ...
    \    log = 0;\n    while ((1 << log) < m) ++log;\n    assert(m == (1 << log));\n\
    \    // \u5404 k, i \u306B\u5BFE\u3057\u3066\u3001prod_{0<=j<2^k} A[i^j] \u3092\
    \u6301\u3064\n    dat.resize(log + 1);\n    dat[0].reserve(1 << log);\n    FOR(i,\
    \ 1 << log) dat[0].eb(f(i));\n    FOR(k, log) {\n      dat[k + 1].assign(1 <<\
    ...
    };\n#line 7 \"test/yukicoder/1891.test.cpp\"\n\nusing mint = modint998;\n\nvoid\
    \ solve() {\n  INT(N, Q);\n  using Mono = Monoid_Affine<mint>;\n  Xor_DisjointSparse<Mono>\
  ...
  - my_template.hpp
  - other/io.hpp
  - ds/disjointsparse/xor_disjointsparse.hpp
  - mod/modint.hpp
