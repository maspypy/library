...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2613.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 5 \"test/yukicoder/2613.test.cpp\"\n\n#line 2 \"mod/primitive_root.hpp\"\
    ...
    \ - A[0] * B[0];\n  return C;\n}\n#line 9 \"test/yukicoder/2613.test.cpp\"\n\n\
    ...
    \  print(ANS);\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n\
    \  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2613\n\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2613.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2613.test.cpp
- /verify/test/yukicoder/2613.test.cpp.html
