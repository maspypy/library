...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/626_knapsack_branch_bound.test.cpp\"\n#define\
    ...
    \ now_val);\n  };\n\n  dfs(dfs, 0, 0, 0);\n  return ANS;\n}\n#line 5 \"test/yukicoder/626_knapsack_branch_bound.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, LIM);\n  vi wt(N), val(N);\n  FOR(i, N) {\n    LL(a,\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/626_knapsack_branch_bound.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/626_knapsack_branch_bound.test.cpp
- /verify/test/yukicoder/626_knapsack_branch_bound.test.cpp.html
