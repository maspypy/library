...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1332.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1332\"\
    ...
    \ + 1, MX::unit());\r\n      FOR(i, N) cumsum_0[i + 1] = MX::op(cumsum_0[i], SUM_data[i]);\r\
    \n    }\r\n    if (MAKE_SUM) cumsum.assign(1 + lg, vc<X>(N + 1, MX::unit()));\r\
    \n    vc<T> A0(N), A1(N);\r\n    vc<X> S0(N), S1(N);\r\n    FOR_R(d, -1, lg) {\r\
    \n      int p0 = 0, p1 = 0;\r\n      if (MAKE_SUM) {\r\n        FOR(i, N) { cumsum[d\
    ...
    \ ret;\r\n  }\r\n\r\n  // xor \u3057\u305F\u7D50\u679C\u3067\u3001[L, R) \u306E\
    \u4E2D\u3067 k>=0 \u756A\u76EE\u3068 prefix sum\r\n  pair<int, T> kth_value_and_sum(int\
    \ L, int R, int k, T xor_val = 0) {\r\n    if (xor_val != 0) assert(set_log);\r\
    \n    assert(0 <= k && k <= R - L);\r\n    if (k == R - L) {\r\n      return {infty<T>,\
    \ MX::op(MX::inverse(cumsum_0[L]), cumsum_0[R])};\r\n    }\r\n    T ret = 0;\r\
    \n    X sm = MX::unit();\r\n    for (int d = lg - 1; d >= 0; --d) {\r\n      bool\
    \ f = (xor_val >> d) & 1;\r\n      int l0 = bv[d].rank(L, 0), r0 = bv[d].rank(R,\
    \ 0);\r\n      int kf = (f ? (R - L) - (r0 - l0) : (r0 - l0));\r\n      X s =\
    \ (f ? get(d, L + mid[d] - l0, R + mid[d] - r0) : get(d, l0, r0));\r\n      if\
    \ (k < kf) {\r\n        if (!f) L = l0, R = r0;\r\n        if (f) L += mid[d]\
    \ - l0, R += mid[d] - r0;\r\n      } else {\r\n        k -= kf, ret |= T(1) <<\
    ...
    \ prefix sum) \u304C true \u3068\u306A\u308B\u3088\u3046\u306A\u6700\u5927\u500B\
    \u6570\r\n  template <typename F>\r\n  int max_right(F check, int L, int R, T\
  ...
  requiredBy: []
  timestamp: '2023-03-28 23:39:22+09:00'
