...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1332.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1332\"\
    ...
    \n    if (k == total_len) {\r\n      X sm = MX::unit();\r\n      for (auto&& [L,\
    \ R]: segments) sm = MX::op(sm, sum_all(L, R));\r\n      return {infty<T>, sm};\r\
    \n    }\r\n    int cnt = 0;\r\n    X sm = MX::unit();\r\n    T ret = 0;\r\n  \
    ...
    \ T(1) << d;\r\n        for (auto&& [L, R]: segments) {\r\n          int l0 =\
    \ bv[d].rank(L, 0), r0 = bv[d].rank(R, 0);\r\n          X s = (f ? get(d, L +\
    \ mid[d] - l0, R + mid[d] - r0) : get(d, l0, r0));\r\n          sm = MX::op(sm,\
    \ s);\r\n          if (!f) L += mid[d] - l0, R += mid[d] - r0;\r\n          if\
    \ (f) L = l0, R = r0;\r\n        }\r\n      }\r\n    }\r\n    for (auto&& [L,\
    \ R]: segments) {\r\n      int t = min(R - L, k - cnt);\r\n      k -= t;\r\n \
    ...
    \ xor_val = 0) {\r\n    assert(0 <= k && k < R - L);\r\n    return kth_value_and_sum(L,\
    \ R, k, xor_val).fi;\r\n  }\r\n\r\n  T kth(vc<pair<int, int>> segments, int L,\
    \ int R, int k, T xor_val = 0) {\r\n    int total_len = 0;\r\n    for (auto&&\
    \ [L, R]: segments) total_len += R - L;\r\n    assert(0 <= k && k < total_len);\r\
    ...
    \ != 0) assert(set_log);\r\n    if (check(R - L, get(lg, L, R))) return R - L;\r\
    \n    int cnt = 0;\r\n    X sm = MX::unit();\r\n    for (int d = lg - 1; d >=\
    \ 0; --d) {\r\n      bool f = (xor_val >> d) & 1;\r\n      int l0 = bv[d].rank(L,\
    ...
    \       0, R - L);\r\n    cnt += k;\r\n    sm = MX::op(sm, get(0, L, L + k));\r\
    \n    return {cnt, sm};\r\n  }\r\n\r\nprivate:\r\n  inline X get(int d, int L,\
    \ int R) {\r\n    return MX::op(MX::inverse(cumsum[d][L]), cumsum[d][R]);\r\n\
    \  }\r\n\r\n  // xor \u3057\u305F\u7D50\u679C\u3067 [0, x) \u306B\u53CE\u307E\u308B\
    \u3082\u306E\u3092\u6570\u3048\u308B\r\n  int prefix_count(int L, int R, T x,\
    \ T xor_val = 0) {\r\n    if (xor_val != 0) assert(set_log);\r\n    x = (COMPRESS\
    \ ? LB(key, x) : x);\r\n    if (x == 0) return 0;\r\n    if (x >= (1 << lg)) return\
    \ R - L;\r\n    int cnt = 0;\r\n    FOR_R(d, lg) {\r\n      bool add = (x >> d)\
    \ & 1;\r\n      bool f = ((xor_val) >> d) & 1;\r\n      int l0 = bv[d].rank(L,\
  ...
  requiredBy: []
  timestamp: '2023-03-29 01:53:56+09:00'
