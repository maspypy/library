...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1911.test.cpp\"\n// competitive-verifier:\
    ...
    \n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1911\n\
    ...
    \u30AF\u30EB\u3092\u63A2\u3059\n  FOR(S, N) {\n    FOR(Sc, 2) {\n      vv(ll,\
    \ dist, 2, N, infty<ll>);\n      pqg<tuple<ll, int, int>> que;\n      auto add\
    \ = [&](ll c, ll v, ll d) -> void {\n        if (chmin(dist[c][v], d)) que.emplace(d,\
    \ c, v);\n      };\n      add(Sc, S, loss[Sc][S]);\n      while (len(que)) {\n\
    \        auto [d, c, v] = POP(que);\n        if (d != dist[c][v]) continue;\n\
    \        for (auto&& e: G[v]) {\n          add(1 - c, e.to, dist[c][v] + loss[1\
    \ - c][e.to]);\n        }\n      }\n      chmax(ANS, sm - dist[1 - Sc][S] + loss[1\
    \ - Sc][S]);\n    }\n  }\n  print(ANS);\n}\n\nsigned main() {\n  cout << fixed\
    \ << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return\
    \ 0;\n}\n"
  dependsOn:
