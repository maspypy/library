...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2801.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2801\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/yukicoder/2801.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    */\ntemplate <class mint>\nstruct Online_Square {\n  vc<mint> f, h, b0, b1;\n\
    ...
    \ * fm[z][i];\n      s = w - 1;\n    }\n    ntt(b0, true);\n    FOR(i, s + 1)\
    \ h[p + i] += b0[s + i];\n    return h[p++];\n  }\n};\n#line 9 \"test/yukicoder/2801.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2801.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2801.test.cpp
- /verify/test/yukicoder/2801.test.cpp.html
