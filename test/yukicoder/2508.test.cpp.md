...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2508.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/2508.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ fastio::rd(s);\n  x = BigInteger(s);\n}\n#endif\n#line 6 \"test/yukicoder/2508.test.cpp\"\
    \n\nusing B = BigInteger;\nvoid solve() {\n  B a, p, q;\n  read(a, p, q);\n  B\
    \ b = a * (p + q);\n  B c = a * p * q;\n  Yes(b * b > B(4) * a * c);\n}\n\nsigned\
    \ main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2508\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2508.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2508.test.cpp
- /verify/test/yukicoder/2508.test.cpp.html
