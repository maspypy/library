...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1789.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/1789.test.cpp\"\n\n#line 2 \"graph/base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T cost;\n  int id;\n\
    ...
    \n    return P;\r\n  }\r\n};\r\n#line 8 \"test/yukicoder/1789.test.cpp\"\n\n#line\
    \ 1 \"flow/hungarian.hpp\"\n// returns: (ans, match, X, Y)\n// N<=M \u3092\u4EEE\
    \u5B9A, infty \u3082 valid \u3068\u3057\u3066\u8A08\u7B97\u3057\u3066\u3044\u308B\
    , O(N^2M) time\u3002\n// \u30DD\u30C6\u30F3\u30B7\u30E3\u30EB\u306F\u6B21\u306E\
    \u53CC\u5BFE\u554F\u984C\u306E\u89E3\u3067\u3042\u308B\uFF1A\n//   maximize \\\
    ...
    \  for (auto&& i: match) --i;\n  if (!MINIMIZE) res = -res;\n  return {res, match,\
    \ X, Y};\n}\n#line 10 \"test/yukicoder/1789.test.cpp\"\n\nvoid solve() {\n  INT(N1);\n\
    \  Graph<int, 0> G1(N1);\n  G1.read_tree();\n  INT(N2);\n  Graph<int, 0> G2(N2);\n\
    ...
    \        FOR(i, n1) {\n          int w1 = ch1[i];\n          FOR(j, n2) {\n  \
    \          for (auto& w2: vs[j]) {\n              chmax(mat[i][j], dp[w1][w2]\
    \ + dist[v2][w2]);\n            }\n          }\n        }\n        auto [ans,\
    \ match, X, Y] = hungarian<ll, false>(mat);\n        if (ans < 0) continue;\n\
    \        dp[v1][v2] = ans;\n      }\n    }\n    chmax(ANS, dp[0][r2]);\n  }\n\
    \  print(ANS);\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n\
    \  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1789\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1789.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1789.test.cpp
- /verify/test/yukicoder/1789.test.cpp.html
