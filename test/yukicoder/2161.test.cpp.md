...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2161.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2161\"\
    ...
    \n};\n#line 5 \"test/yukicoder/2161.test.cpp\"\n\nvoid solve() {\n  LL(N, K, L,\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2161\"\n#include \"my_template.hpp\"\
    ...
    \ dp1 = calc(0, N / 2);\n  auto dp2 = calc(N / 2, N);\n  const ll INF = 1LL <<\
    \ 60;\n  ll ANS = 0;\n  FOR(sz, N / 2 + 1) {\n    // \u5DE6\u5074\u306E\u5927\u304D\
    \u3055\u304C sz\n    if (sz > K) break;\n    Point_Add_Rectangle_Sum<Monoid_Add<int>,\
    \ ll, 0> X;\n    for (auto&& [a, b, c]: dp1) {\n      if (sz == a) X.add_query(b,\
    \ c, 1);\n    }\n    for (auto&& [a, b, c]: dp2) {\n      if (sz + a <= K) X.sum_query(-INF,\
    \ L - b + 1, P - c, INF);\n    }\n    ANS += SUM<ll>(X.calc());\n  }\n  print(ANS);\n\
    }\n\nsigned main() {\n  solve();\n  return 0;\n}"
  dependsOn:
  - my_template.hpp
  ...
  requiredBy: []
  timestamp: '2022-12-23 11:04:31+09:00'
