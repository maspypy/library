...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2338.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/2338.test.cpp\"\n\n#line 2 \"alg/monoid/add.hpp\"\
    \n\r\ntemplate <typename E>\r\nstruct Monoid_Add {\r\n  using X = E;\r\n  using\
    ...
    \ = bit.sum(x + 1);\n    }\n    return res;\n  }\n};\n#line 6 \"test/yukicoder/2338.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M, Q);\n  vc<int> P(N);\n  vc<int> S(N);\n  FOR(i,\
    \ N) {\n    read(P[i]);\n    --P[i];\n    STR(x);\n    S[i] = (x == \"AC\" ? 1\
    ...
    \ { print(ANS1[i], ANS2[i]); }\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n\
    \  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2338\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2338.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2338.test.cpp
- /verify/test/yukicoder/2338.test.cpp.html
