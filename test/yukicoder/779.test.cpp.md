...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/779.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/779\"\
    ...
    \ t = 1) { yes(!t); }\r\n#line 4 \"test/yukicoder/779.test.cpp\"\n\n#line 1 \"\
    ...
    \ (y % 4 == 0 && y % 100 != 0);\n  }\n};\n#line 6 \"test/yukicoder/779.test.cpp\"\
    \n\nusing DT = DateTime;\n\nvoid solve() {\n  LL(y, m, d);\n  DT X(y, m, d);\n\
    \  Yes(DT(1989, 1, 8) <= X && X <= DT(2019, 4, 30));\n}\n\nsigned main() {\n \
    \ cin.tie(nullptr);\n  ios::sync_with_stdio(false);\n  cout << setprecision(15);\n\
    \n  solve();\n\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/779\"\n#include \"my_template.hpp\"\
    \n#include \"other/io.hpp\"\n\n#include \"datetime/datetime.hpp\"\n\nusing DT\
    \ = DateTime;\n\nvoid solve() {\n  LL(y, m, d);\n  DT X(y, m, d);\n  Yes(DT(1989,\
    \ 1, 8) <= X && X <= DT(2019, 4, 30));\n}\n\nsigned main() {\n  cin.tie(nullptr);\n\
    \  ios::sync_with_stdio(false);\n  cout << setprecision(15);\n\n  solve();\n\n\
    \  return 0;\n}\n"
  dependsOn:
  - my_template.hpp
  ...
  verifiedWith: []
documentation_of: test/yukicoder/779.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/779.test.cpp
- /verify/test/yukicoder/779.test.cpp.html
