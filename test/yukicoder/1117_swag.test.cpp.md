...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1117_swag.test.cpp\"\n#define PROBLEM \"\
    ...
    \ }\r\n  static constexpr bool commute = true;\r\n};\r\n#line 6 \"test/yukicoder/1117_swag.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, K, M);\n  VEC(ll, A, N);\n  auto Ac = cumsum(A);\n\
    \  const ll INF = 1LL << 60;\n  vi DP(N + 1, -INF);\n  DP[0] = 0;\n  FOR(K) {\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1117_swag.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1117_swag.test.cpp
- /verify/test/yukicoder/1117_swag.test.cpp.html
