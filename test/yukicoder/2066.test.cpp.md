...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2066.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2066\"\
    ...
    \ in [L,R)} floor(ax + b, mod)\ni128 floor_sum_of_linear(ll L, ll R, ll a, ll\
    \ b, ll mod) {\n  assert(L <= R);\n  i128 res = 0;\n  b += L * a;\n  ll N = R\
    \ - L;\n\n  if (b < 0) {\n    ll k = ceil(-b, mod);\n    b += k * mod;\n    res\
    \ -= i128(N) * k;\n  }\n\n  while (N) {\n    ll q;\n    tie(q, a) = divmod(a,\
    \ mod);\n    res += i128(N) * (N - 1) / 2 * q;\n    if (b >= mod) {\n      tie(q,\
    \ b) = divmod(b, mod);\n      res += i128(N) * q;\n    }\n    tie(N, b) = divmod(a\
    \ * N + b, mod);\n    tie(a, mod) = mp(mod, a);\n  }\n  return res;\n}\n#line\
    \ 5 \"test/yukicoder/2066.test.cpp\"\n\nvoid solve() {\n  LL(P, Q, K);\n  auto\
    \ check = [&](ll N) -> bool {\n    // Px+Qy<=N \u304B\u3064 0 <= x < Q \u304C\
    \ K \u500B\u4EE5\u4E0A\n    ll LIM = min(Q, N / P + 1);\n    // 0 <= x < LIM \u3067\
    \u3001floor(N-Px,Q)+1 \u3092\u548C\n    return floor_sum_of_linear(0, LIM, -P,\
    \ N + Q, Q) - 1 >= K;\n  };\n\n  ll g = gcd(P, Q);\n  P /= g, Q /= g;\n\n  ll\
    \ ANS = binary_search(check, (P + Q) * (K + 1), 0);\n  ANS *= g;\n  print(ANS);\n\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2066\"\n#include \"my_template.hpp\"\
    ...
    \ floor_sum_of_linear(0, LIM, -P, N + Q, Q) - 1 >= K;\n  };\n\n  ll g = gcd(P,\
    \ Q);\n  P /= g, Q /= g;\n\n  ll ANS = binary_search(check, (P + Q) * (K + 1),\
    \ 0);\n  ANS *= g;\n  print(ANS);\n}\n\nsigned main() {\n  cout << fixed << setprecision(15);\n\
    \n  LL(T);\n  FOR(T) solve();\n\n  return 0;\n}\n"
  dependsOn:
  - my_template.hpp
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2066.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2066.test.cpp
- /verify/test/yukicoder/2066.test.cpp.html
