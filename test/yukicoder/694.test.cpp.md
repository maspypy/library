...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/694.test.cpp\"\n// competitive-verifier:\
    ...
    \ dp[L + 1][R] - dp[L + 1][R - 1];\n    if (A[L] > A[R - 1]) ++dp[L][R];\n  }\n\
    \  return dp;\n}\n#line 6 \"test/yukicoder/694.test.cpp\"\n\nvoid solve() {\n\
    \  LL(N);\n  VEC(int, A, N);\n  auto ANS = inversion_rotate(A);\n  for (auto&&\
    \ x: ANS) print(x);\n}\n\nsigned main() {\n  solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/694\n#include\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/694.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/694.test.cpp
- /verify/test/yukicoder/694.test.cpp.html
