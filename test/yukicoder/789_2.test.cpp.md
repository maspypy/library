...
data:
  ...
  bundledCode: "Traceback (most recent call last):\n  File \"/opt/hostedtoolcache/Python/3.11.0/x64/lib/python3.11/site-packages/onlinejudge_verify/documentation/build.py\"\
    ...
    )\nonlinejudge_verify.languages.cplusplus_bundle.BundleErrorAt: ds/dynamic_lazysegtree.hpp:\
    \ line -1: no such header\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/789\"\n#include \"my_template.hpp\"\
    \n#include \"other/io.hpp\"\n#include \"ds/dynamic_lazysegtree.hpp\"\n#include\
    \ \"alg/acted_monoid/cntsum_add.hpp\"\n\nvoid solve() {\n  auto f = [&](ll L,\
    \ ll R) -> pi { return {R - L, 0}; };\n  Dynamic_LazySegTree<ActedMonoid_CntSum_Add<ll>,\
