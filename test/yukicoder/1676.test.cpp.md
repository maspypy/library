...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1676.test.cpp\"\n// competitive-verifier:\
    ...
    \    return result;\n  }\n};\n#line 5 \"test/yukicoder/1676.test.cpp\"\n\nvoid\
    \ solve() {\n  LL(N, K);\n  vi A(N);\n  vvc<int> B(N);\n  FOR(i, N) {\n    LL(a,\
    \ m);\n    A[i] = a;\n    FOR(m) {\n      LL(b);\n      B[i].eb(--b);\n    }\n\
    \  }\n\n  int source = 0;\n  int sink = N + 1;\n  auto idx = [&](int v) -> int\
  ...
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1676\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1676.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1676.test.cpp
- /verify/test/yukicoder/1676.test.cpp.html
