...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1625.test.cpp\"\n// competitive-verifier:\
    ...
    \        prod_rec(2 * idx + 1, x1, x2, y1, y2));\r\n  }\r\n};\r\n#line 6 \"test/yukicoder/1625.test.cpp\"\
    ...
    \  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1625\n\
    ...
    \  FOR(i, N, N + Q) {\n    auto&& [a, b, c] = query[i];\n    if (a != -1) X.eb(a),\
    \ Y.eb(b), V.eb(Mono::unit());\n  }\n  KDTree_Monoid<Mono, int> seg(X, Y, V);\n\
    \n  FOR(q, N, N + Q) {\n    auto&& [a, b, c] = query[q];\n    if (a != -1) {\n\
    \      seg.multiply(a, b, c);\n    } else {\n      ll ANS = seg.prod(b, c, b,\
    \ c);\n      if (ANS == Mono::unit()) ANS = -1;\n      print(ANS);\n    }\n  }\n\
    }\n\nsigned main() {\n  cin.tie(nullptr);\n  ios::sync_with_stdio(false);\n  cout\
    \ << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return\
    \ 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1625.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1625.test.cpp
- /verify/test/yukicoder/1625.test.cpp.html
