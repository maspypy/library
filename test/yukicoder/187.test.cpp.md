...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/187.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/187\"\
    ...
    \  }\n  i128 ret = 0;\n  ll prod = 1;\n  FOR(i, n) {\n    ret += prod * cfs[i];\n\
    \    prod *= mods[i];\n    if (new_mod != -1) {\n      ret %= new_mod;\n     \
    \ prod %= new_mod;\n    }\n  }\n  return ret;\n}\n#line 6 \"test/yukicoder/187.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  vc<int> vals, mods;\n  FOR(i, N) {\n    LL(a,\
    \ b);\n    vals.eb(a);\n    mods.eb(b);\n  }\n\n  if (MAX(vals) == 0) { return\
    \ print(LCM(mods, 1000000007)); }\n  print(CRT(vals, mods, 1000000007, 0));\n\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/187\"\n#include \"my_template.hpp\"\
    ...
    \nvoid solve() {\n  LL(N);\n  vc<int> vals, mods;\n  FOR(i, N) {\n    LL(a, b);\n\
    \    vals.eb(a);\n    mods.eb(b);\n  }\n\n  if (MAX(vals) == 0) { return print(LCM(mods,\
    \ 1000000007)); }\n  print(CRT(vals, mods, 1000000007, 0));\n}\n\nsigned main()\
