...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1421.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1421\"\
    ...
    \ { yes(!t); }\r\n#line 1 \"linalg/solve_linear_xor.hpp\"\n/*\na \u306F 01 \u884C\
    \u5217\u3001b \u306F long long\nXOR = b \u3092\u89E3\u304F\u3002\n\u89E3\u306A\
    \u3057\uFF1Aempty\u3001\u89E3\u3042\u308A\uFF1A\u305D\u306E\u3072\u3068\u3064\n\
    \u30FB\u89E3\u7A7A\u9593\u306E\u8A73\u3057\u3044\u69CB\u9020\u304C\u6B32\u3057\
    \u3044\u5834\u5408\u306B\u306F\u3001\u6841\u3054\u3068\u306B F2 \u7DDA\u5F62\u4EE3\
    \u6570\u3059\u308B\u3053\u3068\uFF01\n*/\ntemplate <typename INTEGER>\nvc<INTEGER>\
    \ solve_linear_xor(vc<vc<INTEGER>> a, vc<INTEGER> b) {\n  auto n = len(a), m =\
    \ len(a[0]);\n  int rk = 0;\n  FOR(j, m) {\n    if (a[rk][j] == 0) {\n      FOR3(i,\
    \ rk + 1, n) if (a[i][j] != 0) {\n        swap(a[rk], a[i]);\n        swap(b[rk],\
    ...
    \  int p = 0;\n  FOR(i, rk) {\n    while (a[i][p] == 0) ++p;\n    x[p] = b[i];\n\
    \  }\n  return x;\n}\n#line 5 \"test/yukicoder/1421.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N, M);\n  vv(int, mat, M, N);\n  vc<int> rhs(M);\n\n  FOR(i, M) {\n\
    \    LL(n);\n    VEC(int, B, n);\n    for (auto&& x: B) --x;\n    for (auto&&\
    \ b: B) mat[i][b] = 1;\n\n    LL(Y);\n    rhs[i] = Y;\n  }\n\n  auto ANS = solve_linear_xor<int>(mat,\
