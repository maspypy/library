...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1548.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1548\"\
    ...
    \ Monoid_X = Monoid_Add_Array<mint, K>;\r\n  using Monoid_A = Monoid_Assign<int,\
    \ -1>;\r\n  using X = typename Monoid_X::value_type;\r\n  using A = typename Monoid_A::value_type;\r\
    \n  static X act(const X &x, const A &b) {\r\n    if (b == -1) return x;\r\n \
    \   X y;\r\n    mint pow = 1;\r\n    FOR(i, K) { y[i] = x[0] * pow, pow *= mint(b);\
    \ }\r\n    return y;\r\n  }\r\n};\r\n#line 7 \"test/yukicoder/1548.test.cpp\"\n\
    \nusing mint = modint998;\n\nvoid solve() {\n  LL(N);\n  using Mono = Monoid_Add_Array<mint,\
    \ 5>;\n  using ARR = typename Mono::value_type;\n  VEC(mint, A, N);\n  vc<ARR>\
    \ seg_raw(N);\n  FOR(i, N) {\n    mint a = A[i];\n    seg_raw[i] = {1, a, a *\
    \ a, a * a * a, a * a * a * a};\n  }\n  LazySegTree<ActedMonoid_Power_Sums_Assign<mint,\
    \ 5>> seg(seg_raw);\n  LL(Q);\n  FOR(Q) {\n    LL(t, u, v, w);\n    if (u > v)\
    \ swap(u, v);\n    if (w < u || v < w) swap(u, v);\n    --u, --v;\n    if (t ==\
    \ 0) {\n      LL(b);\n      if (u < v) {\n        seg.apply(u, v + 1, b);\n  \
    \    } else {\n        seg.apply(0, v + 1, b);\n        seg.apply(u, N, b);\n\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1548\"\n#include \"my_template.hpp\"\
    ...
    \  FOR(i, N) {\n    mint a = A[i];\n    seg_raw[i] = {1, a, a * a, a * a * a,\
    \ a * a * a * a};\n  }\n  LazySegTree<ActedMonoid_Power_Sums_Assign<mint, 5>>\
    \ seg(seg_raw);\n  LL(Q);\n  FOR(Q) {\n    LL(t, u, v, w);\n    if (u > v) swap(u,\
    \ v);\n    if (w < u || v < w) swap(u, v);\n    --u, --v;\n    if (t == 0) {\n\
    \      LL(b);\n      if (u < v) {\n        seg.apply(u, v + 1, b);\n      } else\
    \ {\n        seg.apply(0, v + 1, b);\n        seg.apply(u, N, b);\n      }\n \
    ...
    \     }\n      // print(e);\n      mint n = e[0];\n      mint mu = -e[1] / n;\n\
    \      ll k = t;\n      // sum (x+mu)^k\n      mint ans = 0;\n      FOR(i, k +\
    \ 1) { ans += e[i] * mu.pow(k - i) * C<mint>(k, i); }\n      ans /= n;\n     \
    \ print(ans);\n    }\n  }\n}\n\nsigned main() {\n  cin.tie(nullptr);\n  ios::sync_with_stdio(false);\n\
    \  cout << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n\
    \  return 0;\n}\n"
  dependsOn:
