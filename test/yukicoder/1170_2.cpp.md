...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1170_2.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1170\"\
    ...
    \        if (to == -1) break;\n        uf.merge(v, to);\n        que.eb(to);\n\
    \        done[to] = 1;\n        set_used(to);\n      }\n    }\n  }\n  return uf;\n\
    }\n#line 5 \"test/yukicoder/1170_2.cpp\"\n\nvoid solve() {\n  LL(N, A, B);\n \
    \ VEC(ll, X, N);\n  set<pi> ss;\n  FOR(i, N) ss.insert({X[i], i});\n\n  auto set_used\
    \ = [&](int v) -> void { ss.erase({X[v], v}); };\n  auto find_unused = [&](int\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1170_2.cpp
layout: document
redirect_from:
- /library/test/yukicoder/1170_2.cpp
- /library/test/yukicoder/1170_2.cpp.html
