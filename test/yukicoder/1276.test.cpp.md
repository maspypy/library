...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1276.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1276\"\
    ...
    \u306B\u3001(t, i, k, f(t), f(u)) \u3092\u6301\u305F\u305B\u308B\r\n\r\n  auto\
    \ dfs = [&](auto self, ll t, ll i, ll k, T ft, T fu) -> void {\r\n    T f_nxt\
    \ = fu * f_pe(P[i], k + 1);\r\n    // \u5B50\u30CE\u30FC\u30C9\u3092\u5168\u90E8\
    \u52A0\u7B97\r\n    ANS += f_nxt;\r\n    ANS += ft * (f_psum(double(N) / t) -\
    ...
    */\r\ntemplate <typename T>\r\nstruct PrimeSum {\r\n  ll N;\r\n  ll sqN;\r\n \
    ...
    \ + 1, R + 1) sum_hi[i] -= fp * (sum_lo[N / (double(i) * p)] - x);\r\n      FOR_R(n,\
    \ pp, sqN + 1) sum_lo[n] -= fp * (sum_lo[double(n) / p] - x);\r\n    }\r\n   \
    \ calculated = 1;\r\n  }\r\n\r\n  void calc_count() {\r\n    calc([](ll x) ->\
    \ T { return x; });\r\n  }\r\n\r\n  void calc_sum() {\r\n    calc([](ll x) ->\
    \ T {\r\n      ll a = x, b = x + 1;\r\n      if (!(x & 1)) a /= 2;\r\n      if\
    \ (x & 1) b /= 2;\r\n      return T(a) * T(b);\r\n    });\r\n  }\r\n};\r\n#line\
