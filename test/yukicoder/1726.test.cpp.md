...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/1726
    links:
    - https://yukicoder.me/problems/no/1726
  bundledCode: "#line 1 \"test/yukicoder/1726.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1726\"\
    ...
    \ vals[i]);\r\n  }\r\n};\r\n#line 5 \"test/yukicoder/1726.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N, M);\n  ll ANS = 0;\n  VEC(ll, P, N);\n  VEC(pi, AB, N);\n  VEC(pi,\
    \ CD, M);\n\n  HashMap<ll, 20> MP;\n\n  FOR(2) {\n    for (auto&& [a, b]: AB)\
    \ a = -a;\n    FOR(2) {\n      for (auto&& [a, b]: AB) b = -b;\n      MP.reset();\n\
    \      FOR(i, N) FOR(j, M) {\n        auto [a, b] = AB[i];\n        auto [c, d]\
    ...
    \  }\n  }\n  print(ANS);\n}\n\nsigned main() {\n  solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1726\"\n#include \"my_template.hpp\"\
  ...
  requiredBy: []
  timestamp: '2023-01-31 23:24:38+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/yukicoder/1726.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1726.test.cpp
- /verify/test/yukicoder/1726.test.cpp.html
