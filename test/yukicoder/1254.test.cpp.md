...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1254.test.cpp\"\n// competitive-verifier:\
    ...
    \ D[rb];\n  }\n};\n#line 5 \"test/yukicoder/1254.test.cpp\"\n\nvoid solve() {\n\
    \  LL(N);\n  Graph<int, 0> G(N);\n  G.read_graph(N);\n  UnicyclicGraph X(G);\n\
    \  vc<int> ANS;\n  FOR(i, N) {\n    auto& e = G.edges[i];\n    if (X.in_cycle[e.frm]\
    \ && X.in_cycle[e.to]) ANS.eb(i + 1);\n  }\n  print(len(ANS));\n  print(ANS);\n\
    }\n\nsigned main() {\n  cout << fixed << setprecision(15);\n\n  ll T = 1;\n  //\
    \ LL(T);\n  FOR(T) solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1254\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1254.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1254.test.cpp
- /verify/test/yukicoder/1254.test.cpp.html
