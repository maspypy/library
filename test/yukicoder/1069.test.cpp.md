...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1069.test.cpp\"\n// competitive-verifier:\
    \ PROBLEM https://yukicoder.me/problems/no/1069\n// competitive-verifier: ERROR\
    ...
    \ es.begin() + k};\n      vc<int> new_ng = ng_es;\n      new_ng.eb(es[k]);\n \
    \     nodes.eb(new_es, new_ng);\n    }\n  }\n  return res;\n}\n#line 7 \"test/yukicoder/1069.test.cpp\"\
    \n\nvoid solve() {\n  using Re = double;\n  LL(N, M, K);\n  LL(s, t);\n  --s,\
    \ --t;\n  VEC(pi, P, N);\n  Graph<double, 1> G(N);\n  FOR(M) {\n    LL(i, j);\n\
    \    --i, --j;\n    auto [xi, yi] = P[i];\n    auto [xj, yj] = P[j];\n    Re dx\
    ...
    \ LL(T);\n  FOR(T) solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1069\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1069.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1069.test.cpp
- /verify/test/yukicoder/1069.test.cpp.html
