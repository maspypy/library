...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2258.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2258\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/2258.test.cpp\"\n\n#line 2 \"graph/tree.hpp\"\
    ...
    \  }\n};\n#line 6 \"test/yukicoder/2258.test.cpp\"\n\nvoid solve() {\n  LL(N);\n\
    \  Graph<int, 0> G(N);\n  G.read_tree(0, 0);\n  VEC(int, A, N);\n\n  Tree<decltype(G)>\
    \ tree(G);\n  Static_TopTree<decltype(tree)> STT(tree);\n\n  auto merge = [&](vc<int>&\
    \ A, vc<int>& B) -> pair<vc<int>, vc<int>> {\n    vc<int> C;\n    vc<int> left;\n\
    ...
    \ r = STT.rch[k], a = STT.A[k], b = STT.B[k];\n      if (l == -1 && r == -1) {\
    ...
    \ need);\n      }\n      if (STT.heavy[k]) {\n        // heavy path \u3092\u30DE\
    \u30FC\u30B8\u3057\u305F\u3082\u306E\n        int v1 = dfs(dfs, l, L1, R1, d1,\
    \ need_path);\n        if (v1 != -1) return v1;\n        return dfs(dfs, r, L2,\
    \ R2, d2, need_path - get(l, K, L1, R1, d1));\n      }\n      // light \u3092\u30DE\
    \u30FC\u30B8\u3057\u305F\u3082\u306E\n      int v = dfs(dfs, l, L1, R1, d1, need);\n\
    \      if (v != -1) return v;\n      return dfs(dfs, r, L2, R2, d2, need);\n \
    \   };\n    return dfs(dfs, 0, L, R, delta, need);\n  };\n\n  ll X_SUM = 0;\n\
    \  INT(Q);\n  FOR(Q) {\n    LL(aa, bb, kk, delta);\n    ll a = (aa + X_SUM) %\
    \ N;\n    ll b = (bb + 2 * X_SUM) % N;\n    int mod = 150001;\n    ll K = (kk\
    \ + (X_SUM % mod) * (X_SUM % mod)) % mod;\n    ll L = min(a, b);\n    ll R = 1\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2258\"\n#include \"my_template.hpp\"\
    ...
    \    };\n    dfs(dfs, 0);\n  }\n\n  FOR(i, n) {\n    Ac[i] = {0};\n    for (auto&\
    \ v: V[i]) Ac[i].eb(Ac[i].back() + A[v]);\n    LEFT[i] = cumsum<int>(LEFT[i]);\n\
    \  }\n\n  auto get = [&](int k, ll K, ll L, ll R, ll delta) -> ll {\n    ll cnt\
    \ = R - L;\n    ll sm = Ac[k][R] - Ac[k][L];\n    ll val = K * cnt + sm;\n   \
    \ val = 10 * val + (delta != -1);\n    return val;\n  };\n\n  auto solve = [&](ll\
    \ L, ll R, ll delta, ll K) -> int {\n    ll total = get(0, K, L, R, true);\n \
    \   ll need = ceil<ll>(total, 2);\n    auto dfs = [&](auto& dfs, int k, ll L,\
    \ ll R, ll d, ll need_path) -> int {\n      if (get(k, K, L, R, d) < need_path)\
    ...
    \ dfs(dfs, l, L1, R1, d1, need);\n      }\n      if (STT.heavy[k]) {\n       \
    \ // heavy path \u3092\u30DE\u30FC\u30B8\u3057\u305F\u3082\u306E\n        int\
    \ v1 = dfs(dfs, l, L1, R1, d1, need_path);\n        if (v1 != -1) return v1;\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2258.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2258.test.cpp
- /verify/test/yukicoder/2258.test.cpp.html
