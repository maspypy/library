...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1038.test.cpp\"\n// competitive-verifier:\
    ...
    \ main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1038\n\n\
    ...
    \  FOR(Q) {\n    INT(v, d, x);\n    --v;\n    ll ans = A[v];\n    for (auto& i:\
    \ X.get_indices(v)) { ans += bit.sum(1 + i); }\n    print(ans);\n\n    for (auto&\
    \ [a, b]: X.get_contour_range(v, 0, 1 + d)) {\n      bit.add(a, x), bit.add(b,\
    \ -x);\n    }\n    A[v] += x;\n  }\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n\
    \  FOR(T) solve();\n  return 0;\n}\n"
  dependsOn:
  - my_template.hpp
