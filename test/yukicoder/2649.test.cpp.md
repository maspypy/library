...
data:
  ...
  attributes:
    ...
    links:
    - https://yukicoder.me/problems/no/2649
  bundledCode: "#line 1 \"test/yukicoder/2649.test.cpp\"\n// competitive-verifier:\
    \ PROBLEM https://yukicoder.me/problems/no/2649\n#line 1 \"my_template.hpp\"\n\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/2649.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ fastio::rd(s);\n  x = BigInteger(s);\n}\n#endif\n#line 6 \"test/yukicoder/2649.test.cpp\"\
    \n\nusing B = BigInteger;\n\nvoid solve() {\n  B x;\n  read(x);\n  x = x * x +\
    \ x;\n  x = x.divmod(2).fi;\n  INT(mod);\n  ll ANS = x.divmod(mod).se;\n  print(ANS);\n\
    }\n\nsigned main() {\n  INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2649\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2649.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2649.test.cpp
- /verify/test/yukicoder/2649.test.cpp.html
