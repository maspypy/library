...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1573.test.cpp\"\n// competitive-verifier:\
    ...
    \ prev = N + 1;\r\n  for (u32 q = 1; q <= n; ++q) {\r\n    u64 x = double(N) /\
    \ (q + 1) + 1;\r\n    f(q, x, prev), prev = x;\r\n  }\r\n  for (u32 l = sq; l\
    \ >= 1; --l) { f(u64(double(N) / l), l, l + 1); }\r\n}\r\n#line 5 \"test/yukicoder/1573.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M);\n  i128 ANS = 0;\n  auto f = [&](ll q, ll l, ll\
    \ r) -> void {\n    ll lo = max(l, 1LL);\n    ll hi = min(r - 1, M);\n    if (lo\
    \ > hi) return;\n    i128 x = (q * (q + 1) / 2 + q);\n    i128 y = (lo + hi) *\
    \ (hi - lo + 1) / 2;\n    ANS += x * y;\n  };\n  floor_range(N, f);\n  print(ANS\
    ...
    \n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1573\n\
