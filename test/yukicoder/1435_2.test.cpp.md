...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1435_2.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1435\"\
    ...
    #line 5 \"test/yukicoder/1435_2.test.cpp\"\n\nstruct Mono {\n  using value_type\
    \ = tuple<int, int, int>; // max, min1, min2\n  using X = value_type;\n  static\
    \ X op(X& x, X& y) {\n    auto& [xma, xmi1, xmi2] = x;\n    auto& [yma, ymi1,\
    \ ymi2] = y;\n    if (xma == -1) return y;\n    if (yma == -1) return x;\n   \
    \ if (xmi1 < ymi1) { return {max(xma, yma), xmi1, min(xmi2, ymi1)}; }\n    return\
    \ {max(xma, yma), ymi1, min(ymi2, xmi1)};\n  }\n  static X from_element(int x)\
  ...
  requiredBy: []
  timestamp: '2022-09-20 05:02:25+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/yukicoder/1435_2.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1435_2.test.cpp
- /verify/test/yukicoder/1435_2.test.cpp.html
