...
data:
  ...
  attributes:
    ...
    links:
    - https://yukicoder.me/problems/no/2120
  bundledCode: "#line 1 \"test/yukicoder/2120.test.cpp\"\n// competitive-verifier:\
    \ PROBLEM https://yukicoder.me/problems/no/2120\n#line 1 \"my_template.hpp\"\n\
    ...
    \    return ANS;\r\n  }\r\n};\n#line 5 \"test/yukicoder/2120.test.cpp\"\n\nvoid\
    \ solve() {\n  LL(M, N);\n  auto out = [&](ll x) -> void {\n    string s = to_string(x);\n\
    \    while (len(s) < 8) s = \"0\" + s;\n    print(s);\n  };\n\n  int mod = 100000000;\n\
    \  Binomial B(mod);\n  ll ans = B.C(M, N);\n  out(ans);\n}\n\nsigned main() {\n\
    \  cout << fixed << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\
    \n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2120\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2120.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2120.test.cpp
- /verify/test/yukicoder/2120.test.cpp.html
