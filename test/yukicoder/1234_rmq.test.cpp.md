...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1234_rmq.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1234\"\
    ...
    \ getall:\", get_all()); }\n};\n#line 6 \"test/yukicoder/1234_rmq.test.cpp\"\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1234_rmq.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1234_rmq.test.cpp
- /verify/test/yukicoder/1234_rmq.test.cpp.html
