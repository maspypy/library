...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1397.test.cpp\"\n// competitive-verifier:\
    ...
    \ = connected_dp_squares::polygon_dp_graph(H);\n  const int S = len(states);\n\
    ...
    \ << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return\
    \ 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1397\n\
