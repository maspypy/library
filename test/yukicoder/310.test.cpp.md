...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/310.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/310.test.cpp\"\n\n#line 2 \"seq/find_linear_rec.hpp\"\
    ...
    \    auto [s, t] = ADD;\n    if (s != -1) {\n      w[t] -= v[s];\n      w[t] +=\
    \ v[t];\n    }\n    v.resize(N - 1);\n    w.resize(N - 1);\n    return w;\n  };\n\
    \  mint det = blackbox_det<mint>(N - 1, f);\n  for (auto&& x: indeg) cf *= fact<mint>(x\
    \ - 1);\n  print(cf * det);\n}\n\nsigned main() {\n  cout << fixed << setprecision(15);\n\
    \n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/310\n#include\
