...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1844.test.cpp\"\n// competitive-verifier:\
    ...
    }\r\n#line 6 \"test/yukicoder/1844.test.cpp\"\n\nusing mint = modint107;\n\nvoid\
    \ solve() {\n  LL(N);\n  mint ANS = 1;\n  FOR(N) {\n    LL(p, e);\n    vc<mint>\
    ...
    \  // LL(T);\n  FOR(_, T) solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1844\n\
