...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1666.test.cpp\"\n// competitive-verifier:\
    ...
    \ 6 \"test/yukicoder/1666.test.cpp\"\n\nvoid solve() {\n  LL(K);\n  auto check\
    \ = [&](ll LIM) -> bool {\n    // LIM \u4EE5\u4E0B\u306E\u7D2F\u4E57\u6570\u304C\
    \ K \u500B\u4EE5\u4E0A\n    auto f = [&](ll n) -> ll {\n      ll x = integer_kth_root(n,\
    \ LIM);\n      return x - 1;\n    };\n    vi A(100);\n    FOR3(i, 1, 100) A[i]\
    \ = f(i);\n    multiplier_mobius(A);\n    ll cnt = 0;\n    FOR3(i, 2, 100) cnt\
    \ += A[i];\n    if (1 <= LIM) ++cnt;\n    return cnt >= K;\n  };\n\n  ll ANS =\
    \ binary_search(check, 1e18, 0);\n  print(ANS);\n}\n\nsigned main() {\n  cin.tie(nullptr);\n\
    \  ios::sync_with_stdio(false);\n  cout << setprecision(15);\n\n  LL(T);\n  FOR(_,\
    \ T) solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/1666\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1666.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1666.test.cpp
- /verify/test/yukicoder/1666.test.cpp.html
