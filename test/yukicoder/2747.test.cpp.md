...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2747.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2747\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/yukicoder/2747.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    #line 10 \"test/yukicoder/2747.test.cpp\"\n\nusing mint = modint998;\n\nvoid solve()\
    \ {\n  LL(N, K);\n\n  vc<mint> F(K + 10);\n  FOR(d, 1, K + 10) {\n    F[d] +=\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2747.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2747.test.cpp
- /verify/test/yukicoder/2747.test.cpp.html
