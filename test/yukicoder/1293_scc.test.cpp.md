...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1293_scc.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1293\"\
    ...
    \  }\n  DAG.build();\n  return DAG;\n}\n#line 5 \"test/yukicoder/1293_scc.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, D, W);\n  Graph<int, 1> G(N + N);\n  FOR(D) {\n  \
    \  LL(a, b);\n    --a, --b;\n    G.add(2 * a, 2 * b);\n    G.add(2 * b, 2 * a);\n\
    \  }\n  FOR(W) {\n    LL(a, b);\n    --a, --b;\n    G.add(2 * a + 1, 2 * b + 1);\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1293_scc.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1293_scc.test.cpp
- /verify/test/yukicoder/1293_scc.test.cpp.html
