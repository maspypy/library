...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2243.test.cpp\"\n// competitive-verifier:\
    ...
    \n\r\n  reverse(all(f));\r\n  mint ia = a.inverse();\r\n  mint pow = 1;\r\n  FOR(i,\
    \ n) f[i] *= pow, pow *= ia;\r\n  return f;\r\n}\r\n#line 8 \"test/yukicoder/2243.test.cpp\"\
    ...
    \ (auto&& a: A) { F[n] *= C<mint>(n, a) * fact<mint>(a); }\n  }\n  */\n  F = pascal<mint>(F,\
    \ 0, 1);\n  print(SUM<mint>(F));\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n\
    \  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/2243\n\
