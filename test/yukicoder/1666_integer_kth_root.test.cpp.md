...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1666_integer_kth_root.test.cpp\"\n#define\
    ...
    \ 6 \"test/yukicoder/1666_integer_kth_root.test.cpp\"\n\nvoid solve() {\n  LL(K);\n\
    \  auto check = [&](ll LIM) -> bool {\n    // LIM \u4EE5\u4E0B\u306E\u7D2F\u4E57\
    \u6570\u304C K \u500B\u4EE5\u4E0A\n    auto f = [&](ll n) -> ll {\n      ll x\
    \ = integer_kth_root(n, LIM);\n      return x - 1;\n    };\n    vi A(100);\n \
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1666_integer_kth_root.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1666_integer_kth_root.test.cpp
- /verify/test/yukicoder/1666_integer_kth_root.test.cpp.html
