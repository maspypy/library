...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/1292
    links:
    - https://yukicoder.me/problems/no/1292
  bundledCode: "#line 1 \"test/yukicoder/1292.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1292\"\
    ...
    \ : N(1 << LOG), sz(0), keys(new ll[N]), shift(64 - __lg(N)) {}\n  int hash(ll\
    ...
    #line 5 \"test/yukicoder/1292.test.cpp\"\n\nvoid solve() {\n  HashSetLL<18> MP;\n\
    \  STR(S);\n  ll A = 0;\n  ll B = 1;\n  ll C = 1LL << 20;\n\n  MP.insert(A + B\
    \ + C);\n  for (auto&& x: S) {\n    if (x == 'a') { A = -A + B + C; }\n    if\
    \ (x == 'b') { B = -B + C + A; }\n    if (x == 'c') { C = -C + A + B; }\n    MP.insert(A\
    \ + B + C);\n  }\n  print(len(MP));\n}\n\nsigned main() {\n  cout << fixed <<\
    \ setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return\
    \ 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1292\"\n#include \"my_template.hpp\"\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1292.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1292.test.cpp
- /verify/test/yukicoder/1292.test.cpp.html
