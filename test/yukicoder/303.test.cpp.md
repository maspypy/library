...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/303.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/yukicoder/303.test.cpp\"\n\n#line 1 \"seq/famous/fibonacci.hpp\"\
    ...
    \ fastio::rd(s);\n  x = BigInteger(s);\n}\n#endif\n#line 7 \"test/yukicoder/303.test.cpp\"\
    \n\nusing B = BigInteger;\n\nvoid solve() {\n  LL(N);\n  if (N == 2) {\n    print(3);\n\
    \    print(\"INF\");\n    return;\n  }\n  B x = fibonacci<B>(N);\n  if (N % 2\
    \ == 0) {\n    B y = fibonacci<B>(N / 2);\n    x -= y * y;\n  }\n  print(N);\n\
    \  print(x);\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n\
    \  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://yukicoder.me/problems/no/303\n#include\
