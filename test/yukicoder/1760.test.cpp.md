...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1760.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1760\"\
    ...
    \  divisor_zeta(A);\n  divisor_zeta(B);\n  FOR(i, len(A)) A[i] *= B[i];\n  divisor_mobius(A);\n\
    \  return A;\n}\n#line 8 \"test/yukicoder/1760.test.cpp\"\n\nusing mint = modint998;\n\
  ...
  requiredBy: []
  timestamp: '2022-08-17 06:14:04+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/yukicoder/1760.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1760.test.cpp
- /verify/test/yukicoder/1760.test.cpp.html
