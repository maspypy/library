...
data:
  ...
  bundledCode: "#line 1 \"test/_atcoder/abc229h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc229/tasks/abc229_h\"\
    ...
    \ yes(!t); }\n#line 5 \"test/_atcoder/abc229h.test.cpp\"\n\n#line 1 \"game/dyadic_rational.hpp\"\
    ...
    \  for (auto&& s: states) dfs(dfs, s);\n  return MP;\n}\n#line 7 \"test/_atcoder/abc229h.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  VEC(string, G, N);\n  vc<string> states(N);\n\
  ...
  verifiedWith: []
documentation_of: test/_atcoder/abc229h.test.cpp
layout: document
redirect_from:
- /verify/test/_atcoder/abc229h.test.cpp
- /verify/test/_atcoder/abc229h.test.cpp.html
