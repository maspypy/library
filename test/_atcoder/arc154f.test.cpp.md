...
data:
  ...
  bundledCode: "#line 1 \"test/_atcoder/arc154f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/arc154/tasks/arc154_f\"\
    ...
    \ AB);\n}\n#line 8 \"test/_atcoder/arc154f.test.cpp\"\n\nusing mint = modint998;\n\
    using poly = vc<mint>;\n\nvoid solve() {\n  LL(N, M);\n  vc<poly> DEN;\n  mint\
  ...
  verifiedWith: []
documentation_of: test/_atcoder/arc154f.test.cpp
layout: document
redirect_from:
- /verify/test/_atcoder/arc154f.test.cpp
- /verify/test/_atcoder/arc154f.test.cpp.html
