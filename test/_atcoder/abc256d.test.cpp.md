...
data:
  ...
  bundledCode: "#line 1 \"test/_atcoder/abc256d.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc256/tasks/abc256_d\"\
    ...
    \   int l = 0;\n    while (l < RLIM) {\n      auto t = dat[l];\n      auto r =\
    \ ss.next(l + 1);\n      print(\"l, r, t\", l, r, t);\n      l = r;\n    }\n \
    \ }\n};\n#line 5 \"test/_atcoder/abc256d.test.cpp\"\n\nvoid solve() {\n  Intervals<ll,\
    \ int> I(0);\n  LL(N);\n  FOR(N) {\n    LL(l, r);\n    I.set(l, r, 1);\n  }\n\
  ...
  verifiedWith: []
documentation_of: test/_atcoder/abc256d.test.cpp
layout: document
redirect_from:
- /verify/test/_atcoder/abc256d.test.cpp
- /verify/test/_atcoder/abc256d.test.cpp.html
