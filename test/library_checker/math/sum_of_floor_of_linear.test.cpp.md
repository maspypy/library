...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/math/sum_of_floor_of_linear.test.cpp\"\
    ...
    Yes\" : \"No\"); }\r\nvoid No(bool t = 1) { Yes(!t); }\r\nvoid yes(bool t = 1)\
    \ { print(t ? \"yes\" : \"no\"); }\r\nvoid no(bool t = 1) { yes(!t); }\r\n#line\
    \ 4 \"test/library_checker/math/sum_of_floor_of_linear.test.cpp\"\n\n#line 2 \"\
    ...
    \ solve() {\n  U32(N, mod, a, b);\n  print(floor_sum_of_linear<u64, u64>(0, N,\
    \ a, b, mod));\n}\n\nsigned main() {\n  LL(T);\n  FOR(T) solve();\n\n  return\
    \ 0;\n}\n"
...
layout: document
redirect_from:
- /verify/test/library_checker/math/sum_of_floor_of_linear.test.cpp
- /verify/test/library_checker/math/sum_of_floor_of_linear.test.cpp.html
