...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/math/powproj_sps.test.cpp\"\n#define\
    ...
    \ M) x[i] *= fact<mint>(i);\n  return x;\n}\n#line 8 \"test/library_checker/math/powproj_sps.test.cpp\"\
    \n\nusing mint = modint998;\n\nvoid solve() {\n  LL(N, M);\n  VEC(mint, A, 1 <<\
    \ N);\n  VEC(mint, B, 1 << N);\n  vc<mint> ANS = transposed_sps_composition_poly<mint,\
    \ 20>(A, B, M);\n  print(ANS);\n}\n\nsigned main() {\n  solve();\n  return 0;\n\
    }\n"
  code: "#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/power_projection_of_set_power_series\"\
...
layout: document
redirect_from:
- /verify/test/library_checker/math/powproj_sps.test.cpp
- /verify/test/library_checker/math/powproj_sps.test.cpp.html
