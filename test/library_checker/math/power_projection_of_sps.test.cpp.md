...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/math/power_projection_of_sps.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/power_projection_of_set_power_series\"\
    ...
    \ yes(!t); }\r\n#line 6 \"test/library_checker/math/power_projection_of_sps.test.cpp\"\
    ...
    \ 8 \"test/library_checker/math/power_projection_of_sps.test.cpp\"\n\nusing mint\
    \ = modint998;\n\nvoid solve() {\n  LL(N, M);\n  VEC(mint, A, 1 << N);\n  VEC(mint,\
  ...
  verifiedWith: []
documentation_of: test/library_checker/math/power_projection_of_sps.test.cpp
layout: document
redirect_from:
- /verify/test/library_checker/math/power_projection_of_sps.test.cpp
- /verify/test/library_checker/math/power_projection_of_sps.test.cpp.html
