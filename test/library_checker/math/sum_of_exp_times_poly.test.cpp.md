...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/math/sum_of_exp_times_poly.test.cpp\"\
    ...
    \n    while (pp <= N) {\r\n      ll i = pp;\r\n      while (i <= N) {\r\n    \
    \    f[i] *= xp;\r\n        i += pp;\r\n      }\r\n      pp *= p;\r\n    }\r\n\
    \  }\r\n  return f;\r\n}\r\n#line 6 \"test/library_checker/math/sum_of_exp_times_poly.test.cpp\"\
    \n\nusing mint = modint998;\nvoid solve() {\n  mint r;\n  read(r);\n  LL(d, n);\n\
    \  int L = d + 5;\n  vc<mint> a = powertable_2<mint>(d, L - 1);\n  mint p = 1;\n\
    \  FOR(i, L) {\n    a[i] *= p;\n    p *= r;\n  }\n  a = cumsum<mint>(a, 0);\n\
    \  if (n == 0) return print(0);\n  print(interpolate_poly_exp_sum(a, r, n - 1));\n\
    }\n\nsigned main() {\n  solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/sum_of_exponential_times_polynomial\n\
