...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/tree/mst.test.cpp\"\n#define PROBLEM\
    ...
    \ yes(!t); }\r\n#line 4 \"test/library_checker/tree/mst.test.cpp\"\n\n#line 2\
    ...
    \ in_mst, MST, ANS};\r\n}\n#line 6 \"test/library_checker/tree/mst.test.cpp\"\n\
    \nvoid solve() {\n  LL(N, M);\n  Graph<int, 0> G(N);\n  G.read_graph(M, 1, 0);\n\
...
layout: document
redirect_from:
- /verify/test/library_checker/tree/mst.test.cpp
- /verify/test/library_checker/tree/mst.test.cpp.html
