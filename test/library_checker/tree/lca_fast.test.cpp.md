...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/tree/lca_fast.test.cpp\"\n#define PROBLEM\
    ...
    Yes\" : \"No\"); }\r\nvoid No(bool t = 1) { Yes(!t); }\r\nvoid yes(bool t = 1)\
    \ { print(t ? \"yes\" : \"no\"); }\r\nvoid no(bool t = 1) { yes(!t); }\r\n#line\
    \ 4 \"test/library_checker/tree/lca_fast.test.cpp\"\n\n#line 2 \"graph/base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T cost;\n  int id;\n\
...
layout: document
redirect_from:
- /verify/test/library_checker/tree/lca_fast.test.cpp
- /verify/test/library_checker/tree/lca_fast.test.cpp.html
