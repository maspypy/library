...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/geometry/closest_pair_dc.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/library_checker/geometry/closest_pair_dc.test.cpp\"\
    \n\n#line 2 \"geo/base.hpp\"\ntemplate <typename T>\nstruct Point {\n  T x, y;\n\
    ...
    \ == 0 || dy * dy > best) break;\n        upd(idx, j);\n      }\n      near.eb(idx);\n\
    \    }\n    return I;\n  };\n  dfs(dfs, 0, N);\n  return best_pair;\n}\n#line\
    \ 6 \"test/library_checker/geometry/closest_pair_dc.test.cpp\"\n\nusing P = Point<ll>;\n\
  ...
  verifiedWith: []
documentation_of: test/library_checker/geometry/closest_pair_dc.test.cpp
layout: document
redirect_from:
- /verify/test/library_checker/geometry/closest_pair_dc.test.cpp
- /verify/test/library_checker/geometry/closest_pair_dc.test.cpp.html
