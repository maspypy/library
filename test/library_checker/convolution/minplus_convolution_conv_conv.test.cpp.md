...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/convolution/minplus_convolution_conv_conv.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/library_checker/convolution/minplus_convolution_conv_conv.test.cpp\"\
    ...
    \ B);\n  return {};\n}\n#line 6 \"test/library_checker/convolution/minplus_convolution_conv_conv.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M);\n  VEC(ll, A, N);\n  VEC(ll, B, M);\n  print(minplus_convolution<ll,\
    \ 1, 1>(A, B));\n}\n\nsigned main() {\n  solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/min_plus_convolution_convex_convex\n\
...
layout: document
redirect_from:
- /verify/test/library_checker/convolution/minplus_convolution_conv_conv.test.cpp
- /verify/test/library_checker/convolution/minplus_convolution_conv_conv.test.cpp.html
