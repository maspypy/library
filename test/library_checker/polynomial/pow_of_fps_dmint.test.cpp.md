...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/polynomial/pow_of_fps_dmint.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/library_checker/polynomial/pow_of_fps_dmint.test.cpp\"\
    ...
    \n}\r\n#line 7 \"test/library_checker/polynomial/pow_of_fps_dmint.test.cpp\"\n\
    \nusing mint = modint998;\n\nvoid solve() {\n  using mint = dmint;\n  mint::set_mod(998244353);\n\
    \  LL(N, M);\n  VEC(mint, A, N);\n  print(fps_pow(A, M));\n}\n\nsigned main()\
    \ {\n  solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/pow_of_formal_power_series\n\
...
layout: document
redirect_from:
- /verify/test/library_checker/polynomial/pow_of_fps_dmint.test.cpp
- /verify/test/library_checker/polynomial/pow_of_fps_dmint.test.cpp.html
