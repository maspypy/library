...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/polynomial/exp_of_fps_dmint.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/library_checker/polynomial/exp_of_fps_dmint.test.cpp\"\
    ...
    #line 7 \"test/library_checker/polynomial/exp_of_fps_dmint.test.cpp\"\n\nusing\
    \ mint = dmint;\n\nvoid solve() {\n  mint::set_mod(998244353);\n  LL(N);\n  VEC(mint,\
    \ A, N);\n  print(fps_exp(A));\n}\n\nsigned main() {\n  solve();\n  return 0;\n\
    }\n"
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/exp_of_formal_power_series\n\
  ...
  verifiedWith: []
documentation_of: test/library_checker/polynomial/exp_of_fps_dmint.test.cpp
layout: document
redirect_from:
- /verify/test/library_checker/polynomial/exp_of_fps_dmint.test.cpp
- /verify/test/library_checker/polynomial/exp_of_fps_dmint.test.cpp.html
