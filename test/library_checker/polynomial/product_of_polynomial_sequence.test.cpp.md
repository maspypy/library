...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/polynomial/product_of_polynomial_sequence.test.cpp\"\
    ...
    \   }\r\n    }\r\n    polys.resize(m);\r\n  }\r\n  return polys[0];\r\n}\r\n#line\
    \ 6 \"test/library_checker/polynomial/product_of_polynomial_sequence.test.cpp\"\
    \n\nusing mint = modint998;\n\nvoid solve() {\n  LL(N);\n  vvc<mint> polys;\n\
    \  FOR(N) {\n    LL(d);\n    VEC(mint, f, d + 1);\n    polys.eb(f);\n  }\n  auto\
    \ f = convolution_all(polys);\n  print(f);\n}\n\nsigned main() {\n  cin.tie(nullptr);\n\
    \  ios::sync_with_stdio(false);\n  cout << setprecision(15);\n\n  solve();\n\n\
    \  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/product_of_polynomial_sequence\n\
