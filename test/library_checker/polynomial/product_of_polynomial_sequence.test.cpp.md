...
data:
  ...
  attributes:
    ...
    links: []
  bundledCode: "#line 2 \"test/library_checker/polynomial/product_of_polynomial_sequence.test.cpp\"\
    ...
    \ b);\r\n}\r\n#line 4 \"test/library_checker/polynomial/product_of_polynomial_sequence.test.cpp\"\
  ...
  code: "#pragma once\n\n#include \"poly/convolution.hpp\"\n\ntemplate <typename T>\n\
    ...
    \  while (1) {\n    int n = len(polys);\n    if (n == 1) break;\n    int m = ceil(n,\
    \ 2);\n    FOR(i, m) {\n      if (2 * i + 1 == n) {\n        polys[i] = polys[2\
    \ * i];\n      } else {\n        polys[i] = convolution(polys[2 * i], polys[2\
    \ * i + 1]);\n      }\n    }\n    polys.resize(m);\n  }\n  return polys[0];\n\
    }\n"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2022-11-06 13:30:36+09:00'
