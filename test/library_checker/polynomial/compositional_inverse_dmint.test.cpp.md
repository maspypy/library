...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/polynomial/compositional_inverse_dmint.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/library_checker/polynomial/compositional_inverse_dmint.test.cpp\"\
    ...
    \    G1 = {G1.begin() + n, G1.end()};\n    G1 = fps_div(G1, G2);\n    FOR(i, n)\
    \ G[n + i] -= G1[i];\n  }\n  G.resize(N);\n  return G;\n}\n#line 8 \"test/library_checker/polynomial/compositional_inverse_dmint.test.cpp\"\
    \n\nusing mint = dmint;\n\nvoid solve() {\n  mint::set_mod(998244353);\n  LL(N);\n\
    \  VEC(mint, f, N);\n  f = compositional_inverse(f);\n  print(f);\n}\n\nsigned\
    \ main() { solve(); }\n"
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/compositional_inverse_of_formal_power_series_large\n\
