...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/polynomial/compositional_inverse_dmint.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/library_checker/polynomial/compositional_inverse_dmint.test.cpp\"\
    ...
    \    G1 = {G1.begin() + n, G1.end()};\n    G1 = fps_div(G1, G2);\n    FOR(i, n)\
    \ G[n + i] -= G1[i];\n  }\n  G.resize(N);\n  return G;\n}\n#line 9 \"test/library_checker/polynomial/compositional_inverse_dmint.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2024-05-03 02:53:10+09:00'
