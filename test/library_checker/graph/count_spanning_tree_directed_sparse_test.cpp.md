...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/graph/count_spanning_tree_directed_sparse_test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/counting_spanning_tree_directed\"\
    ...
    Yes\" : \"No\"); }\r\nvoid No(bool t = 1) { Yes(!t); }\r\nvoid yes(bool t = 1)\
    \ { print(t ? \"yes\" : \"no\"); }\r\nvoid no(bool t = 1) { yes(!t); }\r\n#line\
    \ 5 \"test/library_checker/graph/count_spanning_tree_directed_sparse_test.cpp\"\
    ...
    #line 8 \"test/library_checker/graph/count_spanning_tree_directed_sparse_test.cpp\"\
  ...
  code: "#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/counting_spanning_tree_directed\"\
    ...
    \ LL(N, M, r);\n  Graph<int, 1> G(N);\n  G.read_graph(M, 0, 0);\n  mint ANS =\
    \ count_spanning_tree_directed<mint, false>(G, r);\n  print(ANS);\n}\n\nsigned\
    \ main() {\n  solve();\n  return 0;\n}\n"
  dependsOn:
  - my_template.hpp
  - other/io.hpp
  ...
  verifiedWith: []
documentation_of: test/library_checker/graph/count_spanning_tree_directed_sparse_test.cpp
layout: document
redirect_from:
- /library/test/library_checker/graph/count_spanning_tree_directed_sparse_test.cpp
- /library/test/library_checker/graph/count_spanning_tree_directed_sparse_test.cpp.html
