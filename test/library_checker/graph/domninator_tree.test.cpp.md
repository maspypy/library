...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/graph/domninator_tree.test.cpp\"\n\
    ...
    \ yes(!t); }\r\n#line 4 \"test/library_checker/graph/domninator_tree.test.cpp\"\
    ...
    \  }\n  return idom;\n}\n#line 6 \"test/library_checker/graph/domninator_tree.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M, root);\n  Graph<int, 1> G(N);\n  G.read_graph(M,\
    \ 0, 0);\n  auto idom = dominator_tree(G, root);\n  idom[root] = root;\n  print(idom);\n\
    }\n\nsigned main() {\n  solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/dominatortree\n\
...
layout: document
redirect_from:
- /verify/test/library_checker/graph/domninator_tree.test.cpp
- /verify/test/library_checker/graph/domninator_tree.test.cpp.html
