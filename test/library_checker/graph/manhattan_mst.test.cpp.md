...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/graph/manhattan_mst.test.cpp\"\n//\
    ...
    \ yes(!t); }\r\n#line 4 \"test/library_checker/graph/manhattan_mst.test.cpp\"\n\
    ...
    \ T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/manhattanmst\n\
