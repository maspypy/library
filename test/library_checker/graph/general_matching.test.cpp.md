...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/graph/general_matching.test.cpp\"\n\
    ...
    \ yes(!t); }\r\n#line 4 \"test/library_checker/graph/general_matching.test.cpp\"\
    ...
    \ 7 \"test/library_checker/graph/general_matching.test.cpp\"\n\nvoid solve() {\n\
    \  LL(N, M);\n  Graph<int, 0> G(N);\n  G.read_graph(M, 0, 0);\n\n  auto [ans,\
...
layout: document
redirect_from:
- /verify/test/library_checker/graph/general_matching.test.cpp
- /verify/test/library_checker/graph/general_matching.test.cpp.html
