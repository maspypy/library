...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/graph/st_numbering.test.cpp\"\n#define\
    ...
    Yes\" : \"No\"); }\r\nvoid No(bool t = 1) { Yes(!t); }\r\nvoid yes(bool t = 1)\
    \ { print(t ? \"yes\" : \"no\"); }\r\nvoid no(bool t = 1) { yes(!t); }\r\n#line\
    \ 5 \"test/library_checker/graph/st_numbering.test.cpp\"\n\n#line 1 \"graph/st_numbering.hpp\"\
    ...
    \ N, BCT.N) {\n    if (!vis[i]) return 0;\n  }\n  return 1;\n}\n#line 7 \"test/library_checker/graph/st_numbering.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M, s, t);\n  Graph<int, 0> G(N);\n  G.read_graph(M,\
  ...
  requiredBy: []
  timestamp: '2024-06-11 16:44:36+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/library_checker/graph/st_numbering.test.cpp
layout: document
redirect_from:
- /verify/test/library_checker/graph/st_numbering.test.cpp
- /verify/test/library_checker/graph/st_numbering.test.cpp.html
