...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/graph/eulerwalk_ud.test.cpp\"\n// competitive-verifier:\
    ...
    \u3042\u308B\u6210\u5206\u3092\u6570\u3048\u308B\r\n    int nc = 0;\r\n    for\
    \ (int v = 0; v < N; ++v) {\r\n      if (uf[v] == v && cnt_edge[v] >= 1) ++nc;\r\
    \n    }\r\n    return nc <= 1;\r\n  }\r\n}\n#line 6 \"test/library_checker/graph/eulerwalk_ud.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M);\n  Graph<int, 0> G(N);\n  G.read_graph(M, 0, 0);\n\
    \  auto [vs, es] = euler_walk(G);\n  if (vs.empty()) return No();\n  Yes();\n\
    \  print(vs);\n  print(es);\n}\n\nsigned main() {\n  INT(T);\n  FOR(T) solve();\n\
    \  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/eulerian_trail_undirected\n\
...
layout: document
redirect_from:
- /verify/test/library_checker/graph/eulerwalk_ud.test.cpp
- /verify/test/library_checker/graph/eulerwalk_ud.test.cpp.html
