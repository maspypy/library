...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/graph/count_spanning_tree_undirected_sparse.test.cpp\"\
    \n#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/counting_spanning_tree_undirected\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/library_checker/graph/count_spanning_tree_undirected_sparse.test.cpp\"\
    ...
    using modint998 = modint<998244353>;\n#line 8 \"test/library_checker/graph/count_spanning_tree_undirected_sparse.test.cpp\"\
  ...
  code: "#define PROBLEM \\\n  \"https://judge.yosupo.jp/problem/counting_spanning_tree_undirected\"\
    ...
    \ LL(N, M);\n  Graph<int, 0> G(N);\n  G.read_graph(M, 0, 0);\n  mint ANS = count_spanning_tree_undirected<mint,\
    \ true>(G);\n  print(ANS);\n}\n\nsigned main() {\n  solve();\n  return 0;\n}\n"
  dependsOn:
  - my_template.hpp
  - other/io.hpp
  ...
  verifiedWith: []
documentation_of: test/library_checker/graph/count_spanning_tree_undirected_sparse.test.cpp
layout: document
redirect_from:
- /verify/test/library_checker/graph/count_spanning_tree_undirected_sparse.test.cpp
- /verify/test/library_checker/graph/count_spanning_tree_undirected_sparse.test.cpp.html
