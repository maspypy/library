...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/datastructure/vertex_get_range_contour_add_on_tree.test.cpp\"\
    ...
    Yes\" : \"No\"); }\r\nvoid No(bool t = 1) { Yes(!t); }\r\nvoid yes(bool t = 1)\
    \ { print(t ? \"yes\" : \"no\"); }\r\nvoid no(bool t = 1) { yes(!t); }\r\n#line\
    \ 6 \"test/library_checker/datastructure/vertex_get_range_contour_add_on_tree.test.cpp\"\
    ...
    \ v) {\n    vc<int> res;\n    FOR(k, info_indptr[v], info_indptr[v + 1]) {\n \
    \     int idx = info_idx[k];\n      int p = comp[idx];\n      res.eb(comp_range[p]\
    \ + dep[idx]);\n    }\n    return res;\n  }\n};\n#line 9 \"test/library_checker/datastructure/vertex_get_range_contour_add_on_tree.test.cpp\"\
