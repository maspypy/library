...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/datastructure/segment_add_get_min.test.cpp\"\
    ...
    Yes\" : \"No\"); }\r\nvoid No(bool t = 1) { Yes(!t); }\r\nvoid yes(bool t = 1)\
    \ { print(t ? \"yes\" : \"no\"); }\r\nvoid no(bool t = 1) { yes(!t); }\r\n#line\
    \ 5 \"test/library_checker/datastructure/segment_add_get_min.test.cpp\"\n\n#line\
    ...
    \ res1) : max(res, res1));\n    }\n    return res;\n  }\n};\n#line 7 \"test/library_checker/datastructure/segment_add_get_min.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2024-06-17 07:37:54+09:00'
