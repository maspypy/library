...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/datastructure/static_range_frequency.test.cpp\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/library_checker/datastructure/static_range_frequency.test.cpp\"\
    ...
    \ nl;\n  }\n\n  void reset() {\n    static_assert(USE_RESET);\n    S.reset();\n\
    \  }\n};\n#line 7 \"test/library_checker/datastructure/static_range_frequency.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, Q);\n  VEC(int, A, N);\n  Static_Range_Frequency<20>\
    \ X(A);\n  FOR(Q) {\n    INT(l, r, x);\n    print(X.query(l, r, x));\n  }\n}\n\
    \nsigned main() {\n  solve();\n  return 0;\n}\n"
  ...
  requiredBy: []
  timestamp: '2024-01-01 05:07:48+09:00'
