...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/string/lyndon.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 5 \"test/library_checker/string/lyndon.test.cpp\"\n\n#line\
    ...
    \ I;\n  }\n};\n#line 7 \"test/library_checker/string/lyndon.test.cpp\"\n\nvoid\
    \ solve() {\n  STR(S);\n  Incremental_Lyndon_Factorization<char> LYN;\n  for (auto&\
    \ ch: S) LYN.add(ch);\n  print(LYN.factorize());\n}\n\nsigned main() {\n  solve();\n\
    \  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/lyndon_factorization\n\
  ...
  verifiedWith: []
documentation_of: test/library_checker/string/lyndon.test.cpp
layout: document
redirect_from:
- /verify/test/library_checker/string/lyndon.test.cpp
- /verify/test/library_checker/string/lyndon.test.cpp.html
