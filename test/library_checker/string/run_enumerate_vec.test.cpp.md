...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/string/run_enumerate_vec.test.cpp\"\
  ...
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/runenumerate\n\
...
layout: document
redirect_from:
- /verify/test/library_checker/string/run_enumerate_vec.test.cpp
- /verify/test/library_checker/string/run_enumerate_vec.test.cpp.html
