...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/string/zalgorithm_by_rollinghash2.test.cpp\"\
    ...
    Yes\" : \"No\"); }\r\nvoid No(bool t = 1) { Yes(!t); }\r\nvoid yes(bool t = 1)\
    \ { print(t ? \"yes\" : \"no\"); }\r\nvoid no(bool t = 1) { yes(!t); }\r\n#line\
    \ 4 \"test/library_checker/string/zalgorithm_by_rollinghash2.test.cpp\"\n\n#line\
    \ 2 \"alg/monoid/rollinghash.hpp\"\n\r\n#line 2 \"random/base.hpp\"\n\nu64 RNG_64()\
    ...
    \  if (i + n > N) return false;\n      return seg.prod(0, n) == seg.prod(i, i\
