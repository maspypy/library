...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/matrix/det_mod.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test/library_checker/matrix/det_mod.test.cpp\"\n\n#line\
    ...
    #line 6 \"test/library_checker/matrix/det_mod.test.cpp\"\n\nvoid solve() {\n \
    \ LL(N, mod);\n  VV(int, A, N, N);\n  int ANS = det_mod(A, mod);\n  print(ANS);\n\
    }\n\nsigned main() {\n  solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/matrix_det_arbitrary_mod\n\
  ...
  verifiedWith: []
documentation_of: test/library_checker/matrix/det_mod.test.cpp
layout: document
redirect_from:
- /verify/test/library_checker/matrix/det_mod.test.cpp
- /verify/test/library_checker/matrix/det_mod.test.cpp.html
