...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/2995.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2995\"\
    ...
    \  vc<int> get_all() {\n    vc<int> A(n);\n    FOR(i, n) A[i] = (*this)[i];\n\
    \    return A;\n  }\n};\n#line 6 \"test/4_aoj/2995.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N, K);\n  Graph G(N);\n  G.read_tree();\n  Tree T(G);\n  VEC(pi, CD,\
    \ N);\n  for (auto&& [c, d]: CD) --c, --d;\n  /*\n  \u9802\u70B9\u306B\u306A\u3063\
    \u3066\u3044\u308B\uFF1A+x\n  \u9023\u7D50\u6210\u5206\u3054\u3068\u306B\u3001\
    \u30ED\u30B9\u306E min \u3092\u6301\u305F\u305B\u308B\n  */\n  vc<int> tree(K,\
    \ 1);\n  vc<int> history;\n  ll ans = 0;\n  vc<int> ANS(N);\n  UnionFind uf(K);\n\
    \n  auto eval\n      = [&](int v) -> int { return (tree[v] ? uf.size(v) - 1 :\
    \ uf.size(v)); };\n\n  auto ADD = [&](int v) -> void {\n    auto [c, d] = CD[v];\n\
  ...
  verifiedWith: []
documentation_of: test/4_aoj/2995.test.cpp
layout: document
redirect_from:
- /verify/test/4_aoj/2995.test.cpp
- /verify/test/4_aoj/2995.test.cpp.html
