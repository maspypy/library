...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/NTL_2_A.test.cpp\"\n#define PROBLEM \\\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_2_A\"\n#line 1 \"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 5 \"test/4_aoj/NTL_2_A.test.cpp\"\n\n\
    ...
    }\n#endif\n#line 7 \"test/4_aoj/NTL_2_A.test.cpp\"\n\nusing B = BigInteger;\n\n\
    void solve() {\n  B x, y;\n  read(x);\n  read(y);\n  x += y;\n  print(x);\n}\n\
    \nsigned main() {\n  solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \\\n  \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_2_A\"\
...
layout: document
redirect_from:
- /verify/test/4_aoj/NTL_2_A.test.cpp
- /verify/test/4_aoj/NTL_2_A.test.cpp.html
