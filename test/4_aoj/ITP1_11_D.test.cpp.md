...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/ITP1_11_D.test.cpp\"\n#define PROBLEM \\\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_11_D\"\n#line 1\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 5 \"test/4_aoj/ITP1_11_D.test.cpp\"\n\
    ...
    \ d(A);\n        d.rotate(ch);\n        int idx = -1;\n        FOR(j, N) if (dat[j]\
    \ == d.A) idx = j;\n        assert(idx != -1);\n        if (i < idx) G.add(i,\
    \ idx);\n      }\n    }\n    G.build();\n    return G;\n  }\n};\n#line 7 \"test/4_aoj/ITP1_11_D.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/4_aoj/ITP1_11_D.test.cpp
layout: document
redirect_from:
- /verify/test/4_aoj/ITP1_11_D.test.cpp
- /verify/test/4_aoj/ITP1_11_D.test.cpp.html
