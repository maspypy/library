...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/DSL_2_H.test.cpp\"\n#define PROBLEM \\\r\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_H\"\r\n\r\n#line\
    ...
    \  }\n};\n#line 8 \"test/4_aoj/DSL_2_H.test.cpp\"\n\r\nvoid solve() {\r\n  using\
    \ AM = ActedMonoid_Min_Add<ll>;\r\n  LL(N, Q);\r\n  vi A(N);\r\n  Lazy_SegTree<AM>\
    \ seg(A);\r\n  FOR(Q) {\r\n    LL(t, L, R);\r\n    ++R;\r\n    if (t == 0) {\r\
    \n      LL(x);\r\n      seg.apply(L, R, x);\r\n    } else {\r\n      print(seg.prod(L,\
    \ R));\r\n    }\r\n  }\r\n}\r\n\r\nsigned main() {\r\n  cin.tie(nullptr);\r\n\
  ...
  verifiedWith: []
documentation_of: test/4_aoj/DSL_2_H.test.cpp
layout: document
redirect_from:
- /verify/test/4_aoj/DSL_2_H.test.cpp
- /verify/test/4_aoj/DSL_2_H.test.cpp.html
