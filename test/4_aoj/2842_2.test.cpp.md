...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/2842_2.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2842\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 1 \"ds/segtree/segtree_2d_dense.hpp\"\
    ...
    \    dat.assign(4 * H * W, MX::id());\n    FOR(x, H) FOR(y, W) { dat[idx(H + x,\
    \ W + y)] = v[x][y]; }\n    FOR(y, W, W + W) FOR_R(x, H) {\n      dat[idx(x, y)]\
    \ = MX::op(dat[idx(2 * x + 0, y)], dat[idx(2 * x + 1, y)]);\n    }\n    FOR(x,\
    ...
    \ = MX::id();\n    yl += W, yr += W;\n    while (yl < yr) {\n      if (yl & 1)\
    \ res = MX::op(res, dat[idx(x, yl++)]);\n      if (yr & 1) res = MX::op(res, dat[idx(x,\
    \ --yr)]);\n      yl >>= 1, yr >>= 1;\n    }\n    return res;\n  }\n};\n#line\
