...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/ALDS1_1_C.test.cpp\"\n#define PROBLEM \\\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_1_C\"\n#line 1\
    ...
    \n  }\r\n  return true;\r\n}\n#line 6 \"test/4_aoj/ALDS1_1_C.test.cpp\"\n\nvoid\
    \ solve() {\n  ll ANS = 0;\n  LL(N);\n  FOR(N) {\n    LL(p);\n    ANS += primetest(p);\n\
  ...
  verifiedWith: []
documentation_of: test/4_aoj/ALDS1_1_C.test.cpp
layout: document
redirect_from:
- /verify/test/4_aoj/ALDS1_1_C.test.cpp
- /verify/test/4_aoj/ALDS1_1_C.test.cpp.html
