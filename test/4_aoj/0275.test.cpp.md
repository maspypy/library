...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/0275.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0275\"\
    ...
    \ {dist, par, root};\n}\n#line 6 \"test/4_aoj/0275.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N, M);\n  Graph<int, 0> G(N);\n  G.read_graph(M, 1);\n  LL(a, b);\n\
    \  --a, --b;\n\n  auto [dist_a, par_a] = dijkstra<int>(G, a);\n  auto [dist_b,\
    \ par_b] = dijkstra<int>(G, b);\n\n  Graph<int, 1> DG(N);\n  ll d = dist_a[b];\n\
  ...
  verifiedWith: []
documentation_of: test/4_aoj/0275.test.cpp
layout: document
redirect_from:
- /verify/test/4_aoj/0275.test.cpp
- /verify/test/4_aoj/0275.test.cpp.html
