...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/CGL_7_C.test.cpp\"\n#define PROBLEM \\\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_C\"\n#define ERROR\
    ...
    \ 0) return 0;\n  return (det > 0 ? 1 : -1);\n}\n#line 8 \"test/4_aoj/CGL_7_C.test.cpp\"\
    \n\nvoid solve() {\n  using Re = double;\n  LL(a, b, c, d, e, f);\n  Point<ll>\
...
layout: document
redirect_from:
- /verify/test/4_aoj/CGL_7_C.test.cpp
- /verify/test/4_aoj/CGL_7_C.test.cpp.html
