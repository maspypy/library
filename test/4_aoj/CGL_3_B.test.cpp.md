...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/CGL_3_B.test.cpp\"\n#define PROBLEM \\\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_B\"\n#line 1 \"\
    ...
    \    if (a < 0) {\n      a = -a;\n      reverse(all(points));\n    }\n  }\n};\n\
    #line 6 \"test/4_aoj/CGL_3_B.test.cpp\"\n\nvoid solve() {\n  LL(N);\n  VEC(pi,\
  ...
  verifiedWith: []
documentation_of: test/4_aoj/CGL_3_B.test.cpp
layout: document
redirect_from:
- /verify/test/4_aoj/CGL_3_B.test.cpp
- /verify/test/4_aoj/CGL_3_B.test.cpp.html
