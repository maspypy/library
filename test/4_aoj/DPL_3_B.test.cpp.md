...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/DPL_3_B.test.cpp\"\n#define PROBLEM \\\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_3_B\"\n#line 1 \"\
    ...
    \n      res += x * (i - l + 1) * (r - i);\r\n    }\r\n    return res;\r\n  }\r\
    \n};\r\n#line 6 \"test/4_aoj/DPL_3_B.test.cpp\"\n\nvoid solve() {\n  LL(H, W);\n\
    \  vi A(W);\n  ll ANS = 0;\n  FOR(i, H) {\n    FOR(j, W) {\n      LL(x);\n   \
...
layout: document
redirect_from:
- /verify/test/4_aoj/DPL_3_B.test.cpp
- /verify/test/4_aoj/DPL_3_B.test.cpp.html
