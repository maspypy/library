...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/GRL_2_A.test.cpp\"\n#define PROBLEM \\\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_2_A\"\n#line 1 \"\
    ...
    \ in_mst, MST, ANS};\r\n}\n#line 6 \"test/4_aoj/GRL_2_A.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N, M);\n  Graph<int, 0> G(N);\n  G.read_graph(M, 1, 0);\n  auto [cost,\
  ...
  verifiedWith: []
documentation_of: test/4_aoj/GRL_2_A.test.cpp
layout: document
redirect_from:
- /verify/test/4_aoj/GRL_2_A.test.cpp
- /verify/test/4_aoj/GRL_2_A.test.cpp.html
