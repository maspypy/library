...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/ITP1_11_B.test.cpp\"\n#define PROBLEM \\\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_11_B\"\n#line 1\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 5 \"test/4_aoj/ITP1_11_B.test.cpp\"\n\
    ...
    \ G;\n  }\n};\n#line 7 \"test/4_aoj/ITP1_11_B.test.cpp\"\n\nvoid solve() {\n \
    \ array<int, 6> A;\n  FOR(i, 6) read(A[i]);\n  Dice<int> X(A);\n  auto dat = X.gen_all();\n\
    \  LL(Q);\n  FOR(Q) {\n    LL(a, b);\n    for (auto&& B: dat) {\n      if (B[0]\
    \ == a && B[1] == b) print(B[2]);\n    }\n  }\n}\n\nsigned main() {\n  cout <<\
  ...
  verifiedWith: []
documentation_of: test/4_aoj/ITP1_11_B.test.cpp
layout: document
redirect_from:
- /verify/test/4_aoj/ITP1_11_B.test.cpp
- /verify/test/4_aoj/ITP1_11_B.test.cpp.html
