...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/GRL_3_B.test.cpp\"\n#define PROBLEM \\\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_3_B\"\n\n#line 1\
    ...
    \n  return {n_comp, comp};\r\n}\n#line 7 \"test/4_aoj/GRL_3_B.test.cpp\"\n\nvoid\
    \ solve() {\n  LL(N, M);\n  Graph<int, 0> G(N);\n  G.read_graph(M, 0, 0);\n  auto\
  ...
  verifiedWith: []
documentation_of: test/4_aoj/GRL_3_B.test.cpp
layout: document
redirect_from:
- /verify/test/4_aoj/GRL_3_B.test.cpp
- /verify/test/4_aoj/GRL_3_B.test.cpp.html
