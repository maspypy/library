...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/CGL_1_B.test.cpp\"\n#define PROBLEM \\\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_B\"\n#define ERROR\
    ...
    \ (L.a * L.a + L.b * L.b);\n  REAL x = P.x - 2 * t * L.a;\n  REAL y = P.y - 2\
    \ * t * L.b;\n  return Point<REAL>(x, y);\n};\n#line 9 \"test/4_aoj/CGL_1_B.test.cpp\"\
    \n\nvoid solve() {\n  using Re = double;\n  LL(a, b, c, d);\n  Line<ll> L(a, b,\
...
layout: document
redirect_from:
- /verify/test/4_aoj/CGL_1_B.test.cpp
- /verify/test/4_aoj/CGL_1_B.test.cpp.html
