...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/DPL_1_B.test.cpp\"\n#define PROBLEM \\\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_1_B\"\n#line 1 \"\
    ...
    \ (t == t2) return sol_2();\n  return sol_3();\n}\n#line 6 \"test/4_aoj/DPL_1_B.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, W);\n  vc<int> wt, val;\n  FOR(i, N) {\n    LL(b,\
  ...
  verifiedWith: []
documentation_of: test/4_aoj/DPL_1_B.test.cpp
layout: document
redirect_from:
- /verify/test/4_aoj/DPL_1_B.test.cpp
- /verify/test/4_aoj/DPL_1_B.test.cpp.html
