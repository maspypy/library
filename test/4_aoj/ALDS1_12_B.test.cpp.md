...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/ALDS1_12_B.test.cpp\"\n#define PROBLEM \\\n \
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_12_B\"\n#line\
    ...
    \ par};\r\n}\n#line 6 \"test/4_aoj/ALDS1_12_B.test.cpp\"\n\nvoid solve() {\n \
    \ LL(N);\n  Graph<int, 1> G(N);\n  FOR(v, N) {\n    LL(u);\n    assert(u == v);\n\
    \    LL(k);\n    FOR(k) {\n      LL(a, b);\n      G.add(v, a, b);\n    }\n  }\n\
  ...
  verifiedWith: []
documentation_of: test/4_aoj/ALDS1_12_B.test.cpp
layout: document
redirect_from:
- /verify/test/4_aoj/ALDS1_12_B.test.cpp
- /verify/test/4_aoj/ALDS1_12_B.test.cpp.html
