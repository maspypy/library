...
data:
  ...
  bundledCode: "#line 1 \"test/4_aoj/DSL_1_B.test.cpp\"\n#define PROBLEM \\\n  \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_1_B\"\n#line 1 \"\
    ...
    \n    vals[v2] = x;\r\n    par[v2] = v1;\r\n    size[v1] += size[v2];\r\n    --n_comp;\r\
    \n    return true;\r\n  }\r\n};\n#line 7 \"test/4_aoj/DSL_1_B.test.cpp\"\n\nvoid\
...
layout: document
redirect_from:
- /verify/test/4_aoj/DSL_1_B.test.cpp
- /verify/test/4_aoj/DSL_1_B.test.cpp.html
