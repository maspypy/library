...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1962.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1962\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/3_yukicoder/1962.test.cpp\"\n\
    ...
    \ N) {\r\n  assert(0 <= len(P) && len(P) + 1 == len(Q) && len(Q) <= 16 && Q[0]\
    \ == mint(1));\r\n  if (P.empty()) return 0;\r\n  int m = len(Q) - 1;\r\n  vc<u32>\
    \ Q32(m + 1);\r\n  FOR(i, m + 1) Q32[i] = (-Q[i]).val;\r\n\r\n  using poly = vc<u64>;\r\
    \n  auto dfs = [&](auto& dfs, const ll N) -> poly {\r\n    // x^N mod G\r\n  \
    \  if (N == 0) {\r\n      poly f(m);\r\n      f[0] = 1;\r\n      return f;\r\n\
    \    }\r\n    poly f = dfs(dfs, N / 2);\r\n    poly g(len(f) * 2 - 1 + (N & 1));\r\
    ...
    \ vector<mint> Q, ll N) {\r\n  assert(0 <= len(P) && len(P) + 1 == len(Q) && Q[0]\
    \ == mint(1));\r\n  if (P.empty()) return 0;\r\n\r\n  int n = 1;\r\n  while (n\
    \ < len(Q)) n += n;\r\n\r\n  vc<mint> W(n);\r\n  {\r\n    vc<int> btr(n);\r\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1962.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1962.test.cpp
- /verify/test/3_yukicoder/1962.test.cpp.html
