...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2895.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2895\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 4 \"test/3_yukicoder/2895.test.cpp\"\
    ...
    \ 0};\n  }\n};\n#line 6 \"test/3_yukicoder/2895.test.cpp\"\n\nvoid solve() {\n\
    \  LL(N);\n  Basis<60> B;\n  FOR(i, N) {\n    U64(x);\n    auto [ok, way] = B.solve_or_add(x);\n\
    \    if (!ok) continue;\n    vc<int> ANS;\n    FOR(j, 60) if (way >> j & 1) ANS.eb(j\
    \ + 1);\n    ANS.eb(i + 1);\n    print(len(ANS));\n    print(ANS);\n    return;\n\
    \  }\n  print(-1);\n}\n\nsigned main() {\n  solve();\n  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2895.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2895.test.cpp
- /verify/test/3_yukicoder/2895.test.cpp.html
