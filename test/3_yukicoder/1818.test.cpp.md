...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/1818
    links:
    - https://yukicoder.me/problems/no/1818
  bundledCode: "#line 1 \"test/3_yukicoder/1818.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1818\"\
    ...
    \ : \"Bob\"); }\r\nvoid Bob(bool t = 1) { Alice(!t); }\r\n#line 1 \"string/edit_distance.hpp\"\
    \ntemplate <typename STRING>\nint edit_distance(STRING& S, STRING& T) {\n  int\
    \ N = len(S), M = len(T);\n  vc<int> dp(M + 1, 1 << 30);\n  dp[0] = 0;\n  FOR(i,\
    \ N + 1) {\n    vc<int> newdp(M + 1, 1 << 30);\n    FOR(j, M + 1) {\n      if\
    \ (i < N) chmin(newdp[j], dp[j] + 1);\n      if (j < M) chmin(dp[j + 1], dp[j]\
    \ + 1);\n      if (i < N && j < M) chmin(newdp[j + 1], dp[j] + 1);\n      if (i\
    \ < N && j < M && S[i] == T[j]) chmin(newdp[j + 1], dp[j]);\n    }\n    if (i\
    \ < N) swap(dp, newdp);\n  }\n  return dp[M];\n}\n#line 5 \"test/3_yukicoder/1818.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M);\n  VEC(ll, A, N);\n  VEC(ll, B, M);\n  string\
    \ S, T;\n  FOR(i, N) {\n    FOR(A[i]) S += 'a';\n    S += 'b';\n  }\n  FOR(i,\
    \ M) {\n    FOR(B[i]) T += 'a';\n    T += 'b';\n  }\n\n  print(edit_distance(S,\
    \ T));\n}\n\nsigned main() {\n  cout << fixed << setprecision(15);\n\n  ll T =\
    \ 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1818\"\n#include \"my_template.hpp\"\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1818.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1818.test.cpp
- /verify/test/3_yukicoder/1818.test.cpp.html
