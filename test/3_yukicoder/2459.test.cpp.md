...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2459.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2459\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 5 \"test/3_yukicoder/2459.test.cpp\"\
    ...
    \ + 1);\n  den.resize(N + 1);\n  auto f = fps_inv(den);\n  f = convolution(f,\
    \ num);\n  f.resize(N + 1);\n  return f;\n}\n#line 8 \"test/3_yukicoder/2459.test.cpp\"\
    \n\nusing mint = modint998;\n\nvoid solve() {\n  LL(H, W, N, K);\n\n  auto get\
    \ = [&](ll H) -> pi {\n    // 1\uFF5En \u304C 2 \u500B\u3068 n+1 \u304C H-2n \u500B\
    \u3068\u3044\u3046\u5F62\u3067\u66F8\u3051\u308B\n    ll n = 0;\n    if (H < 2\
    \ * K) {\n      n = H - K;\n    } else {\n      n = K - 1;\n    }\n    return\
    \ {n, H - 2 * n};\n  };\n\n  auto [N1, M1] = get(H);\n  auto [N2, M2] = get(W);\n\
    \n  mint ANS = 0;\n  mint F = (H - K + 1) * (W - K + 1);\n\n  mint c = mint(1)\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2459.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2459.test.cpp
- /verify/test/3_yukicoder/2459.test.cpp.html
