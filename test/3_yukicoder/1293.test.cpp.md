...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1293.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1293\"\
    ...
    \ DAG;\n}\n#line 5 \"test/3_yukicoder/1293.test.cpp\"\n\nvoid solve() {\n  LL(N,\
    \ D, W);\n  Graph<int, 1> G(N + N);\n  FOR(D) {\n    LL(a, b);\n    --a, --b;\n\
    \    G.add(2 * a, 2 * b);\n    G.add(2 * b, 2 * a);\n  }\n  FOR(W) {\n    LL(a,\
    \ b);\n    --a, --b;\n    G.add(2 * a + 1, 2 * b + 1);\n    G.add(2 * b + 1, 2\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1293.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1293.test.cpp
- /verify/test/3_yukicoder/1293.test.cpp.html
