...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1625.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1625\"\
    ...
    \ 6 \"test/3_yukicoder/1625.test.cpp\"\n\nvoid solve() {\n  LL(N, Q);\n\n  using\
    \ QT = tuple<ll, ll, ll>;\n  vc<QT> query;\n  FOR(N) {\n    LL(a, b, c, d, e,\
    \ f);\n    ll x = min({a, c, e});\n    ll y = max({a, c, e});\n    ll area = abs((c\
    \ - a) * (f - b) - (e - a) * (d - b));\n    query.eb(x, y, area);\n  }\n  FOR(Q)\
    \ {\n    LL(t);\n    if (t == 1) {\n      LL(a, b, c, d, e, f);\n      ll x =\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1625.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1625.test.cpp
- /verify/test/3_yukicoder/1625.test.cpp.html
