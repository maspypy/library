...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1939.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1939\"\
    ...
    \n}\r\n#line 6 \"test/3_yukicoder/1939.test.cpp\"\n\nusing mint = modint998;\n\
    \nvoid solve() {\n  LL(N, M);\n  ++N;\n\n  vc<mint> P(N);\n  P[0] = 1;\n  FOR(M)\
    \ {\n    LL(a);\n    if (a < N) P[a] += mint(1);\n  }\n  P = fps_pow_1_sparse<mint>(P,\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1939.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1939.test.cpp
- /verify/test/3_yukicoder/1939.test.cpp.html
