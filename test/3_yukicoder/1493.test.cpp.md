...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1493.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1493\"\
    ...
    \    if (it == dp.end()) {\n      dp[x] = sm;\n      sm += sm;\n    } else {\n\
    \      mint d = (*it).se;\n      (*it).se = sm;\n      sm += sm - d;\n    }\n\
    \  }\n  return sm;\n}\n#line 6 \"test/3_yukicoder/1493.test.cpp\"\n\nusing mint\
    \ = modint107;\n\nvoid solve() {\n  LL(N);\n  VEC(int, A, N);\n  FOR(i, N - 1)\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1493.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1493.test.cpp
- /verify/test/3_yukicoder/1493.test.cpp.html
