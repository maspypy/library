...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2265.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2265\"\
    ...
    \ x2);\n      }\n    }\n    while (L < R) {\n      x1 = MX::op(x1, dat[H][L ^\
    \ xor_val]);\n      L += 1 << H;\n    }\n    return MX::op(x1, x2);\n  }\n};\n\
    #line 6 \"test/3_yukicoder/2265.test.cpp\"\n\nusing mint = modint998;\n\nmint\
    \ pow2[1 << 18];\nmint pow11[1 << 18];\n\nstruct Mono {\n  using value_type =\
    \ pair<int, mint>;\n  using X = value_type;\n  static X op(X& x, X& y) {\n   \
    \ return {x.fi + y.fi, x.se * pow11[y.fi] + y.se * pow2[x.fi]};\n  }\n  static\
    \ X from_element(mint x) { return {1, x}; }\n  static constexpr X unit() { return\
    \ {0, mint(0)}; }\n  static constexpr bool commute = 0;\n};\n\nvoid solve() {\n\
    \  LL(N);\n\n  pow2[0] = mint(1);\n  FOR(i, 1, 1 << N) pow2[i] = mint(2) * pow2[i\
    \ - 1];\n  pow11[0] = mint(1);\n  FOR(i, 1, 1 << N) pow11[i] = mint(11) * pow11[i\
    \ - 1];\n  STR(S);\n\n  Xor_SegTree<Mono> seg(1 << N, [&](int i) -> pair<int,\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2265.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2265.test.cpp
- /verify/test/3_yukicoder/2265.test.cpp.html
