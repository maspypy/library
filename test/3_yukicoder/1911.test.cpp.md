...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1911.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1911\"\
    ...
    \ 6 \"test/3_yukicoder/1911.test.cpp\"\n\nvoid solve() {\n  LL(N, M);\n  Graph<int,\
    \ 0> G(N);\n  G.read_graph(M);\n  VV(ll, A, 2, N);\n\n  ll ANS = 0;\n  {\n   \
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1911.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1911.test.cpp
- /verify/test/3_yukicoder/1911.test.cpp.html
