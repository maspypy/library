...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2944.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2944\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 4 \"test/3_yukicoder/2944.test.cpp\"\
    ...
    \ += dp[n - 1][k - 1];\r\n    // min >= 2\r\n    if (n >= k) dp[n][k] += dp[n\
    \ - k][k];\r\n  }\r\n  return dp;\r\n}\r\n#line 7 \"test/3_yukicoder/2944.test.cpp\"\
    \n\nusing mint = modint998;\nvoid solve() {\n  auto A = partition_number_2d<mint>(4000,\
