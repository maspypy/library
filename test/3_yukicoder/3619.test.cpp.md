...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/3619
    links:
    - https://yukicoder.me/problems/no/3619
  bundledCode: "#line 1 \"test/3_yukicoder/3619.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/3619\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 4 \"test/3_yukicoder/3619.test.cpp\"\
    ...
    };\n#line 7 \"test/3_yukicoder/3619.test.cpp\"\n\nusing mint = modint998;\n\n\
    void solve() {\n  LL(N, K);\n  VEC(mint, F, N);\n  Schroder<mint> SCH(F);\n  vc<mint>\
    \ ANS = SCH.iterated_composition(K);\n  print(ANS);\n}\n\nsigned main() { solve();\
    \ }\n"
