...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1332.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1332\"\
    ...
    \ + mid[d] - r0;\r\n      if (l0 < r0) L = l0, R = r0;\r\n      if (l0 == r0)\
    \ L = l1, R = r1;\r\n      seg[d].multiply(L, t);\r\n    }\r\n  }\r\n  void add(int\
    \ i, T t) { multiply(i, t); }\r\n};\r\n#line 5 \"test/3_yukicoder/1332.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1332.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1332.test.cpp
- /verify/test/3_yukicoder/1332.test.cpp.html
