...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1575.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1575\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 4 \"test/3_yukicoder/1575.test.cpp\"\
    ...
    \n}\n#line 10 \"test/3_yukicoder/1575.test.cpp\"\n\nusing mint = modint998;\n\n\
    /*\n\u898B\u304B\u3051\u3060\u304A\u3057\u3067, \u308F\u308A\u3068\u3084\u308B\
    \u3060\u3051\u304B\n*/\n\nvoid solve() {\n  LL(N, M, K, P, Q);\n  VEC(ll, A, N);\n\
    \  vc<mint> U(M), V(K);\n  FOR(i, M) read(U[i]);\n  FOR(i, K) read(V[i]);\n\n\
    \  // \u307E\u305A g(t) = sum_{u in U, v in V} (u+vt)^P \u3092\u6C42\u3081\u308B\
    \n  vc<mint> SM_U = sum_of_powers<mint>(U, P);\n  vc<mint> SM_V = sum_of_powers<mint>(V,\
    \ P);\n  vc<mint> g(P + 1);\n  FOR(i, P + 1) g[i] = C<mint>(P, i) * SM_U[P - i]\
    \ * SM_V[i];\n\n  const int LIM = 100'100;\n\n  // Y[i] = g(1/i)\n  vc<mint> X(LIM);\n\
    \  FOR(i, 1, LIM) X[i] = inv<mint>(i);\n  vc<mint> Y = multipoint_eval<mint>(g,\
    \ X);\n\n  // A \u306E\u60C5\u5831\n  // \u5404 i \u306B\u5BFE\u3057\u3066 i<=a\
    \ \u3068\u306A\u308B a \u306E\u500B\u6570\u304C\u6B32\u3057\u3044\n  vc<mint>\
