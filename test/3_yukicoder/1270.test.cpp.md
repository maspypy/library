...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1270.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1270\"\
    ...
    \n};\r\n#line 6 \"test/3_yukicoder/1270.test.cpp\"\n\n#line 2 \"ds/segtree/lazy_segtree.hpp\"\
    ...
    \    return x + a;\r\n  }\r\n};\r\n#line 9 \"test/3_yukicoder/1270.test.cpp\"\n\
    \nvoid solve() {\n  LL(N, Q);\n  VEC(int, A, N);\n  for (auto&& x: A) --x;\n\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1270.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1270.test.cpp
- /verify/test/3_yukicoder/1270.test.cpp.html
