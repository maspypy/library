...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1826_2.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1826\"\
    ...
    \ 6 \"test/3_yukicoder/1826_2.test.cpp\"\n\nvoid solve() {\n  LL(N);\n  vi X,\
    \ Y, V;\n  FOR(N) {\n    LL(t, x, v);\n    X.eb(t - x), Y.eb(t + x), V.eb(v);\n\
    \  }\n\n  auto I = argsort(X);\n  X = rearrange(X, I), Y = rearrange(Y, I), V\
  ...
  requiredBy: []
  timestamp: '2025-09-05 18:50:59+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/3_yukicoder/1826_2.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1826_2.test.cpp
- /verify/test/3_yukicoder/1826_2.test.cpp.html
