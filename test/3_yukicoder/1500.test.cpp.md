...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1500.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1500\"\
    ...
    }\r\n#line 7 \"test/3_yukicoder/1500.test.cpp\"\n\nusing mint = modint107;\n\n\
    void solve() {\n  vc<mint> A(20);\n  set<pi> ss;\n  ss.insert(mp(0, 0));\n  FOR(i,\
    \ 20) {\n    A[i] = len(ss);\n    set<pi> newss;\n    for (auto&& [x, y]: ss)\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1500.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1500.test.cpp
- /verify/test/3_yukicoder/1500.test.cpp.html
