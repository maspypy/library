...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2161.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2161\"\
    ...
    \ g);\r\n    }\r\n    return res;\r\n  }\r\n};\n#line 5 \"test/3_yukicoder/2161.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, K, L, P);\n  VEC(pi, AB, N);\n  using T = tuple<int,\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2161.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2161.test.cpp
- /verify/test/3_yukicoder/2161.test.cpp.html
