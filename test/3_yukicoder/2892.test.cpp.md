...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2892.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2892\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/3_yukicoder/2892.test.cpp\"\n\n#line 2 \"graph/base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T cost;\n  int id;\n\
    ...
    \  }\n}\n#line 6 \"test/3_yukicoder/2892.test.cpp\"\n\nvoid solve() {\n  LL(N);\n\
    \  Graph<int, 0> G(N);\n  G.read_tree();\n  STR(S);\n\n  ll ANS = 0;\n\n  auto\
    \ f = [&](vc<int> par, vc<int> V, int L1, int R1, int L2, int R2) -> void {\n\
    \    ll n = len(V);\n    vc<int> A(n);\n    FOR(i, n) { A[i] = (S[V[i]] == '1'\
    \ ? 1 : -1); }\n    // \u6839\u3092\u542B\u307E\u306A\u3044\u5834\u5408\u306E\u5024\
    \n    vc<int> dp(n);\n    FOR(i, 1, n) {\n      int p = par[i];\n      dp[i] =\
    \ dp[p] + A[i];\n    }\n\n    vc<int> L, R;\n    FOR(i, L1, R1) L.eb(dp[i] + A[0]\
