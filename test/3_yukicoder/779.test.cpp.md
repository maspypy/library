...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/779.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/779\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 4 \"test/3_yukicoder/779.test.cpp\"\n\
    ...
    \ }\n};\n#line 6 \"test/3_yukicoder/779.test.cpp\"\n\nusing DT = DateTime;\n\n\
    void solve() {\n  LL(y, m, d);\n  DT X(y, m, d);\n  Yes(DT(1989, 1, 8) <= X &&\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/779.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/779.test.cpp
- /verify/test/3_yukicoder/779.test.cpp.html
