...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2109.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2109\"\
    ...
    \ constexpr int month_days[13]\n      = {0, 31, 28, 31, 30, 31, 30, 31, 31, 30,\
    \ 31, 30, 31};\n  int year, month, day;\n  DateTime(int y, int m, int d) : year(y),\
    \ month(m), day(d) {}\n\n  // 1\u5E741\u67081\u65E5\u304C 0 \u3068\u306A\u308B\
    \u3088\u3046\u306B\u5909\u63DB\n  int to_int() {\n    int y = (month <= 2 ? year\
    ...
    \ }\n};\n#line 5 \"test/3_yukicoder/2109.test.cpp\"\n\nvoid solve() {\n  LL(M,\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2109.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2109.test.cpp
- /verify/test/3_yukicoder/2109.test.cpp.html
