...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2935.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2935\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/3_yukicoder/2935.test.cpp\"\n\
    ...
    \n};\n#line 7 \"test/3_yukicoder/2935.test.cpp\"\n\n// x \u306B\u5BFE\u3057\u3066\
    , 1,2,3 \u500B\u3042\u308B\u305F\u3081\u306E\u6700\u5C0F\u306E L \u3092\u6301\u3064\
    ...
    \ + 1] = seg.set(root[1][i + 1], x, i);\n    if (len(I[x]) >= 1) {\n      root[2][i\
    \ + 1] = seg.set(root[2][i + 1], x, I[x][len(I[x]) - 1]);\n    }\n    if (len(I[x])\
    \ >= 2) {\n      root[3][i + 1] = seg.set(root[3][i + 1], x, I[x][len(I[x]) -\
    \ 2]);\n    }\n    I[x].eb(i);\n  }\n\n  LL(Q);\n  ll last = 0;\n\n  auto solve\
    \ = [&](ll L, ll R) -> ll {\n    vi ANS;\n    FOR(k, 1, 4) {\n      ll x =\n \
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2935\"\n#include \"my_template.hpp\"\
    ...
    \u5C0F\u306E L \u3092\u6301\u3064\n\nconst int LIM = 100'100;\n\nvoid solve()\
    \ {\n  LL(N);\n  VEC(int, A, N);\n  Dynamic_SegTree<Monoid_Min<int>, true> seg(0,\
    \ LIM);\n  using np = decltype(seg)::np;\n  vvc<np> root(4);\n  FOR(i, 4) root[i].resize(N\
    \ + 1);\n  vc<int> S(LIM, -1);\n  FOR(i, 1, 4) root[i][0] = seg.new_node(S);\n\
    \  vvc<int> I(LIM);\n\n  FOR(i, N) {\n    int x = A[i];\n    FOR(k, 4) root[k][i\
  ...
  requiredBy: []
  timestamp: '2025-12-02 22:26:52+09:00'
