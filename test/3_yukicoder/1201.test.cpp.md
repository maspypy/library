...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/1201
    links:
    - https://yukicoder.me/problems/no/1201
  bundledCode: "#line 1 \"test/3_yukicoder/1201.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1201\"\
    ...
    \ = mp(mod, a);\n  }\n  return res;\n}\n#line 5 \"test/3_yukicoder/1201.test.cpp\"\
    \n\nconst int mod = 1'000'000'007;\n\nvoid solve() {\n  LL(N, M);\n  VEC(ll, A,\
    \ N);\n  VEC(ll, B, M);\n\n  i128 ANS = 0;\n  for (auto&& a: A) {\n    for (auto&&\
    \ b: B) {\n      // FOR(k, 1, b + 1) ANS += mint(floor(a * k, b));\n      i128\
    \ x = floor_sum_of_linear<i128, ll>(1, b + 1, a, 0, b);\n      ANS += x;\n   \
    \ }\n  }\n  ANS += ANS;\n  ANS %= mod;\n  print(ANS);\n}\n\nsigned main() {\n\
    \  cout << fixed << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\
    \n  return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1201\"\n#include \"my_template.hpp\"\
    \n#include \"other/io.hpp\"\n#include \"mod/floor_sum_of_linear.hpp\"\n\nconst\
    \ int mod = 1'000'000'007;\n\nvoid solve() {\n  LL(N, M);\n  VEC(ll, A, N);\n\
    \  VEC(ll, B, M);\n\n  i128 ANS = 0;\n  for (auto&& a: A) {\n    for (auto&& b:\
    \ B) {\n      // FOR(k, 1, b + 1) ANS += mint(floor(a * k, b));\n      i128 x\
    \ = floor_sum_of_linear<i128, ll>(1, b + 1, a, 0, b);\n      ANS += x;\n    }\n\
    \  }\n  ANS += ANS;\n  ANS %= mod;\n  print(ANS);\n}\n\nsigned main() {\n  cout\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1201.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1201.test.cpp
- /verify/test/3_yukicoder/1201.test.cpp.html
