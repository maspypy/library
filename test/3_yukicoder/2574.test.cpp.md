...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2574.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2574\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 4 \"test/3_yukicoder/2574.test.cpp\"\
    ...
    \ baseline) {\n    assert(IS_MIN);\n    ll res = 0;\n    FOR(i, n) {\n      auto\
    \ [l, r, h] = maximum_rectangle(i);\n      ll x = (baseline ? h : ll(h) * (h +\
    \ 1) / 2);\n      res += x * (i - l + 1) * (r - i);\n    }\n    return res;\n\
    \  }\n};\n#line 6 \"test/3_yukicoder/2574.test.cpp\"\n\nvoid solve() {\n  LL(H,\
    \ W, N);\n  vv(int, A, H, W, 1);\n  FOR(N) {\n    INT(x, y);\n    A[--x][--y]\
    \ = 0;\n  }\n  ll ANS = 0;\n  vc<int> Y(W);\n  FOR(i, H) {\n    FOR(j, W) Y[j]\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2574.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2574.test.cpp
- /verify/test/3_yukicoder/2574.test.cpp.html
