...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2206_2.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2206\"\
    ...
    \      --n;\n      }\n      while (m < mm) {\n        ans += C<mint>(n, m++);\n\
    \      }\n      while (m > mm) {\n        ans -= C<mint>(n, --m);\n      }\n \
    \     ANS[i] = ans;\n    }\n    return ANS;\n  }\n};\n#line 8 \"test/3_yukicoder/2206_2.test.cpp\"\
    \n\nusing mint = modint998;\n\nvoid solve() {\n  LL(Q);\n  const int LIM = 200'000;\n\
    \  vc<mint> POW = power_table_1<mint>(2, LIM + 10);\n  Prefix_Sum_Of_Binom_Offline<mint>\
    \ X;\n\n  vc<mint> CF(Q);\n\n  FOR(q, Q) {\n    INT(n, m);\n    mint cf = POW[n]\
    \ - mint(1);\n    CF[q] = cf;\n    X.add(n - 1, m);\n  }\n  auto res = X.calc();\n\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2206\"\n\n#include \"\
    ...
    \ = modint998;\n\nvoid solve() {\n  LL(Q);\n  const int LIM = 200'000;\n  vc<mint>\
    \ POW = power_table_1<mint>(2, LIM + 10);\n  Prefix_Sum_Of_Binom_Offline<mint>\
    \ X;\n\n  vc<mint> CF(Q);\n\n  FOR(q, Q) {\n    INT(n, m);\n    mint cf = POW[n]\
    \ - mint(1);\n    CF[q] = cf;\n    X.add(n - 1, m);\n  }\n  auto res = X.calc();\n\
    \  FOR(q, Q) print(res[q] * CF[q]);\n}\n\nsigned main() {\n  solve();\n  return\
    \ 0;\n}"
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2206_2.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2206_2.test.cpp
- /verify/test/3_yukicoder/2206_2.test.cpp.html
