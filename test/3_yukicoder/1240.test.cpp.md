...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1240.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1240\"\
    ...
    \ <= (x ^ a) < hi \u3068\u306A\u308B x \u306E\u533A\u9593 [L, R) \u306E\u5217\u6319\
    \ntemplate <typename F>\nvoid xor_range(u64 a, u64 lo, u64 hi, F query) {\n  FOR(k,\
    \ 64) {\n    if (lo == hi) break;\n    ll b = 1LL << k;\n    if (lo & b) { query((lo\
    \ ^ a), (lo ^ a) + b), lo += b; }\n    if (hi & b) { query((hi - b) ^ a, ((hi\
    \ - b) ^ a) + b), hi -= b; }\n    if (a & b) a ^= b;\n  }\n}\n#line 5 \"test/3_yukicoder/1240.test.cpp\"\
    \n\nvoid solve() {\n  const int K = 20;\n  LL(N, X);\n  VEC(ll, A, N);\n  sort(all(A));\n\
    \n  // \u6841\u3054\u3068\u306E\u7D2F\u7A4D\u548C\n  vv(int, dp, K, N);\n  FOR(k,\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1240.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1240.test.cpp
- /verify/test/3_yukicoder/1240.test.cpp.html
