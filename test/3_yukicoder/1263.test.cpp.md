...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/1263
    links:
    - https://yukicoder.me/problems/no/1263
  bundledCode: "#line 1 \"test/3_yukicoder/1263.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1263\"\
    ...
    \ | 1 << a);\n      dfs(dfs, rest - s);\n      POP(S);\n    }\n  };\n  dfs(dfs,\
    \ (u32(1) << N) - 1);\n}\n#line 6 \"test/3_yukicoder/1263.test.cpp\"\n\nusing\
    \ mint = modint107;\n\nvoid solve() {\n  mint ANS = 1;\n  LL(N);\n  auto f = [&](vc<int>\
    \ P) -> void {\n    mint v = fact<mint>(N);\n    for (auto&& x: P) v *= inv<mint>(x)\
    \ * (x % 2 == 0 ? mint(-1) : mint(1));\n    vc<int> CNT(N + 1);\n    for (auto&&\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1263.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1263.test.cpp
- /verify/test/3_yukicoder/1263.test.cpp.html
