...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/3148.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/3148\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 5 \"test/3_yukicoder/3148.test.cpp\"\
    ...
    \ av), set(p, ap);\n  }\n  vc<int> I = {root};\n  while (nxt[I.back()] != -1)\
    \ I.eb(nxt[I.back()]);\n  return {I, A[uf[root]]};\n}\n#line 8 \"test/3_yukicoder/3148.test.cpp\"\
    \n\nstruct Data {\n  ll ans, x0, x1;\n};\n\n// \u4ECA\u56DE\u306F\u8449\u304C\u5148\
    ...
    \ (y.x0 == 0 && y.x1 == 0) return true;\n    return x.x0 * y.x1 > x.x1 * y.x0;\n\
    \  };\n  auto [ord, x] = optimal_product_on_tree<decltype(tree), Mono, false>(tree,\
    \ dat, comp);\n  ll ANS = 0;\n  FOR(i, 1, len(ord)) {\n    int v = ord[i];\n \
    \   ANS += W[v] * i;\n  }\n  print(ANS);\n}\n\nsigned main() {\n  int T = 1;\n\
    \  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
