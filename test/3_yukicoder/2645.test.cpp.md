...
data:
  ...
  attributes:
    ...
    ERROR: 1e-6
    PROBLEM: https://yukicoder.me/problems/no/2645
    links:
    - https://yukicoder.me/problems/no/2645
  bundledCode: "#line 1 \"test/3_yukicoder/2645.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2645\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 6 \"test/3_yukicoder/2645.test.cpp\"\
    \n\n#line 1 \"seq/famous/harmonic.hpp\"\n\n// \u8AA4\u5DEE O(N^{-6})\nlong double\
    \ harmonic_number(ll N) {\n  using Re = long double;\n  static vc<Re> dp(1000);\n\
    \  static bool prepare = 0;\n  if (!prepare) {\n    prepare = 1;\n    FOR(n, 1,\
    \ 1000) dp[n] = dp[n - 1] + Re(1) / n;\n  }\n  if (N < 1000) return dp[N];\n \
    \ Re x = logl(N);\n  Re gamma = 0.577215664901532860606512090;\n  x += gamma;\n\
    \  x += 0.5 / N;\n  x -= 1.0 / 12 / N / N;\n  x += 1.0 / 120 / N / N / N / N;\n\
    \  return x;\n}\n#line 8 \"test/3_yukicoder/2645.test.cpp\"\n\nusing Re = double;\n\
    \n// sum 1/ij\nvoid solve() {\n  LL(N);\n  Re ANS = 0;\n\n  FOR(i, 1, N + 1) {\n\
    \    ll hi = N / i;\n    if (i >= hi) break;\n    Re x = harmonic_number(hi) -\
    \ harmonic_number(i);\n    ANS += x / i;\n  }\n  ANS += ANS;\n  FOR(i, 1, N +\
    \ 1) {\n    if (i * i > N) break;\n    ANS += 1.0 / (i * i);\n  }\n\n  print(ANS);\n\
    }\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return\
    \ 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2645\"\n#define ERROR\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2645.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2645.test.cpp
- /verify/test/3_yukicoder/2645.test.cpp.html
