...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1197.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1197\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 5 \"test/3_yukicoder/1197.test.cpp\"\
    ...
    \ X = value_type;\n  static constexpr X op(const X &x, const X &y) { return Monoid::op(y,\
    \ x); }\n  static constexpr X unit() { return Monoid::unit(); }\n  static const\
    \ bool commute = Monoid::commute;\n};\n#line 1 \"other/bit.hpp\"\n\nint popcnt(int\
    ...
    \ u : tree.V[i - 1]);\r\n    }\r\n    return v;\r\n  }\r\n};\r\n#line 9 \"test/3_yukicoder/1197.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, K, Q);\n  VEC(int, C, K);\n  for (auto&& v: C) --v;\n\
