...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2606.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2606\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/3_yukicoder/2606.test.cpp\"\n\
    ...
    \ (auto&& p: path) res[p]++;\n    FOR_R(k, 1, len(nodes)) {\n      int link =\
    \ nodes[k].link;\n      res[link] += res[k];\n    }\n    return res;\n  }\n};\n\
    #line 6 \"test/3_yukicoder/2606.test.cpp\"\n\nvoid solve() {\n  STR(S);\n  Palindromic_Tree<26>\
    \ X(S, 'a');\n\n  auto CNT = X.count();\n  ll n = len(X.nodes);\n  vi dp(n);\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2606.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2606.test.cpp
- /verify/test/3_yukicoder/2606.test.cpp.html
