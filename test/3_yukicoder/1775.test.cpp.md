...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1775.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1775\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 4 \"test/3_yukicoder/1775.test.cpp\"\
    ...
    \ 6 \"test/3_yukicoder/1775.test.cpp\"\n\nvoid solve() {\n  LL(N, M);\n  INT(X,\
    \ Y, Z);\n  --X, --Y, --Z;\n  vv(bool, can, N, N, 1);\n  FOR(M) {\n    LL(a, b);\n\
    \    --a, --b;\n    can[a][b] = can[b][a] = 0;\n  }\n\n  Graph<int, 0> G(N);\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1775.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1775.test.cpp
- /verify/test/3_yukicoder/1775.test.cpp.html
