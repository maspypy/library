...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/2897
    links:
    - https://yukicoder.me/problems/no/2897
  bundledCode: "#line 1 \"test/3_yukicoder/2897.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2897\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/3_yukicoder/2897.test.cpp\"\n\
    ...
    \n      }\r\n    }\r\n  };\r\n\r\n  calc();\r\n  reverse(all(I));\r\n  FOR(i,\
    \ N + M) points[i].fi *= -1;\r\n  calc();\r\n\r\n  return {dist, nbd_idx};\r\n\
    };\n#line 6 \"test/3_yukicoder/2897.test.cpp\"\n\nvoid solve() {\n  LL(N);\n \
    \ VEC(pi, FRM, N);\n  LL(M);\n  VEC(pi, TO, M);\n  auto [D, J] = manhattan_nns(FRM,\
    \ TO);\n  print(MIN(D));\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n \
    \ FOR(T) solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2897\"\n#include \"my_template.hpp\"\
    \n#include \"other/io.hpp\"\n\n#include \"geo/manhattan_nns.hpp\"\n\nvoid solve()\
    \ {\n  LL(N);\n  VEC(pi, FRM, N);\n  LL(M);\n  VEC(pi, TO, M);\n  auto [D, J]\
    \ = manhattan_nns(FRM, TO);\n  print(MIN(D));\n}\n\nsigned main() {\n  int T =\
    \ 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  dependsOn:
  - my_template.hpp
  - other/io.hpp
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2897.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2897.test.cpp
- /verify/test/3_yukicoder/2897.test.cpp.html
