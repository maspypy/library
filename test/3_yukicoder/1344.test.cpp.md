...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1344.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1344\"\
    ...
    \    }\n  }\n  return dist;\n}\n#line 5 \"test/3_yukicoder/1344.test.cpp\"\n\n\
    void solve() {\n  LL(N, M);\n  Graph<ll, 1> G(N);\n  G.read_graph(M, 1);\n  auto\
    \ dist = warshall_floyd<ll>(G);\n  FOR(v, N) {\n    ll ANS = 0;\n    FOR(w, N)\
    \ if (dist[v][w] != infty<ll>) ANS += dist[v][w];\n    print(ANS);\n  }\n}\n\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1344.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1344.test.cpp
- /verify/test/3_yukicoder/1344.test.cpp.html
