...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1641.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1641\"\
    ...
    \n  static constexpr X unit(){return X(0);};\r\n  static constexpr bool commute\
    \ = true;\r\n};\r\n#line 6 \"test/3_yukicoder/1641.test.cpp\"\n\nvoid solve()\
    \ {\n  LL(N, Q);\n  Graph G(N);\n  VEC(int, A, N);\n  G.read_tree();\n  Tree tree(G);\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1641.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1641.test.cpp
- /verify/test/3_yukicoder/1641.test.cpp.html
