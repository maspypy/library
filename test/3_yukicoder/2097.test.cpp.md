...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2097.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2097\"\
    ...
    #line 1 \"poly/product_of_f_rk_x.hpp\"\n\n#line 1 \"poly/fps_log.hpp\"\n\n#line\
    ...
    \  FOR(i, 1, len(g)) {\n    pow_r *= r;\n    pow_rm *= rm;\n    if (pow_r == mint(1))\
    \ {\n      g[i] *= mint(M);\n    } else {\n      g[i] *= (pow_rm - mint(1)) /\
    \ (pow_r - mint(1));\n    }\n  }\n  return fps_exp(g);\n}\n#line 6 \"test/3_yukicoder/2097.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2097.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2097.test.cpp
- /verify/test/3_yukicoder/2097.test.cpp.html
