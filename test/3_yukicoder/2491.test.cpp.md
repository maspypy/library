...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2491.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2491\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/3_yukicoder/2491.test.cpp\"\n\n#line 2 \"graph/tree.hpp\"\
    ...
    \ X unit() { return {0, 0}; }\r\n  static constexpr bool commute = true;\r\n};\r\
    \n#line 9 \"test/3_yukicoder/2491.test.cpp\"\n\nvoid solve() {\n  INT(N);\n  Graph<int,\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2491\"\n#include \"my_template.hpp\"\
    ...
    \  }\n\n  auto f = [&](vc<int>& par, vc<int>& V, int L1, int R1, int L2, int R2)\
    \ -> void {\n    int n = len(V);\n    vc<int> dep(n);\n    FOR(i, 1, n) dep[i]\
    \ += dep[par[i]] + 1;\n\n    auto F = [&](int L1, int R1, int L2, int R2) -> void\
    \ {\n      // dep range, index range\n      Rectangle_Add_Point_Sum<Monoid_Add_Pair<ll>,\
    \ int, true> X;\n      FOR(i, L1, R1) {\n        int v = V[i];\n        if (v\
    \ == 0) continue;\n        int d = D[v];\n        if (d <= 2) continue;\n    \
    \    // \u8DDD\u96E2\u304C d-2 \u4EE5\u4E0B\n        int d1 = 1, d2 = d - 2 -\
    \ dep[i];\n        if (d1 > d2) continue;\n        // \u8DB3\u3059\u3082\u306E\
    \uFF1A(d - 1 - dep[i]) - x\n        X.add_query(d1, d2 + 1, 0, v, {d - 1 - dep[i],\
    \ -1});\n      }\n      FOR(i, L2, R2) { X.sum_query(dep[i], V[i]); }\n      auto\
    \ res = X.calc();\n      FOR(i, L2, R2) {\n        auto [a, b] = res[i - L2];\n\
    \        ANS[V[i]] -= a + b * dep[i];\n      }\n    };\n    F(L1, R1, L2, R2);\n\
    \    F(L2, R2, L1, R1);\n  };\n\n  centroid_decomposition<1, decltype(G)>(G, f);\n\
  ...
  requiredBy: []
  timestamp: '2024-10-12 23:20:21+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/3_yukicoder/2491.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2491.test.cpp
- /verify/test/3_yukicoder/2491.test.cpp.html
