...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1783.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1783\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/3_yukicoder/1783.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \n  fft(false);\n  FOR(s, TEN[K - T]) {\n    vc<mint> f = {A.begin() + TEN[T]\
    \ * s, A.begin() + TEN[T] * (s + 1)};\n    f = solve_truncate(T, f, M);\n    FOR(j,\
    \ len(f)) { A[TEN[T] * s + j] = f[j]; }\n  }\n  fft(true);\n\n  mint c = mint(1)\
