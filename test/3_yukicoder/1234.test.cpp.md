...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1234.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1234\"\
    ...
    \  }\n};\n#line 6 \"test/3_yukicoder/1234.test.cpp\"\n\nvoid solve() {\n  LL(N);\n\
    \  VEC(ll, A, N);\n  Lazy_SegTree<ActedMonoid_Min_Add<ll>> seg(A);\n  LL(Q);\n\
    \  FOR(Q) {\n    LL(t, l, r, x);\n    --l;\n    if (t == 1) { seg.apply(l, r,\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1234.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1234.test.cpp
- /verify/test/3_yukicoder/1234.test.cpp.html
