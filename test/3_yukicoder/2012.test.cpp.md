...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2012.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2012\"\
    ...
    \    return {-f, i};\r\n  }\r\n};\r\n#line 5 \"test/3_yukicoder/2012.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  CHT_XY<ll> cht;\n  VEC(pi, XY, N);\n  ll ANS =\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2012.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2012.test.cpp
- /verify/test/3_yukicoder/2012.test.cpp.html
