...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1212.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1212\"\
    ...
    \ k) + ((l++) ^ xor_val)]);\n      }\n      if (r & 1) {\n        x = Monoid::op(x,\
    \ dat[(size >> k) + ((--r) ^ xor_val)]);\n      }\n      l /= 2, r /= 2, xor_val\
    \ /= 2;\n    }\n    return x;\n  }\n};\n#line 8 \"test/3_yukicoder/1212.test.cpp\"\
    \n\nvoid solve() {\n  INT(N);\n  Graph<ll, 0> G(N);\n  G.read_tree(1);\n\n  Tree<decltype(G)>\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1212.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1212.test.cpp
- /verify/test/3_yukicoder/1212.test.cpp.html
