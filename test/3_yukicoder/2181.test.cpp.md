...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2181.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2181\"\
    ...
    \    return ANS;\r\n  }\r\n};\n#line 5 \"test/3_yukicoder/2181.test.cpp\"\n\n\
    void solve() {\n  LL(L, R, mod);\n  Binomial X(mod);\n  ll ANS = 0;\n  FOR(n,\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2181.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2181.test.cpp
- /verify/test/3_yukicoder/2181.test.cpp.html
