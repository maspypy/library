...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/3005
    links:
    - https://yukicoder.me/problems/no/3005
  bundledCode: "#line 1 \"test/3_yukicoder/3005.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/3005\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 5 \"test/3_yukicoder/3005.test.cpp\"\n\
    \n#line 2 \"geo/base.hpp\"\ntemplate <typename T>\nstruct Point {\n  T x, y;\n\
    ...
    \ 0) return 0;\n  return (det > 0 ? 1 : -1);\n}\n#line 7 \"test/3_yukicoder/3005.test.cpp\"\
    \n\nusing P = Point<ll>;\n\nvoid solve() {\n  P A, B, C, D;\n  read(A, B, C, D);\n\
    \  if ((A - B).det(A - C) == 0) return NO();\n  int k = outcircle_side(A, B, C,\
    \ D);\n  YES(k == 0);\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n  FOR(T)\
    \ solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/3005\"\n\n#include \"\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/3005.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/3005.test.cpp
- /verify/test/3_yukicoder/3005.test.cpp.html
