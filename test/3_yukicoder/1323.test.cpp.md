...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1323.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1323\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 1 \"graph/shortest_path/grid_bfs.hpp\"\
    \n\n// walls = \"#\" \u3084\u3001walls = {-1} \u306A\u3069\u3002\ntemplate <typename\
    ...
    \ ny, dist[x][y] + 1);\n    }\n  }\n  return dist;\n}\n#line 5 \"test/3_yukicoder/1323.test.cpp\"\
    \n\nvoid solve() {\n  LL(H, W, sx, sy, gx, gy);\n  VEC(string, G, H);\n  --sx,\
    \ --sy, --gx, --gy;\n  ll dx[] = {1, 0, -1, 0};\n  ll dy[] = {0, 1, 0, -1};\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1323.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1323.test.cpp
- /verify/test/3_yukicoder/1323.test.cpp.html
