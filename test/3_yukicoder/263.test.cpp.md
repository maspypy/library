...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/263.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/263\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/3_yukicoder/263.test.cpp\"\n\
    ...
    \ dat.eb(key[i], val[i]);\r\n    }\r\n    build(2 * len(dat));\r\n    for (auto&\
    \ [a, b]: dat) (*this)[a] = b;\r\n  }\r\n};\n#line 8 \"test/3_yukicoder/263.test.cpp\"\
    \n\nvoid solve() {\n  RollingHash RH;\n  using M61 = modint61;\n\n  auto get =\
    \ [&]() -> vc<pair<ll, int>> {\n    vc<pair<ll, int>> res;\n    STR(S);\n    Palindromic_Tree<26>\
    \ X(S, 'A');\n    auto SH = RH.build(S);\n    auto CNT = X.count();\n    FOR(i,\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/263.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/263.test.cpp
- /verify/test/3_yukicoder/263.test.cpp.html
