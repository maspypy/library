...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1907.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1907\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 5 \"test/3_yukicoder/1907.test.cpp\"\n\
    ...
    }\n#line 8 \"test/3_yukicoder/1907.test.cpp\"\n\nusing mint = modint998;\n\nvoid\
    \ solve() {\n  LL(N);\n  VV(mint, A, N, N);\n  VV(mint, B, N, N);\n  auto f =\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1907.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1907.test.cpp
- /verify/test/3_yukicoder/1907.test.cpp.html
