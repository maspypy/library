...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2003.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2003\"\
    ...
    \      add_x(x, y, val), x += x & -x;\r\n    }\r\n  }\r\n\r\n  E sum(int lx, int\
    \ rx, int ly, int ry) { return prod(lx, rx, ly, ry); }\r\n  E prod(int lx, int\
    \ rx, int ly, int ry) {\r\n    E pos = G::id(), neg = G::id();\r\n    while (lx\
    \ < rx) {\r\n      pos = G::op(pos, sum_x(rx, ly, ry)), rx -= rx & -rx;\r\n  \
    \  }\r\n    while (rx < lx) {\r\n      neg = G::op(neg, sum_x(lx, ly, ry)), lx\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2003.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2003.test.cpp
- /verify/test/3_yukicoder/2003.test.cpp.html
