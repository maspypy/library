...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1755.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1755\"\
    ...
    \n}\r\n#line 8 \"test/3_yukicoder/1755.test.cpp\"\n\nusing mint = modint998;\n\
    \nvoid solve() {\n  mint K = 26;\n\n  auto f = [&](int N) -> mint {\n    mint\
    \ ANS = 0;\n    FOR(a, N + 1) {\n      ll n = N - 2 * a;\n      if (n <= 1) break;\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1755.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1755.test.cpp
- /verify/test/3_yukicoder/1755.test.cpp.html
