...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1868.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1868\"\
    ...
    \   FOR(i, 2, n + n) { edges.eb(to_upper_idx(i / 2), to_upper_idx(i), 0); }\n\
    \    FOR(i, 2, n + n) { edges.eb(to_lower_idx(i), to_lower_idx(i / 2), 0); }\n\
    ...
    \ = e.frm;\n        if (e.cost == 0)\n          que.push_front(e.to);\n      \
    \  else\n          que.push_back(e.to);\n      }\n    }\n  }\n  return {dist,\
    \ par, root};\n}\n#line 6 \"test/3_yukicoder/1868.test.cpp\"\n\nvoid solve() {\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1868.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1868.test.cpp
- /verify/test/3_yukicoder/1868.test.cpp.html
