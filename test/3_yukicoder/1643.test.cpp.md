...
data:
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1643\"\n#include \"my_template.hpp\"\
    ...
    \ {\n  STR(S);\n  string ans = \"\";\n  while (is_subsequence(ans, S)) ans +=\
    \ \"a\";\n  print(ans);\n}\n\nsigned main() {\n  solve();\n\n  return 0;\n}\n"
  dependsOn:
  - my_template.hpp
  - other/io.hpp
  - string/is_subsequence.hpp
