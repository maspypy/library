...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/502.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/502\"\
    ...
    #line 5 \"test/3_yukicoder/502.test.cpp\"\n\nvoid solve() {\n  LL(N);\n  print(factorial107(N));\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/502.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/502.test.cpp
- /verify/test/3_yukicoder/502.test.cpp.html
