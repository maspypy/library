...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1600_2.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1600\"\
    ...
    \ (bl) ok = k;\n      if (!bl) ng = k;\n    }\n    return ok;\n  }\n};\n#line\
    \ 7 \"test/3_yukicoder/1600_2.test.cpp\"\n\n#line 1 \"alg/monoid/min.hpp\"\n\n\
    template <typename E>\nstruct Monoid_Min {\n  using X = E;\n  using value_type\
    ...
    \      seg(len(X),\n          [&](int i) -> tuple<int, int, int> { return {X[i],\
    \ Y[i], W[i]}; });\n\n  LL(Q);\n  FOR(Q) {\n    LL(u, v, idx);\n    --u, --v,\
    \ --idx;\n    auto [x, y] = edges[idx];\n    if (par[y] == x) swap(x, y);\n  \
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1600\"\n#include \"my_template.hpp\"\
    ...
    \  using ST = Sparse_Table<Mono>;\n  Wavelet_Matrix_2D_Range<int, false, false,\
    \ Static_Range_Product<Mono, ST>>\n      seg(len(X),\n          [&](int i) ->\
    \ tuple<int, int, int> { return {X[i], Y[i], W[i]}; });\n\n  LL(Q);\n  FOR(Q)\
    \ {\n    LL(u, v, idx);\n    --u, --v, --idx;\n    auto [x, y] = edges[idx];\n\
    \    if (par[y] == x) swap(x, y);\n    bool in_u = tree.in_subtree(u, x);\n  \
    \  bool in_v = tree.in_subtree(v, x);\n    if (!in_G[idx] || in_u == in_v) {\n\
    \      print(tree.dist_weighted(u, v));\n      continue;\n    }\n    // \u6728\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1600_2.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1600_2.test.cpp
- /verify/test/3_yukicoder/1600_2.test.cpp.html
