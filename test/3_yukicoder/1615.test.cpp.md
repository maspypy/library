...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1615.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1615\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 4 \"test/3_yukicoder/1615.test.cpp\"\
    ...
    };\n#line 6 \"test/3_yukicoder/1615.test.cpp\"\n\nvoid solve() {\n  LL(N1, N2,\
    \ K, M);\n  Graph<int, 0> G(N1 + N2);\n  FOR(M) {\n    INT(a, b, c);\n    --a,\
    \ --b;\n    G.add(a, N1 + b, c);\n  }\n  G.build();\n\n  Rank_Maximal_Bipartite_Matching<decltype(G)>\
