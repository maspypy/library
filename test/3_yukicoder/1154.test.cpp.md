...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1154.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1154\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/3_yukicoder/1154.test.cpp\"\n\n#line 2 \"graph/base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T cost;\n  int id;\n\
    ...
    \    return A;\n  }\n};\n#line 7 \"test/3_yukicoder/1154.test.cpp\"\n\n// https://qoj.ac/contest/1245/problem/6514\n\
    void solve() {\n  LL(N);\n  VEC(ll, A, N);\n  Graph<int, 0> G(N);\n  G.read_tree();\n\
  ...
  requiredBy: []
  timestamp: '2024-09-09 09:42:10+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/3_yukicoder/1154.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1154.test.cpp
- /verify/test/3_yukicoder/1154.test.cpp.html
