...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1242.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1242\"\
    ...
    \ max(ti, tj);\r\n  }\r\n};\r\n#line 5 \"test/3_yukicoder/1242.test.cpp\"\n\n\
    void solve() {\n  LL(N, K);\n  VEC(ll, A, K);\n\n  Functional_Graph<Monoid_Add<int>>\
    \ FG(64);\n  FOR(s, 64) {\n    int t = (2 * s) & 63;\n    bool ok = 1;\n    if\
    \ (!(s & 1) && !(s & 32)) ok = 0;\n    if (!(s & 2) && !(s & 16)) ok = 0;\n  \
    \  if (!(s & 4) && !(s & 8)) ok = 0;\n    if (ok) t |= 1;\n    FG.add(s, t);\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1242.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1242.test.cpp
- /verify/test/3_yukicoder/1242.test.cpp.html
