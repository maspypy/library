...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2264.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2264\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 4 \"test/3_yukicoder/2264.test.cpp\"\
    ...
    \nusing modint107 = modint<1000000007>;\nusing modint998 = modint<998244353>;\n\
    #line 8 \"test/3_yukicoder/2264.test.cpp\"\n\nusing mint = modint998;\n\nvoid\
    \ solve() {\n  LL(N, M);\n  VEC(ll, A, N);\n  ll lcm = 1;\n  for (auto&& x : A)\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2264.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2264.test.cpp
- /verify/test/3_yukicoder/2264.test.cpp.html
