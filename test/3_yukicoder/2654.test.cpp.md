...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2654.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2654\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/3_yukicoder/2654.test.cpp\"\n\
    ...
    */\ntemplate <typename T, typename SUM_T = T>\nstruct Slide_Split_Sum {\n  Removable_Queue<pq_max<T>>\
    ...
    #line 7 \"test/3_yukicoder/2654.test.cpp\"\n\nvoid solve() {\n  LL(N);\n  ++N;\n\
    \  VEC(ll, A, N);\n  Graph<int, 0> G(N);\n  G.read_tree(0, 0);\n\n  Removable_Queue<pq_min<ll>>\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2654.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2654.test.cpp
- /verify/test/3_yukicoder/2654.test.cpp.html
