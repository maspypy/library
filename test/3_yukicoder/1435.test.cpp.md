...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1435.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1435\"\
    ...
    \ /= 2;\n    }\n    return x;\n  }\n};\n#line 5 \"test/3_yukicoder/1435.test.cpp\"\
    \n\nstruct Mono {\n  using value_type = tuple<int, int, int>;  // max, min1, min2\n\
    \  using X = value_type;\n  static X op(const X& x, const X& y) {\n    auto& [xma,\
    \ xmi1, xmi2] = x;\n    auto& [yma, ymi1, ymi2] = y;\n    if (xma == -1) return\
    \ y;\n    if (yma == -1) return x;\n    if (xmi1 < ymi1) {\n      return {max(xma,\
    \ yma), xmi1, min(xmi2, ymi1)};\n    }\n    return {max(xma, yma), ymi1, min(ymi2,\
  ...
  requiredBy: []
  timestamp: '2026-04-13 20:33:14+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/3_yukicoder/1435.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1435.test.cpp
- /verify/test/3_yukicoder/1435.test.cpp.html
