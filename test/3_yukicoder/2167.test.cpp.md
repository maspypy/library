...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2167.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2167\"\
    ...
    \ + X.se;\n}\n#line 7 \"test/3_yukicoder/2167.test.cpp\"\n\nvoid solve() {\n \
    \ HashMap<ll> MP;\n  LL(N, LIM);\n  VEC(ll, A, N);\n\n  vi F = {1, 2};\n  while\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2167.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2167.test.cpp
- /verify/test/3_yukicoder/2167.test.cpp.html
