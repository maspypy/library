...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1025.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1025\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/3_yukicoder/1025.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \n  }\r\n  return -1;\r\n}\r\n#line 7 \"test/3_yukicoder/1025.test.cpp\"\n\nusing\
    \ mint = modint107;\n\nvoid solve() {\n  LL(p, n, k, b);\n  const int g = primitive_root(p);\n\
    \  vc<int> EXP(p - 1);\n  vc<int> LOG(p);\n  {\n    EXP[0] = 1;\n    FOR(i, p\
    \ - 2) EXP[i + 1] = EXP[i] * ll(g) % p;\n    FOR(i, p - 1) LOG[EXP[i]] = i;\n\
    \  }\n  k = gcd(k, p - 1);\n  vc<int> root(p);\n  FOR(x, 1, p) {\n    int e =\
    \ LOG[x];\n    e %= k;\n    root[x] = EXP[e];\n  }\n\n  vc<int> S;\n  FOR(i, 0,\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1025.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1025.test.cpp
- /verify/test/3_yukicoder/1025.test.cpp.html
