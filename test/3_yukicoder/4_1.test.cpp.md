...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/4_1.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/4\"\
    ...
    \n    vc<int> res;\r\n    while (x) {\r\n      int i = par[x];\r\n      res.eb(i);\r\
    \n      x -= vals[i];\r\n      if (x < 0) x += mod;\r\n    }\r\n    reverse(all(res));\r\
    \n    return res;\r\n  }\r\n};\r\n#line 5 \"test/3_yukicoder/4_1.test.cpp\"\n\n\
    void solve() {\n  LL(N);\n  VEC(int, A, N);\n  ll S = SUM<ll>(A);\n  Modular_Subset_Sum\
    \ MSS(S + 1, A);\n  if (MSS[S / 2] && S % 2 == 0) {\n    print(\"possible\");\n\
    \  } else {\n    print(\"impossible\");\n  }\n}\n\nsigned main() {\n  cin.tie(nullptr);\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/4_1.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/4_1.test.cpp
- /verify/test/3_yukicoder/4_1.test.cpp.html
