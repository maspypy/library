...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2258.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2258\"\
    ...
    \ 6 \"test/3_yukicoder/2258.test.cpp\"\n\nvoid solve() {\n  LL(N);\n  Graph<int,\
    \ 0> G(N);\n  G.read_tree(0, 0);\n  VEC(int, A, N);\n\n  Tree<decltype(G)> tree(G);\n\
    \  Static_TopTree<decltype(tree)> STT(tree);\n\n  auto merge = [&](vc<int>& A,\
    \ vc<int>& B) -> pair<vc<int>, vc<int>> {\n    vc<int> C;\n    vc<int> left;\n\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2258\"\n#include \"my_template.hpp\"\
    ...
    \ (kk == -1 ? STT.A[k] : kk);\n    };\n    return dfs(dfs, 2 * N - 2, L, R, delta,\
    \ 0, 0);\n  };\n\n  ll X_SUM = 0;\n  INT(Q);\n  FOR(Q) {\n    LL(aa, bb, kk, delta);\n\
    \    ll a = (aa + X_SUM) % N;\n    ll b = (bb + 2 * X_SUM) % N;\n    int mod =\
