...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1813.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1813\"\
    ...
    \ to);\n  }\n  DAG.build();\n  return DAG;\n}\n#line 5 \"test/3_yukicoder/1813.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M);\n  Graph<int, 1> G(N);\n  G.read_graph(M);\n\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1813.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1813.test.cpp
- /verify/test/3_yukicoder/1813.test.cpp.html
