...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1216_2.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1216\"\
    ...
    \ <typename TREE, typename Monoid, bool edge>\nstruct Static_Tree_Monoid {\n \
    ...
    \ f_v);\n    } else {\n      auto f_e = [&](int i) -> X {\n        return (i ==\
    \ 0 ? MX::id() : f(tree.v_to_e(tree.V[i])));\n      };\n      seg.build(N, f_e);\n\
    \      if constexpr (!MX::commute) seg_r.build(N, f_e);\n    }\n  }\n\n  X prod_path(int\
    \ u, int v) {\n    auto pd = tree.get_path_decomposition(u, v, edge);\n    X val\
    \ = MX::id();\n    for (auto &&[a, b] : pd) {\n      val = MX::op(val, get_prod(a,\
    ...
    \ R = prev(R); }\r\n    return pos;\r\n  }\r\n};\r\n#line 7 \"test/3_yukicoder/1216_2.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, Q);\n  Graph<ll, 0> G(N);\n  G.read_tree(1);\n  Tree<decltype(G)>\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1216_2.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1216_2.test.cpp
- /verify/test/3_yukicoder/1216_2.test.cpp.html
