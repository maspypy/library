...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1875.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1875\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/3_yukicoder/1875.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ B.eb(mint(k));\n  return sum_of_exp_bx(N, A, B);\n}\n#line 9 \"test/3_yukicoder/1875.test.cpp\"\
    \n\nusing mint = modint998;\n\nvoid solve() {\n  LL(N, M);\n  using poly = vc<mint>;\n\
    \  vc<mint> A(N), B(N);\n  vi C(N);\n  FOR(i, N) {\n    LL(a, b, c);\n    A[i]\
    \ = a, B[i] = b, C[i] = c;\n  }\n  poly f = product_of_pow_of_linear(M, A, B,\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1875.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1875.test.cpp
- /verify/test/3_yukicoder/1875.test.cpp.html
