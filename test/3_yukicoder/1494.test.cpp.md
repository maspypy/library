...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1494.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1494\"\
    ...
    \ = f_ev(X, v);\n    }\n  }\n};\n#line 7 \"test/3_yukicoder/1494.test.cpp\"\n\n\
    void solve() {\n  LL(N);\n  STR(S);\n  Graph<char, 0> G(N);\n  G.read_tree(1);\n\
    \  Tree<decltype(G)> tree(G);\n\n  // \u6D88\u8CBB\u3057\u305F S \u306E\u6587\u5B57\
    \u6570 \u2192 LCS\n  using Data = vc<int>;\n  Data id = vc<int>(len(S) + 1);\n\
    \n  auto fee = [&](Data x, Data y) -> Data {\n    FOR(i, len(S) + 1) chmax(x[i],\
    \ y[i]);\n    return x;\n  };\n  auto fev = [&](Data x, int v) -> Data { return\
    \ x; };\n  // e \u306F v \u304B\u3089\u51FA\u308B\u6709\u5411\u8FBA\n  auto fve\
    \ = [&](Data x, int r, int nxt_r) -> Data {\n    int eid = tree.get_eid(r, nxt_r);\n\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1494\"\n#include \"my_template.hpp\"\
    ...
    \u3089\u51FA\u308B\u6709\u5411\u8FBA\n  auto fve = [&](Data x, int r, int nxt_r)\
    \ -> Data {\n    int eid = tree.get_eid(r, nxt_r);\n    char c = G.edges[eid].cost;\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1494.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1494.test.cpp
- /verify/test/3_yukicoder/1494.test.cpp.html
