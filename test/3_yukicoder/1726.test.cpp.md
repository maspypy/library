...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1726.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1726\"\
    ...
    \  }\n};\n#line 5 \"test/3_yukicoder/1726.test.cpp\"\n\nvoid solve() {\n  LL(N,\
    \ M);\n  ll ANS = 0;\n  VEC(ll, P, N);\n  VEC(pi, AB, N);\n  VEC(pi, CD, M);\n\
    \n  FOR(2) {\n    for (auto&& [a, b]: AB) a = -a;\n    FOR(2) {\n      for (auto&&\
    \ [a, b]: AB) b = -b;\n      HashMap<ll> MP(N * M);\n      FOR(i, N) FOR(j, M)\
    \ {\n        auto [a, b] = AB[i];\n        auto [c, d] = CD[j];\n        ll key\
    \ = ((a - c) << 32) + (b - d);\n        MP[key] += P[i];\n      }\n      MP.enumerate_all([&](auto\
    \ k, auto v) { chmax(ANS, v); });\n    }\n  }\n  print(ANS);\n}\n\nsigned main()\
    \ {\n  solve();\n  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1726.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1726.test.cpp
- /verify/test/3_yukicoder/1726.test.cpp.html
