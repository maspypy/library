...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1036_3.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1036\"\
    ...
    \ { return 0; }\n  static constexpr bool commute = true;\n};\n#line 6 \"test/3_yukicoder/1036_3.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  VEC(ll, A, N);\n  Sliding_Window_Aggregation<Monoid_Gcd<ll>>\
    \ swag;\n  ll R = 0;\n  ll ANS = 0;\n  FOR(L, N) {\n    chmax(R, L);\n    while\
    \ (R < N && gcd(swag.prod(), A[R]) != 1) swag.push(A[R++]);\n    ANS += N - R;\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1036_3.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1036_3.test.cpp
- /verify/test/3_yukicoder/1036_3.test.cpp.html
