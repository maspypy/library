...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1383.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1383\"\
    ...
    \ dat.eb(key[i], val[i]);\r\n    }\r\n    build(2 * len(dat));\r\n    for (auto&\
    \ [a, b]: dat) (*this)[a] = b;\r\n  }\r\n};\n#line 5 \"test/3_yukicoder/1383.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, K, M);\n\n  HashMap<int> MP(1 << 20);\n  FOR(A, 1,\
    \ 1 << 20) {\n    vi X;\n    ll prod = A;\n    FOR(B, 1, 100) {\n      prod =\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1383.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1383.test.cpp
- /verify/test/3_yukicoder/1383.test.cpp.html
