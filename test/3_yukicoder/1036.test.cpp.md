...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1036.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1036\"\
    ...
    \ static constexpr bool commute = true;\n};\n#line 7 \"test/3_yukicoder/1036.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  VEC(ll, A, N);\n  auto f = [&](ll L, ll R) ->\
    \ ll { return 0; };\n  Dynamic_SegTree<Monoid_Gcd<ll>, false, decltype(f)> seg(0,\
  ...
  requiredBy: []
  timestamp: '2025-09-05 06:12:20+09:00'
