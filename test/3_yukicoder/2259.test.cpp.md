...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/2259
    links:
    - https://yukicoder.me/problems/no/2259
  bundledCode: "#line 1 \"test/3_yukicoder/2259.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2259\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 4 \"test/3_yukicoder/2259.test.cpp\"\
    ...
    \ break;\n  }\n  int y = (ll(a) * x + b) % mod;\n  return {L + x, y};\n}\n#line\
    \ 6 \"test/3_yukicoder/2259.test.cpp\"\n\nvoid solve() {\n  LL(L, R, C);\n  auto\
    \ [x, fx] = min_of_linear(L, R + 1, -C, 0, 1000);\n  print(fx);\n}\n\nsigned main()\
    \ {\n  solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2259\"\n#include \"my_template.hpp\"\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2259.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2259.test.cpp
- /verify/test/3_yukicoder/2259.test.cpp.html
