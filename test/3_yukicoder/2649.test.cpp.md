...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2649.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2649\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/3_yukicoder/2649.test.cpp\"\n\
    ...
    }\n#endif\n#line 6 \"test/3_yukicoder/2649.test.cpp\"\n\nusing B = BigInteger;\n\
    \nvoid solve() {\n  B x;\n  read(x);\n  x = x * x + x;\n  x = x.divmod(2).fi;\n\
    \  INT(mod);\n  ll ANS = x.divmod(mod).se;\n  print(ANS);\n}\n\nsigned main()\
    \ {\n  INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2649\"\n#include \"my_template.hpp\"\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2649.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2649.test.cpp
- /verify/test/3_yukicoder/2649.test.cpp.html
