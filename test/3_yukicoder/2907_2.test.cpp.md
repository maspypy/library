...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2907_2.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2907\"\
    ...
    \ bh = b >> 16;\r\n  u16 c = prod(al, bl);\r\n  return u32(prod(u16(al ^ ah),\
    \ u16(bl ^ bh)) ^ c) << 16 | (p16_15(ah, bh) ^ c);\r\n}\r\nu64 prod(u64 a, u64\
    \ b) {\r\n  u32 al = a & 0xffffffff, ah = a >> 32, bl = b & 0xffffffff, bh = b\
    ...
    \ a) { return SR[0][a & 65535] ^ SR[1][a >> 16]; }\r\nu64 sqrt(u64 a) { return\
    \ SR[0][a & 65535] ^ SR[1][a >> 16 & 65535] ^ SR[2][a >> 32 & 65535] ^ SR[3][a\
    \ >> 48 & 65535]; }\r\n\r\n// inv: 2^16 \u306E\u5171\u5F79\u304C 2^16+1 \u3067\
    \u3042\u308B\u3053\u3068\u306A\u3069\u3092\u4F7F\u3046. x^{-1}=y(xy)^{-1} \u3068\
    \u3044\u3046\u8981\u9818.\r\nu16 inverse(u16 a) { return E[65535 - L[a]]; }\r\n\
    u32 inverse(u32 a) {\r\n  if (a < 65536) return inverse(u16(a));\r\n  u16 al =\
    \ a & 65535, ah = a >> 16;\r\n  u16 norm = prod(al, al ^ ah) ^ E[L[ah] * 2 + 3];\r\
    \n  int k = 65535 - L[norm];\r\n  al = (al ^ ah ? E[L[al ^ ah] + k] : 0), ah =\
    \ E[L[ah] + k];\r\n  return al | u32(ah) << 16;\r\n}\r\nu64 inverse(u64 a) {\r\
