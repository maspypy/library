...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/686.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/686\"\
    ...
    \ X.new_node(infty<int>));\n    LL(L, R);\n    // L\u672A\u6E80 / R \u672A\u6E80\
    \n    np a, b, c, c1, c2;\n    auto check_L = [&](int e) -> bool { return e <\
    \ L; };\n    auto check_R = [&](int e) -> bool { return e < R; };\n    tie(a,\
    \ root) = X.split_max_right(root, check_L);\n    tie(b, c) = X.split_max_right(root,\
    \ check_R);\n    tie(c1, c2) = X.split(c, 1);\n    b = X.apply(b, 1);\n    c1\
    \ = X.set(c1, 0, L);\n    root = X.merge4(a, c1, b, c2);\n  }\n  auto check =\
    \ [&](int e) -> bool { return e < infty<int>; };\n  auto [n1, n2] = X.split_max_right(root,\
