...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1303.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1303\"\
    ...
    \ yes(!t); }\r\n#line 5 \"test/3_yukicoder/1303.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ - 1) A[i].resize(N - 1), B[i].resize(N - 1);\n  auto f = det_A_plus_xB<mint>(A,\
    \ B);\n  print(0);\n  print(f[0] + f[1]);\n}\n\nsigned main() {\n  solve();\n\
    \  return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1303\"\n\n#include \"\
    ...
    \    print(ans);\n    print(cf * ANS);\n    return;\n  }\n\n  // \u5168\u4F53\u304C\
    \u9023\u7D50\u306E\u3068\u304D\n  vv(mint, A, N, N);\n  vv(mint, B, N, N);\n \
    \ FOR(i, N) FOR(j, N) A[i][j] = G[i][j];\n  FOR(i, N) FOR(j, i) if (G[i][j] ==\
    \ 0) {\n    B[i][j] = -1;\n    B[j][i] = -1;\n    B[i][i] += 1;\n    B[j][j] +=\
    \ 1;\n  }\n  A.resize(N - 1), B.resize(N - 1);\n  FOR(i, N - 1) A[i].resize(N\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1303.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1303.test.cpp
- /verify/test/3_yukicoder/1303.test.cpp.html
