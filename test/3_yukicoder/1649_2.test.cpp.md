...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1649_2.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1649\"\
    ...
    #line 6 \"test/3_yukicoder/1649_2.test.cpp\"\n\nusing mint = modint998;\n\nstruct\
    ...
    \ : XY) tie(x, y) = mp(-y, x);\n    seg.reset();\n    int root = 0;\n    sort(all(XY));\n\
    \    for (auto&& [x, y] : XY) {\n      mint x2 = (x + y) * (x + y);\n      mint\
    \ x1 = x + y;\n      mint x0 = 1;\n      auto [s0, s1, s2] = seg.prod(root, -LIM,\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1649\"\n#include \"my_template.hpp\"\
    ...
    \ x, X y) {\n    auto& [x0, x1, x2] = x;\n    auto& [y0, y1, y2] = y;\n    return\
    \ {x0 + y0, x1 + y1, x2 + y2};\n  }\n  static constexpr X id() { return {mint(0),\
    \ mint(0), mint(0)}; }\n  static constexpr bool commute = true;\n};\n\nvoid solve()\
    \ {\n  LL(N);\n  VEC(pi, XY, N);\n  ll LIM = 1 << 30;\n\n  Dynamic_SegTree_Sparse<Mono,\
    \ false> seg(-LIM, LIM);\n\n  mint ANS = 0;\n  FOR(4) {\n    for (auto&& [x, y]\
    \ : XY) tie(x, y) = mp(-y, x);\n    seg.reset();\n    int root = 0;\n    sort(all(XY));\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1649_2.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1649_2.test.cpp
- /verify/test/3_yukicoder/1649_2.test.cpp.html
