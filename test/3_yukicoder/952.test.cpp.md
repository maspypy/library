...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/952.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/952\"\
    ...
    \ + 1, infty<T>);\n  FOR(j, N + 1) {\n    int i = I[j];\n    if (i < j) newdp[j]\
    \ = dp[i] + f(i, j);\n  }\n  return newdp;\n}\n#line 6 \"test/3_yukicoder/952.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  VEC(ll, A, N);\n  A.insert(A.begin(), 0);\n\n\
    \  auto Ac = cumsum<ll>(A);\n\n  auto f = [&](ll L, ll R) -> ll {\n    SHOW(L,\
    \ R);\n    ll x = Ac[R] - Ac[L + 1];\n    return x * x;\n  };\n\n  vi dp(N + 2,\
  ...
  requiredBy: []
  timestamp: '2026-07-19 02:49:20+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/3_yukicoder/952.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/952.test.cpp
- /verify/test/3_yukicoder/952.test.cpp.html
