...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1080_2.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1080\"\
    ...
    \n\n// exp(f/g) \u3067 f,g \u304C sparse\ntemplate <typename mint>\nvc<mint> sparse_exp_of_div(int\
    \ N, const vc<mint>& f, const vc<mint>& g) {\n  assert(f[0] == mint(0));\n  assert(g[0]\
    ...
    \  return from_log_differentiation(N, a, b);\n}\n#line 8 \"test/3_yukicoder/1080_2.test.cpp\"\
