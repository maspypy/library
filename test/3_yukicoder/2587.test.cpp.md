...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2587.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2587\"\
    ...
    void Bob(bool t = 1) { Alice(!t); }\n#line 4 \"test/3_yukicoder/2587.test.cpp\"\
    ...
    \    vc_indeg.resize(N);\n    vc_outdeg.resize(N);\n    for (auto&& e : edges)\
    \ {\n      vc_indeg[e.to]++, vc_outdeg[e.frm]++;\n    }\n  }\n};\n#line 7 \"test/3_yukicoder/2587.test.cpp\"\
    ...
    \ f};\n}\n#line 11 \"test/3_yukicoder/2587.test.cpp\"\n\nusing mint = modint998;\n\
    using poly = vc<mint>;\n\nvoid solve() {\n  LL(N, M, S, T);\n  --S, --T;\n  Graph<int,\
