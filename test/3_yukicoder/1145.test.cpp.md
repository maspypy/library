...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1145.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1145\"\
    ...
    \ + 1);\n  den.resize(N + 1);\n  auto f = fps_inv(den);\n  f = convolution(f,\
    \ num);\n  f.resize(N + 1);\n  return f;\n}\n#line 6 \"test/3_yukicoder/1145.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1145.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1145.test.cpp
- /verify/test/3_yukicoder/1145.test.cpp.html
