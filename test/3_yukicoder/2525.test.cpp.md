...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/2525
    links:
    - https://yukicoder.me/problems/no/2525
  bundledCode: "#line 1 \"test/3_yukicoder/2525.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2525\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test/3_yukicoder/2525.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    }\n#endif\n#line 6 \"test/3_yukicoder/2525.test.cpp\"\n\nvoid solve() {\n  BigInteger\
    \ A, B;\n  read(A, B);\n  bool ok = A.divmod(2).se == B.divmod(2).se;\n  print(ok\
    \ ? \"Possible\" : \"Impossible\");\n}\n\nsigned main() {\n  int T = 1;\n  //\
    \ INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2525\"\n#include \"my_template.hpp\"\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2525.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2525.test.cpp
- /verify/test/3_yukicoder/2525.test.cpp.html
