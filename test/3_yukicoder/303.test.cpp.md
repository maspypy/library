...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/303.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/303\"\
    ...
    \ TIDAK(bool t = 1) { YES(!t); }\r\n#line 4 \"test/3_yukicoder/303.test.cpp\"\n\
    ...
    }\n#endif\n#line 7 \"test/3_yukicoder/303.test.cpp\"\n\nusing B = BigInteger;\n\
    \nvoid solve() {\n  LL(N);\n  if (N == 2) {\n    print(3);\n    print(\"INF\"\
    );\n    return;\n  }\n  B x = fibonacci<B>(N);\n  if (N % 2 == 0) {\n    B y =\
    \ fibonacci<B>(N / 2);\n    x -= y * y;\n  }\n  print(N);\n  print(x);\n}\n\n\
    signed main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/303.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/303.test.cpp
- /verify/test/3_yukicoder/303.test.cpp.html
