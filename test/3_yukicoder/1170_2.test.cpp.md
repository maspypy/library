...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1170_2.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1170\"\
    ...
    \        if (to == -1) break;\n        uf.merge(v, to);\n        que.eb(to);\n\
    \        done[to] = 1;\n        set_used(to);\n      }\n    }\n  }\n  return uf;\n\
    }\n#line 5 \"test/3_yukicoder/1170_2.test.cpp\"\n\nvoid solve() {\n  LL(N, A,\
    ...
    \ {\n      --it;\n      auto [x, idx] = *it;\n      if (x >= X[v] - B) return\
    \ idx;\n    }\n    return -1;\n  };\n  auto uf = blackbox_unionfind(N, set_used,\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1170_2.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1170_2.test.cpp
- /verify/test/3_yukicoder/1170_2.test.cpp.html
