...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1533.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1533\"\
    ...
    \ {\n    for (auto&& [j, x]: dat) {\n      if (i >= j) f[i] += x * f[i - j];\n\
    \    }\n  }\n  return f;\n}\n#line 6 \"test/3_yukicoder/1533.test.cpp\"\nusing\
    \ mint = modint998;\n\nvoid solve() {\n  LL(N, M, K);\n  if (M == 1 && K == 1)\
    \ return print(0);\n\n  if (M == K) { --M; }\n  mint R = 0;\n  FOR(x, -M, M +\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1533.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1533.test.cpp
- /verify/test/3_yukicoder/1533.test.cpp.html
