...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/1874
    links:
    - https://yukicoder.me/problems/no/1874
  bundledCode: "#line 1 \"test/3_yukicoder/1874.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1874\"\
    ...
    \  }\n};\n#line 5 \"test/3_yukicoder/1874.test.cpp\"\n\nstruct Grp {\n  using\
    ...
    \ X;\n\n  FOR(N) {\n    LL(x, y);\n    bit_raw[x] = Grp::op(bit_raw[x], {1, x,\
    \ y, x * y});\n    Y_to_X[y].eb(x);\n    X.eb(x);\n  }\n  UNIQUE(X);\n\n  FenwickTree<Grp>\
    \ bit(bit_raw);\n\n  ll ANS = 1LL << 60;\n  unordered_map<int, ll> MP;\n  FOR(y,\
    \ LIM + 1) {\n    if (len(Y_to_X[y]) == 0) continue;\n    for (auto&& x: Y_to_X[y])\
    \ { bit.add(x, {-2, -2 * x, -2 * y, -2 * x * y}); }\n    MP.clear();\n\n    auto\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1874.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1874.test.cpp
- /verify/test/3_yukicoder/1874.test.cpp.html
