...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/2604.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2604\"\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 4 \"test/3_yukicoder/2604.test.cpp\"\n\
    \n#line 2 \"flow/mincostflow.hpp\"\n\n// atcoder library \u306E\u3082\u306E\u3092\
    \u6539\u5909\nnamespace internal {\ntemplate <class E>\nstruct csr {\n  vector<int>\
    ...
    #line 6 \"test/3_yukicoder/2604.test.cpp\"\n\nvoid solve() {\n  LL(K, N, M);\n\
    \  VEC(int, A, K);\n  for (auto& a: A) --a;\n  VEC(int, B, N);\n\n  int s = N,\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2604.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2604.test.cpp
- /verify/test/3_yukicoder/2604.test.cpp.html
