...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1216.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1216\"\
    ...
    \ R = prev(R); }\r\n    return pos;\r\n  }\r\n};\r\n#line 7 \"test/3_yukicoder/1216.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, Q);\n  Graph<ll, 0> G(N);\n  G.read_tree(1);\n  Tree<decltype(G)>\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1216.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1216.test.cpp
- /verify/test/3_yukicoder/1216.test.cpp.html
