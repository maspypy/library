...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/2243
    links:
    - https://yukicoder.me/problems/no/2243
  bundledCode: "#line 1 \"test/3_yukicoder/2243.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2243\"\
    ...
    \n\r\n  reverse(all(f));\r\n  mint ia = a.inverse();\r\n  mint pow = 1;\r\n  FOR(i,\
    \ n) f[i] *= pow, pow *= ia;\r\n  return f;\r\n}\r\n#line 8 \"test/3_yukicoder/2243.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/2243.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/2243.test.cpp
- /verify/test/3_yukicoder/2243.test.cpp.html
