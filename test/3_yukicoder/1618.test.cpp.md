...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1618.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1618\"\
    ...
    }\r\n#line 5 \"test/3_yukicoder/1618.test.cpp\"\n\nvoid solve() {\n  LL(N);\n\
    \  VEC(ll, A, N);\n  VEC(ll, B, N);\n  A.insert(A.begin(), 0);\n  B.insert(B.begin(),\
    \ 0);\n  vc<ll> f(N + 1);\n  iota(all(f), 0);\n  A = convolution(A, f);\n  B =\
    \ convolution(B, f);\n  FOR(i, len(A)) A[i] += B[i];\n  A.erase(A.begin());\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1618.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1618.test.cpp
- /verify/test/3_yukicoder/1618.test.cpp.html
