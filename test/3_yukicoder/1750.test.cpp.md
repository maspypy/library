...
data:
  ...
  bundledCode: "#line 1 \"test/3_yukicoder/1750.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1750\"\
    ...
    #line 6 \"test/3_yukicoder/1750.test.cpp\"\n\nusing mint = modint998;\n\nvoid\
    \ solve() {\n  LL(N, M, T);\n  vv(mint, A, N, N);\n  FOR(M) {\n    LL(a, b);\n\
    \    A[a][b] = 1;\n    A[b][a] = 1;\n  }\n  A = matrix_pow(A, T);\n  print(A[0][0]);\n\
  ...
  verifiedWith: []
documentation_of: test/3_yukicoder/1750.test.cpp
layout: document
redirect_from:
- /verify/test/3_yukicoder/1750.test.cpp
- /verify/test/3_yukicoder/1750.test.cpp.html
