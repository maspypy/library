...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/tournament.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \ others.begin(), others.end()), ...);\n  return res;\n}\n#endif\n#line 3 \"test/mytest/tournament.test.cpp\"\
    ...
    \ Y[j])) {\n          P.eb(X[i++]);\n        } else {\n          P.eb(Y[j++]);\n\
    \        }\n      }\n    }\n    return P;\n  };\n  return dfs(dfs, 0, n);\n}\n\
    #line 6 \"test/mytest/tournament.test.cpp\"\n\nvoid test() {\n  auto gen = [&](int\
    \ N) -> vvc<bool> {\n    vv(bool, mat, N, N);\n    FOR(i, N) FOR(j, i) {\n   \
    \   bool b = RNG(0, 2);\n      if (b) mat[i][j] = 1;\n      if (!b) mat[j][i]\
    \ = 1;\n    }\n    return mat;\n  };\n\n  FOR(10) {\n    FOR(N, 1, 20) {\n   \
...
layout: document
redirect_from:
- /verify/test/mytest/tournament.test.cpp
- /verify/test/mytest/tournament.test.cpp.html
