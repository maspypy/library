...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/enumerate_multisets.test.cpp\"\n#define PROBLEM\
    ...
    \ yes(!t); }\n#line 4 \"test/mytest/enumerate_multisets.test.cpp\"\n\n#line 1\
    \ \"enumerate/multiset.hpp\"\n// [0, K) \u5185\u306E\u5E83\u7FA9\u5358\u8ABF\u5897\
    \u52A0\u5217\r\ntemplate <typename F>\r\nvoid enumerate_multiset(int K, int N,\
    \ F query) {\r\n  vc<int> A(N);\r\n  auto dfs = [&](auto& dfs, int p, int s) ->\
    \ void {\r\n    if (p == N) {\r\n      query(A);\r\n      return;\r\n    }\r\n\
    \    FOR(x, s, K) {\r\n      A[p] = x;\r\n      dfs(dfs, p + 1, x);\r\n    }\r\
  ...
  requiredBy: []
  timestamp: '2023-01-23 22:36:21+09:00'
