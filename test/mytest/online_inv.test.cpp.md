...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/online_inv.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \ g_i, f_i);\n  }\n};\n#line 8 \"test/mytest/online_inv.test.cpp\"\n\nusing mint\
    \ = modint998;\n\nvoid test() {\n  auto gen = [&](int n) -> vc<mint> {\n    vc<mint>\
    \ f(n + 1);\n    FOR(i, n + 1) f[i] = RNG(mint::get_mod());\n    return f;\n \
    \ };\n  FOR(n, 1000) {\n    vc<mint> f = gen(n);\n    f[0] = mint(1);\n    vc<mint>\
    \ g = fps_inv<mint>(f);\n    Online_Inv<mint> X;\n    FOR(i, n + 1) { assert(g[i]\
    \ == X.query(i, f[i])); }\n  }\n}\n\nvoid solve() {\n  LL(a, b);\n  print(a +\
    \ b);\n}\n\nsigned main() {\n  test();\n  solve();\n\n  return 0;\n}\n"
...
layout: document
redirect_from:
- /verify/test/mytest/online_inv.test.cpp
- /verify/test/mytest/online_inv.test.cpp.html
