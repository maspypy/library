...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/add_chmin_chmax.test.cpp\"\n#define PROBLEM\
    ...
    \  static constexpr bool commute = 0;\n};\n#line 5 \"test/mytest/add_chmin_chmax.test.cpp\"\
    \n\nvoid test() {\n  int N = RNG(1, 100);\n  vc<int> X(N);\n  FOR(i, N) X[i] =\
...
layout: document
redirect_from:
- /verify/test/mytest/add_chmin_chmax.test.cpp
- /verify/test/mytest/add_chmin_chmax.test.cpp.html
