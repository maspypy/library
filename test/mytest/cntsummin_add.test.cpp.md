...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/cntsummin_add.test.cpp\"\n#define PROBLEM \"\
    ...
    \ while ((r & -r) != r);\n    return 0;\n  }\n};\n#line 7 \"test/mytest/cntsummin_add.test.cpp\"\
    \n\nvoid test() {\n  int N = RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] =\
    \ RNG(1, 100);\n  using AM = ActedMonoid_CntSumMin_Add<ll>;\n  using Mono = typename\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n#include \"my_template.hpp\"\
    \n#include \"other/io.hpp\"\n#include \"alg/acted_monoid/cntsummin_add.hpp\"\n\
    #include \"random/base.hpp\"\n#include \"ds/lazysegtree.hpp\"\n\nvoid test() {\n\
    \  int N = RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] = RNG(1, 100);\n  using\
    \ AM = ActedMonoid_CntSumMin_Add<ll>;\n  using Mono = typename AM::Monoid_X;\n\
...
layout: document
redirect_from:
- /verify/test/mytest/cntsummin_add.test.cpp
- /verify/test/mytest/cntsummin_add.test.cpp.html
