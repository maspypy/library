...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/digit_sum.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \ }\n\nll RNG(ll l, ll r) { return l + RNG_64() % (r - l); }\n#line 6 \"test/mytest/digit_sum.test.cpp\"\
    \n\nint naive(u64 x) {\n  int res = 0;\n  while (x) {\n    res += x % 10;\n  \
...
layout: document
redirect_from:
- /verify/test/mytest/digit_sum.test.cpp
- /verify/test/mytest/digit_sum.test.cpp.html
