...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/coprime_factorization.test.cpp\"\n#define PROBLEM\
    ...
    \ others.end()), ...);\n}\n#endif\n#line 3 \"test/mytest/coprime_factorization.test.cpp\"\
    ...
    \ }\n  }\n  return {basis, res};\n}\n#line 6 \"test/mytest/coprime_factorization.test.cpp\"\
    \n\nvoid test() {\n  FOR(N, 0, 100) {\n    vc<ll> dat(N);\n    FOR(i, N) dat[i]\
...
layout: document
redirect_from:
- /verify/test/mytest/coprime_factorization.test.cpp
- /verify/test/mytest/coprime_factorization.test.cpp.html
