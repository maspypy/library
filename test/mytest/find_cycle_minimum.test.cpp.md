...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/find_cycle_minimum.test.cpp\"\n#define PROBLEM\
    ...
    \  return B;\n}\n#endif\n#line 3 \"test/mytest/find_cycle_minimum.test.cpp\"\n\
    ...
    \n    int y = e.frm + e.to - x;\r\n    if (y == a) break;\r\n    vs.eb(y);\r\n\
    \    es.eb(par[y]);\r\n  }\r\n  return {vs, es};\r\n}\r\n#line 7 \"test/mytest/find_cycle_minimum.test.cpp\"\
    \n\ntemplate <int DIRECTED>\nvoid test() {\n  FOR(N, 1, 15) {\n    FOR(1000) {\n\
  ...
  verifiedWith: []
documentation_of: test/mytest/find_cycle_minimum.test.cpp
layout: document
redirect_from:
- /verify/test/mytest/find_cycle_minimum.test.cpp
- /verify/test/mytest/find_cycle_minimum.test.cpp.html
