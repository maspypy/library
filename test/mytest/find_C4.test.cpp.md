...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/find_C4.test.cpp\"\n// competitive-verifier:\
    ...
    \  return B;\n}\n#endif\n#line 3 \"test/mytest/find_C4.test.cpp\"\n\n#line 2 \"\
    graph/base.hpp\"\n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T\
    ...
    \ = -1; }\n    }\n  }\n  return {-1, -1, -1, -1};\n}\n#line 7 \"test/mytest/find_C4.test.cpp\"\
    \n\nvoid test() {\n  FOR(N, 20) {\n    FOR(50) {\n      Graph<int, 0> G(N);\n\
  ...
  code: "// competitive-verifier: PROBLEM https://judge.yosupo.jp/problem/aplusb\n\
    ...
    \ {\n  FOR(N, 20) {\n    FOR(50) {\n      Graph<int, 0> G(N);\n      for (auto&\
    \ [a, b]: random_graph<false>(N, true)) G.add(a, b);\n      G.build();\n     \
    \ vv(int, adj, N, N);\n      for (auto& e: G.edges) adj[e.frm][e.to] += 1, adj[e.to][e.frm]\
    \ += 1;\n      auto [a, b, c, d] = find_C4(G);\n      ll cnt = count_C3_C4(G).se;\n\
    \      if (cnt == 0) {\n        assert(a == -1);\n      } else {\n        assert(adj[a][b]\
    \ && adj[b][c] && adj[c][d] && adj[d][a]);\n      }\n    }\n  }\n}\n\nvoid solve()\
    \ {\n  int a, b;\n  cin >> a >> b;\n  cout << a + b << \"\\n\";\n}\n\nsigned main()\
    \ {\n  test();\n  solve();\n  return 0;\n}\n"
  dependsOn:
  - my_template.hpp
  ...
  verifiedWith: []
documentation_of: test/mytest/find_C4.test.cpp
layout: document
redirect_from:
- /verify/test/mytest/find_C4.test.cpp
- /verify/test/mytest/find_C4.test.cpp.html
