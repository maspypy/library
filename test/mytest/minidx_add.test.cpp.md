...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/minidx_add.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \ getall:\", get_all()); }\n};\n#line 7 \"test/mytest/minidx_add.test.cpp\"\n\n\
    void test() {\n  int N = RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] = RNG(1,\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n#include \"my_template.hpp\"\
    ...
    \ = Lazy_MinIdx_Add<int>;\n  using Mono = typename Lazy::MX;\n  LazySegTree<Lazy>\
    \ seg(N, [&](int i) -> typename Mono::value_type {\n    return {A[i], i};\n  });\n\
    \  int Q = RNG(1, 100);\n  FOR(Q) {\n    ll t = RNG(0, 2);\n    ll L = RNG(0,\
    \ N);\n    ll R = RNG(0, N);\n    if (L > R) swap(L, R);\n    ++R;\n    if (t\
    \ == 1) {\n      ll x = RNG(1, 100);\n      FOR(i, L, R) A[i] += x;\n      seg.apply(L,\
...
layout: document
redirect_from:
- /verify/test/mytest/minidx_add.test.cpp
- /verify/test/mytest/minidx_add.test.cpp.html
