...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/pytagorean_triples.test.cpp\"\n#define PROBLEM\
    ...
    \ { yes(!t); }\r\n#line 5 \"test/mytest/pytagorean_triples.test.cpp\"\n\n#line\
    \ 1 \"nt/pytagorean_triple.hpp\"\n\n/*\nc <= LIM, (a,b,c) \u3068 (b,a,c) \u306F\
    \u540C\u4E00\u8996, O(LIM) \u6642\u9593\n\u30FBLIM = 10^8\uFF1A\u4E92\u3044\u306B\
    ...
    \      while (z <= LIM) {\n        f(x, y, z);\n        x += min(a, b), y += max(a,\
    \ b), z += c;\n      }\n    }\n  }\n}\n#line 7 \"test/mytest/pytagorean_triples.test.cpp\"\
    \n\nvoid test() {\n  int LIM = 10000;\n  int A = 0, B = 0;\n  FOR(y, 1, LIM) {\n\
    \    FOR(x, 1, y) {\n      int z = sqrtl(x * x + y * y);\n      if (z > LIM) break;\n\
...
layout: document
redirect_from:
- /verify/test/mytest/pytagorean_triples.test.cpp
- /verify/test/mytest/pytagorean_triples.test.cpp.html
