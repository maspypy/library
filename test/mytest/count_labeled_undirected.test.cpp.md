...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/count_labeled_undirected.test.cpp\"\n#define\
    ...
    \  return B;\n}\n#endif\n#line 4 \"test/mytest/count_labeled_undirected.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/mytest/count_labeled_undirected.test.cpp
- /verify/test/mytest/count_labeled_undirected.test.cpp.html
