...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/stirling_1_suffix.test.cpp\"\n#define PROBLEM\
    ...
    \n}\r\n#line 5 \"test/mytest/stirling_1_suffix.test.cpp\"\n\nvoid test(ll n) {\n\
    \  using mint = modint998;\n  vc<mint> A = stirling_number_1_n<mint>(n);\n  vc<mint>\
    \ B = stirling_number_1_suffix<mint>(n, n);\n}\n\nvoid solve() {\n  int a, b;\n\
    \  cin >> a >> b;\n  cout << a + b << \"\\n\";\n}\nint main() {\n  FOR(n, 1, 100)\
    \ test(n);\n  solve();\n}\n"
  ...
  verifiedWith: []
documentation_of: test/mytest/stirling_1_suffix.test.cpp
layout: document
redirect_from:
- /verify/test/mytest/stirling_1_suffix.test.cpp
- /verify/test/mytest/stirling_1_suffix.test.cpp.html
