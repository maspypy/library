...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/cntsummin_set.test.cpp\"\n#define PROBLEM \"\
    ...
    \ getall:\", get_all()); }\n};\n#line 7 \"test/mytest/cntsummin_set.test.cpp\"\
    \n\nvoid test() {\n  int N = RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] =\
    \ RNG(1, 100);\n  using Lazy = Lazy_CntSumMin_Set<ll, -1>;\n  using Mono = typename\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n#include \"my_template.hpp\"\
    \n#include \"other/io.hpp\"\n#include \"alg/lazy/cntsummin_set.hpp\"\n#include\
    \ \"random/base.hpp\"\n#include \"ds/lazysegtree.hpp\"\n\nvoid test() {\n  int\
    \ N = RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] = RNG(1, 100);\n  using\
    \ Lazy = Lazy_CntSumMin_Set<ll, -1>;\n  using Mono = typename Lazy::MX;\n  LazySegTree<Lazy_CntSumMin_Set<ll,\
  ...
  verifiedWith: []
documentation_of: test/mytest/cntsummin_set.test.cpp
layout: document
redirect_from:
- /verify/test/mytest/cntsummin_set.test.cpp
- /verify/test/mytest/cntsummin_set.test.cpp.html
