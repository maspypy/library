...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/power_projection.test.cpp\"\n#define PROBLEM\
    ...
    \  return B;\n}\n#endif\n#line 3 \"test/mytest/power_projection.test.cpp\"\n\n\
    ...
    \ yes(!t); }\r\n#line 5 \"test/mytest/power_projection.test.cpp\"\n\n#line 2 \"\
    ...
    \n}\r\n#line 10 \"test/mytest/power_projection.test.cpp\"\n\nusing mint = modint998;\n\
    \nvoid test() {\n  FOR(100) {\n    FOR(N, 10) FOR(K, 10) {\n      vc<mint> f(K\
...
layout: document
redirect_from:
- /verify/test/mytest/power_projection.test.cpp
- /verify/test/mytest/power_projection.test.cpp.html
