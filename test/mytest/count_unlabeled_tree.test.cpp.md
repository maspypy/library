...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/count_unlabeled_tree.test.cpp\"\n#define PROBLEM\
    ...
    \  return B;\n}\n#endif\n#line 3 \"test/mytest/count_unlabeled_tree.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/mytest/count_unlabeled_tree.test.cpp
- /verify/test/mytest/count_unlabeled_tree.test.cpp.html
