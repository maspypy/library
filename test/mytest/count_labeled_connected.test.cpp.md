...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/count_labeled_connected.test.cpp\"\n#define\
    ...
    \  return B;\n}\n#endif\n#line 4 \"test/mytest/count_labeled_connected.test.cpp\"\
    ...
    \     26704,\n                     1866256,\n                     251548592,\n\
    \                     66296291072,\n                     34496488594816};\n  FOR(i,\
    \ 1, 11) { assert(F[i] == mint(OEIS_A001187[i])); }\n}\n\nvoid solve() {\n  int\
    \ a, b;\n  cin >> a >> b;\n  cout << a + b << \"\\n\";\n}\n\nsigned main() {\n\
    \  test();\n  solve();\n  return 0;\n}\n"
...
layout: document
redirect_from:
- /verify/test/mytest/count_labeled_connected.test.cpp
- /verify/test/mytest/count_labeled_connected.test.cpp.html
