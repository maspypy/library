...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/bell_number.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \ others.begin(), others.end()), ...);\n  return res;\n}\n#endif\n#line 3 \"test/mytest/bell_number.test.cpp\"\
    \n\n#line 1 \"other/io.hpp\"\n#define FASTIO\r\n#include <unistd.h>\r\n\r\n//\
    ...
    \ _2, _3, _4, NAME, ...) NAME\r\n#define SHOW1(x) print(#x, \"=\", (x)), flush()\r\
    \n#define SHOW2(x, y) print(#x, \"=\", (x), #y, \"=\", (y)), flush()\r\n#define\
    \ SHOW3(x, y, z) print(#x, \"=\", (x), #y, \"=\", (y), #z, \"=\", (z)), flush()\r\
    ...
    \ yes(!t); }\r\n#line 5 \"test/mytest/bell_number.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ N + 1) f[i] *= fact<mint>(i);\n  return f;\n};\n#line 8 \"test/mytest/bell_number.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/mytest/bell_number.test.cpp
layout: document
redirect_from:
- /verify/test/mytest/bell_number.test.cpp
- /verify/test/mytest/bell_number.test.cpp.html
