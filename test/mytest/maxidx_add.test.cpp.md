...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/maxidx_add.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \ getall:\", get_all()); }\n};\n#line 7 \"test/mytest/maxidx_add.test.cpp\"\n\n\
    void test() {\n  int N = RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] = RNG(1,\
    \ 100);\n  using Lazy = Lazy_MaxIdx_Add<int>;\n  using Mono = typename Lazy::MX;\n\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n#include \"my_template.hpp\"\
    \n#include \"other/io.hpp\"\n#include \"alg/lazy/maxidx_add.hpp\"\n#include \"\
...
layout: document
redirect_from:
- /verify/test/mytest/maxidx_add.test.cpp
- /verify/test/mytest/maxidx_add.test.cpp.html
