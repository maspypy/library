...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/max_dot.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \ others.begin(), others.end()), ...);\n  return res;\n}\n#endif\n#line 3 \"test/mytest/max_dot.test.cpp\"\
    \n\n#line 2 \"geo/base.hpp\"\ntemplate <typename T>\nstruct Point {\n  T x, y;\n\
    ...
    ll RNG(ll l, ll r) { return l + RNG_64() % (r - l); }\n#line 9 \"test/mytest/max_dot.test.cpp\"\
    \n\nusing P = Point<ll>;\n\nvoid test() {\n  int N = RNG(3, 10);\n  vc<P> point(N);\n\
  ...
  verifiedWith: []
documentation_of: test/mytest/max_dot.test.cpp
layout: document
redirect_from:
- /verify/test/mytest/max_dot.test.cpp
- /verify/test/mytest/max_dot.test.cpp.html
