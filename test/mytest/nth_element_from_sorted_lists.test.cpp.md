...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/nth_element_from_sorted_lists.test.cpp\"\n#define\
    ...
    \ others.end()), ...);\n}\n#endif\n#line 3 \"test/mytest/nth_element_from_sorted_lists.test.cpp\"\
    ...
    \ntemplate <typename T>\nvoid shuffle(vc<T>& A) {\n  FOR(i, len(A)) {\n    int\
    \ j = RNG(0, i + 1);\n    if (i != j) swap(A[i], A[j]);\n  }\n}\n#line 6 \"test/mytest/nth_element_from_sorted_lists.test.cpp\"\
    ...
    \ i);\n  while (K) {\n    --K;\n    auto [x, i] = POP(que);\n    A[i]++;\n   \
    \ if (K) que.emplace(g(i, A[i]), i);\n  }\n  return A;\n}\n#line 8 \"test/mytest/nth_element_from_sorted_lists.test.cpp\"\
    \n\nvoid test() {\n  ll N = RNG(1, 20);\n  vi S(N);\n  FOR(i, N) S[i] = RNG(0,\
  ...
  verifiedWith: []
documentation_of: test/mytest/nth_element_from_sorted_lists.test.cpp
layout: document
redirect_from:
- /verify/test/mytest/nth_element_from_sorted_lists.test.cpp
- /verify/test/mytest/nth_element_from_sorted_lists.test.cpp.html
