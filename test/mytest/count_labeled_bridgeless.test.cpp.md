...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/count_labeled_bridgeless.test.cpp\"\n#define\
    ...
    \  return B;\n}\n#endif\n#line 3 \"test/mytest/count_labeled_bridgeless.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/mytest/count_labeled_bridgeless.test.cpp
- /verify/test/mytest/count_labeled_bridgeless.test.cpp.html
