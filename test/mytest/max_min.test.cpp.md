...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/max_min.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \ getall:\", get_all()); }\n};\n#line 7 \"test/mytest/max_min.test.cpp\"\n\nvoid\
    \ test() {\n  int N = RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] = RNG(1,\
    \ 100);\n  using Lazy = Lazy_Max_Min<int>;\n  using Mono = typename Lazy::MX;\n\
    \  LazySegTree<Lazy_Max_Min<int>> seg(A);\n  int Q = RNG(1, 100);\n  FOR(Q) {\n\
    \    ll t = RNG(0, 2);\n    ll L = RNG(0, N);\n    ll R = RNG(0, N);\n    if (L\
    \ > R) swap(L, R);\n    ++R;\n    if (t == 1) {\n      ll x = RNG(1, 100);\n \
  ...
  verifiedWith: []
documentation_of: test/mytest/max_min.test.cpp
layout: document
redirect_from:
- /verify/test/mytest/max_min.test.cpp
- /verify/test/mytest/max_min.test.cpp.html
