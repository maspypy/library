...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/summin_add.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \ = MA::unit();\n  }\n};\n#line 7 \"test/mytest/summin_add.test.cpp\"\n\nvoid\
    \ test() {\n  int N = RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] = RNG(1,\
...
layout: document
redirect_from:
- /verify/test/mytest/summin_add.test.cpp
- /verify/test/mytest/summin_add.test.cpp.html
