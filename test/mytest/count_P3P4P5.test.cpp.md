...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/count_P3P4P5.test.cpp\"\n#define PROBLEM \"\
    ...
    \  return B;\n}\n#endif\n#line 3 \"test/mytest/count_P3P4P5.test.cpp\"\n\n#line\
    \ 2 \"graph/base.hpp\"\n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n\
    ...
    \ G[v]) {\n      if (e.frm == e.to) continue;\n      P5[v] += P4[e.to];\n    }\n\
    \    P5[v] -= C4[v] * 2;\n    P5[v] -= C3[v] * 2 * (deg[v] - 3);\n    P5[v] -=\
    \ P3[v] * (deg[v] - 1);\n  }\n  return {P3, P4, P5};\n}\n#line 6 \"test/mytest/count_P3P4P5.test.cpp\"\
    \n\nvoid test() {\n  FOR(N, 20) {\n    FOR(50) {\n      Graph<int, 0> G(N);\n\
...
layout: document
redirect_from:
- /verify/test/mytest/count_P3P4P5.test.cpp
- /verify/test/mytest/count_P3P4P5.test.cpp.html
