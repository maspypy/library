...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/QOJ5445.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    \ yes(!t); }\n#line 4 \"test/mytest/QOJ5445.test.cpp\"\n\n#line 2 \"graph/base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T cost;\n  int id;\n\
    ...
    \   x = f_ee(dp[e.to], x);\r\n        dp[e.to] = f_ev(x, e.to);\r\n      }\r\n\
    \    }\r\n  }\r\n};\r\n#line 8 \"test/mytest/QOJ5445.test.cpp\"\n\n#line 1 \"\
    ...
    \ m \u884C\u5217\u306E transpose\u3002O((n+m)log(n+m)) \u6642\u9593\u3002\n//\
    ...
    \ & mask) >> width) ^ *y;\n        *x = ((*y << width) & mask) ^ *x;\n      }\n\
    \    }\n  }\n  A.resize(m);\n  if (!keep_A) return A;\n  swap(A, tmp);\n  return\
    \ tmp;\n}\n#line 1 \"linalg/xor/solve_linear_xor.hpp\"\n// solve Ax = b \u3092\
    ...
    \ (A[pivot[k]] >> j & 1)) {\n      x |= UINT(1) << k;\n    }\n    res.eb(x);\n\
    \  }\n  if (keep_A) swap(A, tmp);\n  return res;\n}\n#line 13 \"test/mytest/QOJ5445.test.cpp\"\
    ...
    \  }\n\n  /*\n  \u6728 dp \u306E\u72B6\u614B\n  \u30FB\u6DF1\u3055 d \u306E\u3068\
    \u304D\u306B dual space \u306B a \u304C\u8FFD\u52A0\u3055\u308C\u308B (d,a) \u3068\
    \u3044\u3046\u30A4\u30D9\u30F3\u30C8\u306E\u5217\n  \u30FB\u9AD8\u3005 64\n  */\n\
    \  using P = pair<int, u64>;\n  using Data = vc<P>;\n  Data unit = {};\n\n  auto\
    \ fee = [&](Data& x, Data& y) -> Data {\n    // merge sort\n    Data z;\n    auto\
    \ V = Mono::unit();\n    auto add = [&](P& dat) -> void {\n      if (len(V) ==\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n#include \"my_template.hpp\"\
    ...
    \ solve_QOJ_5445(int N, vc<int> par, vvc<u64> dat) {\n  using Mono = Monoid_XorBasis<u64>;\n\
    \  using SP = Mono::value_type;\n  Graph<bool, 0> G(N);\n  FOR(v, 1, N) { G.add(par[v\
    \ - 1] - 1, v); }\n  G.build();\n  Tree<decltype(G)> tree(G);\n\n  vc<SP> dual(N);\n\
    \  FOR(v, N) {\n    SP X = Mono::unit();\n    for (auto&& e: dat[v]) { Mono::add_element(X,\
    \ e); }\n    dual[v] = solve_linear_xor<u64>(len(X), LOG, X, 0, 0);\n    dual[v].erase(dual[v].begin());\n\
    \  }\n\n  /*\n  \u6728 dp \u306E\u72B6\u614B\n  \u30FB\u6DF1\u3055 d \u306E\u3068\
    \u304D\u306B dual space \u306B a \u304C\u8FFD\u52A0\u3055\u308C\u308B (d,a) \u3068\
    \u3044\u3046\u30A4\u30D9\u30F3\u30C8\u306E\u5217\n  \u30FB\u9AD8\u3005 64\n  */\n\
