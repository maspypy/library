...
data:
  ...
  bundledCode: "#line 1 \"test/mytest/minmax_add.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
    ...
    void test() {\n  int N = RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] = RNG(1,\
    \ 100);\n  using Lazy = Lazy_MinMax_Add<int>;\n  using Mono = typename Lazy::MX;\n\
    \  LazySegTree<Lazy> seg(N, [&](int i) { return Mono::from_element(A[i]); });\n\
    \  int Q = RNG(1, 100);\n  FOR(Q) {\n    ll t = RNG(0, 2);\n    ll L = RNG(0,\
    \ N);\n    ll R = RNG(0, N);\n    if (L > R) swap(L, R);\n    ++R;\n    if (t\
    \ == 1) {\n      ll x = RNG(1, 100);\n      FOR(i, L, R) A[i] += x;\n      seg.apply(L,\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n#include \"my_template.hpp\"\
    \n#include \"other/io.hpp\"\n#include \"alg/lazy/minmax_add.hpp\"\n#include \"\
    random/base.hpp\"\n#include \"ds/lazysegtree.hpp\"\n\nvoid test() {\n  int N =\
    \ RNG(1, 100);\n  vc<int> A(N);\n  FOR(i, N) A[i] = RNG(1, 100);\n  using Lazy\
    \ = Lazy_MinMax_Add<int>;\n  using Mono = typename Lazy::MX;\n  LazySegTree<Lazy>\
    \ seg(N, [&](int i) { return Mono::from_element(A[i]); });\n  int Q = RNG(1, 100);\n\
    \  FOR(Q) {\n    ll t = RNG(0, 2);\n    ll L = RNG(0, N);\n    ll R = RNG(0, N);\n\
    \    if (L > R) swap(L, R);\n    ++R;\n    if (t == 1) {\n      ll x = RNG(1,\
    \ 100);\n      FOR(i, L, R) A[i] += x;\n      seg.apply(L, R, x);\n    }\n   \
...
layout: document
redirect_from:
- /verify/test/mytest/minmax_add.test.cpp
- /verify/test/mytest/minmax_add.test.cpp.html
