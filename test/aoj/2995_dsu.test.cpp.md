...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/2995_dsu.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2995\"\
    ...
    \ true;\n  }\n\n  vc<int> find_all() {\n    vc<int> A(num);\n    FOR(i, num) A[i]\
    \ = find(i);\n    return A;\n  }\n\n  void reset(){\n    comp = num;\n    size.assign(num,\
    \ 1);\n    iota(all(par), 0);\n  }\n};\n#line 6 \"test/aoj/2995_dsu.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, K);\n  Graph G(N);\n  G.read_tree();\n  HLD hld(G);\n\
    \  VEC(pi, CD, N);\n  for (auto&& [c, d]: CD) --c, --d;\n  /*\n  \u9802\u70B9\u306B\
    \u306A\u3063\u3066\u3044\u308B\uFF1A+x\n  \u9023\u7D50\u6210\u5206\u3054\u3068\
    \u306B\u3001\u30ED\u30B9\u306E min \u3092\u6301\u305F\u305B\u308B\n  */\n  vc<int>\
  ...
  verifiedWith: []
documentation_of: test/aoj/2995_dsu.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/2995_dsu.test.cpp
- /verify/test/aoj/2995_dsu.test.cpp.html
