...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/ALDS1_5_inversion.test.cpp\"\n#define PROBLEM \\\
    \n  \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_5_D\"\n\
    ...
    \ { yes(!t); }\r\n#line 5 \"test/aoj/ALDS1_5_inversion.test.cpp\"\n\n#line 2 \"\
    alg/group_add.hpp\"\ntemplate <class X>\r\nstruct Group_Add {\r\n  using value_type\
    ...
    \   bit.add(x, 1);\n  }\n  return ANS;\n}\n#line 7 \"test/aoj/ALDS1_5_inversion.test.cpp\"\
    \n\nvoid solve() {\n  LL(N);\n  VEC(ll, A, N);\n  ll ANS = inversion(A);\n  print(ANS);\n\
  ...
  verifiedWith: []
documentation_of: test/aoj/ALDS1_5_inversion.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/ALDS1_5_inversion.test.cpp
- /verify/test/aoj/ALDS1_5_inversion.test.cpp.html
