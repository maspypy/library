...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0058
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0058
  bundledCode: "#line 1 \"test/aoj/0058.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0058\"\
    ...
    \      a = -a;\n      reverse(all(points));\n    }\n  }\n};\n#line 6 \"test/aoj/0058.test.cpp\"\
    \n\nvoid solve() {\n  string s;\n  while (getline(cin, s)) {\n    auto tokens\
    \ = split(s, \" \");\n    if (len(tokens) != 8) break;\n    vc<int> A(8);\n  \
    \  FOR(i, 8) A[i] = int(round(100000 * stod(tokens[i])));\n    Line<ll> X(Point<ll>(A[0],\
    \ A[1]), Point<ll>(A[2], A[3]));\n    Line<ll> Y(Point<ll>(A[4], A[5]), Point<ll>(A[6],\
    \ A[7]));\n    YES(X.is_orthogonal(Y));\n  }\n}\n\nsigned main() {\n  cout <<\
    \ fixed << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n\
    \  return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0058\"\
    \n#include \"my_template.hpp\"\n#include \"other/io.hpp\"\n#include \"string/split.hpp\"\
    \n#include \"geo/base.hpp\"\n\nvoid solve() {\n  string s;\n  while (getline(cin,\
    \ s)) {\n    auto tokens = split(s, \" \");\n    if (len(tokens) != 8) break;\n\
    \    vc<int> A(8);\n    FOR(i, 8) A[i] = int(round(100000 * stod(tokens[i])));\n\
    \    Line<ll> X(Point<ll>(A[0], A[1]), Point<ll>(A[2], A[3]));\n    Line<ll> Y(Point<ll>(A[4],\
    \ A[5]), Point<ll>(A[6], A[7]));\n    YES(X.is_orthogonal(Y));\n  }\n}\n\nsigned\
  ...
  verifiedWith: []
documentation_of: test/aoj/0058.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/0058.test.cpp
- /verify/test/aoj/0058.test.cpp.html
