...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/ITP2_11_D.test.cpp\"\n// competitive-verifier:\
    ...
    \ (__builtin_ctzll(s) + 1)))\r\n#line 5 \"test/aoj/ITP2_11_D.test.cpp\"\n\nvoid\
    \ solve() {\n  LL(N, K);\n  FOR_nCk(s, N, K) {\n    vi I;\n    FOR(i, N) if (s\
    \ & 1 << i) I.eb(i);\n    print(to_string(s) + \":\", I);\n  }\n}\n\nsigned main()\
    \ {\n  cin.tie(nullptr);\n  ios::sync_with_stdio(false);\n  cout << setprecision(15);\n\
    \n  ll T = 1;\n  // LL(T);\n  FOR(_, T) solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP2_11_D\n\
