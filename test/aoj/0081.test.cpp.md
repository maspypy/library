...
data:
  ...
  attributes:
    ...
    ERROR: '0.0001'
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0081
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0081
  bundledCode: "#line 1 \"test/aoj/0081.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0081\"\
    ...
    \ / (L.a * L.a + L.b * L.b);\n  REAL x = P.x - 2 * t * L.a;\n  REAL y = P.y -\
    \ 2 * t * L.b;\n  return Point<REAL>(x, y);\n};\n#line 8 \"test/aoj/0081.test.cpp\"\
    \n\nvoid solve() {\n  string s;\n  using Re = double;\n  while (cin >> s) {\n\
    \    auto tokens = split(s, \",\");\n    Point<Re> A(stod(tokens[0]), stod(tokens[1]));\n\
    \    Point<Re> B(stod(tokens[2]), stod(tokens[3]));\n    Point<Re> C(stod(tokens[4]),\
    \ stod(tokens[5]));\n    Line<Re> L(A, B);\n    Point<Re> D = reflection<Re, Re,\
    \ Re>(C, L);\n    print(D.x, D.y);\n  }\n}\n\nsigned main() {\n  cout << fixed\
    \ << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return\
    \ 0;\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0081\"\
  ...
  requiredBy: []
  timestamp: '2022-08-28 10:23:35+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/aoj/0081.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/0081.test.cpp
- /verify/test/aoj/0081.test.cpp.html
