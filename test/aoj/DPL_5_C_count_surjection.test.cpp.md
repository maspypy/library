...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/DPL_5_C_count_surjection.test.cpp\"\n#define PROBLEM\
    \ \\\n  \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_5_C\"\n\
    ...
    \ mint res = 0;\r\n  FOR(i, m + 1) {\r\n    mint sgn = ((m - i) & 1 ? -1 : 1);\r\
    \n    res += mint(i).pow(n) * C<mint>(m, i) * sgn;\r\n  }\r\n  return res;\r\n\
    }\n#line 7 \"test/aoj/DPL_5_C_count_surjection.test.cpp\"\n\nusing mint = modint107;\n\
...
layout: document
redirect_from:
- /verify/test/aoj/DPL_5_C_count_surjection.test.cpp
- /verify/test/aoj/DPL_5_C_count_surjection.test.cpp.html
