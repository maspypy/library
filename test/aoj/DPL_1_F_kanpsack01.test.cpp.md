...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/DPL_1_F_kanpsack01.test.cpp\"\n#define PROBLEM\
    \ \\\n  \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_1_F\"\n\
    ...
    \ (t == t2) return sol_2();\n  return sol_3();\n}\n#line 6 \"test/aoj/DPL_1_F_kanpsack01.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, W);\n  vc<int> wt, val;\n  FOR(i, N) {\n    LL(b,\
...
layout: document
redirect_from:
- /verify/test/aoj/DPL_1_F_kanpsack01.test.cpp
- /verify/test/aoj/DPL_1_F_kanpsack01.test.cpp.html
