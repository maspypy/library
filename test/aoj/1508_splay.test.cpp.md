...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/1508_splay.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=1508\"\
    ...
    \n};\r\n#line 2 \"ds/splaytree_monoid.hpp\"\n\n// new_node(x) \uFF1A 1\u8981\u7D20\
    \u3060\u3051\u304B\u3089\u306A\u308B\u6728\n// new_node(A) \uFF1A \u5217\u3092\
    \u6728\u306B\u3059\u308B\u3001\u5148\u982D\u3092\u6839\u3068\u3059\u308B\u3002\
    ...
    \      }\n      else {\n        rotate(n);\n        rotate(n);\n      }\n    }\n\
    \  }\n};\n#line 6 \"test/aoj/1508_splay.test.cpp\"\n\nvoid solve() {\n  LL(N,\
  ...
  verifiedWith: []
documentation_of: test/aoj/1508_splay.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/1508_splay.test.cpp
- /verify/test/aoj/1508_splay.test.cpp.html
