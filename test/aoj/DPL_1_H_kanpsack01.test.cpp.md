...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/DPL_1_H_kanpsack01.test.cpp\"\n#define PROBLEM\
    \ \\\n  \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_1_H\"\n\
    ...
    \ (t == t2) return sol_2();\n  return sol_3();\n}\n#line 6 \"test/aoj/DPL_1_H_kanpsack01.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, W);\n  vc<ll> wt, val;\n  FOR(i, N) {\n    LL(b, a);\n\
  ...
  requiredBy: []
  timestamp: '2022-04-23 13:36:51+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/aoj/DPL_1_H_kanpsack01.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/DPL_1_H_kanpsack01.test.cpp
- /verify/test/aoj/DPL_1_H_kanpsack01.test.cpp.html
