...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/DPL_1_B_kanpsack01.test.cpp\"\n#define PROBLEM\
    \ \\\n  \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_1_B\"\n\
    ...
    \ { print(t ? \"yes\" : \"no\"); }\r\nvoid no(bool t = 1) { yes(!t); }\r\n#line\
    \ 1 \"dp/knapsack01.hpp\"\n/*\nknapsack01 \u306E\u5168\u5217\u6319\n\u30FBO(2^n)\
    \ \u3067\u3001(wt, val) \u3092\u5168\u5217\u6319 + wt \u3067\u30BD\u30FC\u30C8\
    \n\u30FBremove extra = true \u2192 val \u304C\u5897\u52A0\u306B\u306A\u308B\u3068\
    ...
    \ (t == t2) return sol_2();\n  return sol_3();\n}\n#line 6 \"test/aoj/DPL_1_B_kanpsack01.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, W);\n  vc<int> wt, val;\n  FOR(i, N) {\n    LL(b,\
  ...
  requiredBy: []
  timestamp: '2022-04-23 02:26:17+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/aoj/DPL_1_B_kanpsack01.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/DPL_1_B_kanpsack01.test.cpp
- /verify/test/aoj/DPL_1_B_kanpsack01.test.cpp.html
