...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/DPL_2_A_minimum_hamiltonian_cycle.test.cpp\"\n\
    #define PROBLEM \\\n  \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_2_A\"\
    ...
    */\ntemplate <typename T, typename Graph>\npair<T, vc<int>> minimum_hamiltonian_cycle(Graph&\
    ...
    \      }\n      return -1;\n    }();\n    C.eb(frm);\n    t ^= 1 << to;\n  }\n\
    \  reverse(all(C));\n  return {res, C};\n}\n#line 7 \"test/aoj/DPL_2_A_minimum_hamiltonian_cycle.test.cpp\"\
    \n\nvoid solve() {\n  LL(N, M);\n  Graph<int, 1> G(N);\n  G.read_graph(M, 1, 0);\n\
  ...
  requiredBy: []
  timestamp: '2022-04-16 23:37:16+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/aoj/DPL_2_A_minimum_hamiltonian_cycle.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/DPL_2_A_minimum_hamiltonian_cycle.test.cpp
- /verify/test/aoj/DPL_2_A_minimum_hamiltonian_cycle.test.cpp.html
