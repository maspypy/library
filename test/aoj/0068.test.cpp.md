...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0068
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0068
  bundledCode: "#line 1 \"test/aoj/0068.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0068\"\
    ...
    \  FOR(T) solve();\n\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0068\"\
    \n\n#include \"my_template.hpp\"\n#include \"other/io.hpp\"\n#include \"geo/incremental_convexhull.hpp\"\
    \n#include \"string/split.hpp\"\n\nusing Re = double;\n\nvoid solve() {\n  string\
    \ t;\n  while (getline(cin, t)) {\n    if (t == \"0\") break;\n    Incremental_ConvexHull<Re>\
    \ X;\n    int N = stoi(t);\n    FOR(N) {\n      string S;\n      getline(cin,\
    \ S);\n      auto tokens = split(S, \",\");\n      Re x = stod(tokens[0]);\n \
    \     Re y = stod(tokens[1]);\n      X.add(Point<Re>(x, y));\n    }\n    print(N\
    \ - X.V());\n  }\n}\n\nsigned main() {\n  cout << fixed << setprecision(15);\n\
  ...
  requiredBy: []
  timestamp: '2022-08-24 14:17:45+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/aoj/0068.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/0068.test.cpp
- /verify/test/aoj/0068.test.cpp.html
