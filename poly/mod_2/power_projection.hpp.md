...
data:
  ...
  bundledCode: "#line 1 \"my_template.hpp\"\n#if defined(USE_PCH)\n#include <my_template_compiled.hpp>\n\
    ...
    \      a ^= a << (1 << 0);\n      a ^= a << (1 << 1);\n      a ^= a << (1 << 2);\n\
    \      a ^= a << (1 << 3);\n      a ^= a << (1 << 4);\n      a ^= a << (1 << 5);\n\
    \    }\n    resize(N);\n  }\n};\n#line 1 \"poly/mod_2/convolution.hpp\"\n#include\
  ...
  code: "#include \"ds/bit_array.hpp\"\n#include \"poly/mod_2/convolution.hpp\"\n\n\
    ...
    \      g.resize(N + 1);\n\n      Bit_Array nxtf = f.slice(0, n + 1);\n      Bit_Array\
    \ nxtg(n + 1);\n      FOR(i, n + 1) nxtg[n - i] = g[N - 2 * i];\n\n      dfs(dfs,\
    \ nxtf, nxtg, (m - 1) / 2, i0 + step, step * 2);\n    }\n  };\n\n  dfs(dfs, f,\
    \ g, m, 0, 1);\n  return ANS;\n}"
  dependsOn:
  - ds/bit_array.hpp
  - my_template.hpp
  ...
  verifiedWith: []
documentation_of: poly/mod_2/power_projection.hpp
layout: document
redirect_from:
- /library/poly/mod_2/power_projection.hpp
- /library/poly/mod_2/power_projection.hpp.html
