...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"poly/composition_f_a_plus_bx.hpp\"\n\n#line 1 \"poly/poly_taylor_shift.hpp\"\
    ...
    #line 3 \"poly/composition_f_a_plus_bx.hpp\"\n\n// f(a+bx)\ntemplate <typename\
    \ mint>\nvc<mint> composition_f_a_plus_bx(vc<mint> f, mint a, mint b) {\n  f =\
    \ poly_taylor_shift<mint>(f, a); // f(a+x)\n  mint pow_b = 1;\n  FOR(i, len(f))\
    ...
    \ (n <= t ? fps_pow_1_sparse(f, K) : fps_pow_1_dense(f, K));\n}\n#line 3 \"poly/composition_f_a_plus_bx_div_c_plus_dx.hpp\"\
    \n\n// f((a+bx)/(c+dx))\n// only_numerator = true\n//    -> (c+dx)^N f((a+bx)/(c+dx))\
    \ = sum f[i](a+bx)^i(c+dx)^{N-i}\ntemplate <typename mint, bool only_numerator>\n\
    vc<mint> composition_f_a_plus_bx_div_c_plus_dx(vc<mint> f, mint a, mint b, mint\
    \ c, mint d) {\n  int N = len(f) - 1;\n\n  if constexpr (!only_numerator) {\n\
    \    assert(c != mint(0));\n    vc<mint> F = composition_f_a_plus_bx_div_c_plus_dx<mint,\
    \ true>(f, a, b, c, d);\n    d /= c;\n    c = c.inverse().pow(N);\n    // c(1+dx)^{-N}\n\
    \    vc<mint> g = {1, d};\n    g.resize(N + 1);\n    g = fps_pow_1_sparse<mint>(g,\
    \ -N);\n    F = convolution(F, g);\n    F.resize(N + 1);\n    FOR(i, N + 1) F[i]\
    \ *= c;\n    return F;\n  }\n\n  if (mint(d) == 0) {\n    mint pow_c = 1;\n  \
    \  FOR_R(i, N + 1) f[i] *= pow_c, pow_c *= c;\n    return composition_f_a_plus_bx<mint>(f,\
    \ a, b);\n  }\n  // t = c+dx\n  a = (a * d - b * c) / d, b = b / d;\n  // sum\
    \ f[i] (a+bt)^i t^{N-i}\n  f = composition_f_a_plus_bx(f, b, a);\n  reverse(all(f));\n\
    \  return composition_f_a_plus_bx(f, c, d);\n}\n"
  code: "#include \"poly/composition_f_a_plus_bx.hpp\"\n#include \"poly/fps_pow.hpp\"\
    \n\n// f((a+bx)/(c+dx))\n// only_numerator = true\n//    -> (c+dx)^N f((a+bx)/(c+dx))\
    \ = sum f[i](a+bx)^i(c+dx)^{N-i}\ntemplate <typename mint, bool only_numerator>\n\
    vc<mint> composition_f_a_plus_bx_div_c_plus_dx(vc<mint> f, mint a, mint b, mint\
    \ c, mint d) {\n  int N = len(f) - 1;\n\n  if constexpr (!only_numerator) {\n\
...
layout: document
redirect_from:
- /library/poly/composition_f_a_plus_bx_div_c_plus_dx.hpp
- /library/poly/composition_f_a_plus_bx_div_c_plus_dx.hpp.html
