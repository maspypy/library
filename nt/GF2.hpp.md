...
data:
  ...
  bundledCode: "#line 1 \"nt/GF2.hpp\"\n#include <emmintrin.h>\n#include <smmintrin.h>\n\
    ...
    \    const __m128i &a, const __m128i &b) {\n  return _mm_clmulepi64_si128(a, b,\
    \ 0);\n}\n\n// 2^n \u5143\u4F53\ntemplate <int K>\nstruct GF2 {\n  // https://oeis.org/A344141\n\
    \  // irreducible poly x^K + ...\n  static constexpr int POLY[65] = {0, 0, 3,\
    \ 3, 3, 5, 3, 3, 27, 3, 9, 5, 9, 27,\n      33, 3, 43, 9, 9, 39, 9, 5, 3, 33,\
    \ 27, 9, 27, 39, 3, 5, 3, 9, 141, 75, 27,\n      5, 53, 63, 99, 17, 57, 9, 39,\
    \ 89, 33, 27, 3, 33, 45, 113, 29, 75, 9, 71,\n      125, 71, 149, 17, 99, 123,\
