...
data:
  ...
  - name: geo
    ...
    - icon: ':warning:'
      ...
      title: geo/lower_convex_hull_segtree.hpp
    - icon: ':heavy_check_mark:'
  ...
  - name: template
    pages:
    - icon: ':warning:'
      path: template/actedmonoid.hpp
      title: template/actedmonoid.hpp
    - icon: ':warning:'
    ...
    - icon: ':warning:'
      path: template/mo_main.hpp
      title: template/mo_main.hpp
    - icon: ':warning:'
      path: template/mo_main_LR.hpp
      title: template/mo_main_LR.hpp
    - icon: ':warning:'
  ...
  - name: test/2_library_checker/data_structure
    pages:
    - icon: ':heavy_check_mark:'
