...
data:
  ...
  - name: enumerate
    ...
    - icon: ':warning:'
      path: enumerate/enumerate_partitions.hpp
      title: enumerate/enumerate_partitions.hpp
    - icon: ':warning:'
  ...
  - name: string
    ...
    - icon: ':warning:'
      path: string/longest_increasing_subsequence.hpp
      title: string/longest_increasing_subsequence.hpp
    - icon: ':heavy_check_mark:'
