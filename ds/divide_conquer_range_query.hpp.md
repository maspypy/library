...
data:
  ...
  bundledCode: "#line 2 \"ds/divide_conquer_range_query.hpp\"\n\n/*\n\u30FB\u5404\
    \ i \u306B\u5BFE\u3057\u3066\u3001[i, m) \u306B\u5BFE\u3059\u308B\u8A08\u7B97\u7D50\
    \u679C\n\u30FB\u5404 j \u306B\u5BFE\u3057\u3066\u3001[m, j) \u306B\u5BFE\u3059\
    \u308B\u8A08\u7B97\u7D50\u679C\n\u304C\u967D\u306B\u6301\u3066\u3066\u3001\u305D\
    \u3053\u304B\u3089\u30AF\u30A8\u30EA [i, j) \u306B\u7B54\u3048\u3089\u308C\u308B\
    ...
    */\ntemplate <typename Data>\nstruct Divide_Conquer_Range_Query {\n  int n;\n\
    ...
    \ int R, vc<int>& I) -> void {\n      vc<int> left, right;\n      int M = (L +\
    \ R) / 2;\n      // [i, M) \u306B\u5BFE\u3059\u308B\u8A08\u7B97\u30C7\u30FC\u30BF\
    \n      dat[M] = empty_data;\n      FOR3_R(i, L, M) { dat[i] = add_left(i, dat[i\
    \ + 1]); }\n      // [M, R) \u306B\u5BFE\u3059\u308B\u8A08\u7B97\u30C7\u30FC\u30BF\
...
documentation_of: ds/divide_conquer_range_query.hpp
layout: document
redirect_from:
- /library/ds/divide_conquer_range_query.hpp
- /library/ds/divide_conquer_range_query.hpp.html
