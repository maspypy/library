...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"ds/binarytrie/binarytrie.hpp\"\ntemplate <int LOG = 30>\n\
    struct BinaryTrie {\n  struct Node {\n    ll cnt = 0;\n    int ch[2] = {-1, -1};\n\
    \  };\n  vector<Node> ns;\n\n  BinaryTrie() : ns(1) {}\n\n  ll size() const {\
...
documentation_of: ds/binarytrie/binarytrie.hpp
layout: document
redirect_from:
- /library/ds/binarytrie/binarytrie.hpp
- /library/ds/binarytrie/binarytrie.hpp.html
