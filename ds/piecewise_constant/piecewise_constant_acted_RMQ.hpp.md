...
data:
  ...
  bundledCode: "#line 1 \"ds/node_pool.hpp\"\ntemplate <class Node>\nstruct Node_Pool\
    ...
    \ && c->c2() == BT::dec) {\n      que_hi.emplace(d, c);\n    }\n    if (c->c1()\
    \ == BT::dec && c->c2() == BT::inc) {\n      que_lo.emplace(d, c);\n    }\n  }\n\
    };\n#line 2 \"ds/piecewise_constant/piecewise_constant_acted_RMQ.hpp\"\n\n// Y_type\
    \ \u306B\u4F5C\u7528\u3059\u308B\uFF0C\u4F5C\u7528\u304C\u9806\u5E8F\u3092\u4FDD\
    \u3064\u3068\u3059\u308B\n// \u533A\u9593\u3067\u306E y \u306E min,max \u3092\u3068\
    \u308C\u308B\n// https://codeforces.com/problemset/problem/1852/F\ntemplate <typename\
    ...
    \ S {\n    ll x1, x2;  // y on [x1,x2)\n    Y_type y;\n    Y_type y_min, y_max;\n\
    \    Border_Type c1, c2;\n    S(ll x1, ll x2, Y_type y, Border_Type c1, Border_Type\
...
layout: document
redirect_from:
- /library/ds/piecewise_constant/piecewise_constant_acted_RMQ.hpp
- /library/ds/piecewise_constant/piecewise_constant_acted_RMQ.hpp.html
