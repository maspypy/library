...
data:
  ...
  bundledCode: "#line 1 \"my_template.hpp\"\n#if defined(LOCAL)\n#include <my_template_compiled.hpp>\n\
    ...
    \ TIDAK(bool t = 1) { YA(!t); }\r\n#line 3 \"other/mhc_template_directory/para2.cpp\"\
    ...
    \ results(T);\n\n  int next_launch = 0;   // \u6B21\u306B\u6295\u3052\u308B\u30C6\
    \u30B9\u30C8\u30B1\u30FC\u30B9\u306E index\n  int next_collect = 0;  // \u6B21\
    \u306B\u7D50\u679C\u3092\u56DE\u53CE\u3059\u308B index\n  int running = 0;   \
    \    // \u73FE\u5728\u8D70\u3063\u3066\u3044\u308B\u30BF\u30B9\u30AF\u6570\n\n\
    \  // \u6700\u521D\u306B MAX_PAR \u500B\u307E\u3067\u6295\u3052\u308B\n  while\
    \ (next_launch < T && running < MAX_PAR) {\n    futures[next_launch] =\n     \
  ...
  code: "#include \"my_template.hpp\"\n#include \"other/io.hpp\"\n\nusing TestCase\
    ...
    \n  int next_launch = 0;   // \u6B21\u306B\u6295\u3052\u308B\u30C6\u30B9\u30C8\
    \u30B1\u30FC\u30B9\u306E index\n  int next_collect = 0;  // \u6B21\u306B\u7D50\
    \u679C\u3092\u56DE\u53CE\u3059\u308B index\n  int running = 0;       // \u73FE\
    \u5728\u8D70\u3063\u3066\u3044\u308B\u30BF\u30B9\u30AF\u6570\n\n  // \u6700\u521D\
    \u306B MAX_PAR \u500B\u307E\u3067\u6295\u3052\u308B\n  while (next_launch < T\
    \ && running < MAX_PAR) {\n    futures[next_launch] =\n        std::async(std::launch::async,\
    \ solve, cases[next_launch]);\n    ++next_launch;\n    ++running;\n  }\n\n  //\
    \ \u7D50\u679C\u3092\u56DE\u53CE\u3057\u306A\u304C\u3089\u3001\u65B0\u3057\u3044\
    \u30BF\u30B9\u30AF\u3092\u9806\u6B21\u6295\u3052\u308B\n  while (next_collect\
    \ < T) {\n    // next_collect \u756A\u76EE\u306E\u30BF\u30B9\u30AF\u304C\u7D42\
    \u308F\u308B\u306E\u3092\u5F85\u3064\uFF08\u7D42\u308F\u308B\u307E\u3067\u30D6\
    \u30ED\u30C3\u30AF\uFF09\n    results[next_collect] = futures[next_collect].get();\n\
    \    ++next_collect;\n    --running;\n\n    // \u67A0\u304C\u7A7A\u3044\u305F\u3076\
    \u3093\u3060\u3051\u65B0\u3057\u3044\u30BF\u30B9\u30AF\u3092\u6295\u3052\u308B\
  ...
  verifiedWith: []
documentation_of: other/mhc_template_directory/para2.cpp
layout: document
redirect_from:
- /library/other/mhc_template_directory/para2.cpp
- /library/other/mhc_template_directory/para2.cpp.html
