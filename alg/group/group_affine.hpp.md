...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"alg/group/group_affine.hpp\"\ntemplate <typename K>\nstruct\
    \ Group_Affine {\n  using F = pair<K, K>;\n  using value_type = F;\n  static constexpr\
  ...
  path: alg/group/group_affine.hpp
  requiredBy: []
  timestamp: '2022-10-21 16:22:09+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: alg/group/group_affine.hpp
layout: document
redirect_from:
- /library/alg/group/group_affine.hpp
- /library/alg/group/group_affine.hpp.html
title: alg/group/group_affine.hpp
---
