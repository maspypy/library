...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc240ex.test.cpp\"\n// competitive-verifier:\
    ...
    };\r\n#line 7 \"test_atcoder/abc240ex.test.cpp\"\n\nvoid solve() {\n  LL(N);\n\
    \  STR(S);\n  ll LIM = 1;\n  while (LIM * LIM < 2 * N) LIM++;\n  LIM += 10;\n\
    \  chmin(LIM, N);\n  auto rank = sort_substrings(S, LIM);\n\n  // \u6587\u5B57\
    \u5217\u30E9\u30F3\u30AF -> (L, R)\n  ll mx = 0;\n  FOR(i, len(rank)) chmax(mx,\
  ...
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc240/tasks/abc240_Ex\n\
