...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc324g2.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc324/tasks/abc324_g\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test_atcoder/abc324g2.test.cpp\"\n\n#line 1 \"ds/segtree/segtree_2d.hpp\"\
    \n// \u70B9\u306E\u91CD\u8907\u304C\u3042\u3063\u3066\u3082\u5225\u306E\u70B9\u3068\
    ...
    \n};\r\n#line 7 \"test_atcoder/abc324g2.test.cpp\"\n\nvoid solve() {\n  INT(N);\n\
    \  VEC(int, A, N);\n  using T = tuple<int, int, int, int>;\n  vc<T> dat;\n  dat.eb(0,\
    \ N, 0, MAX(A) + 1);\n\n  SegTree_2D<Monoid_Add<int>, int, true> seg(\n      N,\
    \ [&](int i) -> tuple<int, int, int> {\n        return {i, A[i], 0};\n      });\n\
    \n  INT(Q);\n  FOR(Q) {\n    INT(t, s, x);\n    int L = get<0>(dat[s]);\n    int\
    \ R = get<1>(dat[s]);\n    int lo = get<2>(dat[s]);\n    int hi = get<3>(dat[s]);\n\
    \    if (t == 1) {\n      auto check = [&](int M) -> bool { return seg.count(L,\
    \ M, lo, hi) >= x; };\n      if (!check(R)) {\n        dat.eb(0, 0, 0, 0);\n \
