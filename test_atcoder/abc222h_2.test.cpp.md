...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc222h_2.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc222/tasks/abc222_h\"\
    ...
    \ c, K);\n  return ANS;\n}\n#line 6 \"test_atcoder/abc222h_2.test.cpp\"\n\nusing\
    \ mint = modint998;\nusing poly = vc<mint>;\n\nvoid solve() {\n  LL(N);\n  poly\
    \ f = {6 * N, 4 * N};\n  poly g = {1, 3, 1};\n  mint x = from_log_differentiation_kth(N\
    \ - 1, f, g) / mint(N);\n  print(x);\n}\n\nsigned main() {\n  solve();\n  return\
    \ 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc222/tasks/abc222_h\"\n#include\
    ...
    \ poly = vc<mint>;\n\nvoid solve() {\n  LL(N);\n  poly f = {6 * N, 4 * N};\n \
    \ poly g = {1, 3, 1};\n  mint x = from_log_differentiation_kth(N - 1, f, g) /\
    \ mint(N);\n  print(x);\n}\n\nsigned main() {\n  solve();\n  return 0;\n}\n"
  dependsOn:
  - my_template.hpp
  - other/io.hpp
  ...
  verifiedWith: []
documentation_of: test_atcoder/abc222h_2.test.cpp
layout: document
redirect_from:
- /verify/test_atcoder/abc222h_2.test.cpp
- /verify/test_atcoder/abc222h_2.test.cpp.html
