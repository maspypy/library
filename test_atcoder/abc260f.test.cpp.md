...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc260f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc260/tasks/abc260_f\"\
    ...
    \ yes(!t); }\n#line 4 \"test_atcoder/abc260f.test.cpp\"\n\n#line 2 \"graph/base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T cost;\n  int id;\n\
    ...
    \ = -1; }\n    }\n  }\n  return {-1, -1, -1, -1};\n}\n#line 6 \"test_atcoder/abc260f.test.cpp\"\
    \n\nvoid solve() {\n  LL(S, T, M);\n  Graph<int, 0> G(S + T);\n  G.read_graph(M);\n\
    \  auto [a, b, c, d] = find_C4(G);\n  if (a == -1) return print(-1);\n  print(1\
    \ + a, 1 + b, 1 + c, 1 + d);\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n\
    \  FOR(T) solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc260/tasks/abc260_f\"\n#include\
  ...
  verifiedWith: []
documentation_of: test_atcoder/abc260f.test.cpp
layout: document
redirect_from:
- /verify/test_atcoder/abc260f.test.cpp
- /verify/test_atcoder/abc260f.test.cpp.html
