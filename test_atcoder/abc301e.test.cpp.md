...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc301e.test.cpp\"\n// competitive-verifier:\
    ...
    \ ny, dist[x][y] + 1);\n    }\n  }\n  return dist;\n}\n#line 5 \"test_atcoder/abc301e.test.cpp\"\
    \n\nvoid solve() {\n  LL(H, W, T);\n  VEC(string, A, H);\n\n  vc<pi> pos;\n  FOR(x,\
    ...
    \    ll n = popcnt(s) - 2;\n    chmax(ANS, n);\n  }\n  print(ANS);\n}\n\nsigned\
    \ main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc301/tasks/abc301_e\n\
  ...
  verifiedWith: []
documentation_of: test_atcoder/abc301e.test.cpp
layout: document
redirect_from:
- /verify/test_atcoder/abc301e.test.cpp
- /verify/test_atcoder/abc301e.test.cpp.html
