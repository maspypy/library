...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc174f.test.cpp\"\n// competitive-verifier:\
    ...
    \ X(C);\n\n  FOR(Q) {\n    LL(l, r);\n    X.add(--l, r);\n  }\n  for (auto&& x:\
    \ X.calc()) print(x);\n}\n\nsigned main() {\n  solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc174/tasks/abc174_f\n\
...
layout: document
redirect_from:
- /verify/test_atcoder/abc174f.test.cpp
- /verify/test_atcoder/abc174f.test.cpp.html
