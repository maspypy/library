...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc345g.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 5 \"test_atcoder/abc345g.test.cpp\"\n\n#line 2 \"poly/power_projection.hpp\"\
    ...
    \ f, m); }\n  return power_projection_0_garner(wt, f, m);\n}\n#line 8 \"test_atcoder/abc345g.test.cpp\"\
    \n\nusing mint = modint998;\n\nvoid solve() {\n  LL(N, K);\n  mint p = mint(1)\
    \ / mint(K);\n  vc<mint> f(N);\n  FOR(i, N) if (1 <= i && i <= K) f[i] = p;\n\
    \  vc<mint> wt(N, 1);\n  vc<mint> A = power_projection<mint>(wt, f, N);\n  FOR(n,\
    \ 1, N + 1) { print(A[n - 1] - A[n]); }\n}\n\nsigned main() {\n  int T = 1;\n\
    \  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc345/tasks/abc345_g\n\
