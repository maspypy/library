...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc233c.test.cpp\"\n// competitive-verifier:\
    ...
    \ p);\n      p.pop_back();\n    }\n  };\n  vc<int> p;\n  dfs(dfs, p);\n}\n#line\
    \ 5 \"test_atcoder/abc233c.test.cpp\"\n\nvoid solve() {\n  LL(N, X);\n  vc<int>\
    \ S(N);\n  vvc<int> dat(N);\n  FOR(i, N) {\n    read(S[i]);\n    FOR(S[i]) {\n\
    \      INT(x);\n      dat[i].eb(x);\n    }\n  }\n  ll ANS = 0;\n  using I = i128;\n\
    ...
    \ main() {\n  solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc233/tasks/abc233_c\n\
  ...
  verifiedWith: []
documentation_of: test_atcoder/abc233c.test.cpp
layout: document
redirect_from:
- /verify/test_atcoder/abc233c.test.cpp
- /verify/test_atcoder/abc233c.test.cpp.html
