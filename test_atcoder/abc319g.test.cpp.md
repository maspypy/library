...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc319g.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test_atcoder/abc319g.test.cpp\"\n\n#line 2 \"graph/base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T cost;\n  int id;\n\
    ...
    \ V[i - 1]) pre[v] = 0;\n  }\n  // print(dp);\n  print(dp[N - 1]);\n}\n\nsigned\
    \ main() {\n  solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc319/tasks/abc319_g\n\
