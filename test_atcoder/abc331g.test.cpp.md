...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc331/tasks/abc331_g
    links:
    - https://atcoder.jp/contests/abc331/tasks/abc331_g
  bundledCode: "#line 1 \"test_atcoder/abc331g.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc331/tasks/abc331_g\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test_atcoder/abc331g.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ * inv<mint>(d); }\n  }\n  return fps_exp(logf);\n}\n#line 7 \"test_atcoder/abc331g.test.cpp\"\
    \n\nusing mint = modint998;\nusing poly = vc<mint>;\n\nvoid solve() {\n  LL(N,\
    \ M);\n  VEC(ll, A, M);\n  poly f = product_of_one_minus_xn<mint, ll>(A, N);\n\
    \n  mint ANS = 0;\n  FOR(S, N + 1) {\n    if (S == N) continue;\n    ANS -= f[S]\
    \ * inv<mint>(N - S);\n  }\n  ANS *= mint(N);\n  if (M % 2 == 1) ANS = -ANS;\n\
    \  print(ANS);\n}\n\nsigned main() {\n  solve();\n  return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc331/tasks/abc331_g\"\n#include\
    \ \"my_template.hpp\"\n#include \"other/io.hpp\"\n\n#include \"mod/modint.hpp\"\
    \n#include \"poly/product_of_one_minus_xn.hpp\"\n\nusing mint = modint998;\nusing\
    \ poly = vc<mint>;\n\nvoid solve() {\n  LL(N, M);\n  VEC(ll, A, M);\n  poly f\
    \ = product_of_one_minus_xn<mint, ll>(A, N);\n\n  mint ANS = 0;\n  FOR(S, N +\
  ...
  requiredBy: []
  timestamp: '2024-01-28 19:52:24+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test_atcoder/abc331g.test.cpp
layout: document
redirect_from:
- /verify/test_atcoder/abc331g.test.cpp
- /verify/test_atcoder/abc331g.test.cpp.html
