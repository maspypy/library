...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc218c.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc218/tasks/abc218_c\"\
    ...
    Yes\" : \"No\"); }\r\nvoid No(bool t = 1) { Yes(!t); }\r\nvoid yes(bool t = 1)\
    \ { print(t ? \"yes\" : \"no\"); }\r\nvoid no(bool t = 1) { yes(!t); }\r\n#line\
    \ 4 \"test_atcoder/abc218c.test.cpp\"\n\n#line 1 \"linalg/rot90.hpp\"\ntemplate\
    \ <typename VC>\nvc<VC> rot90(const vc<VC>& A, bool counter_clockwise = true,\
    \ int H = -1,\n             int W = -1) {\n  if (H == -1) { H = len(A), W = len(A[0]);\
    \ }\n  vc<VC> B(W, VC(H, A[0][0]));\n  if (counter_clockwise) {\n    FOR(x, H)\
    \ FOR(y, W) B[W - 1 - y][x] = A[x][y];\n  } else {\n    FOR(x, H) FOR(y, W) B[y][H\
...
layout: document
redirect_from:
- /verify/test_atcoder/abc218c.test.cpp
- /verify/test_atcoder/abc218c.test.cpp.html
