...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc266c.test.cpp\"\n// competitive-verifier:\
    ...
    \u5916\uFF1A-1\n  int side(Point<T> p) {\n    int a = LOWER.side(p);\n    int\
    \ b = UPPER.side(-p);\n    if (a == 0 || b == 0) return 0;\n    return min(a,\
    \ b);\n  }\n};\n#line 5 \"test_atcoder/abc266c.test.cpp\"\n\nvoid solve() {\n\
    \  Incremental_ConvexHull<ll, true> X;\n  FOR(4) {\n    LL(a, b);\n    Point<ll>\
    \ P(a, b);\n    X.add(P);\n  }\n  Yes(len(X) == 4);\n}\n\nsigned main() {\n  cout\
    \ << fixed << setprecision(15);\n\n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\
    \n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc266/tasks/abc266_c\n\
...
layout: document
redirect_from:
- /verify/test_atcoder/abc266c.test.cpp
- /verify/test_atcoder/abc266c.test.cpp.html
