...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc339f.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test_atcoder/abc339f.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ dat.eb(key[i], val[i]);\r\n    }\r\n    build(2 * len(dat));\r\n    for (auto&\
    \ [a, b]: dat) (*this)[a] = b;\r\n  }\r\n};\n#line 8 \"test_atcoder/abc339f.test.cpp\"\
    \n\nusing B = BigInteger;\n\nvoid solve() {\n  LL(N);\n  vc<B> A(N);\n  FOR(i,\
    \ N) {\n    STR(S);\n    A[i] = B(S);\n  }\n\n  HashMap<int> MP(N);\n  FOR(i,\
    ...
    \ 0);\n    if (i != j) cnt *= 2;\n    ANS += cnt;\n  }\n  print(ANS);\n}\n\nsigned\
    \ main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc339/tasks/abc339_f\n\
