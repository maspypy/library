...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc253h.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 5 \"test_atcoder/abc253h.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \ 9 \"test_atcoder/abc253h.test.cpp\"\n\nconst int LIM = 14;\nusing mint = modint998;\n\
    \nvoid solve() {\n  LL(N, M);\n\n  vv(int, mat, N, N);\n  FOR(M) {\n    INT(a,\
    \ b);\n    --a, --b;\n    mat[a][b]++, mat[b][a]++;\n  }\n\n  // count tree\n\
    \  vc<mint> dp(1 << N);\n  dp[0] = 0;\n  FOR(i, N) {\n    vc<mint> a = {dp.begin(),\
    \ dp.begin() + (1 << i)};\n    FOR(s, 1 << i) {\n      int k = 0;\n      FOR(j,\
    \ i) if (s >> j & 1) k += mat[i][j];\n      a[s] *= mint(k);\n    }\n    a = sps_exp<mint,\
    \ LIM>(a);\n    copy(all(a), dp.begin() + (1 << i));\n  }\n\n  vc<mint> x(1 <<\
    \ N);\n  x.back() = mint(1);\n  auto y = power_projection_of_sps_egf<mint, LIM>(x,\
    \ dp);\n\n  FOR(k, 1, N) {\n    // k edges = N-k component\n    mint ans = y[N\
    \ - k];\n    ans *= inv<mint>(M).pow(k) * fact<mint>(k);\n    print(ans);\n  }\n\
    }\n\nsigned main() {\n  solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc253/tasks/abc253_Ex\n\
