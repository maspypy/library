...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc335g.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 5 \"test_atcoder/abc335g.test.cpp\"\n\n#line 2 \"nt/factor.hpp\"\
    ...
    \n    a = bt.mul(a, a), n >>= 1;\r\n  }\r\n  return r;\r\n}\n#line 8 \"test_atcoder/abc335g.test.cpp\"\
    ...
    \  auto pfs = factor(P - 1);\n\n  auto F = [&](ll a) -> ll {\n    ll exp = P -\
    \ 1;\n    for (auto& [p, e]: pfs) {\n      while (exp % p == 0 && mod_pow_64(a,\
    \ exp / p, P) == 1) exp /= p;\n    }\n    return exp;\n  };\n\n  Array_On_Divisors<ll>\
    \ A(P - 1);\n\n  FOR(N) {\n    LL(a);\n    a = F(a);\n    A[a]++;\n  }\n  Array_On_Divisors<ll>\
    \ B = A;\n  B.divisor_zeta();\n\n  ll ANS = 0;\n\n  A.enumerate([&](ll d, ll fd)\
    \ -> void { ANS += fd * B[d]; });\n\n  print(ANS);\n}\n\nsigned main() {\n  int\
    \ T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc335/tasks/abc335_g\n\
...
layout: document
redirect_from:
- /verify/test_atcoder/abc335g.test.cpp
- /verify/test_atcoder/abc335g.test.cpp.html
