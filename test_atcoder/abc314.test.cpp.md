...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc314.test.cpp\"\n// competitive-verifier:\
    ...
    \ x) -> Re { return F(x, y); }, -INF, INF).fi;\n  };\n\n  Re ANS = golden_search([&](Re\
    \ y) -> Re { return f(y); }, -INF, INF).fi;\n  print(ANS);\n}\n\nsigned main()\
    \ {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc314/tasks/abc314_Ex\n\
    ...
    \ Re, Re>(seg[i], p));\n    return ma;\n  };\n\n  Re INF = 1e6;\n  auto f = [&](Re\
    \ y) -> Re {\n    return golden_search([&](Re x) -> Re { return F(x, y); }, -INF,\
    \ INF).fi;\n  };\n\n  Re ANS = golden_search([&](Re y) -> Re { return f(y); },\
    \ -INF, INF).fi;\n  print(ANS);\n}\n\nsigned main() {\n  int T = 1;\n  // INT(T);\n\
    \  FOR(T) solve();\n  return 0;\n}\n"
  dependsOn:
  - my_template.hpp
