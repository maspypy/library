...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc321g.test.cpp\"\n// competitive-verifier:\
    ...
    \ yes(!t); }\r\n#line 4 \"test_atcoder/abc321g.test.cpp\"\n\n#line 2 \"mod/modint_common.hpp\"\
    ...
    \    copy(all(a), s.begin() + (1 << i));\n  }\n  return s;\n}\n#line 7 \"test_atcoder/abc321g.test.cpp\"\
    \n\nusing mint = modint998;\n\nvoid solve() {\n  LL(N, M);\n\n  auto get = [&]()\
    \ -> vc<int> {\n    vc<int> dp(1 << N);\n    vc<int> deg(N);\n    FOR(M) {\n \
    \     INT(x);\n      --x;\n      deg[x]++;\n    }\n    FOR(i, N) { FOR(s, 1 <<\
    \ i) dp[s | 1 << i] = dp[s] + deg[i]; }\n    return dp;\n  };\n\n  auto A = get(),\
    \ B = get();\n  vc<mint> F(1 << N);\n  FOR(s, 1 << N) {\n    if (A[s] == B[s])\
    \ { F[s] = fact<mint>(A[s]); }\n  }\n  F = sps_log<mint, 18>(F);\n  // print(A);\n\
    \  // print(B);\n  // print(F);\n  mint ANS = 0;\n  FOR(s, 1, 1 << N) {\n    mint\
    \ x = F[s];\n    if (A[s] == B[s]) {\n      ll n = A[s];\n      ANS += x * C_inv<mint>(M,\
    ...
    \ 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc321/tasks/abc321_g\n\
