...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc267g.test.cpp\"\n// competitive-verifier:\
    ...
    \n\r\n  reverse(all(f));\r\n  mint ia = a.inverse();\r\n  mint pow = 1;\r\n  FOR(i,\
    \ n) f[i] *= pow, pow *= ia;\r\n  return f;\r\n}\r\n#line 8 \"test_atcoder/abc267g.test.cpp\"\
    ...
    \  reverse(all(F));\n  print(F[N - K]);\n}\n\nsigned main() {\n  solve();\n  return\
    \ 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc267/tasks/abc267_g\n\
