...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc326f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc326/tasks/abc326_f\"\
    ...
    \ yes(!t); }\r\n#line 4 \"test_atcoder/abc326f.test.cpp\"\n\n#line 2 \"ds/my_bitset.hpp\"\
    ...
    \ return No();\n\n  vc<int> DIR(N);\n  FOR(i, len(S1)) { DIR[2 * i + 1] = (S1[i]\
    \ == 1 ? 0 : 2); }\n  FOR(i, len(S2)) { DIR[2 * i + 0] = (S2[i] == 1 ? 1 : 3);\
    \ }\n\n  DIR.insert(DIR.begin(), 0);\n  string ANS;\n  FOR(i, N) { ANS += ((DIR[i\
    \ + 1] - DIR[i] - 1) % 4 == 0 ? \"L\" : \"R\"); }\n  Yes();\n  print(ANS);\n}\n\
    \nsigned main() {\n  int T = 1;\n  // INT(T);\n  FOR(T) solve();\n  return 0;\n\
    }\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc326/tasks/abc326_f\"\n#include\
  ...
  verifiedWith: []
documentation_of: test_atcoder/abc326f.test.cpp
layout: document
redirect_from:
- /verify/test_atcoder/abc326f.test.cpp
- /verify/test_atcoder/abc326f.test.cpp.html
