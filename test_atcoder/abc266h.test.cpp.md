...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc266h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc266/tasks/abc266_Ex\"\
    ...
    \ a - b + c, 0);\n      continue;\n    }\n    ll best = -INF<ll>;\n    chmax(best,\
    \ seg1.prod(-INF<ll>, x + 1, x + y - t, INF<ll>));\n    chmax(best, seg2.prod(x,\
    \ INF<ll>, -INF<ll>, x - y + t + 1));\n    if (best < 0) continue;\n    best +=\
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc266/tasks/abc266_Ex\"\n\
    ...
    \  vi X1(N), Y1(N), X2(N), Y2(N);\n  FOR(i, N) {\n    auto [t, x, y, v] = dat[i];\n\
    \    X1[i] = x;\n    X2[i] = x;\n    Y1[i] = x + y - t;\n    Y2[i] = x - y + t;\n\
    \  }\n  SegTree_2D<Mono, ll, false> seg1(X1, Y1);\n  SegTree_2D<Mono, ll, false>\
    \ seg2(X2, Y2);\n\n  ll ANS = 0;\n  FOR(i, N) {\n    const auto [t, x, y, v] =\
    \ dat[i];\n    const ll a = x, b = y, c = t;\n    if (i == 0) {\n      seg1.multiply(a,\
    \ a + b - c, 0);\n      seg2.multiply(a, a - b + c, 0);\n      continue;\n   \
    \ }\n    ll best = -INF<ll>;\n    chmax(best, seg1.prod(-INF<ll>, x + 1, x + y\
    \ - t, INF<ll>));\n    chmax(best, seg2.prod(x, INF<ll>, -INF<ll>, x - y + t +\
    \ 1));\n    if (best < 0) continue;\n    best += v;\n    chmax(ANS, best);\n \
