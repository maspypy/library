...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc198d.test.cpp\"\n// competitive-verifier:\
    ...
    \n  return res;\r\n}\n#line 5 \"test_atcoder/abc198d.test.cpp\"\n\nvoid solve()\
    \ {\n  STR(A, B, C);\n  auto res = solve_hukumenzan(A, B, C);\n  if (len(res)\
    \ == 0) return print(\"UNSOLVABLE\");\n  auto [a, b, c] = res[0];\n  print(a);\n\
    \  print(b);\n  print(c);\n}\n\nsigned main() {\n  cout << fixed << setprecision(15);\n\
    \n  ll T = 1;\n  // LL(T);\n  FOR(T) solve();\n\n  return 0;\n}\n"
  code: "// competitive-verifier: PROBLEM https://atcoder.jp/contests/abc198/tasks/abc198_d\n\
  ...
  verifiedWith: []
documentation_of: test_atcoder/abc198d.test.cpp
layout: document
redirect_from:
- /verify/test_atcoder/abc198d.test.cpp
- /verify/test_atcoder/abc198d.test.cpp.html
