...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc222h.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc222/tasks/abc222_h\"\
    ...
    \n  vc<mint> g(N);\r\n  g[0] = 1;\r\n  FOR(n, N - 1) {\r\n    mint& x = g[n +\
    \ 1];\r\n    for (auto&& [d, cf]: dat) {\r\n      if (d > n + 1) break;\r\n  \
    \    mint t = cf * g[n - d + 1];\r\n      x += t * (K * mint(d) - mint(n - d +\
    \ 1));\r\n    }\r\n    x *= inv<mint>(n + 1);\r\n  }\r\n  return g;\r\n}\r\n\r\
    \ntemplate <typename mint>\r\nvc<mint> fps_pow_1_dense(const vc<mint>& f, mint\
    ...
    \n}\r\n#line 6 \"test_atcoder/abc222h.test.cpp\"\n\nusing mint = modint998;\n\
    using poly = vc<mint>;\nvoid solve() {\n  LL(N);\n  poly f = {1, 3, 1};\n  f.resize(N);\n\
  ...
  requiredBy: []
  timestamp: '2023-05-26 18:56:46+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test_atcoder/abc222h.test.cpp
layout: document
redirect_from:
- /verify/test_atcoder/abc222h.test.cpp
- /verify/test_atcoder/abc222h.test.cpp.html
