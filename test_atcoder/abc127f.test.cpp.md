...
data:
  ...
  bundledCode: "#line 1 \"test_atcoder/abc127f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc127/tasks/abc127_f\"\
    ...
    #line 5 \"test_atcoder/abc127f.test.cpp\"\n\nvoid solve() {\n  LL(Q);\n  Slope_Trick\
    \ f;\n  FOR(Q) {\n    LL(t);\n    if (t == 1) {\n      LL(a, b);\n      f.add_const(b);\n\
  ...
  verifiedWith: []
documentation_of: test_atcoder/abc127f.test.cpp
layout: document
redirect_from:
- /verify/test_atcoder/abc127f.test.cpp
- /verify/test_atcoder/abc127f.test.cpp.html
