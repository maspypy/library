...
data:
  ...
  bundledCode: "#line 2 \"ds/hashmap.hpp\"\n\r\n// u64 -> Val\r\ntemplate <typename\
    ...
    \ r is not art\n    vc<T> f(1 << (N - 1));\n    FOR(L, 1 << r) FOR(R, 1 << (N\
    \ - 1 - r)) f[L | R << r] = dp[L | (R << (1 + r)) | (1 << r)];\n    f = sps_log<T,\
    \ LIM - 1>(f);\n    FOR(L, 1 << r) FOR(R, 1 << (N - 1 - r)) dp[L | (R << (1 +\
    \ r)) | (1 << r)] = f[L | R << r];\n  }\n  // \u306A\u308B\u307B\u3069\uFF1F\n\
    \  FOR(v, N) dp[1 << v] = 1;\n  return dp;\n}\n"
...
layout: document
redirect_from:
- /library/graph/count/count_biconnected_subgraph.hpp
- /library/graph/count/count_biconnected_subgraph.hpp.html
