...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/tree_dp/tree_dp.hpp\"\n\r\n#line 2 \"graph/base.hpp\"\
    \n\ntemplate <typename T>\nstruct Edge {\n  int frm, to;\n  T cost;\n  int id;\n\
    ...
    template <typename TREE, typename Data, typename F1, typename F2, typename F3>\r\
    \nvc<Data> tree_dp(TREE& tree, F1 f_ee, F2 f_ev, F3 f_ve, const Data unit) {\r\
...
layout: document
redirect_from:
- /library/graph/tree_dp/tree_dp.hpp
- /library/graph/tree_dp/tree_dp.hpp.html
