...
data:
  ...
  bundledCode: "#line 2 \"mod/modint61.hpp\"\nstruct modint61 {\r\n  static constexpr\
    ...
    \ }\r\n  }\r\n  return dp;\r\n};\n#line 6 \"graph/classify_subtree_rerooting.hpp\"\
    \n\ntemplate <typename TREE>\nvc<int> classify_subtree(TREE& tree) {\n  int N\
    \ = tree.G.N;\n  RandomNumberGenerator RNG;\n  using mint = modint61;\n  using\
    \ T = mint;\n  T unit = mint(1);\n  vc<mint> hash_base(N + 1);\n  FOR(i, N + 1)\
    \ hash_base[i] = RNG(mint::get_mod());\n\n  auto f_ee = [&](T& A, T B) -> T {\
  ...
  verifiedWith: []
documentation_of: graph/classify_subtree_rerooting.hpp
layout: document
redirect_from:
- /library/graph/classify_subtree_rerooting.hpp
- /library/graph/classify_subtree_rerooting.hpp.html
