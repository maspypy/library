...
data:
  ...
  bundledCode: "#line 1 \"ds/disjointsparse.hpp\"\ntemplate <class Monoid>\r\nstruct\
    ...
    \ }\r\n  static const bool commute = Monoid::commute;\r\n};\r\n#line 4 \"graph/statictreemonoid.hpp\"\
    ...
    \  X prod_path(int u, int v) {\n    auto pd = hld.get_path_decomposition(u, v,\
    \ edge);\n    X val = Monoid::unit();\n    for (auto &&[a, b]: pd) {\n      X\
  ...
  code: "#include \"ds/disjointsparse.hpp\"\n#include \"graph/hld.hpp\"\n#include\
    ...
    \ seg;\n  DisjointSparse<RevMonoid> seg_r;\n\n  StaticTreeMonoid(HLD &hld) : hld(hld),\
    \ N(hld.N), seg(hld.N) {\n    if (!Monoid::commute) seg_r = DisjointSparse<RevMonoid>(hld.N);\n\
    \  }\n\n  StaticTreeMonoid(HLD &hld, vc<X> &dat) : hld(hld), N(hld.N) {\n    vc<X>\
  ...
  requiredBy: []
  timestamp: '2022-08-16 02:52:30+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: graph/statictreemonoid.hpp
layout: document
redirect_from:
- /library/graph/statictreemonoid.hpp
- /library/graph/statictreemonoid.hpp.html
