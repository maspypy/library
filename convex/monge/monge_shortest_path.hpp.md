...
data:
  ...
  code: "#pragma once\n\ntemplate <typename T>\nstruct Monge_Shortest_Path {\n  int\
    \ N;\n  vc<T> dp;\n  vc<int> cnt, frm;\n\n  Monge_Shortest_Path(int N) : N(N)\
    \ {}\n\n  template <typename F>\n  pair<T, int> solve(F f, bool minimize_cnt =\
    \ true) {\n    dp.assign(N + 1, infty<T>);\n    cnt.assign(N + 1, infty<int>);\n\
    \    frm.assign(N + 1, 0);\n\n    dp[0] = 0;\n    cnt[0] = 0;\n\n    auto better_tie\
