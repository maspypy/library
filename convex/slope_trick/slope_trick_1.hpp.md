...
data:
  ...
  bundledCode: "#line 1 \"convex/slope_trick/slope_trick_1.hpp\"\n\n#line 1 \"ds/double_ended_queue_const_add.hpp\"\
    ...
    \ swap(f, g); shift(f, g.x0, g.y0), shift(g,\n  //   -g.x0, -g.y0); if (len(g)\
    \ == 0) { return convolve_segment(f, 0, g.x1,\n  //   g.a0, 0); } auto tmp = ST.get_all(g.root);\
    \ ST.free_subtree(g.root); f =\n  //   convolve_segment(f, 0, tmp[0].fi, g.a0,\
    \ 0); T a = g.a0; FOR(i, len(tmp))\n  //   {\n  //     T nx = (i + 1 < len(tmp)\
    ...
    \u3092\u3069\u3053\u304B\u306B\u633F\u5165\u3059\u308B\n  //   // \u7279\u306B\
    \ x0, y0 \u306F\u3053\u306E\u307E\u307E\u3067\u3088\u3044\n  //   if (f.x0 ==\
    \ f.x1) { return {nullptr, f.x0, f.x0 + d, a, f.y0}; }\n  //   // \u5148\u982D\
    \u306B\u633F\u5165\u3067\u304D\u308B\u5834\u5408\n  //   if (a <= f.a0) {\n  //\
    ...
    \ prod) -> bool {\n  //   return f.a0 + prod.fi < a; }); T asum = ST.prod(l).fi;\
    \ T a1 = a - (asum +\n  //   f.a0); auto [xx, aa] = ST.get(r, 0); ST.apply(r,\
    \ d); ST.set(r, 0, {xx +\n  //   d, aa - a1}); f.root = ST.merge3(l, ST.new_node({xx,\
    \ a1}), r); f.x1 += d;\n  //   return f;\n  // }\n\n  // fx,x\n  tuple<i128, ll,\
  ...
  code: "\n#include \"ds/double_ended_queue_const_add.hpp\"\n#include \"alg/monoid/add.hpp\"\
    ...
    \  }\n};\n"
  dependsOn:
  - ds/double_ended_queue_const_add.hpp
  - alg/monoid/add.hpp
