...
data:
  ...
  bundledCode: "#line 1 \"seq/enumerate_partitions.hpp\"\n/*\nN \u306E partition \u306E\
    ...
    \ enumerate_partitions(int N, F query) {\n  assert(N >= 0);\n  auto dfs = [&](auto\
  ...
  code: "/*\nN \u306E partition \u306E\u5217\u6319\u3057\u3066\u3001partition p \u3054\
    ...
    \ = [&](auto self, vc<int>& p, int sum) -> void {\n    if (sum == N) {\n     \
    \ query(p);\n      return;\n    }\n    int nxt = (len(p) == 0 ? N : p.back());\n\
    \    chmin(nxt, N - sum);\n    p.eb(0);\n    FOR3_R(x, 1, nxt + 1) {\n      p.back()\
    \ = x;\n      self(self, p, sum + x);\n    }\n    p.pop_back();\n  };\n  vc<int>\
    \ p;\n  dfs(dfs, p, 0);\n}"
  ...
  requiredBy: []
  timestamp: '2022-04-30 19:52:08+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: seq/enumerate_partitions.hpp
layout: document
redirect_from:
- /library/seq/enumerate_partitions.hpp
- /library/seq/enumerate_partitions.hpp.html
